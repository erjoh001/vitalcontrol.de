...
C.Canvas={C0:null,AEl:null,QK:A.wg,Ps:0,Ay3:false,La:function(){if(this.Ay3)this.
DetachBitmap();},Init:function(aArg){this.OK=true;},ArI:function(E){if((E[0]<=0)||(
E[1]<=0))E=Cc;if(A.aaX(E,this.FrameSize))return;if(this.Ay3)throw new Error(BD);
...
1;this.Ps>=0;this.Ps--)this.Au9(this.QK,this.QK,0x00000000,0x00000000,0x00000000
...
this):null;this.QK=E6;}},DetachBitmap:function(){if(!this.Ay3)throw new Error(Hp
);this.bitmap=null;this.Ay3=false;this.FrameSize=Cc;this.FrameDelay=0;this.NoOfFrames=
1;this.Vw=false;return this;},AttachBitmap:function(aBitmap){if(!!this.bitmap)throw new
Error(IS);if(!aBitmap)return this;this.bitmap=aBitmap;this.Ay3=true;var noOfFrames=
...
Ago>4096))||(IW>4096)){A.ab5("%s",P3);return;}J7=J7/IW;J8=J8/IW;var x1=Ape+(J8*Aix
);var y1=Apf-(J7*Aix);var x2=Apg+(J8*Aiy);var y2=Aph-(J7*Aiy);var x3=Apg-(J8*Aiy
);var y3=Aph+(J7*Aiy);var x4=Ape-(J8*Aix);var y4=Apf+(J7*Aix);var BeU=A.aaL(A.aci.
...
B=this.C0)&&(B._cycle!=D))B._Mark(B._cycle=D);if((B=this.AEl)&&((B=B[0])._cycle!=
...
0,AlH:true,ABW:function(aX,aY){var Vm=((aX*this.QV)+(aY*this.QW))+this.Wd;var BY=((
...
QV)+(aY*this.QW))+this.Wd;var BY=((aX*this.T4)+(aY*this.T5))+this.We;var AAO=1;if(
!!BY&&(BY!==1)){Eo=Eo/BY;Dg=Dg/BY;Vm=Vm/BY;}if(AtE!==-Vm)AAO=1/(Vm+AtE);if(!!AtE
)AAO=AAO*AtE;this.P0=Eo*AAO;this.P1=Dg*AAO;this.UM=Vm+AtE;return true;},BiT:function(
...
AI5,AI6,AI7){this.V$=this.V$*AI5;this.Wa=this.Wa*AI6;this.YV=this.YV*AI7;this.Wb=
this.Wb*AI5;this.Wc=this.Wc*AI6;this.YX=this.YX*AI7;this.QV=this.QV*AI5;this.QW=
this.QW*AI6;this.YZ=this.YZ*AI7;this.T4=this.T4*AI5;this.T5=this.T5*AI6;this.Y0=
this.Y0*AI7;this.AlH=false;return this;},Bpf:function(AIX,AIY,AIZ){this.YW=((this.
YW+(this.V$*AIX))+(this.Wa*AIY))+(this.YV*AIZ);this.YY=((this.YY+(this.Wb*AIX))+(
this.Wc*AIY))+(this.YX*AIZ);this.Wd=((this.Wd+(this.QV*AIX))+(this.QW*AIY))+(this.
YZ*AIZ);this.We=((this.We+(this.T4*AIX))+(this.T5*AIY))+(this.Y0*AIZ);this.AlH=false;
return this;},ADM:function(){return this.AlH||((((((((((((((((this.V$===1)&&!this.
Wa)&&!this.YV)&&!this.YW)&&!this.Wb)&&(this.Wc===1))&&!this.YX)&&!this.YY)&&!this.
QV)&&!this.QW)&&(this.YZ===1))&&!this.Wd)&&!this.T4)&&!this.T5)&&!this.Y0)&&(this.
We===1));},ANE:function(Ah6,Ah9,Ah7,Ah_,AoM,AoN,Ah8,Ah$){var Azt=Ah7-AoM;var Azv=
Ah_-AoN;var Azu=Ah8-AoM;var Azw=Ah$-AoN;var AA8=((Ah6-Ah7)+AoM)-Ah8;var AA9=((Ah9-
Ah_)+AoN)-Ah$;var Ao0=(Azt*Azw)-(Azv*Azu);if(!Ao0)return null;this.QV=((AA8*Azw)-(
AA9*Azu))/Ao0;this.QW=((Azt*AA9)-(Azv*AA8))/Ao0;this.YZ=0;this.Wd=1;this.V$=(Ah7-
...
Ah$){var Azt=Ah7-AoM;var Azv=Ah_-AoN;var Azu=Ah8-AoM;var Azw=Ah$-AoN;var AA8=((Ah6-
Ah7)+AoM)-Ah8;var AA9=((Ah9-Ah_)+AoN)-Ah$;var Ao0=(Azt*Azw)-(Azv*Azu);this.A15=false;
if(!Ao0)return;var Aiz=((AA8*Azw)-(AA9*Azu))/Ao0;var BI=((Azt*AA9)-(Azv*AA8))/Ao0;
...
null),A5$:null,A42:null,attrSet:null,Aze:A.abi(10,0,{0:0xFF000000}),La:function(
...
inx=inx+1){var entry=this.Aze.Get(inx);if(entry!==0x00000000)A.abF(handle,inx,entry
...
},Blh:function(E){this.AGt(3,E);},A9f:function(E){this.AGt(2,E);},A9e:function(E
){this.AGt(1,E);},Ahj:function(E){this.AGt(0,E);},AUj:function(aFontNo,AfF){var Adg=
...
)Xg=256;Xg=Xg-4;if((Xg>0)&&!this.Aid){this.Aid=A._NewObject(C.ABL,0);HW=true;}if(
!Xg&&!!this.Aid){this.Aid=null;HW=true;}var Bz=this.Aid;while(Xg>0){if((Xg>20)&&
!Bz.Ah){Bz.Ah=A._NewObject(C.ABL,0);HW=true;}Xg=Xg-20;if(Xg>0)Bz=Bz.Ah;}if(!!Bz&&
...
256)Xe=256;Xe=Xe-10;if((Xe>0)&&!this.AfQ){this.AfQ=A._NewObject(C.ABJ,0);HW=true;
}if(!Xe&&!!this.AfQ){this.AfQ=null;HW=true;}var Bz=this.AfQ;while(Xe>0){if((Xe>20
)&&!Bz.Ah){Bz.Ah=A._NewObject(C.ABJ,0);HW=true;}Xe=Xe-20;if(Xe>0)Bz=Bz.Ah;}if(!!
Bz&&!!Bz.Ah){Bz.Ah=null;HW=true;}if(HW){this.AJN();A.we(this,1);}},Bis:function(
){var CB=10;var Bz=this.AfQ;while(!!Bz){CB=CB+20;Bz=Bz.Ah;}return CB;},AGt:function(
aColorNo,aColor){var Ac7=aColorNo;var HW=false;if(Ac7<0)return;if(Ac7<10){HW=this.
Aze.Get(Ac7)!==aColor;this.Aze.Set(Ac7,aColor);}else{var Bz=this.Aic;Ac7=Ac7-10;
...
10;if(Xf>256)Xf=256;Xf=Xf-10;if((Xf>0)&&!this.Aic){this.Aic=A._NewObject(C.ABK,0
);HW=true;}if(!Xf&&!!this.Aic){this.Aic=null;HW=true;}var Bz=this.Aic;while(Xf>0
){if((Xf>20)&&!Bz.Ah){Bz.Ah=A._NewObject(C.ABK,0);HW=true;}Xf=Xf-20;if(Xf>0)Bz=Bz.
...
C.AttrSet.Xl;(this.Aze=[]).__proto__=C.AttrSet.Aze;this.__proto__=C.AttrSet;this.
Apb.Set(0,A.aaL(A.aci.ACq));this.Xl.Set(0,A.aaL(A.aci.TH));this.A5$=A.aaL(A.aci.
ACq);this.A42=A.aaL(A.aci.TH);A.h7++;},_Done:function(){this.La();this.__proto__=
...
null,_className:"Graphics::Path"};C.AuV={Left:0x1,ZN:0x2,Right:0x4,A43:0x8,BDJ:0x10
};C.BDp={BDd:0,BEh:1};C.BEp={BCy:0,BD5:1,BnT:2};C.BEo={BDr:0,BE_:1,BnT:2,AxK:3};
C.BCq={BCp:0,BE5:1,BEt:2,BEu:3,BEw:4,BEv:5};C.AMA={NL:360,JV:0,Ip:0,Q$:0,Ai_:function(
...
JV)||(((((this.Q$===2)||(this.Q$===3))||(this.Q$===4))||(this.Q$===5))&&((0>=this.
...
Q$){this.Js(0,FT+1);this.Js(1,0);this.Fk(0,0,0,this.Ip,this.JV,0,FC,FT);return;}
if(this.Q$===1){this.Js(0,FT+1);this.Js(1,0);this.Fk(0,0,0,this.Ip,this.JV,0,FC,
FT);this.VJ(0);return;}if(this.Q$===2){this.Js(0,FT+1);this.Js(1,0);this.VB(0,0,
0);this.Fk(0,0,0,this.Ip,this.JV,0,FC,FT);this.VJ(0);return;}if(this.Q$===4){var
...
);return;}if(this.Q$===5){var JB=FC;var On=this.Ip*Math.cos(JB*A.k$);var AiM=this.
...
2,AiM/2,LE/2,LE/2,JB,JB-180,Ti);this.VJ(0);return;}if(this.Q$===3){var Ai5=this.
...
0,Aiq/2,Air/2,Adb/2,Adb/2,JB,JB-180,Apv);}this.VJ(0);return;}if(this.Q$===2){this.
...
180,0,Ti);}this.VJ(0);return;}if(this.Q$===5){var JB=FC;var sin=Math.sin(JB*A.k$
...
this.NL,this.NL-FC,FT);}this.VJ(0);return;}if(this.Q$===3){var JB=FC;var Byu=Math.
...
,this);},BmM:function(E){if((E===this.Ip)&&(E===this.JV))return;this.Ip=E;this.JV=
E;if(!!this.NL)A.pe([this,this.Ai_],this);},BmW:function(E){if(E===this.Q$)return;
this.Q$=E;if((!!this.NL&&(this.Ip>0))&&(this.JV>0))A.pe([this,this.Ai_],this);},
