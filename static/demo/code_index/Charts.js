...
,AmN:0,Abb:A.wf,Ash:Ce,A5w:0xFF000000,ADx:0xFF6E0E0C,AHf:0xFF6E0E0C,OG:BD,AqG:0,
Ko:function(CY,aClip,aOffset,Ck,aBlend){var B;var XH=0;var XI=0;var AAN=0;var AAO=
...
Dh=this.Abb[1]+RF;Dh>=RF;Dh=Dh-this.OG[1])CY.Au9(aClip,[RE,Dh],[RE+((B=this.M)[2
]-B[0]),Dh],Aps,Aps,aBlend);for(Dh=(this.Abb[1]+RF)+this.OG[1];Dh<(RF+((B=this.M
)[3]-B[1]));Dh=Dh+this.OG[1])CY.Au9(aClip,[RE,Dh],[RE+((B=this.M)[2]-B[0]),Dh],Aps
,Aps,aBlend);}if(((this.AHf>>24)&0xFF)>0){var Ep;for(Ep=this.Abb[0]+RE;Ep>=RE;Ep=
Ep-this.OG[0])CY.Au9(aClip,[Ep,RF],[Ep,RF+((B=this.M)[3]-B[1])],Ap$,Ap$,aBlend);
for(Ep=(this.Abb[0]+RE)+this.OG[0];Ep<(RE+((B=this.M)[2]-B[0]));Ep=Ep+this.OG[0]
)CY.Au9(aClip,[Ep,RF],[Ep,RF+((B=this.M)[3]-B[1])],Ap$,Ap$,aBlend);}if(!this.EZ)
return;var JA=this.EZ.AlK;if(!!JA){XH=(RE+this.Abb[0])+(JA.P7*this.Ash[0]);XI=(RF+
this.Abb[1])+(JA.P8*this.Ash[1]);JA=JA.Ah;}while(!!JA){AAN=(RE+this.Abb[0])+(JA.
P7*this.Ash[0]);AAO=(RF+this.Abb[1])+(JA.P8*this.Ash[1]);var J$=AAN-XH;var Ka=AAO-
XI;var IY=Math.sqrt((J$*J$)+(Ka*Ka));if(!!IY){J$=J$/IY;Ka=Ka/IY;}if(!!this.Arl)CY.
AhV(aClip,this.Arl,0,XH-(Ka*AlU),XI+(J$*AlU),1,XH+(Ka*AlU),XI-(J$*AlU),1,AAN+(Ka
...
aClip,this.Pw,this.AqG,XH-RD,XI-RD,1,XH+RD,XI-RD,1,XH+RD,XI+RD,1,XH-RD,XI+RD,1,[
0,0,this.Pw.FrameSize[0],this.Pw.FrameSize[1]],Ao9,Ao9,Ao9,Ao9,aBlend,true);XH=AAN;
XI=AAO;JA=JA.Ah;}if((this.AmN>0)&&!!this.Pw)CY.AhV(aClip,this.Pw,this.AqG,XH-RD,
XI-RD,1,XH+RD,XI-RD,1,XH+RD,XI+RD,1,XH-RD,XI+RD,1,[0,0,this.Pw.FrameSize[0],this.
...
null,AY:0,AEg:10,Yi:function(){this.AlK=null;this.AAe=null;this.AY=0;},Aqg:function(
...
null}};C.SM={WQ:null,Ags:null,N5:null,AGe:270,AGy:1,Ko:function(CY,aClip,aOffset
,Ck,aBlend){var Vo;var Bda;Vo=0;Bda=this.AGe;while(Vo<0)Vo=Vo+360;while(Vo>=360)
Vo=Vo-360;var RE=(((this.M[2]+this.M[0])/2)|0)+aOffset[0];var RF=(((this.M[3]+this.
M[1])/2)|0)+aOffset[1];A.Core.P.Ko.call(this,CY,aClip,aOffset,Ck,aBlend);if(!!this.
N5&&(this.N5.AG6>0)){var Hh=this.N5.K1;while(!!Hh){var FF=(Hh.A5/this.N5.AG6)*Bda;
this.Bdg(CY,aClip,RE,RF,Vo,FF,this.AGy,0,Hh.AQ,Ck,aBlend);Vo=Vo+FF;if(Vo>=360)Vo=
Vo-360;Hh=Hh.Ah;}}else this.Bdg(CY,aClip,RE,RF,Vo,this.AGe,this.AGy,0,0xFF800000
...
E===this.WQ)return;this.WQ=E;this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},BnQ:function(
E){var B;if(E<0.01)E=0.01;if(E>1.1)E=1.1;if(E===this.AGy)return;this.AGy=E;this.
Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},Bdg:function(CY,aClip,aX,aY,aStartAngle
,Xj,Alo,A01,aColor,Ck,aBlend){var B;var JI;var JB;var Agl;var Agm;var Agn;var Ago;
var BfL;var BfM;var Al7;var Al8;var LB;var B3=aColor;var Kh=(((Ck+1)*this.G9)>>8
)+1;aBlend=aBlend&&((this.U&0x2)===0x2);if(Kh<256)B3=(B3&0x00FFFFFF)|((((((B3>>24
)&0xFF)*Kh)>>8)&0xFF)<<24);if(!this.WQ)return;var BY=this.WQ.FrameSize[0];var BI=
this.WQ.FrameSize[1];var I1=0;if(Xj>=360){aStartAngle=0;Xj=360;}if(A01>0){var Bdc=
aStartAngle+(Xj/2);JI=Math.sin(Bdc*A.k$);JB=Math.cos(Bdc*A.k$);aX=aX+((A01*JI)|0
);aY=aY-((A01*JB)|0);}while(aStartAngle>=90){aStartAngle=aStartAngle-90;I1=I1+90;
}if(!this.Ags||!A.aaX(this.Ags.FrameSize,this.WQ.FrameSize)){this.Ags=A._NewObject(
A.Graphics.Canvas,0);this.Ags.ArQ(this.WQ.FrameSize);}if((aStartAngle>0)&&((aStartAngle+
Xj)<90)){JI=Math.sin(Xj*A.k$);JB=Math.cos(Xj*A.k$);Agl=(-BY*JB)+(BI*JI);Agm=(-BI
...
,0x00000000,false);this.Ags.AhV([0,0,BY,BI],this.WQ,0,Agl,Agm+BI,1,Agn,Ago+BI,1,
...
*JB)+(BI*JI);Ago=(-BI*JB)+(BY*JI);BfL=BY*JB;BfM=BY*JI;CY.AhV(aClip,this.Ags,0,Agl+
aX,Agm+aY,1,Agn+aX,Ago+aY,1,BfL+aX,BfM+aY,1,aX,aY,1,[0,0,BY,BI],0xFFFFFFFF,0xFFFFFFFF
...
10000,aY,aX,10000];else LB=[-10000,-10000,aX,aY];CY.AhV(A.lb(aClip,LB),this.WQ,0
,Agl+aX,Agm+aY,1,Agn+aX,Ago+aY,1,aX,aY,1,Al7+aX,Al8+aY,1,[0,0,BY,BI],B3,B3,B3,B3
,aBlend,true);I1=I1+90;if(I1>=360)I1=I1-360;Xj=Xj-(90-aStartAngle);}while(Xj>=90
...
,aY,aX,10000];else LB=[-10000,-10000,aX,aY];CY.AhV(A.lb(aClip,LB),this.WQ,0,Agl+
aX,Agm+aY,1,Agn+aX,Ago+aY,1,aX,aY,1,Al7+aX,Al8+aY,1,[0,0,BY,BI],B3,B3,B3,B3,aBlend
,true);I1=I1+90;if(I1>=360)I1=I1-360;Xj=Xj-90;}JI=Math.sin((Xj+I1)*A.k$)*Alo;JB=
Math.cos((Xj+I1)*A.k$)*Alo;Agl=(-BY*JB)+(BI*JI);Agm=(-BI*JB)-(BY*JI);Agn=BI*JI;Ago=-
...
,aX,aY];CY.AhV(A.lb(aClip,LB),this.WQ,0,Agl+aX,Agm+aY,1,Agn+aX,Ago+aY,1,aX,aY,1,
...
){A.Core.P._Init.call(this,aArg);this.__proto__=C.SM;this.H(IU);this.WQ=A.aaL(C.
AT2);},_Mark:function(D){var B;A.Core.P._Mark.call(this,D);if((B=this.WQ)&&(B._cycle
...
"Charts::Record"};C.AUs={K1:null,MX:null,AY:10,AG6:0,Ot:function(A7,aColor){var Hh;
...
B=C.AT3[0]._this)&&(B._cycle!=D))B._Done(C.AT3[0]._this=null);if((B=C.ACE[0]._this
