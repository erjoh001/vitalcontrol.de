...
,AmR:0,Abl:A.wf,Asp:Cf,A5Q:0xFF000000,ADM:0xFF6E0E0C,AHs:0xFF6E0E0C,ON:BD,AqO:0,
Ks:function(C0,aClip,aOffset,Ck,aBlend){var B;var XO=0;var XP=0;var AA1=0;var AA2=
...
Di=this.Abl[1]+RJ;Di>=RJ;Di=Di-this.ON[1])C0.Avb(aClip,[RI,Di],[RI+((B=this.M)[2
]-B[0]),Di],Apx,Apx,aBlend);for(Di=(this.Abl[1]+RJ)+this.ON[1];Di<(RJ+((B=this.M
)[3]-B[1]));Di=Di+this.ON[1])C0.Avb(aClip,[RI,Di],[RI+((B=this.M)[2]-B[0]),Di],Apx
,Apx,aBlend);}if(((this.AHs>>24)&0xFF)>0){var Ep;for(Ep=this.Abl[0]+RI;Ep>=RI;Ep=
Ep-this.ON[0])C0.Avb(aClip,[Ep,RJ],[Ep,RJ+((B=this.M)[3]-B[1])],Aqf,Aqf,aBlend);
for(Ep=(this.Abl[0]+RI)+this.ON[0];Ep<(RI+((B=this.M)[2]-B[0]));Ep=Ep+this.ON[0]
)C0.Avb(aClip,[Ep,RJ],[Ep,RJ+((B=this.M)[3]-B[1])],Aqf,Aqf,aBlend);}if(!this.EZ)
return;var JF=this.EZ.AlO;if(!!JF){XO=(RI+this.Abl[0])+(JF.P_*this.Asp[0]);XP=(RJ+
this.Abl[1])+(JF.P$*this.Asp[1]);JF=JF.Ah;}while(!!JF){AA1=(RI+this.Abl[0])+(JF.
P_*this.Asp[0]);AA2=(RJ+this.Abl[1])+(JF.P$*this.Asp[1]);var Ke=AA1-XO;var Kf=AA2-
XP;var I5=Math.sqrt((Ke*Ke)+(Kf*Kf));if(!!I5){Ke=Ke/I5;Kf=Kf/I5;}if(!!this.Aru)C0.
AhV(aClip,this.Aru,0,XO-(Kf*AlY),XP+(Ke*AlY),1,XO+(Kf*AlY),XP-(Ke*AlY),1,AA1+(Kf
...
aClip,this.PA,this.AqO,XO-RH,XP-RH,1,XO+RH,XP-RH,1,XO+RH,XP+RH,1,XO-RH,XP+RH,1,[
0,0,this.PA.FrameSize[0],this.PA.FrameSize[1]],Apc,Apc,Apc,Apc,aBlend,true);XO=AA1;
XP=AA2;JF=JF.Ah;}if((this.AmR>0)&&!!this.PA)C0.AhV(aClip,this.PA,this.AqO,XO-RH,
XP-RH,1,XO+RH,XP-RH,1,XO+RH,XP+RH,1,XO-RH,XP+RH,1,[0,0,this.PA.FrameSize[0],this.
PA.FrameSize[1]],this.AmQ,this.AmQ,this.AmQ,this.AmQ,aBlend,true);},Ae2:function(
...
,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},BmL:function(E){var B;if(E===this.AmQ)return;
this.AmQ=E;this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},ATp:function(E){var B;if(
E<1)E=0;if(E>25)E=25;this.AmR=E;this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},BmH:
function(E){var B;if(A.aaX(E,this.Abl))return;this.Abl=E;this.Bj([0,0,(B=this.M)[
2]-B[0],B[3]-B[1]]);},Bn1:function(E){var B;if(!E[0])E=[1,E[1]];if(!E[1])E=[E[0]
,1];if(A.aaX(E,this.Asp))return;this.Asp=E;this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-
B[1]]);},Bmv:function(E){if(E===this.A5Q)return;this.A5Q=E;this.Background.L(E);
},Bni:function(E){var B;if(E===this.ADM)return;this.ADM=E;this.Bj([0,0,(B=this.M
)[2]-B[0],B[3]-B[1]]);},Bom:function(E){var B;if(E===this.AHs)return;this.AHs=E;
...
null,A0:0,AEv:10,Yq:function(){this.AlO=null;this.AAr=null;this.A0=0;},Aqm:function(
aX,aY){var JF=null;if((this.AEv>0)&&(this.A0===this.AEv)){JF=this.AlO;this.AlO=JF.
Ah;JF.Ah=null;this.A0=this.A0-1;}else JF=A._NewObject(C.A6h,0);JF.P_=aX;JF.P$=aY;
if(!this.AlO){this.AlO=JF;this.AAr=JF;this.A0=1;}else{this.AAr.Ah=JF;this.AAr=JF;
this.A0=this.A0+1;}},AwZ:function(E){if(E<1)E=1;this.AEv=E;},_Init:function(aArg
...
null}};C.SS={WZ:null,Agu:null,N$:null,AGr:270,AGL:1,Ks:function(C0,aClip,aOffset
,Ck,aBlend){var Vw;var Bdv;Vw=0;Bdv=this.AGr;while(Vw<0)Vw=Vw+360;while(Vw>=360)
Vw=Vw-360;var RI=(((this.M[2]+this.M[0])/2)|0)+aOffset[0];var RJ=(((this.M[3]+this.
M[1])/2)|0)+aOffset[1];A.Core.P.Ks.call(this,C0,aClip,aOffset,Ck,aBlend);if(!!this.
N$&&(this.N$.AHh>0)){var Hj=this.N$.K5;while(!!Hj){var FF=(Hj.A5/this.N$.AHh)*Bdv;
this.BdB(C0,aClip,RI,RJ,Vw,FF,this.AGL,0,Hj.AQ,Ck,aBlend);Vw=Vw+FF;if(Vw>=360)Vw=
Vw-360;Hj=Hj.Ah;}}else this.BdB(C0,aClip,RI,RJ,Vw,this.AGr,this.AGL,0,0xFF800000
,Ck,aBlend);},Bn0:function(E){var B;if(E<0)E=0;if(E>360)E=360;if(E===this.AGr)return;
this.AGr=E;this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},Boa:function(E){var B;if(
E===this.WZ)return;this.WZ=E;this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},Bn_:function(
...
,Xr,Als,A1k,aColor,Ck,aBlend){var B;var JO;var JG;var Agn;var Ago;var Agp;var Agq;
...
this.WZ.FrameSize[1];var I7=0;if(Xr>=360){aStartAngle=0;Xr=360;}if(A1k>0){var Bdx=
aStartAngle+(Xr/2);JO=Math.sin(Bdx*A.k$);JG=Math.cos(Bdx*A.k$);aX=aX+((A1k*JO)|0
);aY=aY-((A1k*JG)|0);}while(aStartAngle>=90){aStartAngle=aStartAngle-90;I7=I7+90;
}if(!this.Agu||!A.aaX(this.Agu.FrameSize,this.WZ.FrameSize)){this.Agu=A._NewObject(
A.Graphics.Canvas,0);this.Agu.ArY(this.WZ.FrameSize);}if((aStartAngle>0)&&((aStartAngle+
Xr)<90)){JO=Math.sin(Xr*A.k$);JG=Math.cos(Xr*A.k$);Agn=(-BZ*JG)+(BL*JO);Ago=(-BL
...
,0x00000000,false);this.Agu.AhV([0,0,BZ,BL],this.WZ,0,Agn,Ago+BL,1,Agp,Agq+BL,1,
...
10000,aY,aX,10000];else LI=[-10000,-10000,aX,aY];C0.AhV(A.lb(aClip,LI),this.WZ,0
...
,aY,aX,10000];else LI=[-10000,-10000,aX,aY];C0.AhV(A.lb(aClip,LI),this.WZ,0,Agn+
aX,Ago+aY,1,Agp+aX,Agq+aY,1,aX,aY,1,Al$+aX,Ama+aY,1,[0,0,BZ,BL],B4,B4,B4,B4,aBlend
,true);I7=I7+90;if(I7>=360)I7=I7-360;Xr=Xr-90;}JO=Math.sin((Xr+I7)*A.k$)*Als;JG=
Math.cos((Xr+I7)*A.k$)*Als;Agn=(-BZ*JG)+(BL*JO);Ago=(-BL*JG)-(BZ*JO);Agp=BL*JO;Agq=-
...
,aX,aY];C0.AhV(A.lb(aClip,LI),this.WZ,0,Agn+aX,Ago+aY,1,Agp+aX,Agq+aY,1,aX,aY,1,
Al$+aX,Ama+aY,1,[0,0,BZ,BL],B4,B4,B4,B4,aBlend,true);}},Acd:function(E){var B;this.
...
AUf);},_Mark:function(D){var B;A.Core.P._Mark.call(this,D);if((B=this.WZ)&&(B._cycle
...
"Charts::Record"};C.AUH={K5:null,M4:null,A0:10,AHh:0,OA:function(A8,aColor){var Hj;
Hj=A._NewObject(C.Record,0);Hj.A5=A8;Hj.AQ=aColor;if(!this.K5){this.K5=Hj;this.M4=
Hj;this.A0=1;}else{this.M4.Ah=Hj;this.M4=Hj;this.A0=this.A0+1;}this.AHh=this.AHh+
