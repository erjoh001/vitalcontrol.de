...
Ss="1,2";var T$="0,1,2";var Zg="3900,3950,4000";var Wb="4050,4100,4150";var IM="Read only";
var Ua="Unknown data export type: ";var Zh="Unhandled Device::DataExportType: ";
var Wc="0,2";var Zi="650,150";var Ub="800,200";var Zj="40000,4000";var Zk="32,7,34,18,23,14";
var Uc="Simulate Scan";var Wd="BNR15;LOM;GEB_DATR;RASSE;GESCHL_R;GEB_VERL;VERBLEIB;MEHRLADR;LOM_MUT\n";
var QV="%d.%m.%Y";var Zl="1";var OO="2";var PK="Unknown gender: ";var Ud="text/csv";
var Zm="National-ID-Animal;Farm-ID-Animal;Transponder-ID;DateOfBirth;Sex;BirthWeight-Kg\n";
var We="hit-geburt-%d-%m-%Y_%H-%M.csv";var Zn="animals-%d-%m-%Y_%H-%M.csv";var Zo=
"hit-zugang-%d-%m-%Y_%H-%M.csv";var Wf="herde-zugang-%d-%m-%Y_%H-%M.csv";var Wg=
"M";var St="F";var Zp="?";var Zq="%Y-%m-%d";var AbO="BNR15;LOM;ZUGA_DAT\n";var Su=
...
var Zr="Transaction not opened.";var Wh="Wrong transaction ID.";var Wi="Unhandled TableId:";
...
);},XV:function(){var K=this.K;return K.Gv.XV();},YZ:function(Ab,AX,CX){var K=this.
K;return K.Gv.YZ(Ab,AX,CX);},G$:function(Ab,AX,CX){var K=this.K;return K.Gv.G$(Ab
,AX,CX);},YY:function(Ab,AX,CX){var K=this.K;return K.Gv.YY(Ab,AX,CX);},Nb:function(
Ab,AX,CX){var K=this.K;return K.Gv.Nb(Ab,AX,CX);},YX:function(Ab,AX,CX){var K=this.
K;return K.Gv.YX(Ab,AX,CX);},K4:function(aColumn,A1){var K=this.K;return K.Gv.K4(
...
K;return K.Gv.Hz();},AaA:function(){var K=this.K;return K.Gv.AaA();},Qd:function(
...
AEr={SF:A.aan(42,null,null),CE:function(aColumn){var B;this.ZB(aColumn);var An=(
C.ABY.isPrototypeOf(B=this.SF.Get(aColumn))?B:null);if(!!An)return An.A4;return 0;
},Va:function(aColumn){var B;this.ZB(aColumn);var An=(C.String.isPrototypeOf(B=this.
SF.Get(aColumn))?B:null);if(!!An)return An.A4;return A.jm;},HW:function(aColumn){
var B;this.ZB(aColumn);var An=(C.Az9.isPrototypeOf(B=this.SF.Get(aColumn))?B:null
);if(!!An)return An.A4;else A.aa8("%s",(B$+aColumn.toFixed())+BH);return false;}
,G$:function(aColumn,A1){this.ZB(aColumn);var An=A._NewObject(C.ABY,0);An.A4=A1;
this.SF.Set(aColumn,An);return true;},YX:function(aColumn,A1){this.ZB(aColumn);var
An=A._NewObject(C.String,0);An.A4=A1;this.SF.Set(aColumn,An);return true;},Nb:function(
aColumn,A1){this.ZB(aColumn);var An=A._NewObject(C.Az9,0);An.A4=A1;this.SF.Set(aColumn
,An);return true;},ZB:function(aColumn){if((aColumn<0)||(aColumn>=42))throw new Error((
...
throw new Error(IL+EE.toFixed());}},Vb:function(aColumn){var B;this.ZB(aColumn);
var An=(C.AE8.isPrototypeOf(B=this.SF.Get(aColumn))?B:null);if(!!An)return An.A4;
return 0;},YZ:function(aColumn,A1){this.ZB(aColumn);var An=A._NewObject(C.AE8,0);
...
H4;default:throw new Error(IL+EE.toFixed());}},RQ:function(aColumn){var B;this.ZB(
aColumn);var An=(C.AE6.isPrototypeOf(B=this.SF.Get(aColumn))?B:null);if(!!An)return An.
A4;return 0;},YY:function(aColumn,A1){this.ZB(aColumn);var An=A._NewObject(C.AE6
...
ZB(aColumn);var An=(C.AE7.isPrototypeOf(B=this.SF.Get(aColumn))?B:null);if(!!An)
return An.A4;return 0;},TQ:function(aColumn,A1){this.ZB(aColumn);var An=A._NewObject(
...
};C.DeviceClass={AsT:null,AHQ:null,Ah$:null,ZZ:null,C3:function(){var K=this.K;K.
A73.call(this,this);},Init:function(aArg){var K=this.K;var B;this.YC(3);A.za([this
,K.Azl],[B=K.AsT,B.A53,B.AQ3],0);this.UpdateAutoActions(OK);K.A73.call(this,this
...
function(Ahq){},AvX:function(){A.Device.DeviceClass.A9s.call(this);this.YC(1);},
AEo:function(){A.Device.DeviceClass.A9q.call(this);this.YC(2);},Cm:function(E){this.
...
E);},YJ:function(E){this.UpdateRGBTopLight(E);},AuV:function(E){this.UpdateAutoRegistrationMode(
...
E);},Aqe:function(E){A.Device.DeviceClass.A9m.call(this,E);this.UpdateActiveActions(
E);},Aqf:function(E){A.Device.DeviceClass.A9n.call(this,E);this.UpdateActiveActionsOrder(
E);},Abc:function(E){A.Device.DeviceClass.A9o.call(this,E);this.UpdateAutoActions(
E);},AEP:function(){var K=this.K;this.UpdateMeasureState(1);K.BxO.call(this,this
);},Arf:function(){var K=this.K;var B;K.ZZ.Av3(this);this.UpdateMeasureState(0);
...
UpdateTemperaturesLowString(E);},Aq2:function(H){this.AuT(T$);this.AqF(Zg);this.
...
){A.Device.DeviceClass.A9t.call(this);A._GetAutoObject(A.kh.A0).BZ(61);},AmC:function(
...
E);},Are:function(){var B;A.ow([B=A._GetAutoObject(C.Arc),B.BcE],this);},Avo:function(
...
Ahk;result.FileName=K.Bff.call(this,Ahk);switch(Ahk){case 0:K.BuL.call(this,result
...
jm,0,[this,K.A0t]);break;default:throw new Error(Zh+Ni.AAB.toFixed());}},ADI:function(
...
E);},Aq3:function(H){this.AuU(Wc);this.AqK(Zi);this.AqJ(Ub);this.AqI(Ub);this.AqL(
Zj);},AqJ:function(E){this.UpdateWeightGainsHighString(E);},AqK:function(E){this.
...
H){this.Aqh(A.jm);this.Aqi(Zk);},ADo:function(E){this.UpdateMassRecordingDateOfBirthMandatory(
...
H){var K=this.K;var B;if((this.MeasureState===1)&&K.AsT.AvY)K.ZZ.AEO(this);},Byp:
function(H){this.UpdateMeasureState(3);},ARt:function(H){var K=this.K;var B;A.za([
B=A._GetAutoObject(A.Device.Helper),B.AI4],[B=K.AsT,B.A54,B.AQ4],0);this.Rt.AC4(
A._GetAutoObject(A.Device.Helper).A34(8));this.R3.AC4(A._GetAutoObject(A.Device.
Helper).A34(8));},A73:function(H){var Ax0=A._NewObject(A.Device.Av0,0);Ax0.OnSetTimestamp(
...
,A._GetAutoObject(A.Device.Device).YO)+String.fromCharCode(0x3B))+K.AhL.call(this
,B4.NaisId))+String.fromCharCode(0x3B))+K.AIa.call(this,B4.DateOfBirth))+String.
fromCharCode(0x3B))+K.A$H.call(this,B4.Breed))+String.fromCharCode(0x3B))+K.A$G.
call(this,B4.Gender))+String.fromCharCode(0x3B))+K.Bva.call(this,B4.EaseOfDelivery
))+String.fromCharCode(0x3B))+K.A$I.call(this,B4.WhereAbouts))+String.fromCharCode(
...
A.Core.Bu,0);Aq.Initialize(AX8);return Aq.Format(QV);},A$H:function(Ab3){if(!Ab3
)return A.jm;return A._GetAutoObject(A.Device.Converter).A2H(Ab3).toFixed();},A$G:
function(LZ){var result=A.jm;switch(LZ){case 0:result=Zl;break;case 1:result=OO;
break;case 2:result=A.jm;break;default:A.aa8("%s",PK+LZ.toFixed());}return result;
},Bva:function(AG5){if(!AG5)return A.jm;return AG5.toFixed();},A$I:function(Ae1){
...
);},BuH:function(Ni){var K=this.K;var B;var SE=Zm;var B4=A._NewObject(A.Device.Animal
...
LW);AcI++;}Ni.AtE=SE;Ni.AEs=AcI;Ni.Am2=true;},Bff:function(Ahk){var AxZ=A.jm;var
Ad=A._NewObject(A.Core.Bu,0);Ad.Initialize(A._GetAutoObject(A.Device.Helper).DB(
));switch(Ahk){case 0:AxZ=Ad.Format(We);break;case 1:AxZ=Ad.Format(Zn);break;case
2:AxZ=Ad.Format(Zo);break;case 3:AxZ=Ad.Format(Wf);break;default:throw new Error(
...
2:result=Zp;break;default:A.aa8("%s",PK+LZ.toFixed());}return result;},Bvf:function(
...
Zq);},BuM:function(Ni){var K=this.K;var B;var SE=AbO;var B4=A._NewObject(A.Device.
...
B4.NaisId>0)){SE=SE+(((((K.AhL.call(this,A._GetAutoObject(A.Device.Device).YO)+String.
...
0x3B))+K.AIa.call(this,B4.DateOfBirth))+String.fromCharCode(0x3B))+K.A$G.call(this
,B4.Gender))+String.fromCharCode(0x3B))+K.A$I.call(this,B4.WhereAbouts))+String.
fromCharCode(0x3B))+K.A$H.call(this,B4.Breed))+String.fromCharCode(0x3B))+K.AIa.
...
_Init.call(K.ZZ={I:this},0);K.__proto__=C.DeviceClass;this.AuW(100);this.AmG(1);
...
ZZ.VN(0);K.ZZ.IF(1);K.ZZ.FA(750);K.ZZ.B1=50000;K.Ah$.R5=[this,K.BxB];K.AsT=A._GetAutoObject(
C.Abw);K.ZZ.R5=[this,K.Byp];K.ZZ.Q=[this,this.ACL,this.AGR];K.Init.call(this,aArg
);A.hJ++;},_Done:function(){var K=this.K;K.__proto__=null;K.Ah$._Done();K.ZZ._Done(
);A.hJ--;},_ReInit:function(){var K=this.K;K.Ah$._ReInit();K.ZZ._ReInit();K.C3.call(
...
B._Mark(B._cycle=D);if((B=this.ZZ)._cycle!=D)B._Mark(B._cycle=D);},_variants:function(
...
HelperClass.A9p.call(this,E);},DB:function(){var K=this.K;return A.Device.HelperClass.
A9l.call(this)+K.A1q;},_Init:function(aArg){var K=this.K;K.__proto__=C.HelperClass;
...
};C.A7_={AvY:false,AEH:false,AQ3:function(E){if(this.AEH===E)return;this.AEH=E;A.
aat([this,this.A53,this.AQ3],0);},A53:function(){return this.AEH;},AQ4:function(
E){if(this.AvY===E)return;this.AvY=E;A.aat([this,this.A54,this.AQ4],0);},A54:function(
){return this.AvY;},BhO:function(){return true;},_Init:function(aArg){this.__proto__=
C.A7_;A.hJ++;},_Done:function(){this.__proto__=null;A.hJ--;},_ReInit:function(){
},_Mark:function(D){var B;if((B=this.I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null
,_cycle:0,_observers:null,_className:"DeviceSimulation::SimulationConfigClass"};
C.Abw={_Init:function(){C.A7_._Init.call(this,0);},_variants:function(){return A.
...
};C.Rating={Cr:function(AF){var Hs=A.Device.Rating.A9r.call(this,AF);if(Hs){var Q5=
...
this.Timestamp)){Q5.A72(Ab,5,this.Temperature);Q5.Aj1(Ab,17,this.RatingTemperature
...
1,9:1}),Bay:512,Aym:-1,AYI:A.aan(15,0,{0:2,1:2,2:2,3:2,4:2,5:3,6:3,7:3,8:3,9:3,10:
...
function(AnI){if(!this.AIm)throw new Error(Zr);if(AnI!==12345)throw new Error(Wh
);this.AIm=false;return true;},XV:function(){return this.A14(A._NewObject(C.AEr,
0));},YZ:function(Ab,AX,CX){var A9=this.Te(Ab);if(!!A9)return A9.YZ(AX,CX);return false;
},G$:function(Ab,AX,CX){var A9=this.Te(Ab);if(!!A9)return A9.G$(AX,CX);return false;
},YY:function(Ab,AX,CX){var A9=this.Te(Ab);if(!!A9)return A9.YY(AX,CX);return false;
...
},OnSetId:function(E){if(this.Id===E)return;this.Id=E;this.A$i();switch(this.Id){
case 0:{this.Bay=128;A.ow([this,this.BsF],this);}break;case 1:A.ow([this,this.BsH
...
);return false;},G_:function(){this.A$i();return true;},Hz:function(){return this.
Bay;},A14:function(Ab){if(this.O2>=512)throw new Error(AeP);this.Gn.Set(this.O2,
...
aIndex<0)||(aIndex>=512))return null;return this.Gn.Get(aIndex);},A$i:function(){
...
0);var P;var BcK=0;for(P=1;P<=7;P=P+1){BcK=3680+(20*P);Oa=BcK>3800;this.Bi(276000312310050+(((
...
A._GetAutoObject(A.Device.Helper).DB();var P;Ad=Ad-2678400;var AhK;var A$z;for(P=
0;P<32;P=P+1){var AZh=this.Bvr();for(;AZh>0;AZh=AZh-1){AhK=this.AZw();A$z=A._GetAutoObject(
A.Device.Converter).Ari(0,AhK);this.AE(Ad,12310020,AhK,A$z,this.AIh(),this.AIh()
...
){this.AH7(s);},Bi:function(Kn,Bs$,Btq,A_o,ArW,LZ,Btg,Btm,Btj,Btk,N5,BsX,Bto,Bti
...
A.Device.Helper).Akc(B4.TransponderId));B4.Abh(Bs$);B4.AmH(Btq);B4.R8(A_o);B4.AjA(
...
Btv);B4.Cr(this);if(N5>0)A._GetAutoObject(C.AvM).AE(A_o,Kn,0,0,0,0,0,0,N5);},AE:
function(LY,Ab1,AnG,BtH,Bs5,Bs6,BsQ,BtJ,BsR){var BW=A._NewObject(A.Device.Rating
,0);BW.Gd();var A_2=A._GetAutoObject(C.Ao9).AMj(26,Ab1);if(A_2>=0)BW.OnSetAnimalId(
A._GetAutoObject(C.Ao9).CE(A_2,0));else A.aa8("%s%U",AeQ,Ab1);BW.OnSetTimestamp(
...
A.Device.AnimalGroup,0);AHr.Gd();AHr.OnSetId(Kn);AHr.ADb(Bta);AHr.Cr(this);},AaA:
...
this,arguments);},BsO:function(H){this.ZK(2016,216,6);this.ZK(2017,217,7);this.ZK(
2018,218,8);this.ZK(2019,219,9);this.ZK(2020,220,10);this.ZK(2021,221,11);},BsG:
function(s){this.AH6(s);},ZK:function(Ab_,Bs1,Bs0){var Un=A._NewObject(A.Device.
...
0,CE:function(Ab,AX){var A9=this.ZI(Ab);if(!!A9)return A9.CE(AX);return 0;},Va:function(
Ab,AX){var A9=this.ZI(Ab);if(!!A9)return A9.Va(AX);return A.jm;},HW:function(Ab,
AX){var A9=this.ZI(Ab);if(!!A9)return A9.HW(AX);return false;},OnSetId:function(
...
Bl.call(this,E);this.AYG(this);},Vb:function(Ab,AX){var A9=this.ZI(Ab);if(!!A9)return A9.
Vb(AX);return 0;},RQ:function(Ab,AX){var A9=this.ZI(Ab);if(!!A9)return A9.RQ(AX);
...
A.Device.Converter).BeV(this.Id,this.Filter));if(!!this.Gh)return this.Gh.A14(A.
_NewObject(C.AEr,0));return-1;},YZ:function(Ab,AX,CX){var A9=this.ZI(Ab);if(!!A9
)return A9.YZ(AX,CX);return false;},G$:function(Ab,AX,CX){var A9=this.ZI(Ab);if(
!!A9)return A9.G$(AX,CX);return false;},YY:function(Ab,AX,CX){var A9=this.ZI(Ab);
if(!!A9)return A9.YY(AX,CX);return false;},Nb:function(Ab,AX,CX){var A9=this.ZI(
Ab);if(!!A9)return A9.Nb(AX,CX);return false;},YX:function(Ab,AX,CX){var A9=this.
ZI(Ab);if(!!A9)return A9.YX(AX,CX);return false;},K4:function(aColumn,A1){if(!!this.
...
Ab,AX){var A9=this.ZI(Ab);if(!!A9)return A9.LD(AX);return 0;},TQ:function(Ab,AX,
CX){var A9=this.ZI(Ab);if(!!A9)return A9.TQ(AX,CX);return false;},Ai0:function(aColumn
...
){if(!!this.Gh)return this.Gh.Hz();return 0;},AaA:function(){if(!!this.Gh)return this.
Gh.AaA();return-1;},Qd:function(){if(!!this.Gh)return this.Gh.O2;return 0;},AYG:
...
AYG],this);},ZI:function(aIndex){if(!!this.Filter){if((aIndex<0)||(aIndex>=128))
...
};C.A7$={Kr:null,AcK:null,A1l:function(H){if(A._GetAutoObject(C.Abw).BhO()===false
...
).Abm(5);this.AcK.Ap(true);}break;case 5:A.ow([this,this.BcE],this);break;case 7:
...
A.Device.Device).Abm(0);A.ow([this,this.A1l],this);}break;default:;}},BcE:function(
...
call(this.AcK={I:this},0);this.__proto__=C.A7$;var B;this.Kr.IF(1);this.AcK.QB(2000
...
};C.Arc={_Init:function(){C.A7$._Init.call(this,0);},_variants:function(){return this;
