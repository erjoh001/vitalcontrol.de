...
S$="1,2";var UT="0,1,2";var Z5="3900,3950,4000";var W7="4050,4100,4150";var It="Read only";
var UU="Unknown data export type: ";var Z6="Unhandled Device::DataExportType: ";
var W8="0,2,1";var Z7="650,150,700";var W9="800,200,900";var Z8="800,200,850";var
Z9="40000,4000,0";var UV="32,7,34,18,23,14";var W_="16384";var O5="1,1024";var Z_=
"Simulate Scan";var O6="BNR15;LOM;GEB_DATR;RASSE;GESCHL_R;GEB_VERL;VERBLEIB;MEHRLADR;LOM_MUT\n";
var Rn="%d.%m.%Y";var W$="1";var Xa="2";var UW="Unknown gender: ";var Z$="text/csv";
var Aaa="National-ID-Animal;Farm-ID-Animal;Transponder-ID;DateOfBirth;Sex;BirthWeight-Kg\n";
var Xb="hit-geburt-%d-%m-%Y_%H-%M.csv";var Xc="animals-%d-%m-%Y_%H-%M.csv";var Ta=
...
var Aac="Nested transactions are not allowed.";var Xd="Transaction not opened.";
var Aad="Wrong transaction ID.";var Xe="Unhandled TableId:";var AhX="Maximum number of rows reached.";
var KZ="Animal row not found in DeviceSimulation::AnimalTableData. NaisId";var AcN=
"10";var Lw="20";var AhY="30";var Aoe="31";var Oc="32";var Xf="Severe: filter set when inserting row into table: ";
...
CF:function(Ad,A4){var K=this.K;return K.GM.CF(Ad,A4);},V1:function(Ad,A4){var K=
this.K;return K.GM.V1(Ad,A4);},H3:function(Ad,A4){var K=this.K;return K.GM.H3(Ad
...
Device.ITable.Bk.call(this,E);K.GM.Bk(E);},V2:function(Ad,A4){var K=this.K;return K.
GM.V2(Ad,A4);},Sm:function(Ad,A4){var K=this.K;return K.GM.Sm(Ad,A4);},Oz:function(
...
,A4,CZ);},ZK:function(Ad,A4,CZ){var K=this.K;return K.GM.ZK(Ad,A4,CZ);},N7:function(
Ad,A4,CZ){var K=this.K;return K.GM.N7(Ad,A4,CZ);},ZJ:function(Ad,A4,CZ){var K=this.
...
AGw={Ti:A.abi(42,null,null),CF:function(aColumn){var B;this.Aao(aColumn);var Aq=(
C.ADW.isPrototypeOf(B=this.Ti.Get(aColumn))?B:null);if(!!Aq)return Aq.A5;return 0;
},V1:function(aColumn){var B;this.Aao(aColumn);var Aq=(C.String.isPrototypeOf(B=
this.Ti.Get(aColumn))?B:null);if(!!Aq)return Aq.A5;return A.jV;},H3:function(aColumn
){var B;this.Aao(aColumn);var Aq=(C.AB2.isPrototypeOf(B=this.Ti.Get(aColumn))?B:
null);if(!!Aq)return Aq.A5;else A.ab5("%s",(Ce+aColumn.toFixed())+BD);return false;
},Ho:function(aColumn,A7){this.Aao(aColumn);var Aq=A._NewObject(C.ADW,0);Aq.A5=A7;
this.Ti.Set(aColumn,Aq);return true;},ZJ:function(aColumn,A7){this.Aao(aColumn);
var Aq=A._NewObject(C.String,0);Aq.A5=A7;this.Ti.Set(aColumn,Aq);return true;},N7:
function(aColumn,A7){this.Aao(aColumn);var Aq=A._NewObject(C.AB2,0);Aq.A5=A7;this.
Ti.Set(aColumn,Aq);return true;},Aao:function(aColumn){if((aColumn<0)||(aColumn>=
42))throw new Error((E7+aColumn.toFixed())+Hr);},BjY:function(AI){if(!!(A.Device.
...
By1(this.V1(AI.EJ),AI.Operator,(A.Device.StringFilterCriterion.isPrototypeOf(AI)?
AI:null).A5);else if(!!(A.Device.BoolFilterCriterion.isPrototypeOf(AI)?AI:null))
return this.By0(this.H3(AI.EJ),AI.Operator,(A.Device.BoolFilterCriterion.isPrototypeOf(
...
AI)?AI:null))return this.By5(this.V2(AI.EJ),AI.Operator,(((B=(A.Device.AssessmentFilterCriterion.
isPrototypeOf(AI)?AI:null).A5)<0)?B+0x100000000:B)&0xFF);else if(!!(A.Device.UInt64FilterCriterion.
isPrototypeOf(AI)?AI:null))return this.By3(this.KP(AI.EJ),AI.Operator,(A.Device.
UInt64FilterCriterion.isPrototypeOf(AI)?AI:null).A5);else if(!!(A.Device.UInt64PartialFilterCriterion.
isPrototypeOf(AI)?AI:null))return this.By4(this.KP(AI.EJ),AI.Operator,(A.Device.
...
toFixed());}},V2:function(aColumn){var B;this.Aao(aColumn);var Aq=(C.AG$.isPrototypeOf(
B=this.Ti.Get(aColumn))?B:null);if(!!Aq)return Aq.A5;return 0;},ZL:function(aColumn
,A7){this.Aao(aColumn);var Aq=A._NewObject(C.AG$,0);Aq.A5=A7;this.Ti.Set(aColumn
...
aColumn){var B;this.Aao(aColumn);var Aq=(C.AG9.isPrototypeOf(B=this.Ti.Get(aColumn
))?B:null);if(!!Aq)return Aq.A5;return 0;},ZK:function(aColumn,A7){this.Aao(aColumn
);var Aq=A._NewObject(C.AG9,0);Aq.A5=A7;this.Ti.Set(aColumn,Aq);return true;},By2:
...
var Aq=(C.AG_.isPrototypeOf(B=this.Ti.Get(aColumn))?B:null);if(!!Aq)return Aq.A5;
return 0;},UB:function(aColumn,A7){this.Aao(aColumn);var Aq=A._NewObject(C.AG_,0
);Aq.A5=A7;this.Ti.Set(aColumn,Aq);return true;},By3:function(Fu,Eb,GB){switch(Eb
...
).ApR(Atx))%A._GetAutoObject(A.Device.Helper).ApR(AI9);var ALv=A.ab0(GB,0,10);switch(
...
}},_Init:function(aArg){(this.Ti=[]).__proto__=C.AGw.Ti;this.__proto__=C.AGw;A.h7++;
},_Done:function(){this.__proto__=null;A.h7--;},_ReInit:function(){},_Mark:function(
D){var B;A.aa6(this.Ti,D);if((B=this.I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null
,_cycle:0,_observers:null,_className:"DeviceSimulation::RowData"};C.Wv={_Init:function(
aArg){this.__proto__=C.Wv;A.h7++;},_Done:function(){this.__proto__=null;A.h7--;}
,_ReInit:function(){},_Mark:function(D){var B;if((B=this.I)&&(B._cycle!=D))B._Mark(
B._cycle=D);},I:null,_cycle:0,_observers:null,_className:"DeviceSimulation::NativeType"
};C.ADW={A5:0,_Init:function(aArg){C.Wv._Init.call(this,aArg);this.__proto__=C.ADW;
},_className:"DeviceSimulation::Int32"};C.String={A5:A.jV,_Init:function(aArg){C.
Wv._Init.call(this,aArg);this.__proto__=C.String;},_className:"DeviceSimulation::String"
};C.AB2={A5:false,_Init:function(aArg){C.Wv._Init.call(this,aArg);this.__proto__=
C.AB2;},_className:"DeviceSimulation::Bool"};C.DeviceClass={Aup:null,Ai3:null,AaP:
null,CP:function(){var K=this.K;K.A$A.call(this,this);},Init:function(aArg){var K=
this.K;var B;this.Zp(3);A.zX([this,K.Bgv],[B=K.Aup,B.A9j,B.ATI],0);this.UpdateAutoActions(
O4);K.A$A.call(this,this);this.Ass(this);this.Ast(this);this.ResetActiveActions(
...
,K.Bgv],this);},An0:function(){var K=this.K;var B;A.ab5("%s",P$);K.Ai3.AnZ(this);
this.UpdateScanState(0);},SetSystemTime:function(Ah$){},AxC:function(){A.Device.
DeviceClass.Ba2.call(this);this.Zp(1);},AGt:function(){A.Device.DeviceClass.Ba0.
...
PopupContext,0);Agp.Id=J6;Agp.EN=Ae;this.AnO.Trigger(Agp,false);},AF3:function(E
...
E);},Ut:function(E){this.UpdateTopLightOn(E);},WG:function(E){this.UpdateRGBTopLight(
...
BaW.call(this,E);this.UpdateActiveActions(E);},ArE:function(E){A.Device.DeviceClass.
BaX.call(this,E);this.UpdateActiveActionsOrder(E);},Akv:function(E){A.Device.DeviceClass.
BaY.call(this,E);this.UpdateAutoActions(E);},AGU:function(){var K=this.K;this.UpdateMeasureState(
1);K.BCp.call(this,this);},AsH:function(){var K=this.K;var B;K.AaP.AnZ(this);this.
...
E);},SR:function(L9){A.ab5("%s%i",Qb,L9);},AFa:function(E){this.UpdateDemoMode(E
...
Awu(UT);this.Ar8(Z5);this.Ar7(W7);this.Axf(3600);},AwN:function(E){this.UpdateFreshCowsHideMeasured(
...
E);},UpdateFirmware:function(){A.Device.DeviceClass.Ba3.call(this);A._GetAutoObject(
...
},AJJ:function(A00){var Qz;switch(A00){case 15:Qz=false;break;default:Qz=true;}return Qz;
...
A._GetAutoObject(C.Acp),B.Bgz],this);},Aw5:function(E){this.UpdatePremisesID(E);
},AwY:function(E){this.UpdateMotherSelectionDriedOffFilter(E);},AFg:function(E){
this.UpdateFreshCowSpan(E);},AF2:function(E){this.UpdateUSBDevice(E.Z1,E.AsQ,E.Asj
);},AxI:function(){var K=this.K;var B;this.Gf.FileName=K.Bji.call(this,this.Gf.AgN
);switch(this.Gf.AgN){case 0:K.Bzc.call(this,(C.VT.isPrototypeOf(B=this.Gf)?B:null
));break;case 1:K.By$.call(this,(C.VT.isPrototypeOf(B=this.Gf)?B:null));break;case
2:K.Bze.call(this,(C.VT.isPrototypeOf(B=this.Gf)?B:null));break;default:throw new
...
,A.jV,0,[this,K.A3p]);break;case 1:A._GetAutoObject(A.Device.Device).A3(90,true,
A.jV,0,[this,K.A3p]);break;case 2:A._GetAutoObject(A.Device.Device).A3(99,true,A.
jV,0,[this,K.A3p]);break;default:throw new Error(Z6+this.Gf.AgN.toFixed());}},AFN:
function(E){throw new Error(It);},Awt:function(E){this.UpdateAnimalIdAutoGenerationMethod(
E);},AFP:function(E){this.UpdateShutdownTimer(E);},Ast:function(G){this.Awv(W8);
this.Asb(Z7);this.Asa(W9);this.Ar$(Z8);this.Asc(Z9);},Asa:function(E){this.UpdateWeightGainsHighString(
...
UV);},AFw:function(E){this.UpdateMassRecordingDateOfBirthMandatory(E);},AjC:function(
...
),B.BhD],this);return true;},AwV:function(E){this.UpdateMaxWeightValuePrecision(
E);},Aw2:function(E){this.UpdateNoNaisIdListActions(E);},ResetNoNaisIdListActions:
function(G){this.Aw2(W_);},Aw3:function(E){this.UpdateNoTransponderListActions(E
...
},Asp:function(AoE,AJf){this.Gf.E6();this.Gf.AgN=AoE;this.Gf.AU1=AJf;this.Gf.E5(
1);this.Gf.E5(2);this.AxI();},AE0:function(E){this.UpdateBirthRegistrationsListResetOnExport(
...
4);}},Bgv:function(G){var K=this.K;var B;if((this.ScanState===1)&&K.Aup.AGP)K.Ai3.
AnX(this);A.ab5("%s",Z_);},BCp:function(G){var K=this.K;var B;if((this.MeasureState===
1)&&K.Aup.AxD)K.AaP.AnX(this);},BC8:function(G){this.UpdateMeasureState(3);},AT9:
function(G){var K=this.K;var B;A.zX([B=A._GetAutoObject(A.Device.Helper),B.AK9],[
B=K.Aup,B.A9k,B.ATJ],0);this.R2.AE$(A._GetAutoObject(A.Device.Helper).A62(8));this.
SB.AE$(A._GetAutoObject(A.Device.Helper).A62(8));},A$A:function(G){var AzO=A._NewObject(
A.Device.AxH,0);AzO.OnSetTimestamp(1711385184);AzO.AFu(1);AzO.AFA(0);AzO.AFK(0);
this.SB=AzO;var Azj=A._NewObject(A.Device.AxH,0);Azj.OnSetTimestamp(1711385184);
Azj.AFu(1);Azj.AFA(0);Azj.AFK(6);this.R2=Azj;var AlV=A._NewObject(A.Device.Avz,0
...
S0=Amm;this.AhL=A.aaR(A.acf.Unknown);},Bzy:function(aFilename,aMimeType,aContent
...
K.Apj.call(this,Cz.NaisId))+String.fromCharCode(0x3B))+K.A2j.call(this,Cz.DateOfBirth
))+String.fromCharCode(0x3B))+K.Bdt.call(this,Cz.Breed))+String.fromCharCode(0x3B
))+K.Bds.call(this,Cz.Gender))+String.fromCharCode(0x3B))+K.BzD.call(this,Cz.EaseOfDelivery
))+String.fromCharCode(0x3B))+K.Bdu.call(this,Cz.WhereAbouts))+String.fromCharCode(
0x3B))+K.BzG.call(this,Cz.BirthType))+String.fromCharCode(0x3B))+K.Apj.call(this
,Cz.NaisIdMother))+L3);Amd++;}}Ac1.Ava=Adc;Ac1.AGx=Amd;Ac1.E5(3);},Apj:function(
Rq){if(!Rq)return A.jV;return Rq.toFixed();},A2j:function(AyZ){var Av=A._NewObject(
A.Core.Bs,0);Av.Initialize(AyZ);return Av.Format(Rn);},Bdt:function(Ac0){if(!Ac0
)return A.jV;return A._GetAutoObject(A.Device.Converter).A5H(Ac0).toFixed();},Bds:
function(L6){var result=A.jV;switch(L6){case 0:result=W$;break;case 1:result=Xa;
break;case 2:result=A.jV;break;default:A.ab5("%s",UW+L6.toFixed());}return result;
},BzD:function(AI_){if(!AI_)return A.jV;return AI_.toFixed();},Bdu:function(AfN){
if(!AfN)return A.jV;return AfN.toFixed();},BzG:function(Atq){return(Atq+1).toFixed(
);},A3p:function(G){var K=this.K;var B;var As=(A.Device.PopupContext.isPrototypeOf(
...
8)this.Gf.E6();},By$:function(Ac1){var K=this.K;var B;var Adc=Aaa;var Cz=A._NewObject(
...
fromCharCode(0x3B))+Azf)+L3);Amd++;}Ac1.Ava=Adc;Ac1.AGx=Amd;Ac1.E5(3);},Bji:function(
AoE){var AJ4=A.jV;var Ac=A._NewObject(A.Core.Bs,0);Ac.Initialize(A._GetAutoObject(
A.Device.Helper).Dv());switch(AoE){case 0:AJ4=Ac.Format(Xb);break;case 1:AJ4=Ac.
Format(Xc);break;case 2:AJ4=Ac.Format(Ta);break;default:throw new Error(UU+AoE.toFixed(
...
break;default:A.ab5("%s",UW+L6.toFixed());}return result;},BzI:function(MP){if(MP<=
...
Bze:function(Ac1){var K=this.K;var B;var Adc=Aab;var Cz=A._NewObject(A.Device.Animal
...
))+K.A2j.call(this,A._GetAutoObject(A.Device.Helper).Dv()))+String.fromCharCode(
0x3B))+K.A2j.call(this,Cz.DateOfBirth))+String.fromCharCode(0x3B))+K.Bds.call(this
,Cz.Gender))+String.fromCharCode(0x3B))+K.Bdu.call(this,Cz.WhereAbouts))+String.
fromCharCode(0x3B))+K.Bdt.call(this,Cz.Breed))+String.fromCharCode(0x3B))+K.Apj.
...
);this.ArU(500);this.Ar0(276000901234567);this.N1(1);K.Ai3.HO(1);K.Ai3.Fr(1000);
K.AaP.WH(0);K.AaP.HO(1);K.AaP.Fr(750);K.AaP.B2=50000;this.Gf=A._NewObject(C.VT,0
);K.Ai3.SC=[this,K.BB$];K.Aup=A._GetAutoObject(C.UC);K.AaP.SC=[this,K.BC8];K.AaP.
...
};C.AG$={A5:0,_Init:function(aArg){C.Wv._Init.call(this,aArg);this.__proto__=C.AG$;
},_className:"DeviceSimulation::UInt8"};C.AG9={A5:0,_Init:function(aArg){C.Wv._Init.
...
HelperClass.BaZ.call(this,E);},Dv:function(){var K=this.K;return A.Device.HelperClass.
BaV.call(this)+K.A4z;},_Init:function(aArg){var K=this.K;K.__proto__=C.HelperClass;
...
};C.A$G={AxD:true,AGP:false,ATI:function(E){if(this.AGP===E)return;this.AGP=E;A.
abo([this,this.A9j,this.ATI],0);},A9j:function(){return this.AGP;},ATJ:function(
E){if(this.AxD===E)return;this.AxD=E;A.abo([this,this.A9k,this.ATJ],0);},A9k:function(
){return this.AxD;},_Init:function(aArg){this.__proto__=C.A$G;A.h7++;},_Done:function(
){this.__proto__=null;A.h7--;},_ReInit:function(){},_Mark:function(D){var B;if((
B=this.I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null,_cycle:0,_observers:null,_className:
"DeviceSimulation::SimulationConfigClass"};C.UC={_Init:function(){C.A$G._Init.call(
...
AH){var HF=A.Device.Rating.Ba1.call(this,AH);if(HF){var Ry=A._GetAutoObject(A.Device.
...
Timestamp)){Ry.A$z(Ad,5,this.Temperature);Ry.AkT(Ad,17,this.RatingTemperature);Ry.
...
0,ALf:0,A4C:A.abi(10,0,{0:3600,1:3750,2:3900,3:4200,4:3780,5:3600,6:3900,7:4010,
8:4020,9:4030}),AKO:0,A35:A.abi(10,0,{0:5,1:4,2:3,3:1,4:2,5:1,6:1,7:1,8:1,9:1}),
Bel:512,AAf:-1,A1z:A.abi(15,0,{0:2,1:2,2:2,3:2,4:2,5:3,6:3,7:3,8:3,9:3,10:1,11:1
,12:1,13:1,14:1}),Af5:false,CF:function(Ad,A4){var Bf=this.TW(Ad);if(!!Bf)return Bf.
CF(A4);return 0;},V1:function(Ad,A4){var Bf=this.TW(Ad);if(!!Bf)return Bf.V1(A4);
return A.jV;},H3:function(Ad,A4){var Bf=this.TW(Ad);if(!!Bf)return Bf.H3(A4);return false;
},V2:function(Ad,A4){var Bf=this.TW(Ad);if(!!Bf)return Bf.V2(A4);return 0;},Sm:function(
Ad,A4){var Bf=this.TW(Ad);if(!!Bf)return Bf.Sm(A4);return 0;},Oz:function(){if(this.
Af5)throw new Error(Aac);this.Af5=true;return 12345;},OB:function(AoQ){if(!this.
Af5)throw new Error(Xd);if(AoQ!==12345)throw new Error(Aad);this.Af5=false;return true;
},YH:function(){return this.A47(A._NewObject(C.AGw,0));},ZL:function(Ad,A4,CZ){var
...
CZ){var Bf=this.TW(Ad);if(!!Bf)return Bf.ZK(A4,CZ);return false;},N7:function(Ad
,A4,CZ){var Bf=this.TW(Ad);if(!!Bf)return Bf.N7(A4,CZ);return false;},ZJ:function(
Ad,A4,CZ){var Bf=this.TW(Ad);if(!!Bf)return Bf.ZJ(A4,CZ);return false;},OnSetId:
function(E){if(this.Id===E)return;this.Id=E;this.Bc4();switch(this.Id){case 0:{this.
Bel=256;A.pe([this,this.Bw4],this);}break;case 1:A.pe([this,this.Bw6],this);break;
case 3:A.pe([this,this.Bw3],this);break;case 4:A.pe([this,this.Bw5],this);break;
case 2:break;default:throw new Error(Xe+this.Id.toFixed());}},B9:function(){return this.
...
,E6:function(){this.Bc4();return true;},HK:function(){return this.Bel;},A47:function(
...
512))return null;return this.Gh.Get(aIndex);},Bc4:function(){var O;for(O=0;O<512;
O=O+1)this.Gh.Set(O,null);this.Pk=0;this.AJy=0;this.AKO=0;this.ALf=0;A.pe([this,
this.Ako],this);},AKi:function(){this.AJy=(this.AJy+1)%15;return this.A1z.Get(this.
AJy);},A2n:function(){this.ALf=(this.ALf+1)%10;return this.A4C.Get(this.ALf);},AJ6:
function(G){if(this.K&&this.K.AJ6)return this.K.AJ6.apply(this,arguments);else return C.
PZ.Bxa.apply(this,arguments);},Bxa:function(G){var B;var Ol=true;this.A1(276000312310001
...
A.Device.Device).A2,A._GetAutoObject(A.Device.Device).AF);var O;var BgH=0;for(O=
1;O<=7;O=O+1){BgH=3680+(20*O);Ol=BgH>3800;this.A1(276000312310050+(((B=O)<0)?B+0x10000000000000000:
...
).A2,A._GetAutoObject(A.Device.Device).AF);}},Bw4:function(s){this.AJ6(s);},AJ8:
...
Helper).Dv();var O;Ac=Ac-2678400;var AiC;var Bdk;for(O=0;O<32;O=O+1){var A19=this.
BzU();for(;A19>0;A19=A19-1){AiC=this.A2n();Bdk=A._GetAutoObject(A.Device.Converter
).AsI(0,AiC);this.AG(Ac,12310020,AiC,Bdk,this.AKi(),this.AKi(),this.AKi(),this.AKi(
...
51000);AiC=this.A2n();this.AG(Ac,276000312310001,AiC,A._GetAutoObject(A.Device.Converter
).AsI(0,AiC),1,3,3,3,0);AiC=this.A2n();this.AG(Ac-86400,276000312310022,3800,A._GetAutoObject(
A.Device.Converter).AsI(1,3800),2,3,3,3,0);this.AG(Ac,276000312310022,AiC,A._GetAutoObject(
A.Device.Converter).AsI(1,AiC),2,3,3,3,0);},Bw6:function(s){this.AJ8(s);},A1:function(
J6,BxB,BxS,Bb8,Atq,L6,BxJ,BxO,BxL,BxM,MP,Bxm,BxQ,BxK,Eo,BxN,Ac0,AI_,AfN,BxX,BAb,
BAc,Bxr,BxZ){var Cz=A._NewObject(A.Device.Animal,0);Cz.Gr();Cz.Axi(0);Cz.Ae9(0);
Cz.Ur(false);Cz.AkC(false);if(BAc)Cz.PW(J6);if(BAb)Cz.Nj(J6);Cz.SK(A._GetAutoObject(
A.Device.Helper).Sk(J6,BxZ&0xFF,Bxr&0xFF)|0);Cz.Ab3(BxB);Cz.AnD(BxS);Cz.Q6(Bb8);
Cz.Akw(Atq);Cz.JU(L6);Cz.AnV(BxJ);Cz.AGI(BxO);Cz.Ae5(BxM);Cz.Ur(BxL);Cz.ArV(BxK);
Cz.AwR(BxQ);Cz.AwC(Bxm);Cz.EC(Eo);Cz.Ae6(BxN);Cz.N1(Ac0);Cz.Aky(AI_);Cz.Nl(AfN);
Cz.AnF(BxX);Cz.Ci(this);if(MP>0)A._GetAutoObject(C.Ask).AG(Bb8,J6,0,0,0,0,0,0,MP
);},AG:function(L5,AcY,AoO,Bx8,Bxv,Bxw,Bxf,Bx_,Bxh){var B1=A._NewObject(A.Device.
Rating,0);B1.Gr();var BcM=A._GetAutoObject(C.Amy).AOA(26,AcY);if(BcM>=0)B1.OnSetAnimalId(
A._GetAutoObject(C.Amy).CF(BcM,0));else A.ab5("%s%U",KZ,AcY);B1.OnSetTimestamp(L5
...
1)%10;return this.A35.Get(this.AKO);},AJ5:function(G){if(this.K&&this.K.AJ5)return this.
...
Device.AnimalGroup,0);AJs.Gr();AJs.OnSetId(J6);AJs.AFi(BxC);AJs.Ci(this);},Abr:function(
){return this.AAf;},AOA:function(aColumn,A7){var O;for(O=0;O<this.Pk;O=O+1)if(this.
Gh.Get(O).KP(aColumn)===A7)return O;return-1;},AJ7:function(G){if(this.K&&this.K.
AJ7)return this.K.AJ7.apply(this,arguments);else return C.PZ.Bxb.apply(this,arguments
);},Bxb:function(G){this.Aay(2016,216,6);this.Aay(2017,217,7);this.Aay(2018,218,
8);this.Aay(2019,219,9);this.Aay(2020,220,10);this.Aay(2021,221,11);},Bw5:function(
s){this.AJ7(s);},Aay:function(Ac7,Bxq,Bxp){var U$=A._NewObject(A.Device.CalfDeregistrations
,0);U$.Gr();U$.AkH(Ac7);U$.AwE(Bxq);U$.AwD(Bxp);U$.Ci(this);},_Init:function(aArg
){A.Device.ITable._Init.call(this,aArg);(this.Gh=[]).__proto__=C.PZ.Gh;(this.A4C=[
]).__proto__=C.PZ.A4C;(this.A35=[]).__proto__=C.PZ.A35;(this.A1z=[]).__proto__=C.
PZ.A1z;this.__proto__=C.PZ;var J4=this._variants();if(J4){this.K={};J4._Init.call(
...
return Bf.CF(A4);return 0;},V1:function(Ad,A4){var Bf=this.Aaw(Ad);if(!!Bf)return Bf.
V1(A4);return A.jV;},H3:function(Ad,A4){var Bf=this.Aaw(Ad);if(!!Bf)return Bf.H3(
...
C.AuZ));break;case 2:break;default:throw new Error(Xe+this.Id.toFixed());}},B9:function(
){if(!!this.Filter)return this.Apg;else if(!!this.E_)return this.E_.Pk;return 0;
},Bk:function(E){A.Device.ITable.Bk.call(this,E);this.A1x(this);},V2:function(Ad
,A4){var Bf=this.Aaw(Ad);if(!!Bf)return Bf.V2(A4);return 0;},Sm:function(Ad,A4){
var Bf=this.Aaw(Ad);if(!!Bf)return Bf.Sm(A4);return 0;},Oz:function(){if(!!this.
E_)return this.E_.Oz();return-1;},OB:function(AoQ){var HF=false;if(!!this.E_)HF=
this.E_.OB(AoQ);if(HF)A.pe([this,this.A1x],this);return HF;},YH:function(){if(!!
this.Filter)throw new Error(Xf+A._GetAutoObject(A.Device.Converter).BiZ(this.Id,
this.Filter));if(!!this.E_)return this.E_.A47(A._NewObject(C.AGw,0));return-1;},
...
ZK(A4,CZ);return false;},N7:function(Ad,A4,CZ){if(!this.E_.Af5)throw new Error(Aae
);var Bf=this.Aaw(Ad);if(!!Bf)return Bf.N7(A4,CZ);return false;},ZJ:function(Ad,
...
!!this.E_)return this.E_.A6D(aColumn,A7);return-1;},KP:function(Ad,A4){var Bf=this.
...
},AjL:function(aColumn,A7){if(!!this.E_)return this.E_.A6D(aColumn,A7)>=0;return false;
...
Pk;return 0;},A1x:function(G){this.A1L();if(!!this.Filter&&!!this.E_){var O;for(
O=0;O<this.E_.B9();O=O+1){var A2b=true;var Aw=this.Filter.AON();var Bf=this.E_.TW(
O);if(!!Bf)while(A2b&&!!Aw){A2b=Bf.BjY(Aw);Aw=this.Filter.AOS(Aw);}else A.ab5("%s"
,((AfC+O.toFixed())+AhZ)+this.E_.B9().toFixed());if(A2b){this.AlJ.Set(this.Apg,this.
E_.Gh.Get(O));this.Apg=this.Apg+1;}}}A.pe([this,this.Ako],this);},A1L:function(){
var O;for(O=0;O<512;O=O+1)this.AlJ.Set(O,null);this.Apg=0;},AF9:function(E){if(this.
E_===E)return;if(!!this.E_)A.z9([this,this.A4A],this.E_,0);this.E_=E;if(!!this.E_
){A.zV([this,this.A4A],this.E_,0);A.pe([this,this.A4A],this);}},A4A:function(G){
A.pe([this,this.A1x],this);},Aaw:function(aIndex){if(!!this.Filter){if((aIndex<0
...
"DeviceSimulation::FilteredTable"};C.A$H={KI:null,AdJ:null,Ox:null,AMT:false,AMU:
true,A4t:function(G){switch(A._GetAutoObject(A.Device.Device).SyncState){case 0:{
...
).Ab8(5);this.AdJ.Ar(true);}break;case 5:A.pe([this,this.Bgz],this);break;case 7:
case 6:break;default:A.ab5("%s%e",UZ,A._GetAutoObject(A.Device.Device).SyncState
);}},BBv:function(G){this.AdJ.Ar(false);A.pe([this,this.A4t],this);},BCy:function(
G){switch(A._GetAutoObject(A.Device.Device).SyncState){case 0:case 6:case 7:{A._GetAutoObject(
A.Device.Device).Ab8(0);A.pe([this,this.A4t],this);}break;default:;}},Bgz:function(
G){this.AdJ.Ar(false);this.KI.Ar(false);A._GetAutoObject(A.Device.Device).Ab8(0);
},AEY:function(E){if(this.AMU===E)return;this.AMU=E;A.abo([this,this.BkY,this.AEY
],0);},BkY:function(){return this.AMU;},Aqn:function(G){var B;this.Ox.Cx=true;this.
Ox.B2=false;this.Ox.Fr(100);this.Ox.HO(1);this.Ox.Q=[this,this.ASz,this.AS8];A.pe([
B=this.Ox,B.AnX],this);},BhD:function(G){var B;this.Ox.Cx=true;this.Ox.B2=false;
this.Ox.Fr(400);this.Ox.Uq(200);this.Ox.HO(3);this.Ox.Q=[this,this.ASz,this.AS8];
this.AEY(false);A.pe([B=this.Ox,B.AnX],this);},AS8:function(E){if(this.AMT===E)return;
...
0);A.acl.TJ._Init.call(this.Ox={I:this},0);this.__proto__=C.A$H;var B;this.KI.HO(
1);this.AdJ.PV(2000);this.KI.SC=[this,this.A4t];this.KI.Q=[B=A._GetAutoObject(A.
Device.Device),B.ASY,B.A0z];this.AdJ.MC=[this,this.BBv];A.h7++;},_Done:function(
){this.__proto__=null;this.KI._Done();this.AdJ._Done();this.Ox._Done();A.h7--;},
_ReInit:function(){this.KI._ReInit();this.AdJ._ReInit();this.Ox._ReInit();},_Mark:
...
"DeviceSimulation::SimulationHelperClass"};C.Acp={_Init:function(){C.A$H._Init.call(
this,0);},_ReInit:function(){},_variants:function(){return this;},_this:null};C.
AG_={A5:0,_Init:function(aArg){C.Wv._Init.call(this,aArg);this.__proto__=C.AG_;}
...
this.UD.Z(true);this.AeO.Ax(A.aaL(A.ach.ARJ));K.Ad8.MC=[this,K.BkP];A.h7++;},_Done:
...
C._Init=function(){C.ADW.__proto__=C.Wv;C.String.__proto__=C.Wv;C.AB2.__proto__=C.
Wv;C.AG$.__proto__=C.Wv;C.AG9.__proto__=C.Wv;C.PZ.__proto__=A.Device.ITable;C.GM.
__proto__=A.Device.ITable;C.AG_.__proto__=C.Wv;C.VT.__proto__=A.Device.VT;};C._ReInit=
