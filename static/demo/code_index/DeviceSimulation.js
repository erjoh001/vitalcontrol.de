...
P5="Temp: ";var J0="Battery: ";var N_="%%";var P6="Selected animal with row index";
...
AGj={Tc:A.abi(42,null,null),CF:function(aColumn){var B;this.Aak(aColumn);var Aq=(
C.ADK.isPrototypeOf(B=this.Tc.Get(aColumn))?B:null);if(!!Aq)return Aq.A4;return 0;
...
){var B;this.Aak(aColumn);var Aq=(C.ABR.isPrototypeOf(B=this.Tc.Get(aColumn))?B:
null);if(!!Aq)return Aq.A4;else A.ab5("%s",(Cc+aColumn.toFixed())+BD);return false;
},Hm:function(aColumn,A9){this.Aak(aColumn);var Aq=A._NewObject(C.ADK,0);Aq.A4=A9;
...
function(aColumn,A9){this.Aak(aColumn);var Aq=A._NewObject(C.ABR,0);Aq.A4=A9;this.
...
toFixed());}},VV:function(aColumn){var B;this.Aak(aColumn);var Aq=(C.AGY.isPrototypeOf(
B=this.Tc.Get(aColumn))?B:null);if(!!Aq)return Aq.A4;return 0;},ZG:function(aColumn
,A9){this.Aak(aColumn);var Aq=A._NewObject(C.AGY,0);Aq.A4=A9;this.Tc.Set(aColumn
...
,0)>=0;case 5:return Fs!==GA;default:throw new Error(Ir+Eb.toFixed());}},Si:function(
aColumn){var B;this.Aak(aColumn);var Aq=(C.AGW.isPrototypeOf(B=this.Tc.Get(aColumn
))?B:null);if(!!Aq)return Aq.A4;return 0;},ZF:function(aColumn,A9){this.Aak(aColumn
);var Aq=A._NewObject(C.AGW,0);Aq.A4=A9;this.Tc.Set(aColumn,Aq);return true;},Bx1:
...
var Aq=(C.AGX.isPrototypeOf(B=this.Tc.Get(aColumn))?B:null);if(!!Aq)return Aq.A4;
return 0;},Uv:function(aColumn,A9){this.Aak(aColumn);var Aq=A._NewObject(C.AGX,0
...
Ir+Eb.toFixed());}},Bx3:function(Fs,Eb,GA,Atj,AI0){var AKR=Fs.toFixed();AKR=A.ab2(
A.abV(AKR,AKR.length-Atj),AI0);Fs=Math.trunc(Fs/A._GetAutoObject(A.Device.Helper
).ApK(Atj))%A._GetAutoObject(A.Device.Helper).ApK(AI0);var ALj=A.ab0(GA,0,10);switch(
...
}},_Init:function(aArg){(this.Tc=[]).__proto__=C.AGj.Tc;this.__proto__=C.AGj;A.h7++;
...
};C.ADK={A4:0,_Init:function(aArg){C.Wn._Init.call(this,aArg);this.__proto__=C.ADK;
...
};C.ABR={A4:false,_Init:function(aArg){C.Wn._Init.call(this,aArg);this.__proto__=
C.ABR;},_className:"DeviceSimulation::Bool"};C.DeviceClass={Aub:null,AiX:null,AaL:
null,CP:function(){var K=this.K;K.A_V.call(this,this);},Init:function(aArg){var K=
this.K;var B;this.Zj(3);A.zX([this,K.BfI],[B=K.Aub,B.A8J,B.ATi],0);this.UpdateAutoActions(
...
,K.ATJ],this);},Zj:function(E){this.UpdateActiveScreen(E);},Awl:function(E){this.
UpdateBatteryChargeState(E);},AET:function(E){this.UpdateChargeActive(E);},ArV:function(
...
E){this.UpdateTemperatureUnit(E);},AER:function(E){this.UpdateBrightness(E);},AFn:
...
DeviceClass.Baj.call(this);this.Zj(1);},AGg:function(){A.Device.DeviceClass.Bah.
call(this);this.Zj(2);},Dv:function(E){this.UpdateOverlayMenu(E);},Aw5:function(
E){this.UpdateUnderTemp(E);},Ab4:function(E){this.UpdateSyncState(E);},ACX:function(
){var aString;aString=((((((((((CQ+A.abz(0,9).toFixed())+Fe)+A.abz(0,9).toFixed(
))+L1)+P5)+A.abz(30,90).toFixed())+A.aaR(A.acf.AGL))+L1)+J0)+A.abz(1,100).toFixed(
))+N_;return aString;},PopupStateChanged:function(J2,Ae){var Agj=A._NewObject(C.
PopupContext,0);Agj.Id=J2;Agj.EV=Ae;this.AnG.Trigger(Agj,false);},AFP:function(E
...
E);},PO:function(E){this.UpdateOffsetID(E);},AFT:function(E){this.UpdateWeightValue(
...
Baf.call(this,E);this.UpdateAutoActions(E);},AGH:function(){var K=this.K;this.UpdateMeasureState(
...
){this.UpdateWeightRecordingMode(E);},AFs:function(E){this.UpdatePredictedTempValue(
E);},SN:function(L7){A.ab5("%s%i",P6,L7);},AEY:function(E){this.UpdateDemoMode(E
);},AEG:function(E){this.UpdateAgeRegistration(E);},Aw7:function(E){this.UpdateWeightRecordingScope(
...
E);},AEI:function(E){this.UpdateAlarmListAction(E);},AE1:function(E){this.UpdateFlashLightInMeasureState(
E);},AeS:function(E){this.UpdateAnimalInfoContent(E);},AFS:function(E){this.UpdateWatchListAction(
E);},AE3:function(E){this.UpdateFreshCowListAction(E);},ResetActiveActions:function(
...
Awi(UN);this.ArZ(Z0);this.ArY(WY);this.Aw5(3600);},AwB:function(E){this.UpdateFreshCowsHideMeasured(
...
A.kR.A$).Cf(53);},Anp:function(E){this.UpdateBootloaderMessage(E);},AED:function(
E){this.UpdateActionListAction(E);},Awg:function(E){this.UpdateActionListHideMeasured(
E);},Uf:function(E){this.UpdateAnimalIdGenerationMethod(E);},Awt:function(E){this.
...
E);},NY:function(E){this.UpdateBreed(E);},AFl:function(E){throw new Error(Is);},
AFf:function(E){throw new Error(Is);},AFM:function(E){throw new Error(Is);},AEN:
function(E){throw new Error(Is);},AEZ:function(E){this.UpdateDryCowListAction(E);
},AJy:function(A0r){var Qt;switch(A0r){case 15:Qt=false;break;default:Qt=true;}return Qt;
},AEM:function(E){this.UpdateBirthListView(E);},AFN:function(E){this.UpdateTransferProgress(
E);},Ar0:function(E){this.UpdateTransferTarget(E);},Asx:function(){var B;A.pe([B=
A._GetAutoObject(C.Ack),B.BfM],this);},AwT:function(E){this.UpdatePremisesID(E);
},AwM:function(E){this.UpdateMotherSelectionDriedOffFilter(E);},AE4:function(E){
this.UpdateFreshCowSpan(E);},AFO:function(E){this.UpdateUSBState(E);},Axw:function(
){var K=this.K;var B;this.GC.FileName=K.Bin.call(this,this.GC.AgH);switch(this.GC.
...
);break;default:throw new Error(Z1+this.GC.AgH.toFixed());}},AFz:function(E){throw new
Error(Is);},Awh:function(E){this.UpdateAnimalIdAutoGenerationMethod(E);},AFB:function(
E){this.UpdateShutdownTimer(E);},Ask:function(G){this.Awj(WZ);this.Ar4(Z2);this.
...
E);},AwX:function(E){this.UpdateStartScreen(E);},ADO:function(){return 1;},ADP:function(
){return 1;},AFk:function(E){this.UpdateMaximumAgeNewOnFarm(E);},Aw3:function(E){
...
UP);},AFi:function(E){this.UpdateMassRecordingDateOfBirthMandatory(E);},Ajv:function(
){A._GetAutoObject(C.Ack).AEL(true);return true;},Aqh:function(){var B;A._GetAutoObject(
...
),B.BgR],this);return true;},AwJ:function(E){this.UpdateMaxWeightValuePrecision(
E);},AwQ:function(E){this.UpdateNoNaisIdListActions(E);},ResetNoNaisIdListActions:
function(G){this.AwQ(W1);},AwR:function(E){this.UpdateNoTransponderListActions(E
);},ResetNoTransponderListActions:function(G){this.AwR(P7);},Aw9:function(E){this.
UpdateYoungNoTransponderListActions(E);},ResetYoungNoTransponderListActions:function(
G){this.Aw9(Z5);},Aw4:function(E){this.UpdateTransponderUnlinkIdChangeMethod(E);
...
this.K;var B;if((this.ScanState===1)&&K.Aub.AGC)K.AiX.AnO(this);A.ab5("%s",O2);}
,BBl:function(G){var K=this.K;var B;if((this.MeasureState===1)&&K.Aub.Axr)K.AaL.
AnO(this);},BB4:function(G){this.UpdateMeasureState(3);},ATJ:function(G){var K=this.
K;var B;A.zX([B=A._GetAutoObject(A.Device.Helper),B.AKX],[B=K.Aub,B.A8K,B.ATj],0
);this.RY.AEX(A._GetAutoObject(A.Device.Helper).A6t(8));this.Sx.AEX(A._GetAutoObject(
A.Device.Helper).A6t(8));},A_V:function(G){var AzF=A._NewObject(A.Device.Axv,0);
AzF.OnSetTimestamp(1711385184);AzF.AFg(1);AzF.AFm(0);AzF.AFv(0);this.Sx=AzF;var Ay$=
A._NewObject(A.Device.Axv,0);Ay$.OnSetTimestamp(1711385184);Ay$.AFg(1);Ay$.AFm(0
);Ay$.AFv(4);this.RY=Ay$;var AlL=A._NewObject(A.Device.Avk,0);AlL.AFd(1);AlL.AFe(
0);AlL.AFc(0);AlL.AFK(1);AlL.AFL(0);AlL.AFJ(0);AlL.OnSetTimestamp(1711385184);this.
QX=AlL;var Amd=A._NewObject(A.Device.Avk,0);Amd.AFd(1);Amd.AFe(0);Amd.AFc(0);Amd.
AFK(1);Amd.AFL(0);Amd.AFJ(0);Amd.OnSetTimestamp(1711385184);this.SW=Amd;this.AhF=
...
,Cy.NaisIdMother))+L1);Al6++;}}AcV.AuX=Ac8;AcV.AGk=Al6;AcV.Fb(3);},Apc:function(
Rn){if(!Rn)return A.jV;return Rn.toFixed();},A1L:function(AyP){var Au=A._NewObject(
A.Core.Bs,0);Au.Initialize(AyP);return Au.Format(W2);},BcF:function(AcU){if(!AcU
...
},ByB:function(AI1){if(!AI1)return A.jV;return AI1.toFixed();},BcG:function(AfI){
...
Z6,(C.VM.isPrototypeOf(B=this.GC)?B:null).AuX);this.GC.E5();}else if(As.PopupState===
8)this.GC.E5();},Bx_:function(AcV){var K=this.K;var B;var Ac8=W6;var Cy=A._NewObject(
A.Device.Animal,0);var O;var Al6=0;for(O=0;O<A._GetAutoObject(A.Device.Device).An.
B9();O++){var Ay7=A.jV;if(Cy.Aq9())Ay7=K.ByG.call(this,Cy.FirstBodyWeight);Cy.E3(
...
fromCharCode(0x3B))+Ay7)+L1);Al6++;}AcV.AuX=Ac8;AcV.AGk=Al6;AcV.Fb(3);},Bin:function(
...
AyP){var Au=A._NewObject(A.Core.Bs,0);Au.Initialize(AyP);return Au.Format(Z7);},
...
call(this,A._GetAutoObject(A.Device.Device).Ur))+L1);Al6++;}}AcV.AuX=Ac8;AcV.AGk=
Al6;AcV.Fb(3);},_Init:function(aArg){var K=this.K;A.acl.Gl._Init.call(K.AiX={I:this
},0);A.acl.Gl._Init.call(K.AaL={I:this},0);K.__proto__=C.DeviceClass;this.Awl(100
...
K.AaL.Wy(0);K.AaL.HM(1);K.AaL.Fp(750);K.AaL.B2=50000;this.GC=A._NewObject(C.VM,0
);K.AiX.Sy=[this,K.BA6];K.Aub=A._GetAutoObject(C.Uw);K.AaL.Sy=[this,K.BB4];K.AaL.
Q=[this,this.AEA,this.AIO];K.Init.call(this,aArg);A.h7++;},_Done:function(){var K=
...
};C.AGY={A4:0,_Init:function(aArg){C.Wn._Init.call(this,aArg);this.__proto__=C.AGY;
},_className:"DeviceSimulation::UInt8"};C.AGW={A4:0,_Init:function(aArg){C.Wn._Init.
call(this,aArg);this.__proto__=C.AGW;},_className:"DeviceSimulation::UInt32"};C.
HelperClass={A3X:0,AFC:function(E){var K=this.K;K.A3X=K.A3X+(E-this.Du());A.Device.
...
};C.A_1={Axr:false,AGC:false,ATi:function(E){if(this.AGC===E)return;this.AGC=E;A.
abo([this,this.A8J,this.ATi],0);},A8J:function(){return this.AGC;},ATj:function(
E){if(this.Axr===E)return;this.Axr=E;A.abo([this,this.A8K,this.ATj],0);},A8K:function(
){return this.Axr;},_Init:function(aArg){this.__proto__=C.A_1;A.h7++;},_Done:function(
...
Animal,0);Cy.E3(Ad,Ru);if((this.Temperature>0)&&(Cy.TimestampLastTemperature<this.
...
).AF$(this)){var LP=A._GetAutoObject(A.Device.Helper).AC1(this);Ru.AkM(Ad,13,LP);
...
},_className:"DeviceSimulation::Rating"};C.PT={Gg:A.abi(512,null,null),Pf:0,AJo:
...
Bdx:512,Az8:-1,A01:A.abi(15,0,{0:2,1:2,2:2,3:2,4:2,5:3,6:3,7:3,8:3,9:3,10:1,11:1
...
},YA:function(){return this.A4t(A._NewObject(C.AGj,0));},ZG:function(Ad,A3,CZ){var
...
,E5:function(){this.Bce();return true;},HI:function(){return this.Bdx;},A4t:function(
Ad){if(this.Pf>=512)throw new Error(KX);this.Gg.Set(this.Pf,Ad);this.Pf=this.Pf+
1;switch(this.Id){case 0:{this.Az8=this.Pf;this.Hm(this.Pf-1,0,this.Az8);}break;
case 1:{this.Az8=this.Pf-1;this.Hm(this.Pf-1,0,this.Az8);}break;default:;}A.pe([
...
O=O+1)this.Gg.Set(O,null);this.Pf=0;this.AJo=0;this.AKC=0;this.AK6=0;A.pe([this,
this.Akh],this);},AJ9:function(){this.AJo=(this.AJo+1)%15;return this.A01.Get(this.
AJo);},A1P:function(){this.AK6=(this.AK6+1)%10;return this.A30.Get(this.AK6);},AJV:
...
J2,Bwz,BwQ,Bbl,Atc,L4,BwH,BwM,BwJ,BwK,ML,Bwk,BwO,BwI,En,BwL,AcU,AI1,AfI,BwV,By$,
Bza,Bwp,BwX){var Cy=A._NewObject(A.Device.Animal,0);Cy.Gq();Cy.Aw8(0);Cy.Ae4(0);
Cy.Uj(false);Cy.Akv(false);if(Bza)Cy.PQ(J2);if(By$)Cy.Nd(J2);Cy.SF(A._GetAutoObject(
A.Device.Helper).Sg(J2,BwX&0xFF,Bwp&0xFF)|0);Cy.AbZ(Bwz);Cy.Anv(BwQ);Cy.Q2(Bbl);
Cy.Akp(Atc);Cy.JR(L4);Cy.AnM(BwH);Cy.AGv(BwM);Cy.Ae0(BwK);Cy.Uj(BwJ);Cy.ArN(BwI);
Cy.AwF(BwO);Cy.Awq(Bwk);Cy.EB(En);Cy.Ae1(BwL);Cy.NY(AcU);Cy.Akr(AI1);Cy.Nf(AfI);
Cy.Anx(BwV);Cy.Cg(this);if(ML>0)A._GetAutoObject(C.Asa).AG(Bbl,J2,0,0,0,0,0,0,ML
...
,W9);},Bv1:function(s){this.AJU(s);},AlF:function(J2,BwA){var AJi=A._NewObject(A.
Device.AnimalGroup,0);AJi.Gq();AJi.OnSetId(J2);AJi.AE6(BwA);AJi.Cg(this);},Abm:function(
){return this.Az8;},AOp:function(aColumn,A9){var O;for(O=0;O<this.Pf;O=O+1)if(this.
...
,0);U5.Gq();U5.AkA(Ac1);U5.Aws(Bwo);U5.Awr(Bwn);U5.Cg(this);},_Init:function(aArg
...
){},_variants:function(){return this;},_this:null};C.Auz={_Init:function(){C.PT.
...
Id){case 0:this.AFV(A._GetAutoObject(C.Amp));break;case 1:this.AFV(A._GetAutoObject(
C.Asa));break;case 3:this.AFV(A._GetAutoObject(C.Auz));break;case 4:this.AFV(A._GetAutoObject(
...
,this.Filter));if(!!this.E9)return this.E9.A4t(A._NewObject(C.AGj,0));return-1;}
...
AOp(aColumn,A9);return-1;},E5:function(){if(!!this.E9)return this.E9.E5();return false;
...
O=0;O<this.E9.B9();O=O+1){var A1D=true;var Av=this.Filter.AOC();var Bf=this.E9.TO(
O);if(!!Bf)while(A1D&&!!Av){A1D=Bf.Bi3(Av);Av=this.Filter.AOH(Av);}else A.ab5("%s"
,((AhT+O.toFixed())+AcJ)+this.E9.B9().toFixed());if(A1D){this.Alz.Set(this.Ao$,this.
E9.Gg.Get(O));this.Ao$=this.Ao$+1;}}}A.pe([this,this.Akh],this);},A1b:function(){
var O;for(O=0;O<512;O=O+1)this.Alz.Set(O,null);this.Ao$=0;},AFV:function(E){if(this.
...
Ar(false);this.KE.Ar(false);A._GetAutoObject(A.Device.Device).Ab4(0);},AEL:function(
E){if(this.AMI===E)return;this.AMI=E;A.abo([this,this.Bj1,this.AEL],0);},Bj1:function(
...
this.Ov.Ui(200);this.Ov.HM(3);this.Ov.Q=[this,this.ASa,this.ASI];this.AEL(false);
...
G){var B;this.Ov.AnQ(this);this.AEL(false);},_Init:function(aArg){A.acl.Gl._Init.
...
function(){return this;},_this:null};C.AGX={A4:0,_Init:function(aArg){C.Wn._Init.
call(this,aArg);this.__proto__=C.AGX;},_className:"DeviceSimulation::UInt64"};C.
AuK={_Init:function(){C.PT._Init.call(this,0);this.OnSetId(4);},_ReInit:function(
...
C._Init=function(){C.ADK.__proto__=C.Wn;C.String.__proto__=C.Wn;C.ABR.__proto__=C.
Wn;C.AGY.__proto__=C.Wn;C.AGW.__proto__=C.Wn;C.PT.__proto__=A.Device.ITable;C.GL.
__proto__=A.Device.ITable;C.AGX.__proto__=C.Wn;C.VM.__proto__=A.Device.VM;};C._ReInit=
