...
EV+aColumn.toFixed())+GS);},BfR:function(AL){if(!!(A.Device.Int32FilterCriterion.
...
An.A4=A1;this.SF.Set(aColumn,An);return true;},Bux:function(H3,EE,H4){switch(EE){
...
,0);An.A4=A1;this.SF.Set(aColumn,An);return true;},Buv:function(H3,EE,H4){switch(
...
C.AE6,0);An.A4=A1;this.SF.Set(aColumn,An);return true;},Buw:function(H3,EE,H4){switch(
EE){case 0:return H3===H4;case 2:return H3>H4;case 3:return H3<H4;case 5:return H3
...
A71.call(this,this);},Init:function(aArg){var K=this.K;var B;this.Yy(3);A.za([this
,K.Azj],[B=K.AsT,B.A51,B.AQ7],0);this.UpdateAutoActions(OK);K.A71.call(this,this
...
function(Aho){},AvW:function(){A.Device.DeviceClass.A9p.call(this);this.Yy(1);},
AEn:function(){A.Device.DeviceClass.A9n.call(this);this.Yy(2);},Co:function(E){this.
...
E);},Aqf:function(E){A.Device.DeviceClass.A9j.call(this,E);this.UpdateActiveActions(
E);},Aqg:function(E){A.Device.DeviceClass.A9k.call(this,E);this.UpdateActiveActionsOrder(
E);},Abb:function(E){A.Device.DeviceClass.A9l.call(this,E);this.UpdateAutoActions(
...
){A.Device.DeviceClass.A9q.call(this);A._GetAutoObject(A.kh.A0).BY(61);},AmD:function(
...
I$);},AC6:function(E){this.UpdateDryCowListAction(E);},AHL:function(AX8){var HR;
switch(AX8){case 15:HR=false;break;default:HR=true;}return HR;},ADv:function(E){
...
E);},Arf:function(){var B;A.ow([B=A._GetAutoObject(C.Ard),B.BcB],this);},Avn:function(
...
Ahi;result.FileName=K.Bfb.call(this,Ahi);switch(Ahi){case 0:K.BuH.call(this,result
);break;case 1:K.BuD.call(this,result);break;case 2:K.BuI.call(this,result);break;
case 3:K.BuG.call(this,result);break;default:throw new Error(T_+Ahi.toFixed());}
...
,[this,K.A0s]);break;case 1:A._GetAutoObject(A.Device.Device).A5(90,true,A.jm,0,[
this,K.A0s]);break;case 2:case 3:A._GetAutoObject(A.Device.Device).A5(100,true,A.
jm,0,[this,K.A0s]);break;default:throw new Error(Zd+Ng.AAz.toFixed());}},ADH:function(
...
B;if((this.ScanState===1)&&K.AsT.AEG)K.Ah9.AEN(this);A.aa8("%s",Ua);},BxK:function(
H){var K=this.K;var B;if((this.MeasureState===1)&&K.AsT.AvX)K.ZW.AEN(this);},Byl:
function(H){this.UpdateMeasureState(3);},ARx:function(H){var K=this.K;var B;A.za([
B=A._GetAutoObject(A.Device.Helper),B.AI8],[B=K.AsT,B.A52,B.AQ8],0);this.Rt.AC3(
A._GetAutoObject(A.Device.Helper).A33(8));this.R3.AC3(A._GetAutoObject(A.Device.
Helper).A33(8));},A71:function(H){var AxX=A._NewObject(A.Device.AvZ,0);AxX.OnSetTimestamp(
...
URL.createObjectURL(bb);a.click();}},BuH:function(Ng){var K=this.K;var B;var SE=
...
fromCharCode(0x3B))+K.A$E.call(this,B3.Breed))+String.fromCharCode(0x3B))+K.A$D.
call(this,B3.Gender))+String.fromCharCode(0x3B))+K.Bu8.call(this,B3.EaseOfDelivery
))+String.fromCharCode(0x3B))+K.A$F.call(this,B3.WhereAbouts))+String.fromCharCode(
...
){if(!QY)return A.jm;return QY.toFixed();},AIe:function(AX7){var Aq=A._NewObject(
A.Core.Bu,0);Aq.Initialize(AX7);return Aq.Format(QT);},A$E:function(Ab2){if(!Ab2
)return A.jm;return A._GetAutoObject(A.Device.Converter).A2G(Ab2).toFixed();},A$D:
...
},Bu8:function(AG9){if(!AG9)return A.jm;return AG9.toFixed();},A$F:function(Ae2){
if(!Ae2)return A.jm;return Ae2.toFixed();},Bu$:function(ArX){return(ArX+1).toFixed(
);},A0s:function(H){var K=this.K;var Ar=(A.Device.PopupContext.isPrototypeOf(H)?
H:null);if(!!Ar&&(Ar.PopupState===7))K.Bu3.call(this,K.AHU.FileName,Ub,K.AHU.AtE
);},BuD:function(Ng){var K=this.K;var B;var SE=Zi;var B3=A._NewObject(A.Device.Animal
,0);var P;var AcH=0;for(P=0;P<A._GetAutoObject(A.Device.Device).Ao.Cj();P++){var
Axq=A.jm;if(B3.ApV())Axq=K.Bvb.call(this,B3.FirstBodyWeight);B3.EK(P,A._GetAutoObject(
...
fromCharCode(0x3B))+K.Bva.call(this,B3.Gender))+String.fromCharCode(0x3B))+Axq)+
Nb);AcH++;}Ng.AtE=SE;Ng.AEr=AcH;Ng.Am3=true;},Bfb:function(Ahi){var AxW=A.jm;var
...
T_+Ahi.toFixed());}return AxW;},Bu9:function(QY){return QY.toFixed();},Bva:function(
...
N5){if(N5<=0)return A.jm;return A._GetAutoObject(A.Device.Converter).And(N5);},Bu7:
function(AX7){var Aq=A._NewObject(A.Core.Bu,0);Aq.Initialize(AX7);return Aq.Format(
Zm);},BuI:function(Ng){var K=this.K;var B;var SE=AbO;var B3=A._NewObject(A.Device.
...
AcH;Ng.Am3=true;},BuG:function(Ng){var K=this.K;var B;var SE=Su;var B3=A._NewObject(
...
0x3B))+K.AIe.call(this,B3.DateOfBirth))+String.fromCharCode(0x3B))+K.A$D.call(this
,B3.Gender))+String.fromCharCode(0x3B))+K.A$F.call(this,B3.WhereAbouts))+String.
fromCharCode(0x3B))+K.A$E.call(this,B3.Breed))+String.fromCharCode(0x3B))+K.AIe.
...
ZW.VN(0);K.ZW.IF(1);K.ZW.Fz(750);K.ZW.B0=50000;K.Ah9.R5=[this,K.Bxx];K.AsT=A._GetAutoObject(
C.Abw);K.ZW.R5=[this,K.Byl];K.ZW.Q=[this,this.ACK,this.AGV];K.Init.call(this,aArg
...
HelperClass={A1p:0,ADK:function(E){var K=this.K;K.A1p=K.A1p+(E-this.DB());A.Device.
HelperClass.A9m.call(this,E);},DB:function(){var K=this.K;return A.Device.HelperClass.
A9i.call(this)+K.A1p;},_Init:function(aArg){var K=this.K;K.__proto__=C.HelperClass;
...
};C.A78={AvX:false,AEG:false,AQ7:function(E){if(this.AEG===E)return;this.AEG=E;A.
aat([this,this.A51,this.AQ7],0);},A51:function(){return this.AEG;},AQ8:function(
E){if(this.AvX===E)return;this.AvX=E;A.aat([this,this.A52,this.AQ8],0);},A52:function(
){return this.AvX;},BhL:function(){return true;},_Init:function(aArg){this.__proto__=
C.A78;A.hJ++;},_Done:function(){this.__proto__=null;A.hJ--;},_ReInit:function(){
},_Mark:function(D){var B;if((B=this.I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null
,_cycle:0,_observers:null,_className:"DeviceSimulation::SimulationConfigClass"};
C.Abw={_Init:function(){C.A78._Init.call(this,0);},_variants:function(){return A.
...
};C.Rating={Cr:function(AF){var Hs=A.Device.Rating.A9o.call(this,AF);if(Hs){var Q3=
...
this.Timestamp)){Q3.A70(Ab,5,this.Temperature);Q3.AjZ(Ab,17,this.RatingTemperature
...
),O2:0,AHB:0,AJe:0,A1s:A.aan(10,0,{0:3600,1:3750,2:3900,3:4200,4:3780,5:3600,6:3900
,7:4010,8:4020,9:4030}),AIR:0,A02:A.aan(10,0,{0:5,1:4,2:3,3:1,4:2,5:1,6:1,7:1,8:
1,9:1}),Bav:512,Ayj:-1,AYH:A.aan(15,0,{0:2,1:2,2:2,3:2,4:2,5:3,6:3,7:3,8:3,9:3,10:
...
);this.AIq=false;return true;},XS:function(){return this.A13(A._NewObject(C.AEq,
...
},OnSetId:function(E){if(this.Id===E)return;this.Id=E;this.A$f();switch(this.Id){
case 0:{this.Bav=128;A.ow([this,this.BsB],this);}break;case 1:A.ow([this,this.BsD
...
);return false;},G9:function(){this.A$f();return true;},Hz:function(){return this.
Bav;},A13:function(Ab){if(this.O2>=512)throw new Error(AeO);this.Gn.Set(this.O2,
...
aIndex<0)||(aIndex>=512))return null;return this.Gn.Get(aIndex);},A$f:function(){
...
AYH.Get(this.AHB);},AZv:function(){this.AJe=(this.AJe+1)%10;return this.A1s.Get(
...
0);var P;var BcH=0;for(P=1;P<=7;P=P+1){BcH=3680+(20*P);Oa=BcH>3800;this.Bi(276000312310050+(((
...
A._GetAutoObject(A.Device.Helper).DB();var P;Ad=Ad-2678400;var AhI;var A$w;for(P=
0;P<32;P=P+1){var AZg=this.Bvn();for(;AZg>0;AZg=AZg-1){AhI=this.AZv();A$w=A._GetAutoObject(
A.Device.Converter).Arj(0,AhI);this.AE(Ad,12310020,AhI,A$w,this.AIl(),this.AIl()
...
,0,0,0,0,0,0,51000);AhI=this.AZv();this.AE(Ad,276000312310001,AhI,A._GetAutoObject(
A.Device.Converter).Arj(0,AhI),1,3,3,3,0);AhI=this.AZv();this.AE(Ad-86400,276000312310022
,3800,A._GetAutoObject(A.Device.Converter).Arj(1,3800),2,3,3,3,0);this.AE(Ad,276000312310022
,AhI,A._GetAutoObject(A.Device.Converter).Arj(1,AhI),2,3,3,3,0);},BsD:function(s
){this.AH$(s);},Bi:function(Kn,Bs7,Btm,A_l,ArX,LY,Btc,Bti,Btf,Btg,N5,BsT,Btk,Bte
,Ee,Bth,Ab2,AG9,Ae2,Btr){var B3=A._NewObject(A.Device.Animal,0);B3.Gd();B3.AvA(0
);B3.Ad6(0);B3.TD(false);B3.AjG(false);B3.M6(Kn);B3.M5(Kn);B3.TF(A._GetAutoObject(
A.Device.Helper).Aka(B3.TransponderId));B3.Abg(Bs7);B3.AmI(Btm);B3.R8(A_l);B3.Ajy(
ArX);B3.JM(LY);B3.AmZ(Btc);B3.AEz(Bti);B3.AgG(Btg);B3.TD(Btf);B3.Aqx(Bte);B3.Avd(
Btk);B3.Au1(BsT);B3.DV(Ee);B3.Ad3(Bth);B3.NP(Ab2);B3.AjB(AG9);B3.M7(Ae2);B3.AmK(
Btr);B3.Cr(this);if(N5>0)A._GetAutoObject(C.AvL).AE(A_l,Kn,0,0,0,0,0,0,N5);},AE:
function(LX,Ab0,AnH,BtD,Bs1,Bs2,BsM,BtF,BsN){var BW=A._NewObject(A.Device.Rating
,0);BW.Gd();var A_Z=A._GetAutoObject(C.Ao_).AMn(26,Ab0);if(A_Z>=0)BW.OnSetAnimalId(
A._GetAutoObject(C.Ao_).CE(A_Z,0));else A.aa8("%s%U",AeP,Ab0);BW.OnSetTimestamp(
LX);BW.OnSetTemperature(AnH);BW.OnSetRatingTemperature(BtD);BW.OnSetFaeces(Bs1);
BW.OnSetFeed(Bs2);BW.OnSetAppearance(BsM);BW.OnSetRespiratory(BtF);BW.OnSetBodyWeight(
BsN);BW.Cr(this);},A3I:function(aColumn,A1){var P;for(P=0;P<this.O2;P=P+1)if(this.
Gn.Get(P).CE(aColumn)===A1)return P;return-1;},Bvn:function(){this.AIR=(this.AIR+
1)%10;return this.A02.Get(this.AIR);},AH8:function(H){if(this.K&&this.K.AH8)return this.
K.AH8.apply(this,arguments);else return C.PE.BsI.apply(this,arguments);},BsI:function(
H){this.AkV(10,JT);this.AkV(20,AeQ);this.AkV(30,Li);this.AkV(31,Ag$);this.AkV(32
,Anf);},BsA:function(s){this.AH8(s);},AkV:function(Kn,Bs8){var AHv=A._NewObject(
A.Device.AnimalGroup,0);AHv.Gd();AHv.OnSetId(Kn);AHv.ADa(Bs8);AHv.Cr(this);},Aay:
...
K&&this.K.AH_)return this.K.AH_.apply(this,arguments);else return C.PE.BsK.apply(
...
function(s){this.AH_(s);},ZH:function(Ab9,BsX,BsW){var Ul=A._NewObject(A.Device.
CalfDeregistrations,0);Ul.Gd();Ul.AjN(Ab9);Ul.Au3(BsX);Ul.Au2(BsW);Ul.Cr(this);}
,_Init:function(aArg){A.Device.ITable._Init.call(this,aArg);(this.Gn=[]).__proto__=
C.PE.Gn;(this.A1s=[]).__proto__=C.PE.A1s;(this.A02=[]).__proto__=C.PE.A02;(this.
AYH=[]).__proto__=C.PE.AYH;this.__proto__=C.PE;var Lj=this._variants();if(Lj){this.
...
Bk.call(this,E);this.AYF(this);},Vb:function(Ab,AX){var A9=this.ZF(Ab);if(!!A9)return A9.
...
AnJ){var Hs=false;if(!!this.Gh)Hs=this.Gh.Or(AnJ);if(Hs)A.ow([this,this.AYF],this
);return Hs;},XS:function(){if(!!this.Filter)throw new Error(N2+A._GetAutoObject(
A.Device.Converter).BeR(this.Id,this.Filter));if(!!this.Gh)return this.Gh.A13(A.
...
return-1;}else if(!!this.Gh)return this.Gh.A3I(aColumn,A1);return-1;},LD:function(
...
,A1){if(!!this.Gh)return this.Gh.A3I(aColumn,A1)>=0;return false;},Af5:function(
...
Gh.Aay();return-1;},Qb:function(){if(!!this.Gh)return this.Gh.O2;return 0;},AYF:
function(H){this.AYU();if(!!this.Filter&&!!this.Gh){var P;for(P=0;P<this.Gh.Cj();
P=P+1){var AZk=true;var Av=this.Filter.AMB();var A9=this.Gh.Tc(P);if(!!A9)while(
AZk&&!!Av){AZk=A9.BfR(Av);Av=this.Filter.AMF(Av);}else A.aa8("%s",((Wi+P.toFixed(
))+Ang)+this.Gh.Cj().toFixed());if(AZk){this.AkP.Set(this.An9,this.Gh.Gn.Get(P));
this.An9=this.An9+1;}}}A.ow([this,this.Aju],this);},AYU:function(){var P;for(P=0;
P<128;P=P+1)this.AkP.Set(P,null);this.An9=0;},AD3:function(E){if(this.Gh===E)return;
if(!!this.Gh)A.zl([this,this.A1q],this.Gh,0);this.Gh=E;if(!!this.Gh){A.y_([this,
this.A1q],this.Gh,0);A.ow([this,this.A1q],this);}},A1q:function(H){A.ow([this,this.
AYF],this);},ZF:function(aIndex){if(!!this.Filter){if((aIndex<0)||(aIndex>=128))
...
};C.A79={Kr:null,AcJ:null,A1k:function(H){if(A._GetAutoObject(C.Abw).BhL()===false
...
).Abm(5);this.AcJ.Ap(true);}break;case 5:A.ow([this,this.BcB],this);break;case 7:
case 6:break;default:A.aa8("%s%e",Ahb,A._GetAutoObject(A.Device.Device).SyncState
);}},BwQ:function(H){this.AcJ.Ap(false);A.ow([this,this.A1k],this);},BxR:function(
H){switch(A._GetAutoObject(A.Device.Device).SyncState){case 0:case 6:case 7:{A._GetAutoObject(
A.Device.Device).Abm(0);A.ow([this,this.A1k],this);}break;default:;}},BcB:function(
...
call(this.AcJ={I:this},0);this.__proto__=C.A79;var B;this.Kr.IF(1);this.AcJ.Qz(2000
);this.Kr.R5=[this,this.A1k];this.Kr.Q=[B=A._GetAutoObject(A.Device.Device),B.AQw
,B.AXI];this.AcJ.M8=[this,this.BwQ];A.hJ++;},_Done:function(){this.__proto__=null;
...
};C.Ard={_Init:function(){C.A79._Init.call(this,0);},_variants:function(){return this;
...
K=this.K;if(K.Ac7.Bw===true){K.Ac7.Ap(false);A.aa8("%s",Uc);}},BgX:function(H){var
...
X(true);this.AdL.At(A.zW(A.abi.APg));K.Ac7.M8=[this,K.BgX];A.hJ++;},_Done:function(
