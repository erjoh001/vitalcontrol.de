...
)<<24);}if((AfB===1)&&(AfC===1))CW.AtA(aClip,AcA,AcB,AkD,AkE,aBlend);else CW.Bex(
...
var IQ=Math.sqrt((JY*JY)+(JZ*JZ));JY=JY/IQ;JZ=JZ/IQ;var A_9=Aob+(JZ*AhK);var A__=
Aoc-(JY*AhK);var AHE=Aod+(JZ*AhL);var AHF=Aoe-(JY*AhL);var AHG=Aod-(JZ*AhL);var AHH=
Aoe+(JY*AhL);var AHI=Aob-(JZ*AhK);var AHJ=Aoc+(JY*AhK);var left=A_9;var right=A_9;
var top=A__;var bottom=A__;if(AHE<left)left=AHE;if(AHG<left)left=AHG;if(AHI<left
...
){var B;if(!!this.Ac&&((this.U&0x1)===0x1))this.Ac.Bg(this.GetExtent());},A7q:function(
...
this.Kt){if(this.Kt.Oy)A.zl([this,this.Rd],this.Kt,0);this.Kt=null;}},A7p:function(
...
)&0xFF)<<24);}CW.Bev(aClip,A.aam(this.M,aOffset),this.Width,Du,DK,DJ,DF,aBlend);
...
0,3),(AM[3]+d)-((d/2)|0));}N_=N_|0xA;}}CW.Beu(aClip,this.Aj,Nk,AM,N_,Du,DK,DJ,DF
...
this.M);},A6G:function(E){var B;if(E===this.AtB)return;this.AtB=E;if(!!this.Ac&&((
...
0x1,0x0);else this.C4(0x0,0x1);},A6U:function(E){var B;if(E[0]<0)E=[0,E[1]];if(E[
...
0xFF)<<24);}if(A.z8([AD[2]-AD[0],AD[3]-AD[1]],CZ))CW.A20(aClip,this.Aj,Nk,A.aam(
this.M,aOffset),A.aaj(this.M.slice(0,2),AD.slice(0,2)),Du,DK,DJ,DF,aBlend);else CW.
BkV(aClip,this.Aj,Nk,A.aam(AD,aOffset),[].concat(BH,CZ),Du,DK,DJ,DF,aBlend,true);
...
)===0x40)){var A0$=((((C9[2]-C9[0])<<16)+((CZ[0]/2)|0))/CZ[0])|0;var Azd=((((C9[
3]-C9[1])<<16)+((CZ[1]/2)|0))/CZ[1])|0;var Ah8=A0$;if(Azd>Ah8)Ah8=Azd;BX=A.aaO(BX
,((CZ[0]*Ah8)+32768)>>16);BX=A.aaL(BX,((CZ[1]*Ah8)+32768)>>16);}else if(((Br&0x80
)===0x80)){var A0$=((((C9[2]-C9[0])<<16)+((CZ[0]/2)|0))/CZ[0])|0;var Azd=((((C9[
3]-C9[1])<<16)+((CZ[1]/2)|0))/CZ[1])|0;var Ah8=A0$;if(Azd<Ah8)Ah8=Azd;BX=A.aaO(BX
...
0,2));return BX;},Bg8:function(){return this.AP;},AQd:function(){return this.Ta;
...
0,Sc:0,AbN:0,Bo:A.vw,J7:0x12,AP:0xFFFFFFFF,AeM:false,Z_:false,Xw:false,AL0:false
,HQ:false,K3:function(){if(!!this.N7){this.AZr(this.N7);this.N7=null;}},J_:function(
...
0x80)|0x1;}if((J4===1)&&!((Br&0x40)===0x40)){CW.A3s(aClip,font,this.CG,2,(this.CG.
...
Descent)+leading;var Bus=aClip[1]-AD[1];var But=aClip[3]-AD[1];var AYF=AD[2]-AD[
0];var Dl=0;var P=1;var BK=this.CG.charCodeAt(1)||0;while(((Dl+ZU)<Bus)&&(BK>0)){
P=P+BK;Dl=Dl+ZU;BK=this.CG.charCodeAt(P)||0;}while((Dl<But)&&(BK>0)){var L5=A.aaj(
...
,P+1);if(((Axs<0)||(Axs>=AoT))&&((Axt<0)||(Axt>=AoT)))OW=false;}if(OW)Alk=AYF;else
if(((Br&0x4)===0x4))L5=[(L5[0]-AYF)+font.XG(this.CG,P+1,BK-1),L5[1]];else if(((Br&
0x2)===0x2))L5=[(L5[0]-((AYF/2)|0))+((font.XG(this.CG,P+1,BK-1)/2)|0),L5[1]];CW.
A3s(aClip,font,this.CG,P+1,BK-1,C9,L5,Alk,0,Du,DK,DJ,DF,true);P=P+BK;Dl=Dl+ZU;BK=
this.CG.charCodeAt(P)||0;}},G:function(E){var B;if(A.z9(E,this.M))return;var Bce;
Bce=((B=this.M)[2]-B[0])!==(E[2]-E[0]);if((((Bce&&!this.AbN)&&this.AeM)&&this.HQ
...
OZ],this);}A.Core.EC.G.call(this,E);A.ow([this,this.Ah1],this);},Buk:function(aBidi
,aRowStart,aRowEnd,aIndex){if(!aBidi)return aIndex;aIndex=A.ze(aBidi,aRowStart,aRowEnd
,aIndex);return aIndex;},Buj:function(aBidi,aRowStart,aRowEnd,aIndex){if(!aBidi)
return aIndex;aIndex=A.zd(aBidi,aRowStart,aRowEnd,aIndex);return aIndex;},AZr:function(
aBidi){if(!aBidi)return;A.qU(aBidi);},BuF:function(aSize){var bidi=null;bidi=A.vj(
...
!this.Z_)WJ=width-(this.I2*2);else WJ=width;if(WJ<0)WJ=1;}if(!!this.N7){this.AZr(
this.N7);this.N7=null;}this.HQ=true;if((this.String!==A.jm)&&!!font){var length=
this.String.length;if(this.AL0)this.N7=this.BuF(length);this.CG=font.Bkl(this.String
,0,WJ,length,this.N7);if(!!this.N7&&!this.BfM()){this.AZr(this.N7);this.N7=null;
...
var J4=Ip.charCodeAt(0)||0;var Ak2=((height+leading)/Ay_)|0;var AYU=false;var AHM=
...
0x100)){Ay$=((J4-Ak2)/2)|0;AI0=(Ay$+Ak2)-1;}else AI0=Ak2-1;AYU=Ay$>0;AHM=AI0<(J4-
1);for(KQ=1;A9<Ay$;A9=A9+1)KQ=KQ+(Ip.charCodeAt(KQ)||0);if(AHM)for(Nl=KQ;A9<AI0;
A9=A9+1)Nl=Nl+(Ip.charCodeAt(Nl)||0);if(AYU){var IQ=Ip.charCodeAt(KQ)||0;tmp=(GS+
...
Ip.charCodeAt(0)||0;for(;A9<J4;A9=A9+1){var Ali=AYU&&!A9;var Alj=AHM&&(A9===(J4-
...
inx)||0;var KQ=WV;var Nl=(WV+IQ)-2;var AZJ=-1;var AZK=-1;if(!this.AeM&&(font.XG(
...
Wy)||Ali)||Alj)&&(KQ<Nl)){if((Wx&&(AsQ||!Wy))||Ali){if(AZJ>0)Ip=A.aaT(Ip,AZJ,0xFEFF
);Ip=A.aaT(Ip,KQ,0x2026);AZJ=KQ;KQ=KQ+1;AsQ=!AsQ;Ali=false;if(font.XG(Ip,WV,IQ-1
)<=AIB){Wx=false;Wy=false;}else Wx=Wx||!Wy;}if((Wy&&(!AsQ||!Wx))||Alj){if(AZK>0)
Ip=A.aaT(Ip,AZK,0xFEFF);Ip=A.aaT(Ip,Nl,0x2026);AZK=Nl;Nl=Nl-1;AsQ=!AsQ;Alj=false;
if(font.XG(Ip,WV,IQ-1)<=AIB){Wx=false;Wy=false;}else Wy=Wy||!Wx;}}inx=inx+IQ;}this.
Alq=[font.A3W(Ip),((Ip.charCodeAt(0)||0)*Ay_)-leading];this.CG=Ip;}if(this.Z_&&(
this.CG!==A.jm)){var AsC=[this.I2,0];this.U=this.U|0x2000;this.G(A.aal(A.z4(this.
C_(),AsC),this.Bo));this.U=this.U&~0x2000;}if(!!this.Ac&&((this.U&0x1)===0x1))this.
Ac.Bg(this.M);A.ow([this,this.Ah1],this);},BiD:function(E){if(E===this.AL0)return;
...
,this.OZ],this);},BjS:function(E){var B;if(E<0)E=0;if(this.Sc===E)return;this.Sc=
...
),this.Bo));if(this.HQ)A.ow([this,this.Ah1],this);},BiC:function(E){if(E===this.
...
A.aal(A.z4(this.C_(),AsC),this.Bo));this.U=this.U&~0x2000;}},Bj9:function(E){if(
...
},Gk:function(E){var B;if(A.z8(E,this.Bo))return;this.Bo=E;if(!!this.Ac&&((this.
...
},BfM:function(){if(!this.HQ)this.WU(this);if(!this.N7)return false;var result=false;
...
0)aIndex=0;var BvP=(this.CG.charCodeAt(0)||0)-1;var L_=this.CG.charCodeAt(1)||0;
var inx=1;var Aia=2;var A9=0;var col=-1;var CO=true;aIndex=aIndex+2;while((A9<BvP
)&&((inx+L_)<=aIndex)){inx=inx+L_;A9=A9+1;Aia=Aia+1;aIndex=aIndex+1;L_=this.CG.charCodeAt(
inx)||0;}if(aIndex>(inx+L_))aIndex=inx+L_;if(!!this.N7)aIndex=(inx+this.Buj(this.
...
)WG=WG+1;WG=WG-Aia;if(!!this.N7)WG=AI1+this.Buk(this.N7,AI1,AoT,WG-AI1);return WG;
...
AD[2]-AD[0])/2)|0)-((font.XG(Nw,0,L_)/2)|0);var col=font.Bfn(Nw,0,L_,(KK[0]-AD[0
...
Bfj(Nw,0,L_,col,Alk);if(pos<0)pos=0;return[FY+pos,Dl];},AMJ:function(Ab){var B;if((
...
)||0)-1;var Bcf=font.XG(this.CG,inx+1,Aza);var A0_=font.A35(this.CG,inx+1,Aza);var
AoU=Bcf;var ZU=font.Ascent+font.Descent;var Azp=(J4*((font.Ascent+font.Descent)+
...
0x10))Dl=(Dl+((height/2)|0))-((Azp/2)|0);FY=(FY+A0_[0])+this.I2;AoU=(AoU+(A0_[2]-
A0_[0]))-Bcf;var BX;{var BbK=[A8[0]+FY,A8[1]+Dl];BX=[].concat(BbK,A.aak(BbK,[AoU
,ZU]));}return A.aam(BX,this.Bo);},AA9:function(Ab){if((this.String===A.jm)||!this.
...
this.B5.A3W(this.CG),this.Alq[1]];this.Alq=[this.Alq[0],((this.CG.charCodeAt(0)||
...
aam(BX,this.Bo);},_Init:function(aArg){A.Core.EC._Init.call(this,aArg);this.__proto__=
...
)return;var AD=this.C_();Ce=Ce+1;if((AD[0]>=AD[2])||(AD[1]>=AD[3]))return;CW.Bes(
...
jm))&&!!this.AttrSet)this.attrString=A._NewObject(A.Graphics.A2l,0);if(!!this.attrString
)this.attrString.Bkk(this.AttrSet,this.String,AJx,false);if(!!this.Ac&&((this.U&
0x1)===0x1))this.Ac.Bg(this.M);A.ow([this,this.Ah1],this);},OZ:function(H){A.ow([
this,this.WU],this);},Bb$:function(H){var B;if(!!this.Ac&&((this.U&0x1)===0x1))this.
...
this,this.OZ],this);},A6q:function(E){if(this.AttrSet===E)return;if(!!this.AttrSet
){A.zl([this,this.Bb$],this.AttrSet,0);A.zl([this,this.OZ],this.AttrSet,1);}this.
AttrSet=E;this.attrString=null;if(!!this.AttrSet){A.y_([this,this.Bb$],this.AttrSet
...
WU(this);if(!this.attrString)return EV;var Br=this.J7;var CZ=this.attrString.Bfo(
...
this.Fs=null;A.ow([this,this.ArW],this);},AYM:function(){return;},As5:function(H
){var B;if(this.SM===0x00)return;if(this.SM===0x45){var KR=A._NewObject(A.Graphics.
Awf,0);KR=KR.Beh(this.Cf.Get(0,0),this.Cf.Get(0,1),this.Cf.Get(1,0),this.Cf.Get(
...
AYM();}if((((this.SM===0x4D)&&!!this.Fs)&&!!this.Uk[0])&&!!this.Uk[1]){var Aid=[
...
Cf.Get(3,1)+0.5)|0];this.AYM();}this.Aow=this.SM;this.SM=0x00;if(!!this.Ac&&((this.
U&0x1)===0x1))this.Ac.Bg(this.GetExtent());},ArW:function(s){this.As5(s);},BjX:function(
...
Bdu(KJ);this.AhA=AG8[0];this.AhB=AG8[1];this.Aow=0x4D;this.SM=0x00;if(!this.Uk[0
...
0x1))this.Ac.Bg(this.GetExtent());this.AYM();},_Init:function(aArg){A.Core.YN._Init.
...
,O:null,A$X:1,A$Y:0,A$Z:0,A$0:0,A$1:1,A$2:0,A$3:0,A$4:0,A$5:1,GM:255,AIv:false,J_:
...
this.U&0x2)===0x2);Ce=Ce+1;var BaK;var BaL;var BaM;var BaN;var BvY=this.GM;BaK=BaL=
BaM=BaN=BvY;var AkD=255|(255<<8)|(255<<16)|((((Ce*BaK)>>8)&0xFF)<<24);var AkE=255|(
255<<8)|(255<<16)|((((Ce*BaL)>>8)&0xFF)<<24);var Bul=255|(255<<8)|(255<<16)|((((
Ce*BaM)>>8)&0xFF)<<24);var Bum=255|(255<<8)|(255<<16)|((((Ce*BaN)>>8)&0xFF)<<24);
...
Get(3,0)+Np,this.Cf.Get(3,1)+Nq,this.Cf.Get(3,2),AD,AkD,AkE,Bul,Bum,aBlend,true);
...
Bv2=A.aak(this.Asu(A.aaj(DX.HU,DX.Dz)),Ff);DX.HU=A.aak(this.Asu(DX.HU),Ff);DX.NI=
A.aak(this.Asu(DX.NI),Ff);DX.Dz=A.aaj(DX.HU,Bv2);return W.GH(DX);}return C.Ag8.GH.
...
function(AG8,KJ){C.Ag8.AFc.call(this,AG8,KJ);this.AIv=false;},Byb:function(){var
...
y4-y1)+(BL*y4);var Lt=y1;this.A$X=AH4-(Lt*BL);this.A$Y=(BK*BL)-Q4;this.A$Z=(Q4*Lt
)-(BK*AH4);this.A$0=(Lt*Asm)-d;this.A$1=a-(BK*Asm);this.A$2=(BK*d)-(a*Lt);this.A$3=(
d*BL)-(AH4*Asm);this.A$4=(Q4*Asm)-(a*BL);this.A$5=(a*AH4)-(Q4*d);this.AIv=true;}
,Asu:function(Fo){var B;if(!this.AIv)this.Byb();var A1L=Fo[0];var A1N=Fo[1];var AzF=((
A1L*this.A$X)+(A1N*this.A$Y))+this.A$Z;var AzI=((A1L*this.A$0)+(A1N*this.A$1))+this.
A$2;var A00=((A1L*this.A$3)+(A1N*this.A$4))+this.A$5;if(!!A00){AzF=AzF/A00;AzI=AzI
/A00;}var AoY=[].concat(BH,this.Uk);AzF=AzF*(AoY[2]-AoY[0]);AzI=AzI*(AoY[3]-AoY[
1]);return A.aak([AzF|0,AzI|0],AoY.slice(0,2));},Rd:function(H){var B;var BaO=this.
Uk;if(!!this.O)this.bitmap=this.O.HO;else this.bitmap=null;if(!!this.bitmap)this.
Uk=this.bitmap.FrameSize;else this.Uk=BH;if(((A.z8(BaO,this.Uk)||((this.Aow===0x45
)&&(this.SM===0x00)))&&!!this.Ac)&&((this.U&0x1)===0x1))this.Ac.Bg(this.GetExtent(
));if(((this.Aow!==0x45)&&(this.SM===0x00))&&!A.z8(BaO,this.Uk)){this.SM=this.Aow;
A.ow([this,this.ArW],this);}},DD:function(E){var B;if(E===this.GM)return;this.GM=
E;if(!!this.Ac&&((this.U&0x1)===0x1))this.Ac.Bg(this.GetExtent());},Bi7:function(
...
,AMo:false,K3:function(){this.AY5();},J_:function(CW,aClip,aOffset,Ce,aBlend){if(
...
);},AY5:function(){return;},Aii:function(H){var B;if(!!this.Ac&&((this.U&0x1)===
...
!!this.Hl)this.Ac.Bg(this.M);},Bi2:function(E){var B;if(E===this.AMo)return;this.
...
,Dz:A.vw,Width:1,K3:function(){this.AY5();},J_:function(CW,aClip,aOffset,Ce,aBlend
...
Du,DK,DJ,DF,true,true);},AY5:function(){return;},Aii:function(H){var B;if(!!this.
Ac&&((this.U&0x1)===0x1))this.Ac.Bg(this.M);},L:function(E){var B;if(E===this.AP
...
};C.BzX={A15:0x1,A14:0x2,A16:0x4,A19:0x8,A18:0x10,A17:0x20,BA$:0x40,BBa:0x80,BBl:
0x100};C.BBp={A15:0x1,A14:0x2,A16:0x4,A19:0x8,A18:0x10,A17:0x20,Byt:0x40,Bys:0x80
,Byy:0x100};C.BAz={Normal:0,BA6:1,BA4:2,BA5:3};
