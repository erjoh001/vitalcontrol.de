...
)<<24);}if((AfB===1)&&(AfC===1))CW.AtA(aClip,AcA,AcB,AkD,AkE,aBlend);else CW.Bez(
...
var IQ=Math.sqrt((JY*JY)+(JZ*JZ));JY=JY/IQ;JZ=JZ/IQ;var A_$=Aob+(JZ*AhK);var A$a=
Aoc-(JY*AhK);var AHE=Aod+(JZ*AhL);var AHF=Aoe-(JY*AhL);var AHG=Aod-(JZ*AhL);var AHH=
Aoe+(JY*AhL);var AHI=Aob-(JZ*AhK);var AHJ=Aoc+(JY*AhK);var left=A_$;var right=A_$;
var top=A$a;var bottom=A$a;if(AHE<left)left=AHE;if(AHG<left)left=AHG;if(AHI<left
...
this.Kt){if(this.Kt.Oy)A.zl([this,this.Rd],this.Kt,0);this.Kt=null;}},A7r:function(
...
)&0xFF)<<24);}CW.Bex(aClip,A.aam(this.M,aOffset),this.Width,Du,DK,DJ,DF,aBlend);
...
0,3),(AM[3]+d)-((d/2)|0));}N_=N_|0xA;}}CW.Bew(aClip,this.Aj,Nk,AM,N_,Du,DK,DJ,DF
...
this.M);},A6I:function(E){var B;if(E===this.AtB)return;this.AtB=E;if(!!this.Ac&&((
...
0xFF)<<24);}if(A.z8([AD[2]-AD[0],AD[3]-AD[1]],CZ))CW.A22(aClip,this.Aj,Nk,A.aam(
this.M,aOffset),A.aaj(this.M.slice(0,2),AD.slice(0,2)),Du,DK,DJ,DF,aBlend);else CW.
BkX(aClip,this.Aj,Nk,A.aam(AD,aOffset),[].concat(BH,CZ),Du,DK,DJ,DF,aBlend,true);
...
)===0x40)){var A1b=((((C9[2]-C9[0])<<16)+((CZ[0]/2)|0))/CZ[0])|0;var Azd=((((C9[
3]-C9[1])<<16)+((CZ[1]/2)|0))/CZ[1])|0;var Ah8=A1b;if(Azd>Ah8)Ah8=Azd;BX=A.aaO(BX
,((CZ[0]*Ah8)+32768)>>16);BX=A.aaL(BX,((CZ[1]*Ah8)+32768)>>16);}else if(((Br&0x80
)===0x80)){var A1b=((((C9[2]-C9[0])<<16)+((CZ[0]/2)|0))/CZ[0])|0;var Azd=((((C9[
3]-C9[1])<<16)+((CZ[1]/2)|0))/CZ[1])|0;var Ah8=A1b;if(Azd<Ah8)Ah8=Azd;BX=A.aaO(BX
...
0,2));return BX;},Bg_:function(){return this.AP;},AQd:function(){return this.Ta;
...
,HQ:false,K3:function(){if(!!this.N7){this.AZt(this.N7);this.N7=null;}},J_:function(
...
Descent)+leading;var Bur=aClip[1]-AD[1];var Bus=aClip[3]-AD[1];var AYH=AD[2]-AD[
...
,P+1);if(((Axs<0)||(Axs>=AoT))&&((Axt<0)||(Axt>=AoT)))OW=false;}if(OW)Alk=AYH;else
if(((Br&0x4)===0x4))L5=[(L5[0]-AYH)+font.XG(this.CG,P+1,BK-1),L5[1]];else if(((Br&
0x2)===0x2))L5=[(L5[0]-((AYH/2)|0))+((font.XG(this.CG,P+1,BK-1)/2)|0),L5[1]];CW.
A3u(aClip,font,this.CG,P+1,BK-1,C9,L5,Alk,0,Du,DK,DJ,DF,true);P=P+BK;Dl=Dl+ZU;BK=
this.CG.charCodeAt(P)||0;}},G:function(E){var B;if(A.z9(E,this.M))return;var Bcg;
Bcg=((B=this.M)[2]-B[0])!==(E[2]-E[0]);if((((Bcg&&!this.AbN)&&this.AeM)&&this.HQ
...
!this.Z_)WJ=width-(this.I2*2);else WJ=width;if(WJ<0)WJ=1;}if(!!this.N7){this.AZt(
this.N7);this.N7=null;}this.HQ=true;if((this.String!==A.jm)&&!!font){var length=
this.String.length;if(this.AL0)this.N7=this.BuE(length);this.CG=font.Bkn(this.String
,0,WJ,length,this.N7);if(!!this.N7&&!this.BfO()){this.AZt(this.N7);this.N7=null;
...
var J4=Ip.charCodeAt(0)||0;var Ak2=((height+leading)/Ay_)|0;var AYW=false;var AHM=
...
0x100)){Ay$=((J4-Ak2)/2)|0;AI0=(Ay$+Ak2)-1;}else AI0=Ak2-1;AYW=Ay$>0;AHM=AI0<(J4-
1);for(KQ=1;A9<Ay$;A9=A9+1)KQ=KQ+(Ip.charCodeAt(KQ)||0);if(AHM)for(Nl=KQ;A9<AI0;
A9=A9+1)Nl=Nl+(Ip.charCodeAt(Nl)||0);if(AYW){var IQ=Ip.charCodeAt(KQ)||0;tmp=(GS+
...
Ip.charCodeAt(0)||0;for(;A9<J4;A9=A9+1){var Ali=AYW&&!A9;var Alj=AHM&&(A9===(J4-
...
inx)||0;var KQ=WV;var Nl=(WV+IQ)-2;var AZL=-1;var AZM=-1;if(!this.AeM&&(font.XG(
...
Wy)||Ali)||Alj)&&(KQ<Nl)){if((Wx&&(AsQ||!Wy))||Ali){if(AZL>0)Ip=A.aaT(Ip,AZL,0xFEFF
);Ip=A.aaT(Ip,KQ,0x2026);AZL=KQ;KQ=KQ+1;AsQ=!AsQ;Ali=false;if(font.XG(Ip,WV,IQ-1
)<=AIB){Wx=false;Wy=false;}else Wx=Wx||!Wy;}if((Wy&&(!AsQ||!Wx))||Alj){if(AZM>0)
Ip=A.aaT(Ip,AZM,0xFEFF);Ip=A.aaT(Ip,Nl,0x2026);AZM=Nl;Nl=Nl-1;AsQ=!AsQ;Alj=false;
if(font.XG(Ip,WV,IQ-1)<=AIB){Wx=false;Wy=false;}else Wy=Wy||!Wx;}}inx=inx+IQ;}this.
Alq=[font.A3Y(Ip),((Ip.charCodeAt(0)||0)*Ay_)-leading];this.CG=Ip;}if(this.Z_&&(
...
Ac.Bg(this.M);A.ow([this,this.Ah1],this);},BiF:function(E){if(E===this.AL0)return;
...
,this.OZ],this);},BjU:function(E){var B;if(E<0)E=0;if(this.Sc===E)return;this.Sc=
...
),this.Bo));if(this.HQ)A.ow([this,this.Ah1],this);},BiE:function(E){if(E===this.
...
A.aal(A.z4(this.C_(),AsC),this.Bo));this.U=this.U&~0x2000;}},Bj$:function(E){if(
...
},BfO:function(){if(!this.HQ)this.WU(this);if(!this.N7)return false;var result=false;
...
AD[2]-AD[0])/2)|0)-((font.XG(Nw,0,L_)/2)|0);var col=font.Bfp(Nw,0,L_,(KK[0]-AD[0
...
Bfl(Nw,0,L_,col,Alk);if(pos<0)pos=0;return[FY+pos,Dl];},AMJ:function(Ab){var B;if((
...
)||0)-1;var Bch=font.XG(this.CG,inx+1,Aza);var A1a=font.A37(this.CG,inx+1,Aza);var
AoU=Bch;var ZU=font.Ascent+font.Descent;var Azp=(J4*((font.Ascent+font.Descent)+
...
0x10))Dl=(Dl+((height/2)|0))-((Azp/2)|0);FY=(FY+A1a[0])+this.I2;AoU=(AoU+(A1a[2]-
...
this.B5.A3Y(this.CG),this.Alq[1]];this.Alq=[this.Alq[0],((this.CG.charCodeAt(0)||
...
)return;var AD=this.C_();Ce=Ce+1;if((AD[0]>=AD[2])||(AD[1]>=AD[3]))return;CW.Beu(
...
)this.attrString.Bkm(this.AttrSet,this.String,AJx,false);if(!!this.Ac&&((this.U&
0x1)===0x1))this.Ac.Bg(this.M);A.ow([this,this.Ah1],this);},OZ:function(H){A.ow([
this,this.WU],this);},Bcb:function(H){var B;if(!!this.Ac&&((this.U&0x1)===0x1))this.
...
WU(this);if(!this.attrString)return EV;var Br=this.J7;var CZ=this.attrString.Bfq(
...
this.Fs=null;A.ow([this,this.ArW],this);},AYO:function(){return;},As5:function(H
){var B;if(this.SM===0x00)return;if(this.SM===0x45){var KR=A._NewObject(A.Graphics.
Awf,0);KR=KR.Bej(this.Cf.Get(0,0),this.Cf.Get(0,1),this.Cf.Get(1,0),this.Cf.Get(
...
AYO();}if((((this.SM===0x4D)&&!!this.Fs)&&!!this.Uk[0])&&!!this.Uk[1]){var Aid=[
...
U&0x1)===0x1))this.Ac.Bg(this.GetExtent());},ArW:function(s){this.As5(s);},BjZ:function(
...
Bdw(KJ);this.AhA=AG8[0];this.AhB=AG8[1];this.Aow=0x4D;this.SM=0x00;if(!this.Uk[0
...
0x1))this.Ac.Bg(this.GetExtent());this.AYO();},_Init:function(aArg){A.Core.YN._Init.
...
,O:null,A$Z:1,A$0:0,A$1:0,A$2:0,A$3:1,A$4:0,A$5:0,A$6:0,A$7:1,GM:255,AIv:false,J_:
...
this.U&0x2)===0x2);Ce=Ce+1;var BaM;var BaN;var BaO;var BaP;var BvX=this.GM;BaM=BaN=
BaO=BaP=BvX;var AkD=255|(255<<8)|(255<<16)|((((Ce*BaM)>>8)&0xFF)<<24);var AkE=255|(
255<<8)|(255<<16)|((((Ce*BaN)>>8)&0xFF)<<24);var Buk=255|(255<<8)|(255<<16)|((((
Ce*BaO)>>8)&0xFF)<<24);var Bul=255|(255<<8)|(255<<16)|((((Ce*BaP)>>8)&0xFF)<<24);
...
y4-y1)+(BL*y4);var Lt=y1;this.A$Z=AH4-(Lt*BL);this.A$0=(BK*BL)-Q4;this.A$1=(Q4*Lt
)-(BK*AH4);this.A$2=(Lt*Asm)-d;this.A$3=a-(BK*Asm);this.A$4=(BK*d)-(a*Lt);this.A$5=(
d*BL)-(AH4*Asm);this.A$6=(Q4*Asm)-(a*BL);this.A$7=(a*AH4)-(Q4*d);this.AIv=true;}
,Asu:function(Fo){var B;if(!this.AIv)this.Bya();var A1N=Fo[0];var A1P=Fo[1];var AzF=((
A1N*this.A$Z)+(A1P*this.A$0))+this.A$1;var AzI=((A1N*this.A$2)+(A1P*this.A$3))+this.
A$4;var A02=((A1N*this.A$5)+(A1P*this.A$6))+this.A$7;if(!!A02){AzF=AzF/A02;AzI=AzI
/A02;}var AoY=[].concat(BH,this.Uk);AzF=AzF*(AoY[2]-AoY[0]);AzI=AzI*(AoY[3]-AoY[
1]);return A.aak([AzF|0,AzI|0],AoY.slice(0,2));},Rd:function(H){var B;var BaQ=this.
Uk;if(!!this.O)this.bitmap=this.O.HO;else this.bitmap=null;if(!!this.bitmap)this.
Uk=this.bitmap.FrameSize;else this.Uk=BH;if(((A.z8(BaQ,this.Uk)||((this.Aow===0x45
)&&(this.SM===0x00)))&&!!this.Ac)&&((this.U&0x1)===0x1))this.Ac.Bg(this.GetExtent(
));if(((this.Aow!==0x45)&&(this.SM===0x00))&&!A.z8(BaQ,this.Uk)){this.SM=this.Aow;
A.ow([this,this.ArW],this);}},DD:function(E){var B;if(E===this.GM)return;this.GM=
E;if(!!this.Ac&&((this.U&0x1)===0x1))this.Ac.Bg(this.GetExtent());},Bi9:function(
...
,AMo:false,K3:function(){this.AY7();},J_:function(CW,aClip,aOffset,Ce,aBlend){if(
...
);},AY7:function(){return;},Aii:function(H){var B;if(!!this.Ac&&((this.U&0x1)===
...
!!this.Hl)this.Ac.Bg(this.M);},Bi4:function(E){var B;if(E===this.AMo)return;this.
...
Du,DK,DJ,DF,true,true);},AY7:function(){return;},Aii:function(H){var B;if(!!this.
Ac&&((this.U&0x1)===0x1))this.Ac.Bg(this.M);},L:function(E){var B;if(E===this.AP
...
};C.BzW={A17:0x1,A16:0x2,A18:0x4,A1$:0x8,A1_:0x10,A19:0x20,BA_:0x40,BA$:0x80,BBk:
0x100};C.BBo={A17:0x1,A16:0x2,A18:0x4,A1$:0x8,A1_:0x10,A19:0x20,Bys:0x40,Byr:0x80
,Byx:0x100};C.BAy={Normal:0,BA5:1,BA3:2,BA4:3};
