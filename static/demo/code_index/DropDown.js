...
B7:null,Background:null,Text:null,Bc:null,V:Ce,LU:0xFF000000,A5F:0xFF454545,A$4:
...
AD)this.AD.GT(this.AzD);this.BgB(this);}},BzR:function(AoR){var B;var B1=AoR;var
AJn=AoR.M;var Ay$=Hr;while(!!B1){var Aaq=B1.FG;if(!B1.Ab&&(B1!==AoR)){B1.Bj(AJn);
return A.abh([0,0,(B=AoR.M)[2]-B[0],B[3]-B[1]],Ay$);}if(!!Aaq){if(((B=Aaq.QO)[0]>=
B[2])||(B[1]>=B[3])){A.we(B1,0);A.we(Aaq,0);}Aaq.QO=A.wC(Aaq.QO,AJn);}if(!((B1.U&
0x1)===0x1))return A.abh([0,0,(B=AoR.M)[2]-B[0],B[3]-B[1]],Ay$);if(B1===AoR)AJn=
A.lb(A.abh(AJn,B1.M.slice(0,2)),B1.M);Ay$=A.abf(Ay$,B1.M.slice(0,2));B1=B1.Ab;}return A.
