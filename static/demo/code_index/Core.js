...
var Qe="Recursive invalidate during active update cycle.";var MQ=[-8,-8,9,9];var
...
){return this.GetExtent();},G6:function(CN){return null;},Yq:function(Dc,BH,Om,Aas
,Ac7,Ac6){return null;},AuO:function(Dc){return Dc;},AuY:function(BJ,MU){return Cf;
},Ano:function(aOffset,Atz){},GetExtent:function(){return BD;},Cs:function(Rw,Vc
){var B;if(((this.U&0x200)===0x200))Rw=Rw&~0x400;var A3n=(this.U&~Vc)|Rw;var XE=
A3n^this.U;this.U=A3n;if(!!this.Ab&&!!(XE&0x14)){var BdL=((this.U&0x14)===0x14);
if(BdL&&!this.Ab.AV)this.Ab.Bb(this);if(!BdL&&(this.Ab.AV===this))this.Ab.Bb(this.
Ab.AC6(this,0x14));}if(!!this.Ab&&!!(XE&0x403))this.Ab.Bj(this.GetClipping());if(((
...
XE&0x100000)===0x100000)&&((Rw&0x100000)===0x100000))&&!((this.U&0x10)===0x10))&&(
...
0x10,0x0);if((((((XE&0x200000)===0x200000)&&((Rw&0x200000)===0x200000))&&((this.
...
MU){var B;var EW=this.PT;var Ar=(C.AEo.isPrototypeOf(B=this.Ev)?B:null);var x1=Ar.
...
Akh;},_className:"Core::LineView"};C.ZJ={KD:A.wf,ML:A.wf,ED:A.wf,Et:A.wf,At3:function(
BJ,Ah_){var Ar=A._NewObject(C.AEp,0);this.Ev=null;Ar.extent=this.GetExtent();Ar.
Be=BJ;Ar.NK=Ah_;Ar.AiU=this.Et;Ar.AiV=this.ED;Ar.AA6=this.ML;Ar.AA7=this.KD;this.
Ev=Ar;},AuY:function(BJ,MU){var B;var EW=this.PT;var Ar=(C.AEp.isPrototypeOf(B=this.
...
y2-y1)-1;var AiA=Ar.extent[0];var AiC=Ar.extent[1];var Af5=(Ar.extent[2]-AiA)-1;
var Af4=(Ar.extent[3]-AiC)-1;if(!Af5)Af5=1;if(!Af4)Af4=1;if(((this.U&0x100)===0x100
)){this.Et=[x1+((((Ar.AiU[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AiU[1]-AiC)*BL)/Af4)|0)];
this.ED=[x1+((((Ar.AiV[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AiV[1]-AiC)*BL)/Af4)|0)];this.
ML=[x1+((((Ar.AA6[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AA6[1]-AiC)*BL)/Af4)|0)];this.KD=[
x1+((((Ar.AA7[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AA7[1]-AiC)*BL)/Af4)|0)];}else{this.
DN([x1+((((Ar.AiU[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AiU[1]-AiC)*BL)/Af4)|0)]);this.DD([
x1+((((Ar.AiV[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AiV[1]-AiC)*BL)/Af4)|0)]);this.KA([x1+((((
Ar.AA6[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AA6[1]-AiC)*BL)/Af4)|0)]);this.J1([x1+((((Ar.
AA7[0]-AiA)*BZ)/Af5)|0),y1+((((Ar.AA7[1]-AiC)*BL)/Af4)|0)]);this.Ev=Ar;}return[BZ+
...
Ab&&((this.U&0x1)===0x1))this.Ab.Bj(this.GetClipping());if((!!this.Ab&&((this.U&
0x400)===0x400))&&!((this.Ab.U&0x2000)===0x2000)){this.U=this.U|0x800;this.Ab.U=
this.Ab.U|0x4000;A.pe([B=this.Ab,B.JP],this);}},ARx:function(K5){var HF=A.abi(4,
A.wf,null);var O=0;var Ik=3;var A2S=false;var A2T=false;HF.Set(0,this.Et);HF.Set(
1,this.ED);HF.Set(2,this.ML);HF.Set(3,this.KD);while(O<4){var Bhu=HF.Get(O)[0];var
ALI=HF.Get(O)[1];var BDf=HF.Get(Ik)[0];var A49=HF.Get(Ik)[1];if(((ALI>K5[1])!==(
A49>K5[1]))||((ALI<K5[1])!==(A49<K5[1]))){var Ep=((((BDf-Bhu)*(K5[1]-ALI))/(A49-
ALI))|0)+Bhu;if(K5[0]>Ep)A2S=!A2S;if(K5[0]<Ep)A2T=!A2T;}Ik=O;O=O+1;}return A2S||
A2T;},BjY:function(){return((((this.Et[0]===this.KD[0])&&(this.ED[0]===this.ML[0
...
C.Art,0);Ar.extent=this.M;Ar.Be=BJ;Ar.NK=Ah_;this.Ev=Ar;},AuY:function(BJ,MU){var
...
__proto__=C.Eu;},_className:"Core::RectView"};C.P={B8:null,B9:null,AKC:null,FG:null
,He:null,XF:null,ApV:null,AV:null,G_:255,AzX:0,Az0:0,AzZ:0,AzY:0,Init:function(aArg
...
)===0x80000)){var Ap8=BD;var X;for(X=this.B8;!!X;X=X.Ah)if(((X.U&0x1)===0x1))Ap8=
A.wC(Ap8,X.GetClipping());Az=A.wC(Az,A.abh(Ap8,this.M.slice(0,2)));}return Az;},
Yq:function(Dc,BH,Om,Aas,Ac7,Ac6){var B;var X=this.B9;var App=null;var AE=BD;var
Kh=null;var A3c=!!this.XF&&(!!this.XF.FS||!!this.XF.B8);if(((B=A.lb(Dc,this.M))[
0]>=B[2])||(B[1]>=B[3]))return null;Dc=A.abg(Dc,this.M.slice(0,2));if(!!Ac7){X=Ac7;
...
U&0x400)===0x400)){if(!(((B=A.lb(extent,AE))[0]>=B[2])||(B[1]>=B[3])))Ao$=X.Yq(AE
,BH,Om,AJ6,Ac7,Ac6);}else if(!(((B=A.lb(extent,Dc))[0]>=B[2])||(B[1]>=B[3]))||(Aas===
X))Ao$=X.Yq(Dc,BH,Om,AJ6,Ac7,Ac6);X=X.AJ;if(!!Ao$){if(!App||((Ao$.Au8<App.Au8)&&(
Ao$.Au8>=0)))App=Ao$;if(!Ao$.Au8)X=null;}}else X=X.AJ;Ac7=null;}return App;},AuO:
function(Dc){var B;var F;var X=this.B8;var LI=BD;var AA0=true;var result=(Dc=F=A.
...
}return A.lb(A.abh(result,this.M.slice(0,2)),this.M);},Cs:function(Rw,Vc){var B;
var Tw=this.U;if(((!!this.Ab&&!!!this.FG)&&((this.U&0x80001)===0x80001))&&((Vc&0x80000
)===0x80000))this.Ab.Bj(this.GetClipping());C.Eu.Cs.call(this,Rw,Vc);if((((!!this.
Ab&&!!!this.FG)&&((this.U&0x1)===0x1))&&((Rw&0x80000)===0x80000))&&!((Tw&0x80000
...
,0x40);}if(!!this.He&&((XE&0x40)===0x40)){if(((this.U&0x40)===0x40)&&((this.He.C2.
U&0x14)===0x14))this.He.C2.Cs(0x40,0x0);else this.He.C2.Cs(0x0,0x40);}if(((XE&0x10
)===0x10)){var X;for(X=this.B8;!!X;X=X.Ah)if((((X.U&0x300000)===0x300000)&&!((X.
U&0x80)===0x80))&&(!((X.U&0x10000)===0x10000)||(this.He.C2===X)))X.Cs(Rw&0x10,Vc&
0x10);}if(!!XE){this.U=this.U|0x8000;A.pe([this,this.ABF],this);}},H:function(E){
...
0)){var Be=[].concat(Cf,Al4);var X=this.B8;while(!!X){if((!X.Ev&&(X.PT!==0x14))&&
...
Ah;return D5;},BC1:function(G){if(!!this.FG){this.FG.C2=this;var AE=A.abg(this.AuO(
...
C2=null;}},BdA:function(C0,aClip,aOffset,Ck,aBlend){var B;var X=this.B8;var LI=BD;
var AA0=true;this.BiX(C0,aClip,aOffset,Ck,aBlend);while(!!X){if(((X.U&0x200)===0x200
...
X.Ks(C0,AE,aOffset,Ck,aBlend);}}X=X.Ah;}this.Bi0(C0,aClip,aOffset,Ck,aBlend);},Bgt:
function(){var B;var A2L=((this.U&0x1000)===0x1000);var AiH=[0,0,(B=this.M)[2]-B[
0],B[3]-B[1]];var AaB=false;var Ado=BD;var K7=BD;var AaC=Cf;var AtZ=0;var At0=0;
var AtY=0;var Qt=0;var X=this.B9;var Kh=null;var AlW=null;while(!!X){if(((X.U&0x800
)===0x800)){AaB=true;X.U=X.U&~0x800;}if(AaB&&((X.U&0x200)===0x200)){AaB=false;if(
!!(C.Y.isPrototypeOf(X)?X:null).Ag2)X.U=X.U|0x1000;}X=X.AJ;}AaB=false;X=this.B8;
if(A2L){this.U=this.U&~0x1000;A2L=!((AiH[0]>=AiH[2])||(AiH[1]>=AiH[3]));}this.U=
this.U|0x2000;while(!!X){if(!AlW&&(AtY!==Qt)){var AdM=X;var AK7=0;var ABk=Ado[2]-
Ado[0];var Azy=Ado[3]-Ado[1];var AJW=0;var Aqe=Cf;do if(((AdM.U&0x200)===0x200))
AdM=null;else if(((AdM.U&0x401)===0x401)){Aqe=[(B=AdM.GetExtent())[2]-B[0],B[3]-
B[1]];if((Qt===3)||(Qt===4))ABk=ABk-Aqe[0];if((Qt===1)||(Qt===2))Azy=Azy-Aqe[1];
if(!AlW||((ABk>=0)&&(Azy>=0))){AlW=AdM;AdM=AdM.Ah;if((Qt===3)||(Qt===4)){ABk=ABk-
AtZ;if(Aqe[1]>AK7)AK7=Aqe[1];}if((Qt===1)||(Qt===2)){Azy=Azy-At0;if(Aqe[0]>AJW)AJW=
Aqe[0];}}else AdM=null;}else AdM=AdM.Ah;while(!!AdM);if(!AlW)AlW=Kh;K7=Ado;switch(
AtY){case 9:case 11:K7=[].concat(K7.slice(0,3),K7[1]+AK7);break;case 10:case 12:
K7=A.abP(K7,K7[3]-AK7);break;case 5:case 7:K7=A.abN(K7,K7[0]+AJW);break;case 6:case
8:K7=[].concat(K7[2]-AJW,K7.slice(1,4));break;default:;}}if(((X.U&0x400)===0x400
)){if(!!X.Ev&&(X.Ev.NK!==Kh))X.Ev=null;if((!X.Ev&&AaB)&&((X.PT!==0x14)||!!Qt))X.
At3(K7,Kh);}if(!!X.Ev){if(A2L&&!((X.U&0x400)===0x400))X.AuY(AiH,0);if(AaB&&((X.U&
0x400)===0x400)){var C6=X.AuY(A.abh(K7,AaC),Qt);if(((X.U&0x1)===0x1)){var Bq=Cf;
...
Qt=AtY;Ado=A.abh(Kh.M,Kh.Br);K7=Ado;AaC=Cf;AtZ=Kh.Space+Kh.AVi;At0=Kh.Space;AaB=
!((Ado[0]>=Ado[2])||(Ado[1]>=Ado[3]));AlW=null;switch(AtY){case 9:case 10:Qt=3;break;
case 11:case 12:Qt=4;break;case 5:case 6:Qt=1;break;case 7:case 8:Qt=2;break;default:;
}}if(AaB)this.Bj(Kh.M);}if(X===AlW){switch(AtY){case 9:case 11:AaC=[0,(AaC[1]+(K7[
3]-K7[1]))+At0];break;case 10:case 12:AaC=[0,(AaC[1]-(K7[3]-K7[1]))-At0];break;case
5:case 7:AaC=[(AaC[0]+(K7[2]-K7[0]))+AtZ,0];break;case 6:case 8:AaC=[(AaC[0]-(K7[
2]-K7[0]))-AtZ,0];break;default:;}AlW=null;}X=X.Ah;}if(AaB)A.pe(Kh.Em,Kh);this.U=
this.U&~0x2000;this.Bl([AiH[2]-AiH[0],AiH[3]-AiH[1]]);},JP:function(G){A.pe([this
,this.ABF],this);},ABF:function(G){var B;var BC9=((this.U&0x1000)===0x1000);if(((
this.U&0x4000)===0x4000)){this.U=this.U&~0x4000;this.Bgt();}if(((this.U&0x8000)===
0x8000)||BC9){this.U=this.U&~0x8000;this.Ai(this.U);}},Bb:function(E){var B;if(!
...
this.FG.AEN=[this,this.BC1];}A.we(this,0);},A86:function(){var B;return((this.U&
...
,0x400);},Bmr:function(E){if(E)this.Cs(0x2,0x0);else this.Cs(0x0,0x2);},Fp:function(
...
0xFF;}},Bi0:function(C0,aClip,aOffset,Ck,aBlend){},BiX:function(C0,aClip,aOffset
,Ck,aBlend){},GetMaximalSize:function(){return Hs;},GetMinimalSize:function(){return Cf;
},AVp:function(Iy,Ol,Xr,Tm,Tn,Ah$,Pf,Rv,LE,LC,LD){var B;if(!this.He){this.AkN(Iy
,Ol,Xr,Tm,Tn,null,null,LE,LC,LD);return;}var Al3=this.He;var JM=Al3.Ah;if(((Iy.U&
0x10000)===0x10000)&&(this.He.C2!==Iy))throw new Error(I0);var Adu=A._NewObject(
...
A.acl.AsM);if(!Xr)Xr=Ol;if(!Tn)Tn=Tm;if(!Tm)Tm=Tn;Adu.RG=Xr;Adu.Mk=Tm;Adu.RP=Tn;
Adu.ApU=Rv;Adu.C2=Iy;Adu.Ah=this.He.Ah;this.He.Ah=null;this.He=Adu;if(this.AV===
Iy)this.Bb(null);Al3.C2.Cs(0x0,0x10040);if(((this.U&0x40)===0x40)&&((Iy.U&0x4)===
0x4))Iy.Cs(0x10040,0x0);else Iy.Cs(0x10000,0x0);if(!!Mk){this.NX(JM.C2,Mk.Aed(),
null,null,LD);this.NX(Al3.C2,RG.Sh(),null,null,true);this.NX(Adu.C2,Ol.Si(),LE,LC
,true);}else if(!!RP){this.NX(JM.C2,RP.Aee(),null,null,LD);this.NX(Al3.C2,RG.Sh(
),null,null,true);this.NX(Adu.C2,Ol.Si(),LE,LC,true);}else if(!!RG){this.NX(Al3.
C2,RG.Sh(),null,null,LD);this.NX(Adu.C2,Ol.Si(),LE,LC,true);}else this.NX(Adu.C2
...
Pf;if(!!Ah$)RG=Ah$;if(!!Mk){this.NX(JM.C2,Mk.Aed(),null,null,LD);this.NX(KI.C2,RG.
Sh(),LE,LC,true);}else if(!!RP){this.NX(JM.C2,RP.Aee(),null,null,LD);this.NX(KI.
C2,RG.Sh(),LE,LC,true);}else this.NX(KI.C2,RG.Sh(),LE,LC,LD);},AkN:function(Iy,Ol
,Xr,Tm,Tn,Pf,Rv,LE,LC,LD){var B;if(!Iy)return;if(!!this.He&&(this.He.C2===Iy)){this.
AVp(Iy,Ol,Xr,Tm,Tn,null,Pf,Rv,LE,LC,LD);return;}if(((Iy.U&0x10000)===0x10000))throw new
...
)Ol=A._GetAutoObject(A.acl.AsM);if(!Xr)Xr=Ol;if(!Tn)Tn=Tm;if(!Tm)Tm=Tn;KI.RG=Xr;
KI.Mk=Tm;KI.RP=Tn;KI.ApU=Rv;if(this.AV===Iy)this.Bb(null);if(!!this.He&&((this.He.
...
,Mk.Aed(),null,null,LD);this.NX(Iy,Ol.Si(),LE,LC,true);}else this.NX(Iy,Ol.Si(),
...
},BjV:function(K5){var tmp=this;while(!!tmp){K5=A.abf(K5,tmp.M.slice(0,2));tmp=tmp.
Ab;}return K5;},DispatchEvent:function(CN){var B;var X=this.AV;var B1=(C.P.isPrototypeOf(
X)?X:null);var GD=null;var A3c=!!this.XF&&(!!this.XF.FS||!!this.XF.B8);if(!!X&&((((
...
},Bl:function(aSize){},Ai:function(Ae){},Bj$:function(){this.U=this.U|0x4000;A.pe([
...
]))){var Aay=B1.FG;if(!B1.Ab&&(B1!==this)){B1.Bj(Dc);return;}if(!!Aay){var BAM=Aay.
QQ;Aay.QQ=A.wC(Aay.QQ,Dc);if(!A.aaY(BAM,Aay.QQ)){A.we(B1,0);A.we(Aay,0);}}if(!((
...
!!Amc)Amc=Amc.AJ;}return null;},Dd:function(aFilter){var B;var X=this.B8;var AE=
...
)throw new Error(Qb);if(!!KH.Ab&&(KH.Ab!==this))throw new Error(Qc);if(!this.XF)
this.XF=A._NewObject(C.AVu,0);FQ.Ab=this;FQ.P=KH;FQ.AKN=LC;FQ.A3E=LE;if(!!KH.ApV
)KH.ApV.Pq.Bo7(KH.ApV);KH.ApV=FQ;KH.U=KH.U|0x20000;if((LD&&!!this.XF.B9)&&!this.
XF.B9.ARt())(A.acl.AC1.isPrototypeOf(B=this.XF.B9)?B:null).A5m(FQ);else{var Pq=A.
_NewObject(A.acl.AC1,0);Pq.A5m(FQ);this.XF.A$N(Pq,false);}},AhF:function(Ag,Kb){
...
Error(CR);if(Ag.Ab!==this)throw new Error(Fe);if(!Ag.Ah)return;var IB=this.B9;var
...
AC6(Ag,0x14));if(!!Ag.AJ)Ag.AJ.Ah=Ag.Ah;if(!!Ag.Ah)Ag.Ah.AJ=Ag.AJ;if(this.B8===Ag
...
J7){Ag.Ab=null;Ag.Asc(LV);Ag.Ab=this;}if(!Kb){if(!!this.B9)this.B9.Ah=Ag;Ag.AJ=this.
...
J9);if(!!Ag.Ab)throw new Error(Oh);var GC=null;var LV=Ag.J7;if(((Qk<0)&&!!this.B9
)&&(this.B9.J7>=LV)){GC=this.B9;Qk=Qk+1;}while((((Qk<0)&&!!GC)&&!!GC.AJ)&&(GC.AJ.
J7>=LV)){GC=GC.AJ;Qk=Qk+1;}if((!GC&&!!this.B9)&&(this.B9.J7>LV))GC=this.B9;while((
...
B9)&&(B._cycle!=D))B._Mark(B._cycle=D);if((B=this.AKC)&&(B._cycle!=D))B._Mark(B.
...
XD:A.abi(10,0,null),Af3:A.abi(10,A.wf,null),AtQ:A.abi(10,0,null),Air:A.abi(10,A.
wf,null),XC:A.abi(10,A.wf,null),RF:A.abi(10,A.wf,null),Adf:A.abi(10,A.wf,null),EP:
...
,aOffset,Ck,aBlend);},Cs:function(Rw,Vc){var B;C.P.Cs.call(this,Rw,Vc);if(!this.
Ab&&(((Rw&0x1)===0x1)||((Vc&0x1)===0x1)))this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[
1]]);if(!this.Ab&&(((Rw&0x2)===0x2)||((Vc&0x2)===0x2)))this.Bj([0,0,(B=this.M)[2
]-B[0],B[3]-B[1]]);},Bb:function(E){if((E!==null)||!E)C.P.Bb.call(this,E);},ArS:
function(E){var B;var BAK=this.FG;C.P.ArS.call(this,E);if(((BAK!==this.FG)&&!this.
...
Kj));this.Oy.Set(AAo,this.Oy.Get(this.Kj));}},Bzm:function(){var LO=A._NewObject(
C.AqP,0);LO.AvZ=!!this.Ii;if(!!this.Ii)LO.Bs=this.Ii;return LO;},Ao9:function(){
var LO=A._NewObject(C.Aeg,0);LO.AvZ=!!this.Ii;if(!!this.Ii)LO.Bs=this.Ii;return LO;
},AtP:function(){var LO=A._NewObject(C.Au5,0);LO.AvZ=!!this.Ii;if(!!this.Ii)LO.Bs=
this.Ii;return LO;},Bzq:function(G){var O;var App=false;for(O=0;O<10;O=O+1)if(!!
...
O,this.Air.Get(O),this.Af3.Get(O),this.XD.Get(O),this.Mg.Get(O)+1,this.XC.Get(O)
,false,this.RF.Get(O),this.Adf.Get(O)));this.BroadcastEvent(this.AtP().InitializeUp(
O,this.Mg.Get(O)+1,false,tmp,this.RF.Get(O)),0x18);}else{this.XD.Set(O,(this.Ais.
Bs-this.AtQ.Get(O))|0);if(this.XD.Get(O)<10)this.XD.Set(O,10);this.EP=O;this.Fu.
Get(O).G6(this.Ao9().InitializeHold(O,pos,this.Af3.Get(O),this.XD.Get(O),this.Mg.
Get(O)+1,this.XC.Get(O),this.RF.Get(O),this.Adf.Get(O)));App=true;}}if(!App)this.
...
this.AKn+1;this.Kj=0;}},UpdateCanvas:function(C0,aOffset){var B;var Agx=BD;var By5=[
...
this.Km.Get(O),aOffset),[-aOffset[0],-aOffset[1]],255,true);Agx=A.wC(Agx,A.lb(By5
...
KG,Ay$,Tl){var B;var A4k=!!this.RM;if(!!this.RM&&((!Tl||(this.AAm!==KG))||(this.
...
Ay$,true);if(!!D5)D5.G6(LO);else if(!!X)X.G6(LO);}if(!this.RM&&Tl){if(!!KG)this.
...
InitializeUp(BH,this.Air.Get(BH),this.Af3.Get(BH),this.XD.Get(BH),this.Mg.Get(BH
)+1,this.XC.Get(BH),false,this.RF.Get(BH),this.Adf.Get(BH)));this.BroadcastEvent(
this.AtP().InitializeUp(BH,this.Mg.Get(BH)+1,false,tmp,Fg),0x18);}else{this.Air.
Set(BH,pos);this.EP=BH;this.Fu.Get(BH).G6(this.Bzm().Initialize(BH,pos,this.Af3.
Get(BH),Fw,this.XD.Get(BH),this.Mg.Get(BH)+1,this.XC.Get(BH),Fg,this.Adf.Get(BH)
));}this.Ii=0;return true;},DriveCursorHitting:function(Tl,BH,Fg){return this.DriveMultiTouchHitting(
Tl,BH,Fg);},DriveMultiTouchHitting:function(Tl,BH,Fg){if((BH<0)||(BH>9)){this.Ii=
0;return false;}var ticksCount=this.Ii;if(!ticksCount)ticksCount=((new Date).getTime(
)-A.v$)|0;var BCh=this.Ii;this.DriveMultiTouchMovement(BH,Fg);Fg=this.RF.Get(BH);
this.Ii=BCh;if(Tl)this.Adf.Set(BH,Fg);if(Tl&&!this.Fu.Get(BH)){var JK;var pos=Fg;
if(A.wa(this.AJ2.Get(BH),Fg)&&((ticksCount-this.AtQ.Get(BH))<=250))this.Mg.Set(BH
,this.Mg.Get(BH)+1);else this.Mg.Set(BH,0);this.AJ2.Set(BH,A.abh(MQ,Fg));this.AtQ.
Set(BH,ticksCount);if(!!this.JL)JK=this.Yq(A.abh(MQ,Fg),BH,this.Mg.Get(BH)+1,this.
JL.C2,null,0x0);else JK=this.Yq(A.abh(MQ,Fg),BH,this.Mg.Get(BH)+1,null,null,0x0);
if(!!JK){this.BroadcastEvent(this.AtP().InitializeDown(BH,this.Mg.Get(BH)+1,false
,JK.Cj,Fg),0x18);this.Fu.Set(BH,JK.Cj);this.XC.Set(BH,JK.DH);}else{this.Fu.Set(BH
,null);this.XC.Set(BH,Cf);this.Ii=0;return false;}var B1=JK.Cj.Ab;while(!!B1&&(B1
!==this)){pos=A.abe(pos,B1.M.slice(0,2));B1=B1.Ab;}this.Af3.Set(BH,pos);this.Air.
Set(BH,pos);this.XD.Set(BH,0);this.Ais.As(true);this.EP=BH;this.Fu.Get(BH).G6(this.
Ao9().InitializeDown(BH,pos,this.Mg.Get(BH)+1,this.XC.Get(BH),false,Fg));this.Ii=
0;return true;}if(!Tl&&!!this.Fu.Get(BH)){var pos=Fg;var B1=this.Fu.Get(BH).Ab;while(
...
).InitializeUp(BH,pos,this.Af3.Get(BH),this.XD.Get(BH),this.Mg.Get(BH)+1,this.XC.
Get(BH),false,Fg,this.Adf.Get(BH)));this.BroadcastEvent(this.AtP().InitializeUp(
BH,this.Mg.Get(BH)+1,false,tmp,Fg),0x18);this.Ii=0;return true;}this.Ii=0;return false;
},AUN:function(Aau,Bcy,Ac7,Ac6){if(Aau===this)Aau=null;if(!!!Aau&&!!this.JL)Aau=
this.JL.C2;if(!this.Fu.Get(this.EP))return;var JK;JK=this.Yq(A.abh(MQ,this.RF.Get(
this.EP)),this.EP,1,Aau,Ac7,Ac6);if(!!JK&&(this.Fu.Get(this.EP)!==JK.Cj))this.AN0(
JK.Cj,JK.DH);if(!JK&&(this.Fu.Get(this.EP)!==Bcy))this.AN0(Bcy,Cf);},AN0:function(
Aau,Xs){if(!this.Fu.Get(this.EP)||(this.Fu.Get(this.EP)===Aau))return;var tmp=this.
Fu.Get(this.EP);this.Fu.Set(this.EP,null);tmp.G6(this.Ao9().InitializeUp(this.EP
,this.Air.Get(this.EP),this.Af3.Get(this.EP),this.XD.Get(this.EP),this.Mg.Get(this.
EP)+1,this.XC.Get(this.EP),true,this.RF.Get(this.EP),this.Adf.Get(this.EP)));this.
...
0;ticksCount=((new Date).getTime()-A.v$)|0;this.Fu.Set(this.EP,Aau);this.XC.Set(
this.EP,Xs);this.Af3.Set(this.EP,pos);this.Air.Set(this.EP,pos);this.Mg.Set(this.
EP,0);this.XD.Set(this.EP,0);this.AtQ.Set(this.EP,ticksCount);this.Adf.Set(this.
EP,this.RF.Get(this.EP));this.Fu.Get(this.EP).G6(this.Ao9().InitializeDown(this.
EP,pos,this.Mg.Get(this.EP)+1,this.XC.Get(this.EP),true,this.Adf.Get(this.EP)));
...
AJ2=[]).__proto__=C.Root.AJ2;(this.XD=[]).__proto__=C.Root.XD;(this.Af3=[]).__proto__=
C.Root.Af3;(this.AtQ=[]).__proto__=C.Root.AtQ;(this.Air=[]).__proto__=C.Root.Air;(
this.XC=[]).__proto__=C.Root.XC;(this.RF=[]).__proto__=C.Root.RF;(this.Adf=[]).__proto__=
C.Root.Adf;(this.Oy=[]).__proto__=C.Root.Oy;(this.Km=[]).__proto__=C.Root.Km;this.
__proto__=C.Root;this.U=0x10007F;this.Ais.PZ(10);this.Ais.MJ=[this,this.Bzq];this.
...
Down=Tl;this.Dy=0x00;var A12=KG-10;var AtK=KG-105;if((A12>=0)&&(A12<=9))this.Dy=(
...
break;case 140:this.Dy=0x3B;break;default:;}return this;},Bke:function(Bcn){switch(
...
B._cycle=D);},_className:"Core::CursorGrabEvent"};C.Aeg={Ag4:A.wf,L0:A.wf,Oc:0,Jy:
0,NZ:A.wf,H5:A.wf,IO:0,Down:false,NQ:false,InitializeHold:function(BH,Alp,Azc,Azd
,Om,Xs,Aat,Azb){this.Down=true;this.IO=BH;this.H5=A.abf(Alp,Xs);this.NZ=A.abf(Azc
,Xs);this.Jy=Azd;this.Oc=Om;this.L0=Aat;this.Ag4=Azb;return this;},InitializeUp:
function(BH,Alp,Azc,Azd,Om,Xs,AoH,Aat,Azb){this.Down=false;this.IO=BH;this.H5=A.
abf(Alp,Xs);this.NZ=A.abf(Azc,Xs);this.Jy=Azd;this.Oc=Om;this.NQ=AoH;this.L0=Aat;
this.Ag4=Azb;return this;},InitializeDown:function(BH,Alp,Om,Xs,AoH,Aat){this.Down=
true;this.IO=BH;this.H5=A.abf(Alp,Xs);this.NZ=A.abf(Alp,Xs);this.Jy=0;this.Oc=Om;
this.NQ=AoH;this.L0=Aat;this.Ag4=Aat;return this;},_Init:function(aArg){C.Event.
_Init.call(this,aArg);this.__proto__=C.Aeg;},_className:"Core::CursorEvent"};C.AqP={
Ag4:A.wf,L0:A.wf,Oc:0,Jy:0,DH:A.wf,NZ:A.wf,H5:A.wf,IO:0,Initialize:function(BH,Alp
,Azc,aOffset,Azd,Byp,Xs,Aat,Azb){this.IO=BH;this.H5=A.abf(Alp,Xs);this.NZ=A.abf(
Azc,Xs);this.DH=aOffset;this.Jy=Azd;this.Oc=Byp;this.L0=Aat;this.Ag4=Azb;return this;
...
Az=A.wC(Az,Ap8);}return Az;},Cs:function(Rw,Vc){var B;var Tw=this.U;if((!!this.Ab&&((
this.U&0x80001)===0x80001))&&((Vc&0x80000)===0x80000))this.Ab.Bj(this.GetClipping(
));C.Eu.Cs.call(this,Rw,Vc);if(((!!this.Ab&&((this.U&0x1)===0x1))&&((Rw&0x80000)===
...
B=this.Ab,B.JP],this);}},Boc:function(E){var B;if(E<0)E=0;if(E===this.Space)return;
...
this.Ab,B.JP],this);}},VG:function(Ac0,E9){var AtK=this.Dd(0x1);var RC=this.M;var
Vq=A.abe(AtK.slice(0,2),RC.slice(0,2));var Mi=A.abe(AtK.slice(2,4),RC.slice(2,4)
...
Qz=null;this.NI=null;}this.BY=Ac0;if(!this.BY){this.Gc(A.abe(this.Br,Bq));(E9)?E9[
...
ApP];this.BY.Afa(false);this.BY.As(true);this.NI=E9;}},HK:function(Ag,Ac4,Ac0,E9
){var B;if(!Ag)return;if((Ag.Ab!==this.Ab)||!((Ag.U&0x400)===0x400))throw new Error(
U1);this.Bgi();var Az=Ag.GetExtent();var Be=this.M;var LT=A.lb(Az,Be);if((!Ac4&&
!((LT[0]>=LT[2])||(LT[1]>=LT[3])))||(Ac4&&A.aaY(LT,Az))){(E9)?E9[1].call(E9[0],this
...
BY.Qz=null;this.NI=null;}this.BY=Ac0;if(!this.BY){this.Gc(A.abe(this.Br,Bq));(E9
...
,this.ApP];this.BY.Afa(false);this.BY.As(true);this.NI=E9;}},BjH:function(Ag){var
...
HD:null,BY:null,Cj:null,W1:null,NI:null,Em:null,Ho:null,Tt:-1,Ts:0,Ju:-1,Hu:0,AiK:
8,Ot:0,UF:0,AcN:A.wf,G8:-1,Br:0,Gu:-1,OY:0,GO:24,AZ:0,Lo:null,NW:false,At6:false
,AVp:function(Iy,Ol,Xr,Tm,Tn,Ah$,Pf,Rv,LE,LC,LD){throw new Error(Aac);},AqN:function(
Iy,Ah$,Pf,Rv,LE,LC,LD){throw new Error(U2);},AkN:function(Iy,Ol,Xr,Tm,Tn,Pf,Rv,LE
,LC,LD){throw new Error(Aad);},DispatchEvent:function(CN){var B;var result=null;
if(((this.Gu>=0)&&(this.Gu<this.AZ))&&!this.AV){this.G8=this.Gu;this.Cj=(C.Cj.isPrototypeOf(
B=A._NewObject(this.Lo,0))?B:null);if(!!this.B9)this.B9.Ah=this.Cj;else this.B8=
this.Cj;this.Cj.AJ=this.B9;this.B9=this.Cj;this.Cj.Ab=this;this.AcN=[(B=this.M)[
...
AZ)G2=this.AZ-1;if(FU<0)FU=0;}else if(this.AZ<=0){FU=0;G2=-1;}var Ai0=this.Hu;var
Ai1=this.Ju;var ApC=0;var ApD=-1;if(FU>Ai0)Ai0=FU;if(G2<Ai1)Ai1=G2;if(Ai0<=Ai1){
while((this.Ju<G2)&&(this.Hu<Ai0)){this.AdH();this.AzD();}while((this.Hu>FU)&&(this.
Ju>Ai1)){this.ABe();this.AzC();}}else{this.Ju=(this.Ju-this.Hu)+FU;this.Hu=FU;ApC=
this.Hu;ApD=this.Ju;}while(this.Hu<FU)this.AdH();while(this.Ju>G2)this.ABe();while(
this.Hu>FU)this.AzC();while(this.Ju<G2)this.AzD();var Aa=this.B8;var inx=this.Hu;
var pos=[0,(AA3+this.Br)+this.Jr(inx,0)];var BL=(B=this.M)[3]-B[1];var AlM=null;
var Bhh=(B=this.M)[2]-B[0];while(!!Aa){var IF=inx;if(this.NW){if(IF<0)IF=this.AZ-(-
IF%this.AZ);if(IF>0)IF=IF%this.AZ;}var AdI=((IF>=this.Ts)&&(IF<=this.Tt))||((inx>=
ApC)&&(inx<=ApD));var Api=Aa.GetExtent();var Bq=A.abe(pos,Api.slice(0,2));if(AdI
)this.UF=this.GO;else this.UF=Api[3]-Api[1];var A22=pos[1];var A23=pos[1]+this.UF;
if(!A.aaX(Bq,Cf))Aa.Ano(Bq,true);if((AdI&&(A22<BL))&&(A23>0)){this.Cj=Aa;this.G8=
IF;this.AcN=[Bhh,this.UF];(B=this.Ho)?B[1].call(B[0],this):null;}Aa=Aa.Ah;inx+=1;
pos=[pos[0],pos[1]+this.UF];}inx=this.Hu;Aa=this.B8;pos=[0,(AA3+this.Br)+this.Jr(
inx,0)];while(!!Aa){var IF=inx;if(this.NW){if(IF<0)IF=this.AZ-(-IF%this.AZ);if(IF>
0)IF=IF%this.AZ;}var AdI=((IF>=this.Ts)&&(IF<=this.Tt))||((inx>=ApC)&&(inx<=ApD)
);if(AdI)this.UF=this.GO;else this.UF=(B=Aa.GetExtent())[3]-B[1];var A22=pos[1];
var A23=pos[1]+this.UF;if(AdI&&!((A22<BL)&&(A23>0))){this.Cj=Aa;this.G8=IF;this.
AcN=[Bhh,this.UF];(B=this.Ho)?B[1].call(B[0],this):null;}if(((IF===this.Gu)&&this.
...
Ah;inx+=1;pos=[pos[0],pos[1]+this.UF];}this.Ts=0;this.Tt=-1;this.Cj=null;this.G8=-
1;this.Bb(AlM);this.At6=false;A.pe(this.Em,this);},QL:function(Ag,GA,aFilter){return null;
},AqU:function(Ag,aFilter){return null;},TX:function(Ag,aFilter){return null;},AC6:
function(Ag,aFilter){return null;},Dd:function(aFilter){return BD;},NX:function(
KH,FQ,LE,LC,LD){throw new Error(Xf);},AhF:function(Ag,Kb){throw new Error(Aae);}
,ZL:function(Ag){throw new Error(Aaf);},J5:function(Ag,Qk){throw new Error(U3);}
,HR:function(Ag){throw new Error(Xg);},AMm:function(Ag,Kb){throw new Error(Pa);}
,J:function(Ag,Qk){throw new Error(Aag);},Jr:function(Hb,A1d){return Hb*this.GO;
},Amb:function(Fg,A1d){return(Fg/this.GO)|0;},ABe:function(){var Aa=this.B9;if(!
...
},AzD:function(){var B;var Aa=this.HD;var Adr=this.Lo;var AdL=++this.Ju;if(this.
NW){if(AdL<0)AdL=this.AZ-(-AdL%this.AZ);if(AdL>0)AdL=AdL%this.AZ;}while(!!Aa&&(((
B=Aa)?B.__proto__:null)!==Adr))Aa=Aa.Ah;if(!!Aa){if(!!Aa.Ah)Aa.Ah.AJ=Aa.AJ;if(!!
Aa.AJ)Aa.AJ.Ah=Aa.Ah;if(this.HD===Aa)this.HD=Aa.Ah;Aa.Ah=null;Aa.AJ=null;this.Ot--;
}else{Aa=(C.Cj.isPrototypeOf(B=A._NewObject(Adr,0))?B:null);Aa.A1(0x1D);if(!!this.
Ot)this.AiK++;}this.UF=this.GO;this.G8=AdL;this.AcN=[(B=this.M)[2]-B[0],this.UF];
this.Cj=Aa;(B=this.Ho)?B[1].call(B[0],this):null;this.Cj=null;this.G8=-1;if(!!this.
B9)this.B9.Ah=Aa;Aa.Ab=this;Aa.AJ=this.B9;this.B9=Aa;if(!this.B8)this.B8=Aa;if(AdL===
this.Gu)this.Bb(Aa);return Aa;},AdH:function(){var Aa=this.B8;if(!Aa)return null;
if(Aa===this.AV)this.Bb(null);this.Hu=this.Hu+1;if(!!Aa.Ah)Aa.Ah.AJ=null;else this.
B9=null;this.B8=Aa.Ah;Aa.Ah=null;Aa.Ab=null;Aa.Ev=null;if(this.Ot<this.AiK){if(!
!this.HD)this.HD.AJ=Aa;Aa.Ah=this.HD;this.HD=Aa;this.Ot++;}return Aa;},AzC:function(
){var B;var Aa=this.HD;var Adr=this.Lo;var M9=--this.Hu;if(this.NW){if(M9<0)M9=this.
AZ-(-M9%this.AZ);if(M9>0)M9=M9%this.AZ;}while(!!Aa&&(((B=Aa)?B.__proto__:null)!==
Adr))Aa=Aa.Ah;if(!!Aa){if(!!Aa.Ah)Aa.Ah.AJ=Aa.AJ;if(!!Aa.AJ)Aa.AJ.Ah=Aa.Ah;if(this.
HD===Aa)this.HD=Aa.Ah;Aa.Ah=null;Aa.AJ=null;this.Ot--;}else{Aa=(C.Cj.isPrototypeOf(
B=A._NewObject(Adr,0))?B:null);Aa.A1(0x1D);if(!!this.Ot)this.AiK++;}this.UF=this.
GO;this.G8=M9;this.AcN=[(B=this.M)[2]-B[0],this.UF];this.Cj=Aa;(B=this.Ho)?B[1].
call(B[0],this):null;this.Cj=null;this.G8=-1;if(!!this.B8)this.B8.AJ=Aa;Aa.Ab=this;
...
B[1].call(B[0],this):null;},BBE:function(G){this.Gc(this.W1.DH[1]);},BBF:function(
G){var B;if(!!this.BY){this.BY.As(false);this.BY.Q=null;this.BY.Qz=null;this.BY=
null;}if(!this.NW){var AE=this.Aq1(0,this.AZ-1);var Agm=this.M.slice(0,2);AE=A.abP(
...
]-AE[1]);if(A3h>0)A3h=0;this.W1.DH=[0,this.Br];this.W1.Gq=[0,(this.Br+A3h)-Fw];this.
W1.F$=[0,this.Br-Fw];}else{var Fw=32000-(32000%this.GO);this.W1.DH=[0,this.Br];this.
W1.Gq=[0,this.Br-Fw];this.W1.F$=[0,this.Br+Fw];}},ATq:function(E){var B;if(this.
NW===E)return;this.NW=E;while(!!this.AdH());this.Am();this.Bj([0,0,(B=this.M)[2]-
B[0],B[3]-B[1]]);},Axb:function(E){if(E===this.W1)return;if(!!E&&!!E.Auh){A.ab5(
"%s%*%s",Oi,E,Rp);throw new Error(Xh);}if(!!this.W1){this.W1.AKX=null;this.W1.Auh=
null;}this.W1=E;if(!!E){E.AKX=[this,this.BBF];E.Auh=[this,this.BBE];}},Gc:function(
E){var B;if(this.NW&&(this.AZ>0)){var HG=this.Jr(this.AZ,3);if(E<0)E=HG-(-E%HG);
...
OY=E;if(!this.NW){this.Am();this.Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);}},Ae9:function(
E){var B;if(E<1)E=1;if(E===this.GO)return;this.GO=E;while(!!this.AdH());this.Am(
...
while(!!this.AdH());this.AZ=E;this.Am();this.Bj(AE);},N8:function(E){var B;if(E===
this.Lo)return;this.Lo=E;while(!!this.AdH());this.HD=null;this.Ot=0;this.Am();this.
Bj([0,0,(B=this.M)[2]-B[0],B[3]-B[1]]);},BjU:function(Hb){if(this.At6)return null;
if((Hb<0)||(Hb>=this.AZ))return null;if(!this.NW){if((Hb<this.Hu)||(Hb>this.Ju))
return null;var X=this.B8;while(Hb>this.Hu){X=X.Ah;Hb=Hb-1;}return X;}else{var M9=
this.Hu;if(M9<0)M9=this.AZ-(-M9%this.AZ);if(M9>0)M9=M9%this.AZ;var X=this.B8;while(
!!X){if((M9%this.AZ)===Hb)return X;X=X.Ah;M9=M9+1;}return null;}},ABY:function(Ac0
,E9){var B;if(this.NW){(E9)?E9[1].call(E9[0],this):null;return;}var AKp=this.Br;
var BdR=((((B=this.M)[3]-B[1])-this.Br)-this.OY)-this.Jr(this.AZ,3);var Bq=0;if(
...
this.BY.Qz=null;this.NI=null;}this.BY=Ac0;if(!this.BY){this.Gc(this.Br+Bq);(E9)?
E9[1].call(E9[0],this):null;}else{this.BY.As(false);this.BY.HQ(1);this.BY.Q=[this
,this.Anz,this.Gc];this.BY.Cx=this.Br;this.BY.B3=this.Br+Bq;this.BY.Qz=[this,this.
ApP];this.BY.Afa(false);this.BY.As(true);this.NI=E9;}},HK:function(Hb,Ac4,Ac0,E9
){var B;if((Hb<0)||(Hb>=this.AZ))return;var Az=this.Aq1(Hb,Hb);var Be=this.M;var
LT=A.lb(Az,Be);if((!Ac4&&!((LT[0]>=LT[2])||(LT[1]>=LT[3])))||(Ac4&&A.aaY(LT,Az))
...
E9[1].call(E9[0],this):null;}else{this.BY.As(false);this.BY.HQ(1);this.BY.Q=[this
,this.Anz,this.Gc];this.BY.Cx=this.Br;this.BY.B3=this.Br-Bq;this.BY.Qz=[this,this.
ApP];this.BY.Afa(false);this.BY.As(true);this.NI=E9;}},BjM:function(){return BD;
...
){if(((this.AZ<=0)||(Fg[0]<this.M[0]))||(Fg[0]>=this.M[2]))return-1;Fg=A.abe(Fg,
this.M.slice(0,2));if(!this.NW){var Aa=(Fg[1]-this.Br)-this.OY;if(Aa>0)Aa=this.Amb(
Aa,0);if((Aa<0)||(Aa>=this.AZ))return-1;return Aa;}var Aa=Fg[1]-this.Br;if(Aa>0)
Aa=this.Amb(Aa,0);if(Aa<0)Aa=this.Amb(Aa,0)-1;if(Aa<0)Aa=this.AZ-(-Aa%this.AZ);if(
Aa>0)Aa=Aa%this.AZ;return Aa;},Aq1:function(J$,Mb){if(J$<0)J$=0;if(Mb>=this.AZ)Mb=
this.AZ-1;if(J$>Mb)return BD;var AE=this.M;var Bq=this.Br;if(this.NW){var HG=this.
Jr(this.AZ,3);if(Bq<0)Bq=HG-(-Bq%HG);if(Bq>0)Bq=Bq%HG;if(Bq>0)Bq=Bq-HG;}else Bq=
Bq+this.OY;AE=[].concat(AE.slice(0,3),(AE[1]+Bq)+this.Jr(Mb+1,0));AE=A.abP(AE,(AE[
1]+Bq)+this.Jr(J$,0));return AE;},AbM:function(J$,Mb){var B;if(J$<0)J$=0;if(J$>Mb
...
]-AE[1])>0)){var Bq=this.Br;var HG=this.Jr(this.AZ,3);if(Bq<0)Bq=HG-(-Bq%HG);if(
...
this.Lo=A.acg.Text;},_Mark:function(D){var B;C.P._Mark.call(this,D);if((B=this.HD
...
,BY:null,Cj:null,NI:null,Ho:null,Tt:-1,Ts:0,Ju:-1,Hu:0,AiK:8,Ot:0,ST:0,AcN:A.wf,
G8:-1,Br:0,Gu:-1,Wl:24,AZ:0,Lo:null,At6:false,AVp:function(Iy,Ol,Xr,Tm,Tn,Ah$,Pf
,Rv,LE,LC,LD){throw new Error(Tf);},AqN:function(Iy,Ah$,Pf,Rv,LE,LC,LD){throw new
Error(Xj);},AkN:function(Iy,Ol,Xr,Tm,Tn,Pf,Rv,LE,LC,LD){throw new Error(Aah);},DispatchEvent:
function(CN){var B;var result=null;if(((this.Gu>=0)&&(this.Gu<this.AZ))&&!this.AV
){this.G8=this.Gu;this.Cj=(C.Cj.isPrototypeOf(B=A._NewObject(this.Lo,0))?B:null);
if(!!this.B9)this.B9.Ah=this.Cj;else this.B8=this.Cj;this.Cj.AJ=this.B9;this.B9=
this.Cj;this.Cj.Ab=this;this.AcN=[this.ST,(B=this.M)[3]-B[1]];(B=this.Ho)?B[1].call(
B[0],this):null;var B1=(C.P.isPrototypeOf(B=this.Cj)?B:null);if(!!B1)result=B1.DispatchEvent(
CN);else result=this.Cj.G6(CN);if(!!this.Cj.AJ)this.Cj.AJ.Ah=null;else this.B8=null;
...
Ju){FU=FU-Ain;G2=G2+Aim;}else{FU=this.Hu;G2=this.Ju;}if(FU>=this.AZ){FU=0;G2=-1;
}else if(G2<0){FU=0;G2=-1;}if(G2>=this.AZ)G2=this.AZ-1;if(FU<0)FU=0;var Ai0=this.
Hu;var Ai1=this.Ju;var ApC=0;var ApD=-1;if(FU>Ai0)Ai0=FU;if(G2<Ai1)Ai1=G2;if(Ai0<=
Ai1){while((this.Ju<G2)&&(this.Hu<Ai0)){this.AdH();this.AzD();}while((this.Hu>FU
)&&(this.Ju>Ai1)){this.ABe();this.AzC();}}else{this.Ju=(this.Ju-this.Hu)+FU;this.
Hu=FU;ApC=this.Hu;ApD=this.Ju;}while(this.Hu<FU)this.AdH();while(this.Ju>G2)this.
ABe();while(this.Hu>FU)this.AzC();while(this.Ju<G2)this.AzD();var Aa=this.B8;var
inx=this.Hu;var pos=[this.Br+this.Jr(inx,0),0];var BZ=(B=this.M)[2]-B[0];var AlM=
null;var Bg6=(B=this.M)[3]-B[1];while(!!Aa){var IF=inx;var AdI=((IF>=this.Ts)&&(
IF<=this.Tt))||((inx>=ApC)&&(inx<=ApD));var Api=Aa.GetExtent();var Bq=A.abe(pos,
Api.slice(0,2));if(AdI)this.ST=this.Wl;else this.ST=Api[2]-Api[0];var A20=pos[0];
var A21=pos[0]+this.ST;if(!A.aaX(Bq,Cf))Aa.Ano(Bq,true);if((AdI&&(A20<BZ))&&(A21>
0)){this.Cj=Aa;this.G8=IF;this.AcN=[this.ST,Bg6];(B=this.Ho)?B[1].call(B[0],this
):null;}Aa=Aa.Ah;inx+=1;pos=[pos[0]+this.ST,pos[1]];}inx=this.Hu;Aa=this.B8;pos=[
this.Br+this.Jr(inx,0),0];while(!!Aa){var IF=inx;var AdI=((IF>=this.Ts)&&(IF<=this.
Tt))||((inx>=ApC)&&(inx<=ApD));if(AdI)this.ST=this.Wl;else this.ST=(B=Aa.GetExtent(
))[2]-B[0];var A20=pos[0];var A21=pos[0]+this.ST;if(AdI&&!((A20<BZ)&&(A21>0))){this.
Cj=Aa;this.G8=IF;this.AcN=[this.ST,Bg6];(B=this.Ho)?B[1].call(B[0],this):null;}if(
IF===this.Gu)AlM=Aa;Aa=Aa.Ah;inx+=1;pos=[pos[0]+this.ST,pos[1]];}this.Ts=0;this.
Tt=-1;this.Cj=null;this.G8=-1;this.Bb(AlM);this.At6=false;},QL:function(Ag,GA,aFilter
){return null;},AqU:function(Ag,aFilter){return null;},TX:function(Ag,aFilter){return null;
},AC6:function(Ag,aFilter){return null;},Dd:function(aFilter){return BD;},NX:function(
KH,FQ,LE,LC,LD){throw new Error(Xk);},AhF:function(Ag,Kb){throw new Error(Xl);},
ZL:function(Ag){throw new Error(Tg);},J5:function(Ag,Qk){throw new Error(Th);},HR:
function(Ag){throw new Error(Ti);},AMm:function(Ag,Kb){throw new Error(Aai);},J:
function(Ag,Qk){throw new Error(Tj);},Jr:function(Hb,A1d){return Hb*this.Wl;},Amb:
function(Fg,A1d){return(Fg/this.Wl)|0;},ABe:function(){var Aa=this.B9;if(!Aa)return null;
if(Aa===this.AV)this.Bb(null);this.Ju=this.Ju-1;if(!!Aa.AJ)Aa.AJ.Ah=null;else this.
B8=null;this.B9=Aa.AJ;Aa.AJ=null;Aa.Ab=null;Aa.Ev=null;if(this.Ot<this.AiK){if(!
!this.HD)this.HD.AJ=Aa;Aa.Ah=this.HD;this.HD=Aa;this.Ot++;}return Aa;},AzD:function(
){var B;var Aa=this.HD;var Adr=this.Lo;var AdL=++this.Ju;while(!!Aa&&(((B=Aa)?B.
__proto__:null)!==Adr))Aa=Aa.Ah;if(!!Aa){if(!!Aa.Ah)Aa.Ah.AJ=Aa.AJ;if(!!Aa.AJ)Aa.
AJ.Ah=Aa.Ah;if(this.HD===Aa)this.HD=Aa.Ah;Aa.Ah=null;Aa.AJ=null;this.Ot--;}else{
Aa=(C.Cj.isPrototypeOf(B=A._NewObject(Adr,0))?B:null);Aa.A1(0x1D);if(!!this.Ot)this.
AiK++;}this.ST=this.Wl;this.G8=AdL;this.AcN=[this.ST,(B=this.M)[3]-B[1]];this.Cj=
Aa;(B=this.Ho)?B[1].call(B[0],this):null;this.Cj=null;this.G8=-1;if(!!this.B9)this.
B9.Ah=Aa;Aa.Ab=this;Aa.AJ=this.B9;this.B9=Aa;if(!this.B8)this.B8=Aa;if(AdL===this.
Gu)this.Bb(Aa);return Aa;},AdH:function(){var Aa=this.B8;if(!Aa)return null;if(Aa===
this.AV)this.Bb(null);this.Hu=this.Hu+1;if(!!Aa.Ah)Aa.Ah.AJ=null;else this.B9=null;
this.B8=Aa.Ah;Aa.Ah=null;Aa.Ab=null;Aa.Ev=null;if(this.Ot<this.AiK){if(!!this.HD
)this.HD.AJ=Aa;Aa.Ah=this.HD;this.HD=Aa;this.Ot++;}return Aa;},AzC:function(){var
B;var Aa=this.HD;var Adr=this.Lo;var M9=--this.Hu;while(!!Aa&&(((B=Aa)?B.__proto__:
null)!==Adr))Aa=Aa.Ah;if(!!Aa){if(!!Aa.Ah)Aa.Ah.AJ=Aa.AJ;if(!!Aa.AJ)Aa.AJ.Ah=Aa.
Ah;if(this.HD===Aa)this.HD=Aa.Ah;Aa.Ah=null;Aa.AJ=null;this.Ot--;}else{Aa=(C.Cj.
isPrototypeOf(B=A._NewObject(Adr,0))?B:null);Aa.A1(0x1D);if(!!this.Ot)this.AiK++;
}this.ST=this.Wl;this.G8=M9;this.AcN=[this.ST,(B=this.M)[3]-B[1]];this.Cj=Aa;(B=
this.Ho)?B[1].call(B[0],this):null;this.Cj=null;this.G8=-1;if(!!this.B8)this.B8.
...
if(E<1)E=1;if(E===this.Wl)return;this.Wl=E;while(!!this.AdH());this.Am();this.Bj([
...
this.Lo=E;while(!!this.AdH());this.HD=null;this.Ot=0;this.Am();this.Bj([0,0,(B=this.
M)[2]-B[0],B[3]-B[1]]);},BpQ:function(Byq,Byr){if(!this.BY)return;if(Byq)this.Gc(
this.BY.B3);var A4X=this.NI;this.BY.As(false);this.BY.Q=null;this.BY.Qz=null;this.
NI=null;this.BY=null;if(Byr)(A4X)?A4X[1].call(A4X[0],this):null;},Bkj:function(){
return!!this.BY;},HK:function(Hb,Ac4,Ac0,E9){var B;if((Hb<0)||(Hb>=this.AZ))return;
var Az=this.Aq1(Hb,Hb);var Be=this.M;var LT=A.lb(Az,Be);if((!Ac4&&!((LT[0]>=LT[2
])||(LT[1]>=LT[3])))||(Ac4&&A.aaY(LT,Az))){(E9)?E9[1].call(E9[0],this):null;return;
...
Ac0;if(!this.BY){this.Gc(this.Br-Bq);(E9)?E9[1].call(E9[0],this):null;}else{this.
BY.As(false);this.BY.HQ(1);this.BY.Q=[this,this.Anz,this.Gc];this.BY.Cx=this.Br;
this.BY.B3=this.Br-Bq;this.BY.Qz=[this,this.ApP];this.BY.Afa(false);this.BY.As(true
);this.NI=E9;}},Aq1:function(J$,Mb){if(J$<0)J$=0;if(Mb>=this.AZ)Mb=this.AZ-1;if(
J$>Mb)return BD;var AE=this.M;var Bq=this.Br;AE=A.abN(AE,(AE[0]+Bq)+this.Jr(Mb+1
,0));AE=[].concat((AE[0]+Bq)+this.Jr(J$,0),AE.slice(1,4));return AE;},AbM:function(
...
Lt:null,BG:null,ALk:0,Bp:0,IO:0,Bs:0,Oc:0,Jy:0,DH:A.wf,NZ:A.wf,H5:A.wf,AxC:8,Afh:
0,A7$:1,Down:false,YP:false,NQ:false,A2r:false,AAw:0,Ks:function(C0,aClip,aOffset
,Ck,aBlend){},G6:function(CN){var B;var BO=(C.Aeg.isPrototypeOf(CN)?CN:null);var
D4=(C.AqP.isPrototypeOf(CN)?CN:null);var AKz=this.YP;var AaR;var Vn;var ABz;var M6;
var AzV;if(!BO&&!D4)return null;AaR=(!!BO&&BO.Down)&&!BO.Jy;Vn=(!!BO&&BO.Down)&&(
BO.Jy>0);ABz=(!!BO&&BO.Down)&&(BO.Jy>this.AAw);M6=!!BO&&!BO.Down;AzV=!!D4;if(AaR
)this.AAw=((B=(BO.NQ?0:50))&0x80)?B|0xFFFFFF00:B&0xFF;if((((this.Afh&0x20)===0x20
...
ALk=0x20;this.Bp=this.Bp|67108864;return null;}}if(AaR){var ApJ=0;var Adm;this.Bp=
this.Bp|(1<<BO.IO);for(Adm=this.Bp&4095;Adm>0;Adm=Adm>>1)if(!!(Adm&1))ApJ=ApJ+1;
if(ApJ===1)this.Bp=(this.Bp|16777216)|(4096<<BO.IO);}if(M6&&(this.Bp<16777216)){
var II=this.Iq();var JK=null;if(!!II){var A4O=(!!this.AJ?this.AJ:this.Ab);var A2f=(
!!II.JL?II.JL.C2:null);JK=II.Yq(A.abh(Aaj,BO.L0),BO.IO,BO.Oc,A2f,A4O,0x0);}if(!!
JK){var O;for(O=0;O<10;O++)if(!!(this.Bp&(1<<O)))JK.Cj.G6(A._NewObject(C.Aeg,0).
InitializeDown(O,BO.H5,BO.Oc,Cf,true,BO.L0));for(O=0;O<10;O++)if(!!(this.Bp&(1<<
O)))JK.Cj.G6(A._NewObject(C.Aeg,0).InitializeUp(O,BO.H5,BO.H5,0,BO.Oc,Cf,false,BO.
L0,BO.L0));}}if(M6)this.Bp=(this.Bp&~(1<<BO.IO))|33554432;if(ABz&&(this.Bp<16777216
))this.Bp=this.Bp|67108864;if(M6&&BO.NQ)this.Bp=this.Bp|67108864;if(M6&&!(this.Bp&
4095))this.ALk=0x0;if(M6&&!(this.Bp&16777215))this.Bp=0;if(Vn&&(this.Bp>=67108864
)){var II=this.Iq();if(!!II)II.AUN(null,null,this,this.ALk);}if((Vn&&!!(this.Bp&
...
16777216))return this;if(((AaR||AzV)||Vn)&&((this.Bp<16777216)||(this.Bp>=33554432
)))return this;if(M6)this.Bp=this.Bp&3758100479;if(M6&&!(this.Bp&16777215))this.
Bp=0;if(!!BO){this.Down=AaR||Vn;this.YP=this.ARx(BO.H5);this.NZ=BO.NZ;this.H5=BO.
H5;this.DH=Cf;this.Jy=BO.Jy;this.Oc=BO.Oc;this.NQ=BO.NQ;this.IO=BO.IO;this.Bs=BO.
Bs;if(BO.Down&&!BO.Jy)AKz=false;}if(!!D4){this.Down=true;this.YP=this.ARx(D4.H5);
...
this.Down&&this.YP)&&!AKz){this.A2r=true;(B=this.Awd)?B[1].call(B[0],this):null;
}if(this.A2r&&(((A2l&&!this.YP)&&AKz)||((!A2l&&this.YP)&&AKz))){this.A2r=false;(
B=this.AE3)?B[1].call(B[0],this):null;}if(!!BO&&!A2l)(B=this.Lt)?B[1].call(B[0],
this):null;if(!!this.Afh){var AdG=0x0;if(((((this.Afh&0x10)===0x10)&&!!BO)&&BO.Down
)&&(BO.Jy>=1000))AdG=0x10;if((((this.Afh&0x1)===0x1)&&!!D4)&&((D4.L0[1]-D4.Ag4[1
])<=-this.AxC))AdG=0x1;if((((this.Afh&0x2)===0x2)&&!!D4)&&((D4.L0[1]-D4.Ag4[1])>=
this.AxC))AdG=0x2;if((((this.Afh&0x4)===0x4)&&!!D4)&&((D4.L0[0]-D4.Ag4[0])<=-this.
AxC))AdG=0x4;if((((this.Afh&0x8)===0x8)&&!!D4)&&((D4.L0[0]-D4.Ag4[0])>=this.AxC)
)AdG=0x8;if(!!AdG){var II=this.Iq();if(!!II){this.ALk=AdG;II.AUN(null,this,this,
AdG);}}}return this;},Yq:function(Dc,BH,Om,Aas,Ac7,Ac6){var B;if(!!Aas&&(Aas!==this
))return null;if((Om<1)||(Om>this.A7$))return null;if(this.Bp>=33554432)return null;
if((this.Bp>=16777216)&&!(this.Bp&(4096<<BH)))return null;if(!!(Ac6&this.Afh))return null;
if(this.BjY()){var Az=A.lb(Dc,this.GetExtent());if(!((Az[0]>=Az[2])||(Az[1]>=Az[
...
_NewObject(C.Au6,0).Initialize(this,A.abe(HF.Get(O),HF.Get(0)));}return null;},Bn6:
...
};C.Ic={timer:null,AKX:null,Auh:null,AGl:null,Zt:null,SQ:null,Bp:0,AJy:0,Adp:5000
,Ap3:0,AKy:A.wf,Apf:0,AfS:0,EY:0,Amn:0,Auv:0,Ape:0,AfR:0,EX:0,Amm:0,Amk:0,NZ:A.wf
,A6r:A.wf,F$:A.wf,Gq:A.wf,DH:A.wf,W3:A.wf,A65:0.5,A$K:true,AG2:true,ZU:false,XP:
false,XQ:false,Ao0:false,AAw:0,Ks:function(C0,aClip,aOffset,Ck,aBlend){},G6:function(
CN){var B;var BO=(C.Aeg.isPrototypeOf(CN)?CN:null);var D4=(C.AqP.isPrototypeOf(CN
)?CN:null);var ID=(C.Au5.isPrototypeOf(CN)?CN:null);var AaR;var Vn;var ABz;var M6;
var AzV;AaR=(!!BO&&BO.Down)&&!BO.Jy;Vn=(!!BO&&BO.Down)&&(BO.Jy>0);ABz=(!!BO&&BO.
Down)&&(BO.Jy>this.AAw);M6=!!BO&&!BO.Down;AzV=!!D4;if(AaR)this.AAw=((B=(BO.NQ?0:
50))&0x80)?B|0xFFFFFF00:B&0xFF;if(AaR){var ApJ=0;var Adm;this.Bp=this.Bp|(1<<BO.
IO);for(Adm=this.Bp&4095;Adm>0;Adm=Adm>>1)if(!!(Adm&1))ApJ=ApJ+1;if(ApJ===1)this.
...
C2:null);JK=II.Yq(A.abh(Aaj,BO.L0),BO.IO,BO.Oc,A2f,A4O,0x0);}if(!!JK){var O;for(
O=0;O<10;O++)if(!!(this.Bp&(1<<O)))JK.Cj.G6(A._NewObject(C.Aeg,0).InitializeDown(
O,BO.H5,BO.Oc,Cf,true,BO.L0));for(O=0;O<10;O++)if(!!(this.Bp&(1<<O)))JK.Cj.G6(A.
_NewObject(C.Aeg,0).InitializeUp(O,BO.H5,BO.H5,0,BO.Oc,Cf,false,BO.L0,BO.L0));}}
if(M6)this.Bp=(this.Bp&~(1<<BO.IO))|33554432;if(ABz&&(this.Bp<16777216))this.Bp=
this.Bp|67108864;if(M6&&BO.NQ)this.Bp=this.Bp|67108864;if(M6&&!(this.Bp&16777215
))this.Bp=0;if(Vn&&(this.Bp>=67108864)){var II=this.Iq();if(!!II)II.AUN(null,null
...
)return this;if(M6&&!(this.Bp&16777216))return this;if(((AaR||AzV)||Vn)&&((this.
Bp<16777216)||(this.Bp>=33554432)))return this;if(M6)this.Bp=this.Bp&3758100479;
if(M6&&!(this.Bp&16777215))this.Bp=0;if(!!ID&&(ID.AxU===this))return null;if((!!
...
IO)))return null;if((!BO&&!D4)&&!ID)return null;if(!!BO){this.Ao0=AaR||Vn;this.AJy=
BO.IO;this.NZ=BO.NZ;}if(!!D4)this.AJy=D4.IO;if(!!ID){this.Ao0=ID.Down;this.AJy=ID.
IO;}if(!!ID&&ID.Down){this.A4P();this.EX=(((ID.Bs-this.Amk)*0.001)*this.AfR)+this.
EX;this.EY=(((ID.Bs-this.Auv)*0.001)*this.AfS)+this.EY;if(this.XP)this.EX=0;if(this.
XQ)this.EY=0;this.AfR=0;this.AfS=0;this.XP=false;this.XQ=false;this.AKy=this.DH;
this.Ap3=ID.Bs;return this;}if(AaR){this.A4P();this.EX=(((BO.Bs-this.Amk)*0.001)
*this.AfR)+this.EX;this.EY=(((BO.Bs-this.Auv)*0.001)*this.AfS)+this.EY;if(this.XP||
!this.ZU)this.EX=0;if(this.XQ||!this.ZU)this.EY=0;this.AfR=0;this.AfS=0;this.XP=
...
}}if((!!ID&&!ID.Down)&&((ID.Bs-this.Ap3)>=200)){this.EX=0;this.EY=0;}if(Vn&&((BO.
...
AiN)*0.5;this.EY=(this.EY+AiO)*0.5;this.Ap3=D4.Bs;}if(!M6&&!ID)return this;if(!!
...
F$[0];if(ER<Fi)EI=this.Gq[0];else if(ER>EI)Fi=this.F$[0];else if(this.W3[0]<=1){
Fi=ER;EI=ER;}else{var Adt=(EI-ER)%this.W3[0];EI=(ER-this.W3[0])+Adt;Fi=ER+Adt;if(
...
Jq*2)*this.Adp)+20;if(Jq<0)this.EX=-Math.sqrt((-Jq*2)*this.Adp)-20;this.AfR=(400-(
this.EX*this.EX))/(2*Jq);this.Ape=ER;}}else{var BCC=this.EX*this.EX;var Jq=BCC/(
2*this.Adp);var ER=this.DH[0];if(this.EX>0)ER=ER+(Jq|0);if(this.EX<0)ER=ER-(Jq|0
...
F$[0];else if(this.W3[0]<=1){Fi=ER;EI=ER;}else{var Adt=(EI-ER)%this.W3[0];EI=(ER-
this.W3[0])+Adt;Fi=ER+Adt;if(EI<this.Gq[0])EI=this.Gq[0];if(Fi>this.F$[0])Fi=this.
...
Math.sqrt((Ai9*2)*this.Adp);if(Ai9<0)this.EX=this.EX-Math.sqrt((-Ai9*2)*this.Adp
);}if(this.EX>0)this.EX=this.EX+20;if(this.EX<0)this.EX=this.EX-20;this.AfR=(400-(
...
else if(this.W3[1]<=1){Fi=ES;EI=ES;}else{var Adt=(EI-ES)%this.W3[1];EI=(ES-this.
W3[1])+Adt;Fi=ES+Adt;if(EI<this.Gq[1])EI=this.Gq[1];if(Fi>this.F$[1])Fi=this.F$[
1];}if((Fi-ES)<=(ES-EI))ES=Fi;else ES=EI;if(ES!==this.DH[1]){var Jq=ES-this.DH[1
];if(Jq>0)this.EY=Math.sqrt((Jq*2)*this.Adp)+20;if(Jq<0)this.EY=-Math.sqrt((-Jq*
2)*this.Adp)-20;this.AfS=(400-(this.EY*this.EY))/(2*Jq);this.Apf=ES;}}else{var BCD=
this.EY*this.EY;var Jq=BCD/(2*this.Adp);var ES=this.DH[1];if(this.EY>0)ES=ES+(Jq|
...
Gq[1];else if(ES>EI)Fi=this.F$[1];else if(this.W3[1]<=1){Fi=ES;EI=ES;}else{var Adt=(
EI-ES)%this.W3[1];EI=(ES-this.W3[1])+Adt;Fi=ES+Adt;if(EI<this.Gq[1])EI=this.Gq[1
...
Bg2;if(Ai9>0)this.EY=this.EY+Math.sqrt((Ai9*2)*this.Adp);if(Ai9<0)this.EY=this.EY-
Math.sqrt((-Ai9*2)*this.Adp);}if(this.EY>0)this.EY=this.EY+20;if(this.EY<0)this.
EY=this.EY-20;this.AfS=(400-(this.EY*this.EY))/(2*Jq);this.Apf=ES;}else this.EY=
0;}if(!!BO)this.Amk=BO.Bs;if(!!ID)this.Amk=ID.Bs;this.Auv=this.Amk;this.Amm=this.
DH[0];this.Amn=this.DH[1];this.BCE();return this;},Yq:function(Dc,BH,Om,Aas,Ac7,
Ac6){var B;if(!!Aas&&(Aas!==this))return null;if(this.Bp>=33554432)return null;if((
this.Bp>=16777216)&&!(this.Bp&(4096<<BH)))return null;if(!this.AG2&&!!(Ac6&0xC))
...
}},BCE:function(){this.timer=A._GetAutoObject(A.acl.Aek);A.zV([this,this.Mm],this.
timer,0);},Mm:function(G){var B;if(!this.timer)return;var AuA=(this.timer.Bs-this.
Amk)*0.001;var AuB=(this.timer.Bs-this.Auv)*0.001;var BCP=AuA*AuA;var BCQ=AuB*AuB;
var AiN=(this.AfR*AuA)+this.EX;var AiO=(this.AfS*AuB)+this.EY;var CE=[((((this.AfR
*0.5)*BCP)+(this.EX*AuA))+this.Amm)|0,((((this.AfS*0.5)*BCQ)+(this.EY*AuB))+this.
Amn)|0];if(this.XP&&(AuA>=0.5)){CE=[this.Ape,CE[1]];this.EX=0;this.AfR=0;this.Amm=
CE[0];this.XP=false;}else if(this.XP){var LP=1-Math.pow(1-(AuA/0.5),5);CE=[(this.
Amm+((this.Ape-this.Amm)*LP))|0,CE[1]];}if(this.XQ&&(AuB>=0.5)){CE=[CE[0],this.Apf
];this.EY=0;this.AfS=0;this.Amn=CE[1];this.XQ=false;}else if(this.XQ){var LP=1-Math.
...
0)&&(AiO<0))||((this.EY<0)&&(AiO>0))){AiO=0;CE=[CE[0],this.DH[1]];}if(!this.XP&&(
CE[0]<this.Gq[0])){this.Amm=CE[0];this.Ape=this.Gq[0];this.Amk=this.timer.Bs;this.
XP=true;}else if(!this.XP&&(CE[0]>this.F$[0])){this.Amm=CE[0];this.Ape=this.F$[0
];this.Amk=this.timer.Bs;this.XP=true;}if(!this.XQ&&(CE[1]<this.Gq[1])){this.Amn=
CE[1];this.Apf=this.Gq[1];this.Auv=this.timer.Bs;this.XQ=true;}else if(!this.XQ&&(
CE[1]>this.F$[1])){this.Amn=CE[1];this.Apf=this.F$[1];this.Auv=this.timer.Bs;this.
XQ=true;}if(((!this.XP&&!!this.EX)&&(AiN>-20))&&(AiN<20)){CE=[this.Ape,CE[1]];this.
EX=0;this.AfR=0;this.Amm=CE[0];}if(((!this.XQ&&!!this.EY)&&(AiO>-20))&&(AiO<20)){
CE=[CE[0],this.Apf];this.EY=0;this.AfS=0;this.Amn=CE[1];}if(!A.aaX(CE,this.DH)){
this.A6r=A.abe(CE,this.DH);this.DH=CE;(B=this.Auh)?B[1].call(B[0],this):null;(B=
this.AGl)?B[1].call(B[0],this):null;}if(((!this.EX&&!this.EY)&&!this.XP)&&!this.
XQ){this.A4P();this.ZU=false;(B=this.Zt)?B[1].call(B[0],this):null;}},ATX:function(
E){if(E[0]<0)E=[0,E[1]];if(E[1]<0)E=[E[0],0];this.W3=E;},ATs:function(E){if(E<0)
E=0;if(E>1)E=1;if(E===this.A65)return;this.A65=E;if(E<(1e-007))E=1e-007;this.Adp=
...
_className:"Core::SlideTouchHandler"};C.BF={Ah:null,Lt:null,BG:null,D1:null,ApY:
0,Bs:0,A$F:0,Filter:148,CP:0,Dy:0,Bw:true,Down:false,Aco:false,Mw:false,Init:function(
aArg){var B;var C2=(C.P.isPrototypeOf(B=this.I)?B:null);if(!C2)throw new Error(AfE
);this.Ah=C2.AKC;C2.AKC=this;},G6:function(CN){var B;if(!!CN&&CN.Bke(this.Filter
)){this.Down=CN.Down;this.CP=CN.CP;this.Dy=CN.Dy;this.Bs=CN.Bs;this.Mw=false;if(
CN.Down){this.A$F=this.ApY;this.Aco=this.ApY>0;if(this.Aco)(B=this.D1)?B[1].call(
B[0],this):null;else(B=this.BG)?B[1].call(B[0],this):null;if(!this.Mw)this.ApY=this.
ApY+1;return!this.Mw;}if(!CN.Down){this.Aco=this.ApY>1;this.A$F=this.ApY-1;this.
ApY=0;(B=this.Lt)?B[1].call(B[0],this):null;return!this.Mw;}}return false;},_Init:
...
null,_className:"Core::DialogContext"};C.AVu={FS:null,B9:null,B8:null,Beq:false,
Bzf:function(){if(!this.FS)return;var Pq=this.FS;this.FS.Pm=null;this.FS=null;A.
pe([this,this.A3X],this);Pq.A8H(this);},BA6:function(G){if(!!this.FS)return;if(!
this.B8)return;this.FS=this.B8;this.B8=this.B8.Ah;if(!!this.B8)this.B8.AJ=null;else
this.B9=null;this.FS.Ah=null;this.Beq=true;this.FS.SQ(this);this.Beq=false;},BBq:
function(G){A.pe([this,this.BA6],this);},BBp:function(G){A.pe([this,this.BBq],this
);},A3X:function(G){A.pe([this,this.BBp],this);},Bib:function(Jn){if(!Jn||!Jn.Pm
)return;if(Jn.Pm!==this)throw new Error(Aak);var Bhv=false;if(this.FS===Jn){this.
FS=null;Bhv=true;A.pe([this,this.A3X],this);}else{if(!!Jn.Ah)Jn.Ah.AJ=Jn.AJ;else
this.B9=Jn.AJ;if(!!Jn.AJ)Jn.AJ.Ah=Jn.Ah;else this.B8=Jn.Ah;Jn.AJ=null;Jn.Ah=null;
}Jn.Pm=null;if(Bhv)Jn.A8G(this);},A$N:function(Jn,A1K){if(!Jn)return;if(!!Jn.Pm)
throw new Error(Xm);Jn.Pm=this;if(A1K){Jn.Ah=this.B8;if(!!this.B8)this.B8.AJ=Jn;
else this.B9=Jn;this.B8=Jn;}else{Jn.AJ=this.B9;if(!!this.B9)this.B9.Ah=Jn;else this.
B8=Jn;this.B9=Jn;}if(!this.FS)A.pe([this,this.A3X],this);},_Init:function(aArg){
...
null,A8H:function(AtD){},A8G:function(AtD){},SQ:function(AtD){this.AmG();},Mv:function(
){if(!!this.Pm&&(this.Pm.FS===this))this.Pm.Bzf();},AmG:function(){if(!!this.Pm)
this.Pm.Bib(this);},ARt:function(){return!!this.Pm&&(this.Pm.FS===this);},_Init:
...
null,SQ:function(AtD){this.Aux.Ar=this.Ar;A.we(this.Aux,0);A.pe([this,this.BA3],
this);},BA3:function(G){this.Aux.Ar=null;this.Aux=null;this.Ar=null;this.Mv();},
...
function(){return this;},_this:null};C.AhE={resource:null,Lh:function(){this.resource=
null;},Init:function(aArg){this.resource=aArg;},_Init:function(aArg){this.__proto__=
C.AhE;this.Init(aArg);A.h7++;},_Done:function(){this.Lh();this.__proto__=null;A.
...
this.Period=E;if(this.Bw)this.AK5(this.VO,E);},WO:function(E){if(E<0)E=0;if(E===
this.VO)return;this.VO=E;if(this.Bw)this.AK5(E,this.Period);},As:function(E){if(
E===this.Bw)return;this.Bw=E;if(E)this.AK5(this.VO,this.Period);else this.AK5(0,
...
Period)this.As(false);(B=this.MJ)?B[1].call(B[0],this):null;},AxR:function(G){this.
...
,AjU:0,GL:0,Hm:0,Year:0,BdY:function(AfO,A1b){if(A1b)switch(AfO){case 1:return A.
aci.Bkn;case 2:return A.aci.Bjg;case 3:return A.aci.BkG;case 4:return A.aci.BhR;
case 5:return A.aci.BkK;case 6:return A.aci.Bkq;case 7:return A.aci.Bkp;case 8:return A.
aci.BhT;case 9:return A.aci.Bpq;case 10:return A.aci.Bk4;case 11:return A.aci.Bk3;
case 12:return A.aci.BiA;default:return A.jV;}else switch(AfO){case 1:return A.aci.
...
Bcs){case 1:return A.aci.BkP;case 2:return A.aci.BqH;case 3:return A.aci.Bro;case
4:return A.aci.Bqu;case 5:return A.aci.Bjt;case 6:return A.aci.Bpi;case 0:return A.
aci.Bqh;default:return A.jV;}else switch(Bcs){case 1:return A.aci.BkO;case 2:return A.
aci.BqG;case 3:return A.aci.Brn;case 4:return A.aci.Bqt;case 5:return A.aci.Bjs;
case 6:return A.aci.Bph;case 0:return A.aci.Bqg;default:return A.jV;}},BdV:function(
){var result=0;{var d=new Date;result=Math.trunc(d.getTime()/1000-(d.getTimezoneOffset(
)*60));}return result;},JY:function(){var d=this.GL;var K9=this.Hm;var Di=this.Year-((
K9<=2)?1:0);var AzW=(((Di>=0)?Di:Di-399)/400)|0;var Amu=Di-(AzW*400);var Vl=(((((
153*(K9+((K9>2)?-3:9)))+2)/5)|0)+d)-1;var Apb=(((Amu*365)+((Amu/4)|0))-((Amu/100
)|0))+Vl;var Qp=((AzW*146097)+Apb)-719468;return(((Qp*86400)+(this.AjU*3600))+(this.
Av8*60))+this.AUX;},AF6:function(E){var B;E+=62162035200;if(E<0)E=0;var Vz=Math.
trunc(E/86400)|0;var AzW=(((Vz>=0)?Vz:Vz-146096)/146097)|0;var Apb=Vz-(AzW*146097
);var Amu=((((Apb-((Apb/1460)|0))+((Apb/36524)|0))-((Apb/146096)|0))/365)|0;var Di=
Amu+(AzW*400);var Vl=Apb-(((365*Amu)+((Amu/4)|0))-((Amu/100)|0));var A3k=(((5*Vl
)+2)/153)|0;var d=(Vl-((((153*A3k)+2)/5)|0))+1;var K9=A3k+((A3k<10)?3:-9);var BL=
Math.trunc(E/3600)%24|0;var O=Math.trunc(E/60)%60|0;var s=E%60|0;this.Year=Di+((
K9<=2)?1:0);this.Uz(K9);this.Lv(d);this.AnG(BL+((BL<0)?24:0));this.AnJ(O+((O<0)?
...
},Bmf:function(){var B;var Vl=this.Ab6()-1;var AtU=(6+this.Awj())%7;var Apd=((371+
AtU)-Vl)%7;if(this.Hm===12){var d=this.GL;if((d===31)&&(AtU<3))return 0;if((d===
30)&&(AtU<2))return 0;if((d===29)&&(AtU<1))return 0;}if(Apd<=3)Vl+=Apd;else Vl-=(
7-Apd);if(Vl<0){var d=this.GL;var K9=this.Hm;this.Year--;this.Lv(31);this.Uz(12);
Vl=this.Ab6()-1;AtU=(6+this.Awj())%7;Apd=((371+AtU)-Vl)%7;if(Apd<=3)Vl+=Apd;else
Vl-=Apd;this.Year++;this.Lv(d);this.Uz(K9);}return(Vl/7)|0;},Ab6:function(){var B;
var d=this.GL;var K9=this.Hm;var Di=this.Year;var Af$=((!!!(Di%4)&&(!!(Di%100)||
!!!(Di%400)))?1:0);switch(K9){case 2:d+=31;break;case 3:d+=(59+Af$);break;case 4:
d+=(90+Af$);break;case 5:d+=(120+Af$);break;case 6:d+=(151+Af$);break;case 7:d+=(
181+Af$);break;case 8:d+=(212+Af$);break;case 9:d+=(243+Af$);break;case 10:d+=(273+
Af$);break;case 11:d+=(304+Af$);break;case 12:d+=(334+Af$);break;default:;}return d;
},Awj:function(){var B;var d=this.GL;var K9=this.Hm+((this.Hm>2)?-2:10);var Di=this.
Year-((this.Hm<=2)?1:0);var B4=(Di/100)|0;Di%=100;d+=((((((((26*K9)-2)/10)|0)+Di
...
59)E=59;this.Av8=E;},AnG:function(E){if(E<0)E=0;if(E>23)E=23;this.AjU=E;},Lv:function(
...
A.aci.BhB;else result=result+A.aci.BoF;break;case 0x53:result=result+A.abl(this.
...
A.abl(this.Ab6(),3*AaL,10);break;case 0x57:result=result+A.abl(this.Bmf(),2*AaL,
...
return result;},Initialize2:function(Ac8,AfO,Bxx,BxO,Bx5,Byl){this.Year=Ac8;this.
Uz(AfO);this.Lv(Bxx);this.AnG(BxO);this.AnJ(Bx5);this.AnM(Byl);return this;},Initialize:
function(Aia){this.AF6(Aia);return this;},BiF:function(Aia){if(!Aia)return A._NewObject(
C.An9,0).Initialize(this.JY());return A._NewObject(C.An9,0).Initialize(this.JY()-
Aia.JY());},BpU:function(Azf){if(!Azf)return this;return A._NewObject(C.Bs,0).Initialize(
...
,Initialize2:function(Bxy,BxP,Bx6,Byo){this.Kq=Bxy;this.ADN=BxP;this.AEz=Bx6;this.
AGN=Byo;return this;},Initialize:function(Aia){this.AF6(Aia);return this;},_Init:
...
this.JS=null;},BmS:function(E){if(this.Event===E)return;if(!!this.Event)A.z9([this
...
I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null,_cycle:0,_observers:null,_className:
"Core::SystemEventHandler"};C.BGQ={Dt:0x1,BDy:0x2,BEH:0x4,BGF:0x8,Bw:0x10,Ib:0x20
,BEI:0x40,BFj:0x80,BED:0x100,BEZ:0x200,BEr:0x400,BFY:0x800,Bl:0x1000,BGN:0x2000,
BFG:0x4000,BFH:0x8000,Abr:0x10000,BFF:0x20000,BF$:0x40000,BEi:0x80000,BFP:0x100000
,BEc:0x200000};C.PT={BF0:0x1,BF1:0x2,BDu:0x4,BDv:0x8,BDw:0x10,BDt:0x20};C.Ag2={None:
0,BGB:1,BDR:2,BE4:3,BF4:4,BGC:5,BGD:6,BDS:7,BDT:8,BE6:9,BE5:10,BF6:11,BF5:12};C.
Au_={None:0,BGy:1,Left:2,BDP:3,ZZ:4,A5Z:5,BGz:6,Right:7,BDQ:8};C.KeyCode={NoKey:
...
343,ShiftHome:344,ShiftEnd:345,ShiftTab:346};C.BF2={BGW:0x1,BGT:0x2,BGU:0x4,BGV:
0x8,BE8:0x10,BEK:0x20};
...
C.Event;C.Au5.__proto__=C.Event;C.Aeg.__proto__=C.Event;C.AqP.__proto__=C.Event;
