...
var Qa="No view to remove";var J3="No view to add";var Oc="View already in a group";
var Qb="Recursive invalidate during active update cycle.";var MJ=[-8,-8,9,9];var
Ta="No group to end the modal state.";var UU="The group is not modal.";var Z5="No group to obtain the modal state.";
...
"The method RestackTop() is not available in Core::VerticalList.";var UW="The method Restack() is not available in Core::VerticalList.";
...
"its content.";var Xb=[0,0,170,120];var UX="The method SwitchToDialog() is not available in Core::HorizontalList.";
...
var Tb="The method RestackTop() is not available in Core::HorizontalList.";var UY=
"The method Restack() is not available in Core::HorizontalList.";var UZ="The method Remove() is not available in Core::HorizontalList.";
var AcM="The method AddBehind() is not available in Core::HorizontalList.";var Tc=
...
},Ank:function(aOffset,Atu){},GetExtent:function(){return BD;},Cs:function(Rt,U8
){var B;if(((this.U&0x200)===0x200))Rt=Rt&~0x400;var A24=(this.U&~U8)|Rt;var Xz=
A24^this.U;this.U=A24;if(!!this.Ab&&!!(Xz&0x14)){var Bdr=((this.U&0x14)===0x14);
if(Bdr&&!this.Ab.AV)this.Ab.Bb(this);if(!Bdr&&(this.Ab.AV===this))this.Ab.Bb(this.
...
this.Ab,B.JJ],this);}if(((((Xz&0x100000)===0x100000)&&((U8&0x100000)===0x100000)
...
U&0x10)===0x10))))this.Cs(0x10,0x0);if(((((Xz&0x200000)===0x200000)&&((U8&0x200000
...
As.AAT[0]-Aiz)*BY)/Af2)|0),y1+((((As.AAT[1]-AiB)*BI)/Af1)|0)]);this.JV([x1+((((As.
...
1,this.ED);HC.Set(2,this.ME);HC.Set(3,this.Kz);while(O<4){var Bg$=HC.Get(O)[0];var
ALx=HC.Get(O)[1];var BC6=HC.Get(Ig)[0];var A4P=HC.Get(Ig)[1];if(((ALx>K0[1])!==(
A4P>K0[1]))||((ALx<K0[1])!==(A4P<K0[1]))){var Ep=((((BC6-Bg$)*(K0[1]-ALx))/(A4P-
ALx))|0)+Bg$;if(K0[0]>Ep)A2x=!A2x;if(K0[0]<Ep)A2y=!A2y;}Ig=O;O=O+1;}return A2x||
...
8;aBlend=aBlend&&((this.U&0x2)===0x2);if(!this.FG||(CY.C0===this))this.Bdg(CY,aClip
...
var Tq=this.U;if(((!!this.Ab&&!!!this.FG)&&((this.U&0x80001)===0x80001))&&((U8&0x80000
)===0x80000))this.Ab.Bj(this.GetClipping());C.Eu.Cs.call(this,Rt,U8);if((((!!this.
Ab&&!!!this.FG)&&((this.U&0x1)===0x1))&&((Rt&0x80000)===0x80000))&&!((Tq&0x80000
)===0x80000))this.Ab.Bj(this.GetClipping());var Xz=this.U^Tq;if(!!this.AV&&((Xz&
...
U&0x80)===0x80))&&(!((X.U&0x10000)===0x10000)||(this.Hd.C0===X)))X.Cs(Rt&0x10,U8&
...
this,this.ABs],this);}},A31:function(CN){var Beb=(C.KeyEvent.isPrototypeOf(CN)?CN:
null);var D5=this.AKs;if(!Beb)return null;while(!!D5&&(!D5.Bw||!D5.G4(Beb)))D5=D5.
...
,0x00000000,0x00000000,0x00000000,false);this.Bdg(this.FG,AE,Ce,255,true);this.FG.
C0=null;}},Bdg:function(CY,aClip,aOffset,Ck,aBlend){var B;var X=this.B7;var LB=BD;
var AAN=true;this.BiC(CY,aClip,aOffset,Ck,aBlend);while(!!X){if(((X.U&0x200)===0x200
...
X.Ko(CY,AE,aOffset,Ck,aBlend);}}X=X.Ah;}this.BiF(CY,aClip,aOffset,Ck,aBlend);},Bf_:
...
,this.ABs],this);},ABs:function(G){var B;var BCY=((this.U&0x1000)===0x1000);if(((
this.U&0x4000)===0x4000)){this.U=this.U&~0x4000;this.Bf_();}if(((this.U&0x8000)===
...
,0x0);}},Bbp:function(Aq){this.Bb(Aq);},ASB:function(){return!!this.FG;},ArJ:function(
...
this.FG.AEz=[this,this.BCQ];}A.we(this,0);},A8L:function(){var B;return((this.U&
...
0xFF;}},BiF:function(CY,aClip,aOffset,Ck,aBlend){},BiC:function(CY,aClip,aOffset
,Ck,aBlend){},GetMaximalSize:function(){return Hr;},GetMinimalSize:function(){return Ce;
},AU$:function(Iu,Oe,Xl,Tf,Tg,Ah_,O$,Rs,Lz,Lx,Ly){var B;if(!this.Hd){this.AkM(Iu
,Oe,Xl,Tf,Tg,null,null,Lz,Lx,Ly);return;}var AlZ=this.Hd;var JG=AlZ.Ah;if(((Iu.U&
0x10000)===0x10000)&&(this.Hd.C0!==Iu))throw new Error(IU);var Adt=A._NewObject(
C.AN0,0);var RD=AlZ.RD;var RM=null;var Me=null;if(!!JG){RM=JG.RM;Me=JG.Me;}if(!!
JG&&!!AlZ.ApP)RM=AlZ.ApP;if(!!JG&&!!O$)Me=O$;if(!!Ah_)RD=Ah_;if(!Oe)Oe=A._GetAutoObject(
A.acl.AsE);if(!Xl)Xl=Oe;if(!Tg)Tg=Tf;if(!Tf)Tf=Tg;Adt.RD=Xl;Adt.Me=Tf;Adt.RM=Tg;
...
,true);}else if(!!RM){this.NS(JG.C0,RM.Aed(),null,null,Ly);this.NS(AlZ.C0,RD.Sd(
...
0x40,0x0);var RD=KE.RD;var RM=null;var Me=null;if(!!JG)RM=JG.RM;if(!!JG&&!!KE.ApP
)RM=KE.ApP;if(!!JG&&!!Rs)RM=Rs;if(!!ApV&&!!JG)Me=JG.Me;if((!!ApV&&!!JG)&&!!O$)Me=
O$;if(!!Ah_)RD=Ah_;if(!!Me){this.NS(JG.C0,Me.Aec(),null,null,Ly);this.NS(KE.C0,RD.
Sd(),Lz,Lx,true);}else if(!!RM){this.NS(JG.C0,RM.Aed(),null,null,Ly);this.NS(KE.
C0,RD.Sd(),Lz,Lx,true);}else this.NS(KE.C0,RD.Sd(),Lz,Lx,Ly);},AkM:function(Iu,Oe
,Xl,Tf,Tg,O$,Rs,Lz,Lx,Ly){var B;if(!Iu)return;if(!!this.Hd&&(this.Hd.C0===Iu)){this.
AU$(Iu,Oe,Xl,Tf,Tg,null,O$,Rs,Lz,Lx,Ly);return;}if(((Iu.U&0x10000)===0x10000))throw new
...
)Oe=A._GetAutoObject(A.acl.AsE);if(!Xl)Xl=Oe;if(!Tg)Tg=Tf;if(!Tf)Tf=Tg;KE.RD=Xl;
KE.Me=Tf;KE.RM=Tg;KE.ApP=Rs;if(this.AV===Iu)this.Bb(null);if(!!this.Hd&&((this.Hd.
...
Lz,Lx,Ly);},A6_:function(Ae){var B;return(B=Ae)&&((this.U&B)===B);},A7M:function(
...
BcV=0;var IZ=0x10000;var AKS;if(((aFilter&0x10000)===0x10000))IZ=0x0;var top=((GA===
...
Rv[0];Jm=(Jm*AKr)*AKr;if((Jm<BcV)||!A1B){BcV=Jm;A1B=X;}}}}return A1B;},AqM:function(
...
},TR:function(Ag,aFilter){var B;if(!!Ag&&(Ag.Ab!==this))return null;var X=this.B7;
...
this.XA=A._NewObject(C.AVe,0);FP.Ab=this;FP.P=KD;FP.AKD=Lx;FP.A3j=Lz;if(!!KD.ApQ
)KD.ApQ.Pm.BoN(KD.ApQ);KD.ApQ=FP;KD.U=KD.U|0x20000;if((Ly&&!!this.XA.B8)&&!this.
XA.B8.ARj())(A.acl.ACN.isPrototypeOf(B=this.XA.B8)?B:null).A44(FP);else{var Pm=A.
_NewObject(A.acl.ACN,0);Pm.A44(FP);this.XA.A$t(Pm,false);}},AhE:function(Ag,J7){
...
){var B;if(!Ag)throw new Error(J3);if(!!Ag.Ab)throw new Error(Oc);if(!!J7&&(J7.Ab
...
J3);if(!!Ag.Ab)throw new Error(Oc);var GC=null;var LP=Ag.J1;if(((Qh<0)&&!!this.B8
...
Ag.U|0x800;this.U=this.U|0x4000;A.pe([this,this.JJ],this);}},A8N:function(){return this.
...
B._cycle=D);},_className:"Core::Group"};C.Root={RJ:null,JF:null,Fv:A.abi(10,null
...
this.Kf=this.Kf+1;return;}var Ig;var RI;var Az_=0;var AAb=0;var BcU=2147483647;this.
...
);var BfK=((ALk<<8)/(this.Os.Get(Ig)+this.Os.Get(RI)))|0;if(BfK<BcU){BcU=BfK;Az_=
...
Kf));this.Os.Set(AAb,this.Os.Get(this.Kf));}},Bzb:function(){var LJ=A._NewObject(
...
Air.Ar(false);},GetFPS:function(){var ticksCount=0;var Bdw=0;ticksCount=((new Date
).getTime()-A.v$)|0;if(!!this.AKe&&(ticksCount>this.AKe))Bdw=((this.AKd*1000)/((
ticksCount-this.AKe)|0))|0;this.AKd=0;this.AKe=ticksCount;return Bdw;},Update:function(
...
this.AKd+1;this.Kf=0;}},UpdateCanvas:function(CY,aOffset){var B;var Agv=BD;var ByU=[
...
this.M)[2]-B[0],B[3]-B[1]])){var BgO=A.abi(3,A.wg,null);var BgN=this.Kf;for(O=0;
O<BgN;O++)BgO.Set(O,this.Ki.Get(O));for(O=0;O<BgN;O++){var Bf5=A.abh(BgO.Get(O),
this.M.slice(0,2));var Bf6=this.AuJ(Bf5);if(!A.aaY(Bf5,Bf6))this.Bj(A.abg(Bf6,this.
...
KC,AyY,Te){var B;var A32=!!this.RJ;if(!!this.RJ&&((!Te||(this.Az$!==KC))||(this.
...
AyY,true);if(!!D5)D5.G4(LJ);else if(!!X)X.G4(LJ);}if(!this.RJ&&Te){if(!!KC)this.
...
)this.RJ=null;this.Az$=KC;this.At0=AyY;A32=A32||!!this.RJ;}this.Ie=0;return A32;
...
));}this.Ie=0;return true;},DriveCursorHitting:function(Te,BF,Fh){return this.DriveMultiTouchHitting(
Te,BF,Fh);},DriveMultiTouchHitting:function(Te,BF,Fh){if((BF<0)||(BF>9)){this.Ie=
0;return false;}var ticksCount=this.Ie;if(!ticksCount)ticksCount=((new Date).getTime(
)-A.v$)|0;var BB8=this.Ie;this.DriveMultiTouchMovement(BF,Fh);Fh=this.RC.Get(BF);
this.Ie=BB8;if(Te)this.Ade.Set(BF,Fh);if(Te&&!this.Fv.Get(BF)){var JE;var pos=Fh;
...
0;return true;}if(!Te&&!!this.Fv.Get(BF)){var pos=Fh;var B0=this.Fv.Get(BF).Ab;while(
...
},AUy:function(Aal,Bce,Ac6,Ac5){if(Aal===this)Aal=null;if(!!!Aal&&!!this.JF)Aal=
this.JF.C0;if(!this.Fv.Get(this.EP))return;var JE;JE=this.Yj(A.abh(MJ,this.RC.Get(
this.EP)),this.EP,1,Aal,Ac6,Ac5);if(!!JE&&(this.Fv.Get(this.EP)!==JE.Cj))this.ANQ(
JE.Cj,JE.DG);if(!JE&&(this.Fv.Get(this.EP)!==Bce))this.ANQ(Bce,Ce);},ANQ:function(
...
},AOR:function(){if(!!this.JF)return this.JF.C0;return null;},ACK:function(KD){var
B;if(!KD)throw new Error(Ta);if(!((KD.U&0x80)===0x80))throw new Error(UU);if(this.
...
,0x0);else this.Cs(0x50,0x0);}},AMX:function(KD){var B;var As=A._NewObject(C.A7Y
...
,Initialize2:function(KC,Te){this.CO=0;this.DQ=KC;this.Down=Te;if((KC>=0x30)&&(KC<=
...
CO=140;break;default:;}return this;},Initialize:function(KC,Te){this.CO=KC;this.
Down=Te;this.DQ=0x00;var A1H=KC-10;var AtF=KC-105;if((A1H>=0)&&(A1H<=9))this.DQ=(
...
break;case 140:this.DQ=0x3B;break;default:;}return this;},BjV:function(Bb5){switch(
Bb5){case 141:return((this.DQ>=0x41)&&(this.DQ<=0x5A))||((this.DQ>=0x61)&&(this.
...
)||!!this.CO;default:;}return Bb5===this.CO;},_Init:function(aArg){C.Event._Init.
...
"Core::LanguageEvent"};C.Au1={AxO:null,LU:A.wf,N9:0,IJ:0,Down:false,NJ:false,InitializeUp:
function(BF,Of,AoC,A1j,Aak){this.Down=false;this.IJ=BF;this.N9=Of;this.LU=Aak;this.
AxO=A1j;this.NJ=AoC;return this;},InitializeDown:function(BF,Of,AoC,A1j,Aak){this.
Down=true;this.IJ=BF;this.N9=Of;this.LU=Aak;this.AxO=A1j;this.NJ=AoC;return this;
...
B._cycle=D);},_className:"Core::CursorGrabEvent"};C.Aef={Ag3:A.wf,LU:A.wf,N9:0,Jt:
0,NU:A.wf,H1:A.wf,IJ:0,Down:false,NJ:false,InitializeHold:function(BF,All,Ay1,Ay2
,Of,Xm,Aak,Ay0){this.Down=true;this.IJ=BF;this.H1=A.abf(All,Xm);this.NU=A.abf(Ay1
,Xm);this.Jt=Ay2;this.N9=Of;this.LU=Aak;this.Ag3=Ay0;return this;},InitializeUp:
function(BF,All,Ay1,Ay2,Of,Xm,AoC,Aak,Ay0){this.Down=false;this.IJ=BF;this.H1=A.
abf(All,Xm);this.NU=A.abf(Ay1,Xm);this.Jt=Ay2;this.N9=Of;this.NJ=AoC;this.LU=Aak;
this.Ag3=Ay0;return this;},InitializeDown:function(BF,All,Of,Xm,AoC,Aak){this.Down=
true;this.IJ=BF;this.H1=A.abf(All,Xm);this.NU=A.abf(All,Xm);this.Jt=0;this.N9=Of;
...
Ag3:A.wf,LU:A.wf,N9:0,Jt:0,DG:A.wf,NU:A.wf,H1:A.wf,IJ:0,Initialize:function(BF,All
,Ay1,aOffset,Ay2,Byf,Xm,Aak,Ay0){this.IJ=BF;this.H1=A.abf(All,Xm);this.NU=A.abf(
Ay1,Xm);this.DG=aOffset;this.Jt=Ay2;this.N9=Byf;this.LU=Aak;this.Ag3=Ay0;return this;
...
Az=A.wC(Az,Ap3);}return Az;},Cs:function(Rt,U8){var B;var Tq=this.U;if((!!this.Ab&&((
...
0x80000))&&!((Tq&0x80000)===0x80000))this.Ab.Bj(this.GetClipping());},H:function(
...
JJ],this);}}},BfZ:function(){var B;if((!this.Ag1||!!!this.Ab)||!((this.Ab.U&0x4000
...
0x200))break;}if(A11){this.U=this.U&~0x4000;this.Ab.Bf_();}},ApK:function(G){var
...
this.Em,this);},A_J:function(E){var B;if(E<0)E=0;if(E===this.AU4)return;this.AU4=
...
this.Ab,B.JJ],this);}},VA:function(AcZ,E8){var AtF=this.Dc(0x1);var Rz=this.M;var
Vk=A.abe(AtF.slice(0,2),Rz.slice(0,2));var Mc=A.abe(AtF.slice(2,4),Rz.slice(2,4)
);var Bq=Ce;if((Vk[0]>0)&&(Mc[0]>Vk[0]))Bq=[Vk[0],Bq[1]];else if((Vk[0]>0)&&(Mc[
0]>0))Bq=[Mc[0],Bq[1]];if((Mc[0]<0)&&(Vk[0]<Mc[0]))Bq=[Mc[0],Bq[1]];else if((Mc[
0]<0)&&(Vk[0]<0))Bq=[Vk[0],Bq[1]];if((Vk[1]>0)&&(Mc[1]>Vk[1]))Bq=[Bq[0],Vk[1]];else
if((Vk[1]>0)&&(Mc[1]>0))Bq=[Bq[0],Mc[1]];if((Mc[1]<0)&&(Vk[1]<Mc[1]))Bq=[Bq[0],Mc[
1]];else if((Mc[1]<0)&&(Vk[1]<0))Bq=[Bq[0],Vk[1]];if(A.aaX(Bq,Ce)){(E8)?E8[1].call(
...
UV);this.BfZ();var Az=Ag.GetExtent();var Bd=this.M;var LN=A.lb(Az,Bd);if((!Ac3&&
...
},TR:function(Ag,aFilter){var B;if(!!Ag&&((Ag.Ab!==this.Ab)||!((Ag.U&0x400)===0x400
...
},Dc:function(aFilter){var B;var X=this.Ah;var AE=BD;var IZ=0x10000;this.BfZ();if(((
...
HB:null,BX:null,Cj:null,WT:null,NB:null,Em:null,Hm:null,Tn:-1,Tm:0,Jp:-1,Ht:0,AiJ:
8,On:0,Uz:0,AcJ:A.wf,G6:-1,Br:0,Gt:-1,OS:0,GO:24,AY:0,Lj:null,NR:false,At1:false
,AU$:function(Iu,Oe,Xl,Tf,Tg,Ah_,O$,Rs,Lz,Lx,Ly){throw new Error(Z6);},AqF:function(
Iu,Ah_,O$,Rs,Lz,Lx,Ly){throw new Error(W9);},AkM:function(Iu,Oe,Xl,Tf,Tg,O$,Rs,Lz
...
Jp>Ai0)){this.AA3();this.Azp();}}else{this.Jp=(this.Jp-this.Ht)+FT;this.Ht=FT;Apx=
this.Ht;Apy=this.Jp;}while(this.Ht<FT)this.AdG();while(this.Jp>G0)this.AA3();while(
...
var BgY=(B=this.M)[2]-B[0];while(!!Aa){var IA=inx;if(this.NR){if(IA<0)IA=this.AY-(-
IA%this.AY);if(IA>0)IA=IA%this.AY;}var AdH=((IA>=this.Tm)&&(IA<=this.Tn))||((inx>=
Apx)&&(inx<=Apy));var Apd=Aa.GetExtent();var Bq=A.abe(pos,Apd.slice(0,2));if(AdH
)this.Uz=this.GO;else this.Uz=Apd[3]-Apd[1];var A2H=pos[1];var A2I=pos[1]+this.Uz;
if(!A.aaX(Bq,Ce))Aa.Ank(Bq,true);if((AdH&&(A2H<BI))&&(A2I>0)){this.Cj=Aa;this.G6=
IA;this.AcJ=[BgY,this.Uz];(B=this.Hm)?B[1].call(B[0],this):null;}Aa=Aa.Ah;inx+=1;
pos=[pos[0],pos[1]+this.Uz];}inx=this.Ht;Aa=this.B7;pos=[0,(AAQ+this.Br)+this.Jn(
inx,0)];while(!!Aa){var IA=inx;if(this.NR){if(IA<0)IA=this.AY-(-IA%this.AY);if(IA>
0)IA=IA%this.AY;}var AdH=((IA>=this.Tm)&&(IA<=this.Tn))||((inx>=Apx)&&(inx<=Apy)
);if(AdH)this.Uz=this.GO;else this.Uz=(B=Aa.GetExtent())[3]-B[1];var A2H=pos[1];
var A2I=pos[1]+this.Uz;if(AdH&&!((A2H<BI)&&(A2I>0))){this.Cj=Aa;this.G6=IA;this.
AcJ=[BgY,this.Uz];(B=this.Hm)?B[1].call(B[0],this):null;}if(((IA===this.Gt)&&this.
...
Ah;inx+=1;pos=[pos[0],pos[1]+this.Uz];}this.Tm=0;this.Tn=-1;this.Cj=null;this.G6=-
1;this.Bb(AlI);this.At1=false;A.pe(this.Em,this);},QJ:function(Ag,GA,aFilter){return null;
},AqM:function(Ag,aFilter){return null;},TR:function(Ag,aFilter){return null;},ACS:
function(Ag,aFilter){return null;},Dc:function(aFilter){return BD;},NS:function(
KD,FP,Lz,Lx,Ly){throw new Error(W_);},AhE:function(Ag,J7){throw new Error(Z8);},
ZF:function(Ag){throw new Error(Z9);},JZ:function(Ag,Qh){throw new Error(UW);},HP:
function(Ag){throw new Error(W$);},AMb:function(Ag,J7){throw new Error(O5);},J:function(
Ag,Qh){throw new Error(Z_);},Jn:function(Ha,A0U){return Ha*this.GO;},Al9:function(
Fh,A0U){return(Fh/this.GO)|0;},AA3:function(){var Aa=this.B8;if(!Aa)return null;
...
}this.Uz=this.GO;this.G6=AdK;this.AcJ=[(B=this.M)[2]-B[0],this.Uz];this.Cj=Aa;(B=
...
A._NewObject(Adq,0))?B:null);Aa.A0(0x1D);if(!!this.On)this.AiJ++;}this.Uz=this.GO;
this.G6=M3;this.AcJ=[(B=this.M)[2]-B[0],this.Uz];this.Cj=Aa;(B=this.Hm)?B[1].call(
...
B[1].call(B[0],this):null;},BBt:function(G){this.Gb(this.WT.DG[1]);},BBu:function(
...
]-AE[1]);if(A2Y>0)A2Y=0;this.WT.DG=[0,this.Br];this.WT.Gp=[0,(this.Br+A2Y)-Fx];this.
...
null;}this.WT=E;if(!!E){E.AKM=[this,this.BBu];E.Auc=[this,this.BBt];}},Gb:function(
...
this.Gt=E;this.Am();},A_v:function(E){var B;if(E<0)E=0;if(E===this.OS)return;this.
...
var Bdx=((((B=this.M)[3]-B[1])-this.Br)-this.OS)-this.Jn(this.AY,3);var Bq=0;if(
AKf>0)Bq=-AKf;else if(Bdx>0)Bq=Bdx;if((Bq>0)&&(Bq>-AKf))Bq=-AKf;if(!Bq){(E8)?E8[
...
1]+this.Br);AE=[].concat(AE.slice(0,3),AE[1]+this.OS);return AE;},A6Y:function(Fh
...
)return;if(this.Tm>this.Tn){this.Tm=J5;this.Tn=L7;}else{if(J5<this.Tm)this.Tm=J5;
if(L7>this.Tn)this.Tn=L7;}var AE=[0,0,(B=this.M)[2]-B[0],B[3]-B[1]];if(!this.NR){
...
,BX:null,Cj:null,NB:null,Hm:null,Tn:-1,Tm:0,Jp:-1,Ht:0,AiJ:8,On:0,SP:0,AcJ:A.wf,
G6:-1,Br:0,Gt:-1,We:24,AY:0,Lj:null,At1:false,AU$:function(Iu,Oe,Xl,Tf,Tg,Ah_,O$
,Rs,Lz,Lx,Ly){throw new Error(UX);},AqF:function(Iu,Ah_,O$,Rs,Lz,Lx,Ly){throw new
Error(Z$);},AkM:function(Iu,Oe,Xl,Tf,Tg,O$,Rs,Lz,Lx,Ly){throw new Error(Aaa);},DispatchEvent:
...
this.Cj;this.Cj.Ab=this;this.AcJ=[this.SP,(B=this.M)[3]-B[1]];(B=this.Hm)?B[1].call(
...
)&&(this.Jp>Ai0)){this.AA3();this.Azp();}}else{this.Jp=(this.Jp-this.Ht)+FT;this.
Ht=FT;Apx=this.Ht;Apy=this.Jp;}while(this.Ht<FT)this.AdG();while(this.Jp>G0)this.
AA3();while(this.Ht>FT)this.Azp();while(this.Jp<G0)this.Azq();var Aa=this.B7;var
inx=this.Ht;var pos=[this.Br+this.Jn(inx,0),0];var BY=(B=this.M)[2]-B[0];var AlI=
null;var BgL=(B=this.M)[3]-B[1];while(!!Aa){var IA=inx;var AdH=((IA>=this.Tm)&&(
IA<=this.Tn))||((inx>=Apx)&&(inx<=Apy));var Apd=Aa.GetExtent();var Bq=A.abe(pos,
Apd.slice(0,2));if(AdH)this.SP=this.We;else this.SP=Apd[2]-Apd[0];var A2F=pos[0];
var A2G=pos[0]+this.SP;if(!A.aaX(Bq,Ce))Aa.Ank(Bq,true);if((AdH&&(A2F<BY))&&(A2G>
0)){this.Cj=Aa;this.G6=IA;this.AcJ=[this.SP,BgL];(B=this.Hm)?B[1].call(B[0],this
):null;}Aa=Aa.Ah;inx+=1;pos=[pos[0]+this.SP,pos[1]];}inx=this.Ht;Aa=this.B7;pos=[
this.Br+this.Jn(inx,0),0];while(!!Aa){var IA=inx;var AdH=((IA>=this.Tm)&&(IA<=this.
Tn))||((inx>=Apx)&&(inx<=Apy));if(AdH)this.SP=this.We;else this.SP=(B=Aa.GetExtent(
))[2]-B[0];var A2F=pos[0];var A2G=pos[0]+this.SP;if(AdH&&!((A2F<BY)&&(A2G>0))){this.
Cj=Aa;this.G6=IA;this.AcJ=[this.SP,BgL];(B=this.Hm)?B[1].call(B[0],this):null;}if(
IA===this.Gt)AlI=Aa;Aa=Aa.Ah;inx+=1;pos=[pos[0]+this.SP,pos[1]];}this.Tm=0;this.
Tn=-1;this.Cj=null;this.G6=-1;this.Bb(AlI);this.At1=false;},QJ:function(Ag,GA,aFilter
){return null;},AqM:function(Ag,aFilter){return null;},TR:function(Ag,aFilter){return null;
},ACS:function(Ag,aFilter){return null;},Dc:function(aFilter){return BD;},NS:function(
KD,FP,Lz,Lx,Ly){throw new Error(Xc);},AhE:function(Ag,J7){throw new Error(Xd);},
ZF:function(Ag){throw new Error(Tb);},JZ:function(Ag,Qh){throw new Error(UY);},HP:
function(Ag){throw new Error(UZ);},AMb:function(Ag,J7){throw new Error(AcM);},J:
function(Ag,Qh){throw new Error(Tc);},Jn:function(Ha,A0U){return Ha*this.We;},Al9:
function(Fh,A0U){return(Fh/this.We)|0;},AA3:function(){var Aa=this.B8;if(!Aa)return null;
if(Aa===this.AV)this.Bb(null);this.Jp=this.Jp-1;if(!!Aa.AJ)Aa.AJ.Ah=null;else this.
B7=null;this.B8=Aa.AJ;Aa.AJ=null;Aa.Ab=null;Aa.Ev=null;if(this.On<this.AiJ){if(!
!this.HB)this.HB.AJ=Aa;Aa.Ah=this.HB;this.HB=Aa;this.On++;}return Aa;},Azq:function(
...
AiJ++;}this.SP=this.We;this.G6=AdK;this.AcJ=[this.SP,(B=this.M)[3]-B[1]];this.Cj=
...
Ah;if(this.HB===Aa)this.HB=Aa.Ah;Aa.Ah=null;Aa.AJ=null;this.On--;}else{Aa=(C.Cj.
isPrototypeOf(B=A._NewObject(Adq,0))?B:null);Aa.A0(0x1D);if(!!this.On)this.AiJ++;
}this.SP=this.We;this.G6=M3;this.AcJ=[this.SP,(B=this.M)[3]-B[1]];this.Cj=Aa;(B=
...
J5,L7){var B;if(J5<0)J5=0;if(J5>L7)return;if(this.Tm>this.Tn){this.Tm=J5;this.Tn=
L7;}else{if(J5<this.Tm)this.Tm=J5;if(L7>this.Tn)this.Tn=L7;}var AE=[0,0,(B=this.
...
Lo:null,BL:null,AK$:0,Bp:0,IJ:0,Bs:0,N9:0,Jt:0,DG:A.wf,NU:A.wf,H1:A.wf,Axw:8,Afg:
0,A7R:1,Down:false,YI:false,NJ:false,A18:false,AAk:0,Ko:function(CY,aClip,aOffset
,Ck,aBlend){},G4:function(CN){var B;var BN=(C.Aef.isPrototypeOf(CN)?CN:null);var
D4=(C.AqH.isPrototypeOf(CN)?CN:null);var AKp=this.YI;var AaI;var Vh;var ABm;var M0;
var AzI;if(!BN&&!D4)return null;AaI=(!!BN&&BN.Down)&&!BN.Jt;Vh=(!!BN&&BN.Down)&&(
BN.Jt>0);ABm=(!!BN&&BN.Down)&&(BN.Jt>this.AAk);M0=!!BN&&!BN.Down;AzI=!!D4;if(AaI
...
!!Iy&&Iy.Down)&&(Iy.AxO!==this))&&A.wa(this.GetExtent(),this.Ab.A7M(Iy.LU))){this.
...
!!IE.JF?IE.JF.C0:null);JE=IE.Yj(A.abh(Aab,BN.LU),BN.IJ,BN.N9,A1W,A4u,0x0);}if(!!
...
O)))JE.Cj.G4(A._NewObject(C.Aef,0).InitializeUp(O,BN.H1,BN.H1,0,BN.N9,Ce,false,BN.
LU,BN.LU));}}if(M0)this.Bp=(this.Bp&~(1<<BN.IJ))|33554432;if(ABm&&(this.Bp<16777216
))this.Bp=this.Bp|67108864;if(M0&&BN.NJ)this.Bp=this.Bp|67108864;if(M0&&!(this.Bp&
4095))this.AK$=0x0;if(M0&&!(this.Bp&16777215))this.Bp=0;if(Vh&&(this.Bp>=67108864
)){var IE=this.Im();if(!!IE)IE.AUy(null,null,this,this.AK$);}if((Vh&&!!(this.Bp&
16777216))&&!!(this.Bp&33554432)){Vh=false;M0=true;}if(!!BN&&!(this.Bp&(4096<<BN.
IJ)))return this;if(!!D4&&!(this.Bp&(4096<<D4.IJ)))return this;if(M0&&!(this.Bp&
16777216))return this;if(((AaI||AzI)||Vh)&&((this.Bp<16777216)||(this.Bp>=33554432
)))return this;if(M0)this.Bp=this.Bp&3758100479;if(M0&&!(this.Bp&16777215))this.
Bp=0;if(!!BN){this.Down=AaI||Vh;this.YI=this.ARn(BN.H1);this.NU=BN.NU;this.H1=BN.
H1;this.DG=Ce;this.Jt=BN.Jt;this.N9=BN.N9;this.NJ=BN.NJ;this.IJ=BN.IJ;this.Bs=BN.
Bs;if(BN.Down&&!BN.Jt)AKp=false;}if(!!D4){this.Down=true;this.YI=this.ARn(D4.H1);
this.NU=D4.NU;this.H1=D4.H1;this.DG=D4.DG;this.Jt=D4.Jt;this.N9=D4.N9;this.IJ=D4.
...
this.Down&&this.YI)&&!AKp){this.A18=true;(B=this.Av$)?B[1].call(B[0],this):null;
}if(this.A18&&(((A12&&!this.YI)&&AKp)||((!A12&&this.YI)&&AKp))){this.A18=false;(
B=this.AEP)?B[1].call(B[0],this):null;}if(!!BN&&!A12)(B=this.Lo)?B[1].call(B[0],
...
))return null;if((Of<1)||(Of>this.A7R))return null;if(this.Bp>=33554432)return null;
...
function(E){if(E<1)E=1;this.Axw=E;},AFy:function(E){if(E<1)E=1;this.A7R=E;},Ar:function(
...
};C.H_={timer:null,AKM:null,Auc:null,AF$:null,Zn:null,SM:null,Bp:0,AJo:0,Ado:5000
,ApY:0,AKo:A.wf,Apa:0,AfP:0,EY:0,Amj:0,Auq:0,Ao$:0,AfO:0,EX:0,Ami:0,Amg:0,NU:A.wf
,A59:A.wf,F_:A.wf,Gp:A.wf,DG:A.wf,WV:A.wf,A6L:0.5,A$q:true,AGR:true,ZN:false,XJ:
...
)?CN:null);var Iy=(C.Au1.isPrototypeOf(CN)?CN:null);var AaI;var Vh;var ABm;var M0;
var AzI;AaI=(!!BN&&BN.Down)&&!BN.Jt;Vh=(!!BN&&BN.Down)&&(BN.Jt>0);ABm=(!!BN&&BN.
...
C0:null);JE=IE.Yj(A.abh(Aab,BN.LU),BN.IJ,BN.N9,A1W,A4u,0x0);}if(!!JE){var O;for(
O=0;O<10;O++)if(!!(this.Bp&(1<<O)))JE.Cj.G4(A._NewObject(C.Aef,0).InitializeDown(
O,BN.H1,BN.N9,Ce,true,BN.LU));for(O=0;O<10;O++)if(!!(this.Bp&(1<<O)))JE.Cj.G4(A.
_NewObject(C.Aef,0).InitializeUp(O,BN.H1,BN.H1,0,BN.N9,Ce,false,BN.LU,BN.LU));}}
if(M0)this.Bp=(this.Bp&~(1<<BN.IJ))|33554432;if(ABm&&(this.Bp<16777216))this.Bp=
this.Bp|67108864;if(M0&&BN.NJ)this.Bp=this.Bp|67108864;if(M0&&!(this.Bp&16777215
))this.Bp=0;if(Vh&&(this.Bp>=67108864)){var IE=this.Im();if(!!IE)IE.AUy(null,null
,this,0x0);}if((Vh&&!!(this.Bp&16777216))&&!!(this.Bp&33554432)){Vh=false;M0=true;
}if(!!BN&&!(this.Bp&(4096<<BN.IJ)))return this;if(!!D4&&!(this.Bp&(4096<<D4.IJ))
)return this;if(M0&&!(this.Bp&16777216))return this;if(((AaI||AzI)||Vh)&&((this.
...
this.Ab.A7M(Iy.LU)))return null;if((!!Iy&&!Iy.Down)&&(!this.AoV||(this.AJo!==Iy.
IJ)))return null;if((!BN&&!D4)&&!Iy)return null;if(!!BN){this.AoV=AaI||Vh;this.AJo=
BN.IJ;this.NU=BN.NU;}if(!!D4)this.AJo=D4.IJ;if(!!Iy){this.AoV=Iy.Down;this.AJo=Iy.
...
false;this.XK=false;if(!this.ZN){this.ZN=true;(B=this.SM)?B[1].call(B[0],this):null;(
...
];CD=[CD[0],this.AKo[1]+Hc[1]];if(this.A$q){if(CD[0]<this.Gp[0])CD=[this.Gp[0]+(((
...
}}if((!!Iy&&!Iy.Down)&&((Iy.Bs-this.ApY)>=200)){this.EX=0;this.EY=0;}if(Vh&&((BN.
Bs-this.ApY)>=200)){this.EX=0;this.EY=0;}if(!!D4&&(D4.Bs>this.ApY)){var Hc=D4.DG;
var Bd0=1000/(D4.Bs-this.ApY);var AiM=0;var AiN;if(this.AGR)AiM=Hc[0]*Bd0;AiN=Hc[
1]*Bd0;if((AiM*this.EX)<0)this.EX=0;if((AiN*this.EY)<0)this.EY=0;this.EX=(this.EX+
...
);if(ER>this.F_[0])ER=this.F_[0];else if(ER<this.Gp[0])ER=this.Gp[0];var BgG=ER;
...
this.DG[0]){Jm=ER-this.DG[0];if(ER!==BgG){var Ai8=ER-BgG;if(Ai8>0)this.EX=this.EX+
...
])ES=this.Gp[1];var BgH=ES;var Fj=this.Gp[1];var EI=this.F_[1];if(ES<Fj)EI=this.
...
ES))ES=Fj;else ES=EI;if(ES!==this.DG[1]){Jm=ES-this.DG[1];if(ES!==BgH){var Ai8=ES-
BgH;if(Ai8>0)this.EY=this.EY+Math.sqrt((Ai8*2)*this.Ado);if(Ai8<0)this.EY=this.EY-
...
DG[0];this.Amj=this.DG[1];this.BCt();return this;},Yj:function(Db,BF,Of,Aaj,Ac6,
...
E=0;if(E>1)E=1;if(E===this.A6L)return;this.A6L=E;if(E<(1e-007))E=1e-007;this.Ado=
...
)B._Mark(B._cycle=D);if((B=this.SM)&&((B=B[0])._cycle!=D))B._Mark(B._cycle=D);},
_className:"Core::SlideTouchHandler"};C.BK={Ah:null,Lo:null,BL:null,D1:null,ApT:
0,Bs:0,A$l:0,Filter:148,CO:0,DQ:0,Bw:true,Down:false,Ach:false,NL:false,Init:function(
aArg){var B;var C0=(C.P.isPrototypeOf(B=this.I)?B:null);if(!C0)throw new Error(AfB
);this.Ah=C0.AKs;C0.AKs=this;},G4:function(CN){var B;if(!!CN&&CN.BjV(this.Filter
)){this.Down=CN.Down;this.CO=CN.CO;this.DQ=CN.DQ;this.Bs=CN.Bs;this.NL=false;if(
CN.Down){this.A$l=this.ApT;this.Ach=this.ApT>0;if(this.Ach)(B=this.D1)?B[1].call(
B[0],this):null;else(B=this.BL)?B[1].call(B[0],this):null;if(!this.NL)this.ApT=this.
ApT+1;return!this.NL;}if(!CN.Down){this.Ach=this.ApT>1;this.A$l=this.ApT-1;this.
...
,_cycle:0,_observers:null,_className:"Core::CursorHit"};C.A7Y={Ah:null,C0:null,_Init:
...
null,_className:"Core::DialogContext"};C.AVe={FQ:null,B8:null,B7:null,Bd7:false,
By6:function(){if(!this.FQ)return;var Pm=this.FQ;this.FQ.Ph=null;this.FQ=null;A.
pe([this,this.A3D],this);Pm.A8n(this);},BAU:function(G){if(!!this.FQ)return;if(!
this.B7)return;this.FQ=this.B7;this.B7=this.B7.Ah;if(!!this.B7)this.B7.AJ=null;else
this.B8=null;this.FQ.Ah=null;this.Bd7=true;this.FQ.SM(this);this.Bd7=false;},BBf:
function(G){A.pe([this,this.BAU],this);},BBe:function(G){A.pe([this,this.BBf],this
);},A3D:function(G){A.pe([this,this.BBe],this);},BhS:function(Ji){if(!Ji||!Ji.Ph
)return;if(Ji.Ph!==this)throw new Error(Aac);var Bha=false;if(this.FQ===Ji){this.
FQ=null;Bha=true;A.pe([this,this.A3D],this);}else{if(!!Ji.Ah)Ji.Ah.AJ=Ji.AJ;else
this.B8=Ji.AJ;if(!!Ji.AJ)Ji.AJ.Ah=Ji.Ah;else this.B7=Ji.Ah;Ji.AJ=null;Ji.Ah=null;
}Ji.Ph=null;if(Bha)Ji.A8m(this);},A$t:function(Ji,A1p){if(!Ji)return;if(!!Ji.Ph)
throw new Error(Xe);Ji.Ph=this;if(A1p){Ji.Ah=this.B7;if(!!this.B7)this.B7.AJ=Ji;
...
null,A8n:function(Aty){},A8m:function(Aty){},SM:function(Aty){this.AmC();},Mp:function(
){if(!!this.Ph&&(this.Ph.FQ===this))this.Ph.By6();},AmC:function(){if(!!this.Ph)
this.Ph.BhS(this);},ARj:function(){return!!this.Ph&&(this.Ph.FQ===this);},_Init:
...
null,SM:function(Aty){this.Aus.As=this.As;A.we(this.Aus,0);A.pe([this,this.BAR],
...
};C.Timer={MC:null,timer:null,Bs:0,Period:1000,VI:0,Bw:false,Lc:function(){var tmp=
...
this.Period=E;if(this.Bw)this.AKU(this.VI,E);},WG:function(E){if(E<0)E=0;if(E===
this.VI)return;this.VI=E;if(this.Bw)this.AKU(E,this.Period);},Ar:function(E){if(
E===this.Bw)return;this.Bw=E;if(E)this.AKU(this.VI,this.Period);else this.AKU(0,
...
,AjU:0,GL:0,Hk:0,Year:0,BdE:function(AfL,A0S){if(A0S)switch(AfL){case 1:return A.
aci.Bj5;case 2:return A.aci.BiX;case 3:return A.aci.Bkl;case 4:return A.aci.Bhw;
case 5:return A.aci.Bkp;case 6:return A.aci.Bj8;case 7:return A.aci.Bj7;case 8:return A.
aci.Bhy;case 9:return A.aci.Bo9;case 10:return A.aci.BkJ;case 11:return A.aci.BkI;
case 12:return A.aci.Bif;default:return A.jV;}else switch(AfL){case 1:return A.aci.
...
case 12:return A.aci.ACA;default:return A.jV;}},BdC:function(Bb_,A0S){if(A0S)switch(
Bb_){case 1:return A.aci.Bku;case 2:return A.aci.Bqr;case 3:return A.aci.Bq9;case
4:return A.aci.Bqc;case 5:return A.aci.Bi_;case 6:return A.aci.Bo0;case 0:return A.
aci.Bp1;default:return A.jV;}else switch(Bb_){case 1:return A.aci.Bkt;case 2:return A.
aci.Bqq;case 3:return A.aci.Bq8;case 4:return A.aci.Bqb;case 5:return A.aci.Bi9;
case 6:return A.aci.BoZ;case 0:return A.aci.Bp0;default:return A.jV;}},BdB:function(
...
K4<=2)?1:0);var AzJ=(((Dh>=0)?Dh:Dh-399)/400)|0;var Amq=Dh-(AzJ*400);var Vf=(((((
153*(K4+((K4>2)?-3:9)))+2)/5)|0)+d)-1;var Ao8=(((Amq*365)+((Amq/4)|0))-((Amq/100
)|0))+Vf;var Qm=((AzJ*146097)+Ao8)-719468;return(((Qm*86400)+(this.AjU*3600))+(this.
Av5*60))+this.AUH;},AFT:function(E){var B;E+=62162035200;if(E<0)E=0;var Vt=Math.
trunc(E/86400)|0;var AzJ=(((Vt>=0)?Vt:Vt-146096)/146097)|0;var Ao8=Vt-(AzJ*146097
);var Amq=((((Ao8-((Ao8/1460)|0))+((Ao8/36524)|0))-((Ao8/146096)|0))/365)|0;var Dh=
Amq+(AzJ*400);var Vf=Ao8-(((365*Amq)+((Amq/4)|0))-((Amq/100)|0));var A21=(((5*Vf
)+2)/153)|0;var d=(Vf-((((153*A21)+2)/5)|0))+1;var K4=A21+((A21<10)?3:-9);var BI=
Math.trunc(E/3600)%24|0;var O=Math.trunc(E/60)%60|0;var s=E%60|0;this.Year=Dh+((
K4<=2)?1:0);this.Ut(K4);this.Lq(d);this.AnB(BI+((BI<0)?24:0));this.AnE(O+((O<0)?
...
},BlX:function(){var B;var Vf=this.AbY()-1;var AtP=(6+this.Awf())%7;var Ao_=((371+
AtP)-Vf)%7;if(this.Hk===12){var d=this.GL;if((d===31)&&(AtP<3))return 0;if((d===
30)&&(AtP<2))return 0;if((d===29)&&(AtP<1))return 0;}if(Ao_<=3)Vf+=Ao_;else Vf-=(
7-Ao_);if(Vf<0){var d=this.GL;var K4=this.Hk;this.Year--;this.Lq(31);this.Ut(12);
Vf=this.AbY()-1;AtP=(6+this.Awf())%7;Ao_=((371+AtP)-Vf)%7;if(Ao_<=3)Vf+=Ao_;else
Vf-=Ao_;this.Year++;this.Lq(d);this.Ut(K4);}return(Vf/7)|0;},AbY:function(){var B;
...
E){if(E<1)E=1;if(E>31)E=31;this.GL=E;},Ut:function(E){if(E<1)E=1;if(E>12)E=12;this.
...
A.aci.Bhg;else result=result+A.aci.Bol;break;case 0x53:result=result+A.abl(this.
...
10);break;case 0x61:result=result+this.BdC(this.Awf(),true);break;case 0x41:result=
result+this.BdC(this.Awf(),false);break;case 0x62:result=result+this.BdE(this.Hk
,true);break;case 0x42:result=result+this.BdE(this.Hk,false);break;default:;}inx=
...
Ut(AfL);this.Lq(Bxn);this.AnB(BxE);this.AnE(BxV);this.AnH(Byb);return this;},Initialize:
function(Ah$){this.AFT(Ah$);return this;},Bik:function(Ah$){if(!Ah$)return A._NewObject(
...
0,_observers:null,_className:"Core::Time"};C.An5={AGC:0,AEl:0,ADz:0,Km:0,JS:function(
...
,Initialize2:function(Bxo,BxF,BxW,Bye){this.Km=Bxo;this.ADz=BxF;this.AEl=BxW;this.
AGC=Bye;return this;},Initialize:function(Ah$){this.AFT(Ah$);return this;},_Init:
...
};C.A$S={As:null,Ph:null,Trigger:function(AoD,A1p){var Pm=A._NewObject(C.AVc,0);
Pm.Aus=this;Pm.As=AoD;this.Ph.A$t(Pm,A1p);},_Init:function(aArg){this.__proto__=
C.A$S;this.Ph=A._GetAutoObject(C.AxN);A.h7++;},_Done:function(){this.__proto__=null;
...
I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null,_cycle:0,_observers:null,_className:
"Core::SystemEvent"};C.A$T={JM:null,Event:null,ASu:null,At7:function(G){var B;if(
...
Event,0);},_Init:function(aArg){this.__proto__=C.A$T;A.h7++;},_Done:function(){this.
__proto__=null;A.h7--;},_ReInit:function(){},_Mark:function(D){var B;if((B=this.
