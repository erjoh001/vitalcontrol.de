...
P5=[125,0,240,60];var JZ=[0,0];var N_=[100,0];var P6=[100,60];var MG=[0,60];var S6=[
...
var AxU=[3,11,253,51];var AxV=[50,0];var O3=[50,60];var Rk=[100,10,370,50];var AxW=
"276000901234567";var UU=[3,10,57,50];var AsO=[3,11,55,50];var AxX="Unhandled temperature unit";
var AxY=[110,0,260,60];var AxZ=[235,10,370,50];var Aob="39.5";var Afz=[0,0,270,40
...
135,0];var Aog=[100,0,370,60];var AsS="Error: Nullpointer Exception";var Ax0="Unknown Date Piecker Unit Index: ";
var Ax1="0";var Ax2="Unhandled scan type:";
...
null}};C.AVl={Ad_:null,AX:null,AR:null,Background:null,H9:null,AD:null,IP:null,Dl:
...
G){if(!!this.AX){this.AD.Jw(this.AX.B$());this.AD.AbA(0,this.AD.AY-1);}else this.
AD.Jw(0);if(this.A7K!==this.AD.AY){this.AD.ABy(null,null);this.A7K=this.AD.AY;}A.
pe([this,this.Fj],this);},Akn:function(G){var B;this.H(A.abI(this.M,(B=this.AD.AOI(
))[3]-B[1]));},Akm:function(G){this.H(A.abI(this.M,180));},A84:function(G){var Jz=(
A.Core.BK.isPrototypeOf(G)?G:null);var Gf=this.AD.Gs;if(Jz.CO===4)Gf=Gf-1;else if(
Jz.CO===5)Gf=Gf+1;else if((Jz.DQ>=0x30)&&(Jz.DQ<=0x39))A._GetAutoObject(A.aco.AgI
).Ey(Jz.DQ);else if(Jz.CO===45)A._GetAutoObject(A.aco.AgI).Delete();else Jz.NH=true;
...
0);A.Core.BK._Init.call(this.Dl={I:this},0);this.__proto__=C.AVl;this.H(Cc);this.
...
this,this.Hk];this.AD.AwV(this.H9);this.AR=[this,this.Byh];this.Dl.BL=[this,this.
A84];this.Dl.D1=[this,this.A84];},_Done:function(){this.__proto__=A.acn.Menu;this.
...
,_className:"Demonstrator::SelectionArea"};C.AMk={ABe:0,J$:0,Background:null,V:null
...
);this.Mh.Z(false);}if(!this.KD&&Fu)A._GetAutoObject(A.aco.Ht).A90(this.ABe);this.
Mh.Bmy(this.J$>0);this.Mh.Bm1(this.ABe>0);this.V.R(this.Mf.toFixed());this.LF=Hd;
this.KD=Fu;},Ce:function(Ad){if(!this.AX){this.XK.Aw(A.aaL(A.ach.Aet));this.AdR.
L(A.jb.Afp);return;}this.Hq=Ad;if(!!this.AX){this.J$=this.AX.KM(Ad,26);this.ABe=
...
break;case 1:this.XK.Aw(A.aaL(A.ach.Avu));break;case 2:this.XK.Aw(A.aaL(A.ach.Avx
...
AdR.H(Ir);this.AdR.L(A.jb.E2);this.XK.H(Ir);this.AdS.H(Ir);this.AdS.L(A.jb.Text);
...
aaL(A.fl.Bi));this.Aji.Aw(A.aaL(C.AHa));this.AdR.Aw(A.aaL(C.AVC));this.XK.Aw(A.aaL(
...
,N7:null,ZD:null,Acs:null,AvT:false,AxG:false,CP:function(){this.Am();},Ai:function(
...
AxG){this.Nj.R(A.aaR(A.acf.BnZ));if(this.AvT){this.Ut.Aw(A.aaL(C.AxH));this.WD.Aw(
A.aaL(C.AxH));}else{this.Ut.Aw(A.aaL(C.Asm));this.WD.Aw(A.aaL(C.Asm));}}else if(
this.AvT){this.Ut.Aw(A.aaL(C.ACt));this.WD.Aw(A.aaL(C.ACt));this.Nj.R(P3);}var A3H=
this.AxG||this.AvT;this.Ut.Z(A3H);this.WD.Z(A3H);this.Nj.Z(A3H);this.ZD.Ar(this.
AxG);},Bm1:function(E){if(this.AxG===E)return;this.AxG=E;this.Am();},Bmy:function(
E){if(this.AvT===E)return;this.AvT=E;this.Am();},_Init:function(aArg){A.Core.P._Init.
...
);this.ZD.AZ(0x3);this.ZD.JR(JZ);this.ZD.Kr(N_);this.ZD.DC(P6);this.ZD.DM(MG);this.
Acs.AZ(0x3);this.Acs.JR(S6);this.Acs.Kr(UN);this.Acs.DC(Z0);this.Acs.DM(WY);this.
...
CP();},_className:"Demonstrator::FilterView"};C.Aa$={Dj:null,Yd:null,Sa:null,Ye:
null,DT:null,Yy:null,Amz:null,Au:null,O9:null,M3:null,Aa_:null,FY:0,AvE:0,AFZ:false
,Ai:function(Ae){A.Core.P.Ai.call(this,Ae);this.Sa.R(this.Au.Format(Is));if(this.
AFZ){this.Sa.Z(false);this.Yy.Z(false);this.DT.Z(false);this.Ye.Z(false);this.O9.
...
this.M3.M,this.Sa.M[2]));}},Bz_:function(G){this.BmF(!this.AFZ);},Adu:function(G
){var F;if(!!this.Dj)this.Ug((F=this.Dj,F[1].call(F[0])));},Ab2:function(E){if(A.
...
Am();},AiB:function(G){var B;var F;var BO=this.FY;var Ai7=this.Aa_.C7(this.AvE);
this.AJd(Ai7);if(this.Au.Year>2100)this.Au.Initialize2(2100,12,31,0,0,0);this.Ug(((
B=(this.Au.JO()|0))<0)?B+0x100000000:B);if(this.FY!==BO){if(!!this.Dj)(F=this.Dj
,F[2].call(F[0],this.FY));A.abo(this.Dj,0);}},Ain:function(G){var B;var F;var BO=
this.FY;var Ai7=this.Aa_.C7(this.AvE);this.AK2(Ai7);if(this.Au.Year<2000)this.Au.
Initialize2(2000,1,1,0,0,0);this.Ug(((B=(this.Au.JO()|0))<0)?B+0x100000000:B);if(
this.FY!==BO){if(!!this.Dj)(F=this.Dj,F[2].call(F[0],this.FY));A.abo(this.Dj,0);
}},Bmb:function(E){if(this.AvE===E)return;this.AvE=E;},BmF:function(E){if(this.AFZ===
E)return;this.AFZ=E;this.Am();},BAI:function(G){var B;var F;var BO=this.FY;this.
Au.Lo(this.O9.AEo());this.Au.Uk(this.O9.AEt());this.Au.Year=this.O9.Aru();this.Ug(((
B=(this.Au.JO()|0))<0)?B+0x100000000:B);if(this.FY!==BO){if(!!this.Dj)(F=this.Dj
,F[2].call(F[0],this.FY));A.abo(this.Dj,0);}},BBc:function(G){this.O9.Lo(this.Au.
GK);this.O9.Uk(this.Au.Hi);this.O9.AkA(this.Au.Year);},AJd:function(AyT){var B;switch(
AyT){case 0:if(this.Au.GK<this.Au.Zi())this.Au.Lo(this.Au.GK+1);else{this.Au.Lo(
...
this.Au.Hi<12)this.Au.Uk(this.Au.Hi+1);else{this.Au.Uk(1);this.AJd(3);}break;case
3:this.Au.Year++;break;default:throw new Error(UO+AyT.toFixed());}},AK2:function(
AyT){var B;switch(AyT){case 0:if(this.Au.GK>1)this.Au.Lo(this.Au.GK-1);else{this.
...
case 3:this.Au.Year--;break;default:throw new Error(UO+AyT.toFixed());}},Bkl:function(
){return this.AvE;},_Init:function(aArg){A.Core.P._Init.call(this,aArg);A.acg.Text.
_Init.call(this.Yd={I:this},0);A.acg.Text._Init.call(this.Sa={I:this},0);C.Avs._Init.
call(this.Ye={I:this},0);A.acq.DT._Init.call(this.DT={I:this},0);C.Avs._Init.call(
this.Yy={I:this},0);A.acg.Ap._Init.call(this.Amz={I:this},0);A.Core.Bs._Init.call(
this.Au={I:this},0);C.ANy._Init.call(this.O9={I:this},0);C.Avs._Init.call(this.M3={
...
aaL(A.fl.Ak));this.DT.Awz(A.aaL(A.fl.Ak));this.Yy.AR=[this,this.AiB];this.Yy.DB(
...
DT.ArG(A.aaL(A.fl.Ak));this.DT.Awz(A.aaL(A.fl.Ak));},_Mark:function(D){var B;A.Core.
...
};C.Avs={C8:null,Axe:null,ANO:null,AR:null,Bo:null,Dl:null,CR:null,Hv:null,Yr:null
...
Hv.Aw(this.Axe);this.Hv.Cu(this.ATO);}else{this.Hv.Aw(this.C8);this.Hv.Cu(this.TM
);}this.Hv.L(this.AQ);this.LF=Hd;this.KD=Fu;this.Qp=GE;},Qo:function(G){this.Am(
);A.pe(this.AR,this);},AiL:function(G){if(this.CR.Down)return;if(this.Dl.Acc)return;
this.Am();if(this.Bo.Bw){A.pe(this.AR,this);this.Bo.Ar(false);}this.Bo.Ar(true);
},Beh:function(G){this.Am();},AAw:function(G){if(!this.CR.YB)return;if(this.CR.NF
...
){if(this.C8===E)return;this.C8=E;this.Am();},AS_:function(E){if(this.Axe===E)return;
this.Axe=E;this.Am();},A2U:function(G){if(!this.CR.YB)return;if(this.CR.NF)return;
...
,aArg);A.Core.Timer._Init.call(this.Bo={I:this},0);A.Core.BK._Init.call(this.Dl={
I:this},0);A.Core.Bn._Init.call(this.CR={I:this},0);A.acg.Ap._Init.call(this.Hv={
I:this},0);A.Core.Timer._Init.call(this.Yr={I:this},0);this.__proto__=C.Avs;this.
H(O2);this.Bo.PP(0);this.Bo.Ww(50);this.Dl.Filter=149;this.CR.AZ(0x3F);this.CR.JR(
Rj);this.CR.Kr(W2);this.CR.DC(W3);this.CR.DM(JZ);this.CR.Afb=0xF;this.CR.AFh(100
);this.Hv.AZ(0x3F);this.Hv.H(O2);this.Hv.A5(0x12);this.Yr.PP(0);this.J(this.CR,0
);this.J(this.Hv,0);this.Bo.Mz=[this,this.Qo];this.Dl.BL=[this,this.AiL];this.CR.
AEz=[this,this.Beh];this.CR.AvY=[this,this.Beh];this.CR.D1=[this,this.A2U];this.
CR.Lm=[this,this.AAw];this.CR.BL=[this,this.AAv];this.Hv.Aw(A.aaL(A.aci.TH));this.
C8=A.aaL(A.aci.TH);this.Axe=A.aaL(A.aci.TH);this.ANO=A.aaL(A.aci.TH);this.Yr.Mz=[
this,this.BzD];},_Done:function(){this.__proto__=A.acn.Ahu;this.Bo._Done();this.
Dl._Done();this.CR._Done();this.Hv._Done();this.Yr._Done();A.acn.Ahu._Done.call(
this);},_ReInit:function(){A.acn.Ahu._ReInit.call(this);this.Bo._ReInit();this.Dl.
...
D);if((B=this.Axe)&&(B._cycle!=D))B._Mark(B._cycle=D);if((B=this.ANO)&&(B._cycle
...
};C.Aup={Pv:null,V:null,AeN:null,AeL:null,Bn:null,DK:W6,Ahh:false,Ai:function(Ae
...
I:this},0);this.__proto__=C.Aup;this.H(Cc);this.Pv.AZ(0x1D);this.Pv.H(Cc);this.Pv.
...
Bn.JR(JZ);this.Bn.Kr(UQ);this.Bn.DC(UR);this.Bn.DM(MG);this.J(this.Pv,0);this.J(
...
__proto__=C.Ba;this.H(Cc);this.CR.AZ(0x3F);this.CR.JR(MG);this.CR.Kr(UR);this.CR.
DC(UQ);this.CR.DM(JZ);this.CR.Afb=0xF;this.CR.AFh(100);this.J(this.CR,0);this.CR.
...
Aa1.L(A.jb.Text);else this.Aa1.L(A.jb.Bc);this.LF=Hd;this.KD=Fu;this.BBm=Bdh;},AAr:
...
this.AJ8(this.AEt(),this.Aru());if(E<1)E=1;if(E>U9)E=U9;this.KP.Gb(((E-2)-1)*-this.
...
WQ.Zh=[this,this.AAr];this.WQ.SG=[this,this.A3d];this.WO.Zh=[this,this.AAr];this.
WO.SG=[this,this.A3d];this.WN.Zh=[this,this.AAr];this.WN.SG=[this,this.A3d];this.
Na.Hk=[this,this.Bk1];this.Na.AwV(this.WQ);this.M$.Hk=[this,this.Bk0];this.M$.AwV(
this.WO);this.KP.Hk=[this,this.BkY];this.KP.AwV(this.WN);},_Done:function(){this.
...
E6);this.Y.JP(1);this.Vr.H(Afx);this.Vr.Aj(true);this.Vr.ArP(true);this.Tw.AZ(0x3
...
_Init:function(aArg){C.Aup._Init.call(this,aArg);this.__proto__=C.Vr;this.T(A.aaR(
A.acf.A5y));},_ReInit:function(){C.Aup._ReInit.call(this);this.T(A.aaR(A.acf.A5y
...
A.aco.Ht),B.AEv,B.AFu],0);A.pe([this,this.BeA],this);},Akn:function(G){this.ArP(
...
_GetAutoObject(A.aco.Ht).Ahz===2;A._GetAutoObject(A.Device.Helper).JW(this.ZC,BA5
...
H(Lu);this.Y.JP(1);this.Acr.H(AhS);this.Acr.Aj(true);this.Acg.H(An7);this.Acg.Aj(
...
Ag5.Cu(0);this.Bn.JR(JZ);this.Bn.Kr(N_);this.Bn.DC(P6);this.Bn.DM(MG);this.C4.DC(
...
C.Acg={AGl:null,DT:null,Yu:null,BU:null,M7:null,AhA:null,ANs:0,Init:function(aArg
){var B;A.zX([this,this.BeK],[B=A._GetAutoObject(A.aco.Ht),B.AEv,B.AFu],0);A.pe([
...
));}},BeK:function(G){var AJa=null;var AKm=0;switch(A._GetAutoObject(A.aco.Ht).Ahz
){case 2:{AJa=A.aaL(A.ach.Avp);AKm=276;}break;case 0:{AJa=A.aaL(A.ach.AjR);AKm=900;
}break;case 1:{AJa=A.aaL(C.AxH);AKm=276;}break;default:A.ab5("%s%e",AsN,A._GetAutoObject(
A.aco.Ht).Ahz);}this.Yu.R(((AKm*1000000000000)+(A.abY(this.Yu.String,0,10)%1000000000000
)).toFixed());this.Yv.Aw(AJa);},Blo:function(E){var F;if(this.ANs===E)return;this.
ANs=E;if(!!this.AGl)(F=this.AGl,F[2].call(F[0],E));},Bj9:function(){return this.
...
0);this.__proto__=C.Acg;var B;this.DT.H(AxU);this.DT.ArO(120);this.DT.GN=30;this.
...
this.DT.A9i(A.jb.Re);this.Bn.JR(AxV);this.Bn.DM(O3);this.Yu.H(Rk);this.Yu.R(AxW);
...
Blo]);this.DT.A9s(this.AhA);this.DT.ArG(A.aaL(A.fl.Bi));this.DT.Awz(A.aaL(A.fl.Bi
...
));this.DT.Awz(A.aaL(A.fl.Bi));},_Mark:function(D){var B;C.Jo._Mark.call(this,D);
...
A._GetAutoObject(A.aco.Ht),B.ASs,B.ATd],0);A.zX([this,this.AAz],[B=A._GetAutoObject(
A.Device.Device),B.Arr,B.Ata],0);A.pe([this,this.AAz],this);},Ai:function(Ae){C.
Jo.Ai.call(this,Ae);this.OS.Z(!A._GetAutoObject(A.aco.Ht).Axf);},Af6:function(G){
var B;A._GetAutoObject(A.aco.Ht).Bek(this);},AAz:function(G){if(A._GetAutoObject(
...
);break;case 1:{var Aue=A._GetAutoObject(A.Device.Converter).AUT(A._GetAutoObject(
A.aco.Ht).WK/100,0,A._GetAutoObject(A.Device.Device).TemperatureUnit);this.OS.R(
A.abk(Aue,0,1));}break;default:A.ab5("%s%e",AxX,A._GetAutoObject(A.Device.Device
...
},0);C.OS._Init.call(this.OS={I:this},0);this.__proto__=C.Acr;var B;this.UE.H(AxY
);this.UE.A9H(A.aaR(A.acf.A4O));this.OS.H(AxZ);this.OS.R(Aob);this.OS.L(A.jb.Text
...
A.aco.Ht),B.ASs,B.ATd]);this.UE.OnSetAppearance(A._GetAutoObject(A.acx.AuK));this.
...
abK(this.Hn.M,aSize));this.BU.Axm(1);this.BU.Js(0,40);this.BU.Fk(0,aSize[0]-20,20
...
s);},At:function(E){if(A.aaZ(this.Q,E))return;if(!!this.Q)A.z$([this,this.Kc],this.
Q,0);this.Q=E;if(!!E)A.zX([this,this.Kc],E,0);if(!!E)A.pe([this,this.Kc],this);}
,Kc:function(G){this.Am();},Bk3:function(G){var B;if(((this.U&0x80)===0x80))this.
Il().ACw(this);},Bes:function(G){},_Init:function(aArg){A.Core.P._Init.call(this
...
JR(JZ);this.Bn.Kr(Aoc);this.Bn.DC(IT);this.Bn.DM(Rj);this.AgF.Fp(530);this.AgF.Ui(
...
A.aco.AgI),B.A8E,B.AFw]);},_Done:function(){this.__proto__=A.Core.P;this.Background.
...
,D6:0,AQ:0xFFB3B3B3,AvO:15,ANA:false,Lz:false,Bl:function(aSize){this.Hn.H(A.abK(
this.Hn.M,aSize));this.BU.Axm(1);this.BU.Js(0,40);this.BU.Fk(0,aSize[0]-20,20,12.5
...
this.Text.AGH(this.D6);var pos=this.Text.Afc(A3B);this.CW.DM(A.abe(pos,[0,this.B6.
Ascent]));this.CW.DC(A.abf(pos,[0,this.B6.Descent]));if(this.IU.Bw){this.IU.Ar(false
);this.IU.Ar(true);}if(this.Lz){A.pe([this,this.A39],this);this.Lz=false;}},AAv:
...
this.Di,this);},Beg:function(G){if(this.String.length>=this.AvO)return;var Byj=this.
KK.DQ;var Auc=String.fromCharCode(Byj);this.R(A.abU(this.String,Auc,this.D6));this.
D6=this.D6+Auc.length;this.Lz=true;A.pe(this.Di,this);},R:function(E){if(this.String===
E)return;this.String=E;if(this.D6>(E.length+1))this.D6=E.length;this.Text.R(E+String.
fromCharCode(0x0A));this.Lz=true;this.Text.Gb(JZ);},L:function(E){if(this.AQ===E
)return;this.AQ=E;this.Text.L(E);this.CW.L(E);this.Hn.L(E);},S:function(E){if(this.
B6===E)return;this.B6=E;this.Text.S(E);this.Lz=true;this.Text.Gb(JZ);},Bet:function(
G){if(this.ANA===false)return;if(this.String.indexOf(String.fromCharCode(0x2E),0
)>=0)return;if(this.String.length>=this.AvO)return;this.R(A.abU(this.String,S8,this.
...
));}this.Lz=true;this.Text.Gb(JZ);},Bmv:function(E){if(this.AvO===E)return;this.
AvO=E;this.R(A.abV(this.String,E));this.Lz=true;this.Text.Gb(JZ);},Bz7:function(
G){if(this.A6z(0x80)){this.Il().ACw(this);this.Cr(0x10,0x0);}this.Am();},BzV:function(
...
Amw.Filter=45;this.Sc.Filter=44;this.KK.Filter=143;this.Bn.AZ(0x3F);this.Bn.JR(Rj
);this.Bn.Kr(IT);this.Bn.DC(Aoc);this.Bn.DM(JZ);this.Bn.AFh(3);this.Text.AZ(0x3F
...
this,this.AAp];this.Amw.BL=[this,this.Beb];this.Amw.D1=[this,this.Beb];this.Sc.BL=[
this,this.AAq];this.Sc.D1=[this,this.AAq];this.KK.BL=[this,this.Beg];this.KK.D1=[
this,this.Beg];this.Bn.BL=[this,this.AAv];this.Text.Q3([this,this.Ame]);this.Text.
...
1,FrameSize:[50,60],FrameDelay:0,_this:null}};C.Aa_={TimespanDaysToString:null,Avh:
...
3:Ai7=3;break;default:throw new Error(Ax0+aIndex.toFixed());}return Ai7;},_Init:
...
BFg={GK:0,AVr:1,Hi:2,Year:3};C.ACt={_class:function(){return A.aci.Al;},0:{FileName:
"./res_index/DemonstratorEarTagIcon.png",Format:A._PIXEL_FORMAT_ALPHA8,NoOfFrames:
2,FrameSize:[37,37],FrameDelay:0,_this:null}};C.AxH={_class:function(){return A.
...
Af6:function(G){var B;var J4=this.Aeb.String;var O;O=J4.indexOf(String.fromCharCode(
0x2E),0);while(O>=0){J4=A.ab1(J4,O,1);O=J4.indexOf(String.fromCharCode(0x2E),O);
}J4=J4+Ax1;J4=J4+A._GetAutoObject(A.acj.VA).ACQ(J4).toFixed();var A1j=A._GetAutoObject(
A.Device.AnE).Be1(J4);A._GetAutoObject(A.aco.Ht).BBk(((B=(A1j|0))<0)?B+0x100000000:
...
10);this.J(this.Aeb,-1);this.Yv.Aw(A.aaL(A.ach.Avp));this.Init(aArg);},_Done:function(
...
};C.Ahz={BFu:0,BFq:1,VA:2,LAST:3};C.AhA={AhB:null,Avh:function(aIndex){if(this.AqO(
...
);break;default:throw new Error(Ax2+Bct.toFixed());}return AKS;},_Init:function(
...
String.fromCharCode(0x2E),O);}if(Bfb>=2)return;if(this.String.length>=this.AvO)return;
...
C.Ba;C.Mh.__proto__=A.Core.P;C.Yk.__proto__=C.Aq7;C.Aa$.__proto__=A.Core.P;C.Avs.
__proto__=A.acn.Ahu;C.AMy.__proto__=C.FB;C.Aup.__proto__=C.FB;C.Ba.__proto__=A.Core.
P;C.FB.__proto__=A.Core.P;C.ANy.__proto__=A.acn.Ahs;C.AhE.__proto__=A.Core.P;C.AMr.
__proto__=C.AhE;C.Vr.__proto__=C.Aup;C.ALV.__proto__=A.Core.P;C.Jo.__proto__=A.Core.
...
B._cycle!=D))B._Done(C.AUK[0]._this=null);if((B=C.ACt[0]._this)&&(B._cycle!=D))B.
_Done(C.ACt[0]._this=null);if((B=C.AxH[0]._this)&&(B._cycle!=D))B._Done(C.AxH[0].
_this=null);};return C;})();
