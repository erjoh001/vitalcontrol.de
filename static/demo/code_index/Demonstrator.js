...
var IS=[58,10,120,50];var Ir=[0,0,60,60];var O1=[120,0,360,60];var P4="\u2015";var
P5=[0,0,240,60];var CQ=[0,0,40,60];var Fe=[100,0,130,60];var L1=[43,0,100,60];var
P6=[125,0,240,60];var J0=[0,0];var N_=[100,0];var P7=[100,60];var MG=[0,60];var S6=[
107,0];var UN=[240,0];var ZZ=[240,60];var WZ=[107,60];var Is="%d.%m.%Y";var UO="Unhandled date unit: ";
var Z0=[0,0,200,180];var W0=[36,0,200,30];var Z1=[0,30,160,60];var W1="Text";var
Z2=[0,70,40,110];var Z3=[44,70,156,110];var UP=[160,70,200,110];var W2=[7,2,27,25
];var P8=[0,30,170,180];var Z4=[170,34,190,57];var O2=[0,0,40,40];var Ri=[0,40];
var W3=[40,40];var W4=[40,0];var W5=[0,0,370,100];var W6=[20,0,290,60];var Z5=[0
,60,370,100];var W7="Cap";var W8=[20,0,370,60];var S7=[310,0,370,60];var UQ=[370
,0];var UR=[370,60];var AcH="UpdateData is called for the base class ListItemBase. Please make "+
"sure this method is implemented by a derived class.";var S8=".";var Z6=[0,0,170
,150];var Afw=[0,59,170,90];var Z7=[110,0,170,150];var W9=[0,30];var Z8=[50,0,100
,150];var Z9=[0,0,40,150];var Afx=[0,0,370,240];var KX=[0,60,370,710];var AcI=[0
,0,370,300];var Lu=[0,60,370,300];var AhS=[0,60,370,120];var An7=[0,120,370,180];
var N$=[0,180,370,240];var W_=[0,240,370,300];var An8=[370,120];var US=[0,120];var
...
var AxV=[3,11,253,51];var AxW=[50,0];var O3=[50,60];var Rj=[100,10,370,50];var AxX=
...
];var Aoc=[270,0];var IT=[270,40];var Aod=[150,0,170,40];var W$=[205,10,207,30];
...
,Format:A._PIXEL_FORMAT_NATIVE,NoOfFrames:1,FrameSize:[40,40],FrameDelay:0,_this:
null}};C.APX={_class:function(){return A.aci.Al;},0:{FileName:"./res_index/DemonstratorIconDatePicker.png"
...
null}};C.AUO={_class:function(){return A.aci.Al;},0:{FileName:"./res_index/DemonstratorTemperatureIcon.png"
,Format:A._PIXEL_FORMAT_NATIVE,NoOfFrames:1,FrameSize:[17,37],FrameDelay:0,_this:
null}};C.AVk={Ad_:null,AX:null,AR:null,Background:null,H9:null,AD:null,IP:null,Dm:
null,Lh:null,A7h:null,A7J:0,Bl:function(aSize){A.acn.Menu.Bl.call(this,aSize);this.
...
);if(IA&&(this.AD.Gr<0))this.AD.GS(0);},NZ:function(E){if(this.Lh===E)return;this.
Lh=E;this.AD.NZ(E);},Bmv:function(E){var B;if(this.A7h===E)return;if(!!this.Ad_){
this.HN(this.Ad_);this.Ad_=null;}if(!!E){this.Ad_=(C.FB.isPrototypeOf(B=A._NewObject(
E,0))?B:null);this.Ad_.A9L([this,this.Akm]);this.Ad_.A9M([this,this.Akn]);this.Ad_.
BmB(null);this.J(this.Ad_,0);this.AD.A9S((B=this.Ad_.M)[3]-B[1]);}else this.AD.A9S(
0);this.IP.H(A.abP(this.IP.M,this.AD.OP));A.pe([this,this.Fj],this);this.A7h=E;}
,Hk:function(G){var B;var Ge=this.AD.G4;var Aa=(C.Ba.isPrototypeOf(B=this.AD.Ch)?
B:null);if(!Aa)return;Aa.Zm(this.AX);Aa.Ce(Ge);Aa.Zq(this.AR);Aa.H(A.abK(Aa.M,[(
...
AD.Jw(0);if(this.A7J!==this.AD.AY){this.AD.ABy(null,null);this.A7J=this.AD.AY;}A.
pe([this,this.Fj],this);},Akn:function(G){var B;this.H(A.abI(this.M,(B=this.AD.AOH(
))[3]-B[1]));},Akm:function(G){this.H(A.abI(this.M,180));},A83:function(G){var JA=(
A.Core.BK.isPrototypeOf(G)?G:null);var Ge=this.AD.Gr;if(JA.CO===4)Ge=Ge-1;else if(
JA.CO===5)Ge=Ge+1;else if((JA.DQ>=0x30)&&(JA.DQ<=0x39))A._GetAutoObject(A.aco.AgI
).Ey(JA.DQ);else if(JA.CO===45)A._GetAutoObject(A.aco.AgI).Delete();else JA.NH=true;
if((Ge<0)||(Ge>=this.AD.AY))return;this.AD.GS(Ge);this.Bys(Ge,true);},Byh:function(
...
AD.M;Bd=A.abP(Bd,(B=this.AD.AOH())[3]-B[1]);Bd=A.abI(Bd,(((B=this.AD.M)[3]-B[1])-((
B=this.AD.AOH())[3]-B[1]))-((B=this.AD.Biv())[3]-B[1]));var LM=A.lb(Az,Bd);if((!
...
AD.Ga(this.AD.Br-Bq);},An0:function(G){this.AD.GS(-1);},Fj:function(G){var B;this.
...
0);A.Core.BK._Init.call(this.Dm={I:this},0);this.__proto__=C.AVk;this.H(Cc);this.
...
A83];this.Dm.D1=[this,this.A83];},_Done:function(){this.__proto__=A.acn.Menu;this.
...
};C.AUg={GJ:null,AK:null,BT:null,Init:function(aArg){var B;A.zX([this,this.GH],[
B=A._GetAutoObject(A.aco.Ht),B.A8G,B.A92],0);A.pe([this,this.GH],this);},AbY:function(
E){if(this.GJ===E)return;if(!!this.GJ)this.HN(this.GJ);this.GJ=E;if(!!this.GJ)this.
J(this.GJ,0);this.Bb(E);this.Ahy(E,this.BT);this.Am();},GH:function(G){var B;if(
...
_Init.call(this.BT={I:this},0);this.__proto__=C.AUg;this.H(E6);this.AK.AZ(0x3F);
...
,_className:"Demonstrator::SelectionArea"};C.AMk={ABe:0,Ka:0,Background:null,V:null
...
);this.Mh.Z(false);}if(!this.KD&&Fu)A._GetAutoObject(A.aco.Ht).A9Z(this.ABe);this.
Mh.Bmx(this.Ka>0);this.Mh.Bm0(this.ABe>0);this.V.R(this.Mf.toFixed());this.LF=Hd;
this.KD=Fu;},Ce:function(Ad){if(!this.AX){this.XK.Aw(A.aaL(A.ach.Aet));this.AdR.
L(A.jb.Afp);return;}this.Hq=Ad;if(!!this.AX){this.Ka=this.AX.KM(Ad,26);this.ABe=
this.AX.KM(Ad,22);this.Mf=this.AX.CF(Ad,1);var AlG=this.AX.H2(Ad,11);var Alx=this.
AX.I4(Ad,17);var LP=this.AX.I4(Ad,13);var Ib=this.AX.AmN(Ad,14);var Xk=A._GetAutoObject(
...
A.acj.Assessment).Qm(Xk));this.Am();}},_Init:function(aArg){C.Ba._Init.call(this
...
aaL(A.fl.Bh));this.Aji.Aw(A.aaL(C.AHa));this.AdR.Aw(A.aaL(C.AVB));this.XK.Aw(A.aaL(
...
AxH){this.Nj.R(A.aaR(A.acf.BnY));if(this.AvU){this.Ut.Aw(A.aaL(C.AxI));this.WD.Aw(
A.aaL(C.AxI));}else{this.Ut.Aw(A.aaL(C.Asm));this.WD.Aw(A.aaL(C.Asm));}}else if(
this.AvU){this.Ut.Aw(A.aaL(C.ACt));this.WD.Aw(A.aaL(C.ACt));this.Nj.R(P4);}var A3G=
this.AxH||this.AvU;this.Ut.Z(A3G);this.WD.Z(A3G);this.Nj.Z(A3G);this.ZD.Ar(this.
AxH);},Bm0:function(E){if(this.AxH===E)return;this.AxH=E;this.Am();},Bmx:function(
...
B;this.H(P5);this.Ut.AZ(0x6);this.Ut.H(CQ);this.Ut.L(A.jb.CS);this.Ut.Cu(1);this.
...
this.N7.H(P6);this.N7.R(A.aaR(A.acf.Temperature));this.N7.A5(0x11);this.N7.L(0xFF000000
);this.ZD.AZ(0x3);this.ZD.JS(J0);this.ZD.Ks(N_);this.ZD.DC(P7);this.ZD.DM(MG);this.
Acs.AZ(0x3);this.Acs.JS(S6);this.Acs.Ks(UN);this.Acs.DC(ZZ);this.Acs.DM(WZ);this.
...
aaL(C.Asm));this.AkT.Aw(A.aaL(C.AUO));this.Nj.S(A.aaL(A.fl.Af));this.Nj.A2(A.aaL(
A.fl.Ak));this.Nj.Ct(A.aaL(A.fl.Bh));this.N7.S(A.aaL(A.fl.Af));this.N7.A2(A.aaL(
A.fl.Ak));this.N7.Ct(A.aaL(A.fl.Bh));this.ZD.Lm=[B=A._GetAutoObject(A.aco.Ht),B.
Bey];this.Acs.Lm=[B=A._GetAutoObject(A.aco.Ht),B.Bej];},_Done:function(){this.__proto__=
...
));this.Nj.Ct(A.aaL(A.fl.Bh));this.N7.S(A.aaL(A.fl.Af));this.N7.A2(A.aaL(A.fl.Ak
));this.N7.Ct(A.aaL(A.fl.Bh));this.CP();},_Mark:function(D){var B;A.Core.P._Mark.
...
A.aaR(A.acf.Filter));},A7Q:function(G){var D5=(A.Core.BK.isPrototypeOf(G)?G:null
);if(!!D5)A._GetAutoObject(A.aco.AgI).Ey(D5.DQ);},A7O:function(G){A._GetAutoObject(
...
CP();},_className:"Demonstrator::FilterView"};C.Aa$={Dk:null,Yd:null,R$:null,Ye:
null,DT:null,Yy:null,Amz:null,Au:null,O9:null,M3:null,Aa_:null,FX:0,AvF:0,AFZ:false
,Ai:function(Ae){A.Core.P.Ai.call(this,Ae);this.R$.R(this.Au.Format(Is));if(this.
AFZ){this.R$.Z(false);this.Yy.Z(false);this.DT.Z(false);this.Ye.Z(false);this.O9.
Ar(true);this.O9.Z(true);this.M3.Cu(2);this.M3.AS8(2);this.M3.H(A.abM(this.M3.M,
this.O9.M[2]));}else{this.R$.Z(true);this.Yy.Z(true);this.DT.Z(true);this.Ye.Z(true
);this.O9.Ar(false);this.O9.Z(false);this.M3.Cu(3);this.M3.AS8(3);this.M3.H(A.abM(
this.M3.M,this.R$.M[2]));}},Bz_:function(G){this.BmE(!this.AFZ);},Adu:function(G
){var F;if(!!this.Dk)this.Uh((F=this.Dk,F[1].call(F[0])));},Ab2:function(E){if(A.
aaZ(this.Dk,E))return;if(!!this.Dk)A.z$([this,this.Adu],this.Dk,0);this.Dk=E;if(
!!E)A.zX([this,this.Adu],E,0);if(!!E)A.pe([this,this.Adu],this);},Uh:function(E){
if(this.FX===E)return;this.FX=E;this.Au.Initialize(this.FX);this.BBc(this);this.
Am();},AiB:function(G){var B;var F;var BO=this.FX;var Ai7=this.Aa_.C7(this.AvF);
this.AJd(Ai7);if(this.Au.Year>2100)this.Au.Initialize2(2100,12,31,0,0,0);this.Uh(((
B=(this.Au.JP()|0))<0)?B+0x100000000:B);if(this.FX!==BO){if(!!this.Dk)(F=this.Dk
,F[2].call(F[0],this.FX));A.abo(this.Dk,0);}},Ain:function(G){var B;var F;var BO=
this.FX;var Ai7=this.Aa_.C7(this.AvF);this.AK2(Ai7);if(this.Au.Year<2000)this.Au.
Initialize2(2000,1,1,0,0,0);this.Uh(((B=(this.Au.JP()|0))<0)?B+0x100000000:B);if(
this.FX!==BO){if(!!this.Dk)(F=this.Dk,F[2].call(F[0],this.FX));A.abo(this.Dk,0);
}},Bma:function(E){if(this.AvF===E)return;this.AvF=E;},BmE:function(E){if(this.AFZ===
E)return;this.AFZ=E;this.Am();},BAI:function(G){var B;var F;var BO=this.FX;this.
Au.Lo(this.O9.AEo());this.Au.Ul(this.O9.AEt());this.Au.Year=this.O9.Aru();this.Uh(((
B=(this.Au.JP()|0))<0)?B+0x100000000:B);if(this.FX!==BO){if(!!this.Dk)(F=this.Dk
,F[2].call(F[0],this.FX));A.abo(this.Dk,0);}},BBc:function(G){this.O9.Lo(this.Au.
GK);this.O9.Ul(this.Au.Hi);this.O9.AkA(this.Au.Year);},AJd:function(AyU){var B;switch(
AyU){case 0:if(this.Au.GK<this.Au.Zi())this.Au.Lo(this.Au.GK+1);else{this.Au.Lo(
1);this.AJd(2);}break;case 1:if((this.Au.GK+7)<=this.Au.Zi())this.Au.Lo(this.Au.
GK+7);else{this.Au.Lo((7-this.Au.Zi())+this.Au.GK);this.AJd(2);}break;case 2:if(
this.Au.Hi<12)this.Au.Ul(this.Au.Hi+1);else{this.Au.Ul(1);this.AJd(3);}break;case
3:this.Au.Year++;break;default:throw new Error(UO+AyU.toFixed());}},AK2:function(
AyU){var B;switch(AyU){case 0:if(this.Au.GK>1)this.Au.Lo(this.Au.GK-1);else{this.
...
if(this.Au.Hi>1)this.Au.Ul(this.Au.Hi-1);else{this.Au.Ul(12);this.AK2(3);}break;
case 3:this.Au.Year--;break;default:throw new Error(UO+AyU.toFixed());}},Bkk:function(
){return this.AvF;},_Init:function(aArg){A.Core.P._Init.call(this,aArg);A.acg.Text.
_Init.call(this.Yd={I:this},0);A.acg.Text._Init.call(this.R$={I:this},0);C.Avt._Init.
...
I:this},0);C.Aa_._Init.call(this.Aa_={I:this},0);this.__proto__=C.Aa$;this.H(Z0);
this.Yd.H(W0);this.Yd.A5(0x11);this.Yd.R(A.aaR(A.acf.Date));this.Yd.L(0xFF000000
);this.R$.H(Z1);this.R$.A5(0x11);this.R$.R(W1);this.R$.L(0xFF000000);this.Ye.H(Z2
);this.Ye.A9C(200);this.DT.H(Z3);this.DT.ArO(120);this.DT.GN=30;this.DT.ASK(A.jb.
CS);this.DT.A9f(A.jb.CS);this.DT.A9j(A.jb.CS);this.DT.ASL(A.jb.Text);this.DT.A9k(
A.jb.Text);this.DT.A9g(A.jb.AV);this.DT.A9l(A.jb.Bm);this.DT.A9i(A.jb.AV);this.DT.
A9h(A.jb.Text);this.Yy.H(UP);this.Yy.A9C(200);this.Amz.H(W2);this.O9.H(P8);this.
M3.H(Z4);this.M3.Cu(3);this.M3.AS8(3);this.M3.L(A.jb.Text);this.J(this.Yd,0);this.
J(this.R$,0);this.J(this.Ye,0);this.J(this.DT,0);this.J(this.Yy,0);this.J(this.Amz
,0);this.J(this.O9,0);this.J(this.M3,0);this.Yd.S(A.aaL(A.fl.Ak));this.R$.S(A.aaL(
A.fl.EK));this.Ye.AR=[this,this.Ain];this.Ye.DB(A.aaL(C.AMU));this.Ye.AS9(A.aaL(
C.AMV));this.DT.At([this,this.Bkk,this.Bma]);this.DT.A9r(this.Aa_);this.DT.ArG(A.
aaL(A.fl.Ak));this.DT.AwA(A.aaL(A.fl.Ak));this.Yy.AR=[this,this.AiB];this.Yy.DB(
A.aaL(C.AMW));this.Yy.AS9(A.aaL(C.AMX));this.Amz.Aw(A.aaL(C.APX));this.O9.Di=[this
,this.BAI];this.M3.AR=[this,this.Bz_];this.M3.DB(A.aaL(A.ach.Ajn));this.M3.AS9(A.
aaL(A.ach.Ajn));},_Done:function(){this.__proto__=A.Core.P;this.Yd._Done();this.
R$._Done();this.Ye._Done();this.DT._Done();this.Yy._Done();this.Amz._Done();this.
Au._Done();this.O9._Done();this.M3._Done();this.Aa_._Done();A.Core.P._Done.call(
this);},_ReInit:function(){A.Core.P._ReInit.call(this);this.Yd._ReInit();this.R$.
...
Yd.R(A.aaR(A.acf.Date));this.Yd.S(A.aaL(A.fl.Ak));this.R$.S(A.aaL(A.fl.EK));this.
...
B=this.Yd)._cycle!=D)B._Mark(B._cycle=D);if((B=this.R$)._cycle!=D)B._Mark(B._cycle=
...
,APA:0,TN:0,ATN:0,AQ:0xFFFFFFFF,A1U:false,LF:false,KD:false,Qq:false,Ai:function(
...
Hv.Aw(this.Axf);this.Hv.Cu(this.ATN);}else{this.Hv.Aw(this.C8);this.Hv.Cu(this.TN
);}this.Hv.L(this.AQ);this.LF=Hd;this.KD=Fu;this.Qq=GE;},Qp:function(G){this.Am(
...
},Beg:function(G){this.Am();},AAw:function(G){if(!this.CR.YB)return;if(this.CR.NF
)return;if((this.Yr.VB<=0)||(this.CR.Jr<this.Yr.VB)){if(this.CR.Jr>=this.Bo.VB)A.
pe(this.AR,this);else this.Bo.Ar(true);}this.Yr.Ar(false);},AAv:function(G){this.
Yr.Ar(true);if(this.Bo.Bw){A.pe(this.AR,this);this.Bo.Ar(false);}},DB:function(E
){if(this.C8===E)return;this.C8=E;this.Am();},AS9:function(E){if(this.Axf===E)return;
this.Axf=E;this.Am();},A2T:function(G){if(!this.CR.YB)return;if(this.CR.NF)return;
if((this.APA>=0)&&this.A1U){this.A1U=false;this.Yr.Ar(true);A.pe(this.AR,this);}
},A9C:function(E){if(this.APA===E)return;this.APA=E;this.Yr.Ww(E);},BzD:function(
G){this.A1U=true;},Cu:function(E){if(this.TN===E)return;this.TN=E;this.Am();},AS8:
function(E){if(this.ATN===E)return;this.ATN=E;this.Am();},L:function(E){if(this.
...
H(O2);this.Bo.PQ(0);this.Bo.Ww(50);this.Dm.Filter=149;this.CR.AZ(0x3F);this.CR.JS(
Ri);this.CR.Ks(W3);this.CR.DC(W4);this.CR.DM(J0);this.CR.Afb=0xF;this.CR.AFh(100
);this.Hv.AZ(0x3F);this.Hv.H(O2);this.Hv.A5(0x12);this.Yr.PQ(0);this.J(this.CR,0
);this.J(this.Hv,0);this.Bo.Mz=[this,this.Qp];this.Dm.BL=[this,this.AiL];this.CR.
AEz=[this,this.Beg];this.CR.AvZ=[this,this.Beg];this.CR.D1=[this,this.A2T];this.
CR.Lm=[this,this.AAw];this.CR.BL=[this,this.AAv];this.Hv.Aw(A.aaL(A.aci.TI));this.
C8=A.aaL(A.aci.TI);this.Axf=A.aaL(A.aci.TI);this.ANO=A.aaL(A.aci.TI);this.Yr.Mz=[
...
"Demonstrator::IconButton"};C.AMy={Pw:null,V:null,Aem:null,_Init:function(aArg){
C.FB._Init.call(this,aArg);A.acg.AK._Init.call(this.Pw={I:this},0);A.acg.Text._Init.
call(this.V={I:this},0);C.Aem._Init.call(this.Aem={I:this},0);this.__proto__=C.AMy;
this.H(W5);this.Pw.AZ(0x1D);this.Pw.H(Cc);this.Pw.L(0xFFE6E6E6);this.V.AZ(0x1D);
this.V.H(W6);this.V.A5(0x11);this.V.R(A.aaR(A.acf.A4G));this.V.L(0xFF000000);this.
Aem.H(Z5);this.J(this.Pw,0);this.J(this.V,0);this.J(this.Aem,0);this.V.S(A.aaL(A.
fl.Af));},_Done:function(){this.__proto__=C.FB;this.Pw._Done();this.V._Done();this.
Aem._Done();C.FB._Done.call(this);},_ReInit:function(){C.FB._ReInit.call(this);this.
Pw._ReInit();this.V._ReInit();this.Aem._ReInit();this.V.R(A.aaR(A.acf.A4G));this.
V.S(A.aaL(A.fl.Af));},_Mark:function(D){var B;C.FB._Mark.call(this,D);if((B=this.
Pw)._cycle!=D)B._Mark(B._cycle=D);if((B=this.V)._cycle!=D)B._Mark(B._cycle=D);if((
B=this.Aem)._cycle!=D)B._Mark(B._cycle=D);},_className:"Demonstrator::AnimalsHeader"
};C.Auq={Pw:null,V:null,AeN:null,AeL:null,Bn:null,DK:W7,Ahh:false,Ai:function(Ae
...
);},_Init:function(aArg){C.FB._Init.call(this,aArg);A.acg.AK._Init.call(this.Pw={
...
I:this},0);this.__proto__=C.Auq;this.H(Cc);this.Pw.AZ(0x1D);this.Pw.H(Cc);this.Pw.
L(0xFFE6E6E6);this.V.AZ(0x1D);this.V.H(W8);this.V.A5(0x11);this.V.R(W7);this.V.L(
0xFF000000);this.AeN.H(S7);this.AeN.Z(false);this.AeL.AZ(0x3A);this.AeL.H(S7);this.
Bn.JS(J0);this.Bn.Ks(UQ);this.Bn.DC(UR);this.Bn.DM(MG);this.J(this.Pw,0);this.J(
...
BAu];},_Done:function(){this.__proto__=C.FB;this.Pw._Done();this.V._Done();this.
AeN._Done();this.AeL._Done();this.Bn._Done();C.FB._Done.call(this);},_ReInit:function(
){C.FB._ReInit.call(this);this.Pw._ReInit();this.V._ReInit();this.AeN._ReInit();
this.AeL._ReInit();this.Bn._ReInit();this.V.S(A.aaL(A.fl.Af));},_Mark:function(D
){var B;C.FB._Mark.call(this,D);if((B=this.Pw)._cycle!=D)B._Mark(B._cycle=D);if((
...
ab5("%s",AcH);},Zq:function(E){if(A.aa0(this.AR,E))return;this.AR=E;},AAw:function(
...
DC(UQ);this.CR.DM(J0);this.CR.Afb=0xF;this.CR.AFh(100);this.J(this.CR,0);this.CR.
Lm=[this,this.AAw];},_Done:function(){this.__proto__=A.Core.P;this.CR._Done();A.
...
};C.FB={AR3:null,Akn:null,Akm:null,BmB:function(E){if(A.aa0(this.AR3,E))return;this.
AR3=E;},A9M:function(E){if(A.aa0(this.Akn,E))return;this.Akn=E;},A9L:function(E){
...
call(this,D);if((B=this.AR3)&&((B=B[0])._cycle!=D))B._Mark(B._cycle=D);if((B=this.
...
var Fu=((Ae&0x20)===0x20);var Bdg=(this.WN.ZI||this.WO.ZI)||this.WQ.ZI;if(Bdg)this.
Aa1.L(A.jb.Text);else this.Aa1.L(A.jb.Bc);this.LF=Hd;this.KD=Fu;this.BBm=Bdg;},AAr:
function(G){this.Am();if((!this.WN.ZI&&!this.WO.ZI)&&!this.WQ.ZI){var U9=this.AJ8(
this.AEt(),this.Aru());var Ac$=this.AEo();this.KP.Jw(U9);if(Ac$>U9)this.Lo(U9);A.
pe(this.Di,this);}},A3c:function(G){this.Am();},Bk0:function(G){var B;var Ge=this.
Na.G4;var Cz=(A.acg.Text.isPrototypeOf(B=this.Na.Ch)?B:null);if(!Cz)return;Cz.R(
A.abl(Ge+1900,4,10));Cz.S(A.aaL(A.fl.Af));Cz.L(A.jb.Text);Cz.A5(0x12);Cz.H(A.abK(
Cz.M,[(B=this.Na.M)[2]-B[0],this.Na.GN]));},BkZ:function(G){var B;var Ge=this.M$.
G4;var Cz=(A.acg.Text.isPrototypeOf(B=this.M$.Ch)?B:null);if(!Cz)return;Cz.R(A.abl(
Ge+1,2,10)+S8);Cz.S(A.aaL(A.fl.Af));Cz.L(A.jb.Text);Cz.A5(0x12);Cz.H(A.abK(Cz.M,[(
B=this.M$.M)[2]-B[0],this.M$.GN]));},BkX:function(G){var B;var Ge=this.KP.G4;var
Cz=(A.acg.Text.isPrototypeOf(B=this.KP.Ch)?B:null);if(!Cz)return;Cz.R(A.abl(Ge+1
...
Na.GN)|0)+2)%200);},AkA:function(E){if(E<1900)E=1900;if(E>2100)E=2100;this.Na.Ga(((
E-1900)-2)*-this.Na.GN);var U9=this.AJ8(this.AEt(),E);this.KP.Jw(U9);if(this.AEo(
)>U9)this.Lo(U9);},AEt:function(){return 1+((((-this.M$.Br/this.M$.GN)|0)+2)%12);
},Ul:function(E){if(E<1)E=1;if(E>12)E=12;this.M$.Ga(((E-1)-2)*-this.M$.GN);var U9=
this.AJ8(E,this.Aru());this.KP.Jw(U9);if(this.AEo()>U9)this.Lo(U9);},AEo:function(
){return 1+((((-this.KP.Br/this.KP.GN)|0)+2)%this.KP.AY);},Lo:function(E){var U9=
this.AJ8(this.AEt(),this.Aru());if(E<1)E=1;if(E>U9)E=U9;this.KP.Ga(((E-2)-1)*-this.
...
);A.acg.BT._Init.call(this.Aa1={I:this},0);A.Core.H9._Init.call(this.WQ={I:this}
...
},0);A.Core.CM._Init.call(this.KP={I:this},0);this.__proto__=C.ANy;this.H(Z6);this.
Aa1.H(Afw);this.Aa1.Ng(3);this.Aa1.L(0xFFE1E1E1);this.Aa1.Z(true);this.WQ.H(Z7);
this.WQ.ATj(W9);this.WQ.ASR(0.2);this.WO.H(Z8);this.WO.ATj(W9);this.WO.ASR(0.2);
this.WN.H(Z9);this.WN.ATj(W9);this.WN.ASR(0.2);this.Na.H(Z7);this.Na.ASP(true);this.
Na.Ga(60);this.Na.Ae3(30);this.Na.Jw(200);this.M$.H(Z8);this.M$.ASP(true);this.M$.
Ga(60);this.M$.Ae3(30);this.M$.Jw(12);this.KP.H(Z9);this.KP.ASP(true);this.KP.Ga(
...
WQ.Zh=[this,this.AAr];this.WQ.SF=[this,this.A3c];this.WO.Zh=[this,this.AAr];this.
WO.SF=[this,this.A3c];this.WN.Zh=[this,this.AAr];this.WN.SF=[this,this.A3c];this.
Na.Hk=[this,this.Bk0];this.Na.AwW(this.WQ);this.M$.Hk=[this,this.BkZ];this.M$.AwW(
this.WO);this.KP.Hk=[this,this.BkX];this.KP.AwW(this.WN);},_Done:function(){this.
...
null}};C.AVB={_class:function(){return A.aci.Al;},0:{FileName:"./res_index/DemonstratorWhiteTileSmall.png"
,Format:A._PIXEL_FORMAT_ALPHA8,NoOfFrames:1,FrameSize:[40,40],FrameDelay:0,_this:
...
,Vr:null,Tx:null,BAW:function(G){var B;this.Tx.H(A.abI(this.Tx.M,((B=this.M)[3]-
...
AVk._Init.call(this.Tx={I:this},0);this.__proto__=C.AMr;this.Y.AZ(0x3F);this.Y.H(
E6);this.Y.JQ(1);this.Vr.H(Afx);this.Vr.Aj(true);this.Vr.ArP(true);this.Tx.AZ(0x3
);this.Tx.H(KX);this.Tx.Aj(true);this.Tx.NZ(C.AMk);this.Tx.Bmv(C.AMy);this.J(this.
Y,0);this.J(this.Vr,0);this.J(this.Tx,0);this.Bb(this.Tx);this.Y.El=[this,this.BAW
];this.Tx.Zm(A._GetAutoObject(A.aco.Aqa));},_Done:function(){this.__proto__=C.AhE;
this.Y._Done();this.Vr._Done();this.Tx._Done();C.AhE._Done.call(this);},_ReInit:
function(){C.AhE._ReInit.call(this);this.Y._ReInit();this.Vr._ReInit();this.Tx._ReInit(
);},_Mark:function(D){var B;C.AhE._Mark.call(this,D);if((B=this.Y)._cycle!=D)B._Mark(
B._cycle=D);if((B=this.Vr)._cycle!=D)B._Mark(B._cycle=D);if((B=this.Tx)._cycle!=
...
A.acf.A5x));},_ReInit:function(){C.Auq._ReInit.call(this);this.T(A.aaR(A.acf.A5x
...
null,Ahh:false,Init:function(aArg){var B;A.zX([this,this.Bez],[B=A._GetAutoObject(
A.aco.Ht),B.AEv,B.AFu],0);A.pe([this,this.Bez],this);},Akn:function(G){this.ArP(
true);},Akm:function(G){this.ArP(false);},ArP:function(E){if(this.Ahh===E)return;
this.Ahh=E;this.XJ.ArP(E);A.pe([this,this.BeK],this);},Bez:function(G){var BA5=A.
_GetAutoObject(A.aco.Ht).Ahz===2;A._GetAutoObject(A.Device.Helper).JX(this.ZC,BA5
);},BeK:function(G){var B;if(this.Ahh)this.H(A.abI(this.M,(B=this.XJ.M)[3]-B[1])
...
true);this.ZC.H(N$);this.ZC.Aj(true);this.Acq.H(W_);this.Acq.Aj(true);this.Aj7.DC(
...
XJ.A9M([this,this.Akn]);this.XJ.A9L([this,this.Akm]);this.Y.El=[this,this.BeK];this.
...
Yv:null,Ag5:null,Bn:null,C4:null,Af6:function(G){},A0a:function(s){this.Af6(s);}
...
Ag5.Cu(0);this.Bn.JS(J0);this.Bn.Ks(N_);this.Bn.DC(P7);this.Bn.DM(MG);this.C4.DC(
P7);this.C4.DM(N_);this.C4.L(A.jb.Bc);this.J(this.Yv,0);this.J(this.Ag5,0);this.
J(this.Bn,0);this.J(this.C4,0);this.Yv.Aw(A.aaL(A.aci.TI));this.Ag5.Aw(A.aaL(A.aci.
ATD));this.Bn.BL=[this,this.A0a];},_Done:function(){this.__proto__=A.Core.P;this.
...
C.Acg={AGl:null,DT:null,Yu:null,BT:null,M7:null,AhA:null,ANs:0,Init:function(aArg
){var B;A.zX([this,this.BeJ],[B=A._GetAutoObject(A.aco.Ht),B.AEv,B.AFu],0);A.pe([
this,this.BeJ],this);},Af6:function(G){var Iy=A.ab0(this.Yu.String,0,10);var Ih=
false;switch(A._GetAutoObject(A.aco.Ht).Ahz){case 2:Ih=A._GetAutoObject(A.aco.Ht
).BBj(Iy);break;case 0:case 1:Ih=A._GetAutoObject(A.aco.Ht).BfI(Iy);break;default:
A.ab5("%s%e",AsN,A._GetAutoObject(A.aco.Ht).Ahz);}if(Ih){Iy=Iy+1;this.Yu.R(Iy.toFixed(
));}},BeJ:function(G){var AJa=null;var AKm=0;switch(A._GetAutoObject(A.aco.Ht).Ahz
){case 2:{AJa=A.aaL(A.ach.Avq);AKm=276;}break;case 0:{AJa=A.aaL(A.ach.AjR);AKm=900;
}break;case 1:{AJa=A.aaL(C.AxI);AKm=276;}break;default:A.ab5("%s%e",AsN,A._GetAutoObject(
A.aco.Ht).Ahz);}this.Yu.R(((AKm*1000000000000)+(A.abY(this.Yu.String,0,10)%1000000000000
)).toFixed());this.Yv.Aw(AJa);},Bln:function(E){var F;if(this.ANs===E)return;this.
ANs=E;if(!!this.AGl)(F=this.AGl,F[2].call(F[0],E));},Bj8:function(){return this.
ANs;},_Init:function(aArg){C.Jo._Init.call(this,aArg);A.acq.DT._Init.call(this.DT={
I:this},0);C.Aki._Init.call(this.Yu={I:this},0);A.acg.BT._Init.call(this.BT={I:this
...
DT.ASK(A.jb.Rd);this.DT.A9f(A.jb.CS);this.DT.A9j(A.jb.CS);this.DT.ASL(A.jb.Rd);this.
DT.A9k(A.jb.Text);this.DT.A9g(A.jb.AV);this.DT.A9l(A.jb.Bm);this.DT.A9i(A.jb.AV);
this.DT.A9h(A.jb.Rd);this.Bn.JS(AxW);this.Bn.DM(O3);this.Yu.H(Rj);this.Yu.R(AxX);
this.Yu.L(A.jb.Text);this.BT.H(UU);this.BT.Ng(2);this.BT.L(A.jb.Text);this.M7.H(
AsO);this.M7.L(A.jb.Text);this.M7.A5(0xC);this.M7.Cu(3);this.J(this.DT,-2);this.
J(this.Yu,-1);this.J(this.BT,0);this.J(this.M7,0);this.DT.At([this,this.Bj8,this.
Bln]);this.DT.A9r(this.AhA);this.DT.ArG(A.aaL(A.fl.Bh));this.DT.AwA(A.aaL(A.fl.Bh
));this.M7.Aw(A.aaL(A.ach.Ajn));this.AGl=[B=A._GetAutoObject(A.aco.Ht),B.AEv,B.AFu
];this.Init(aArg);},_Done:function(){this.__proto__=C.Jo;this.DT._Done();this.Yu.
_Done();this.BT._Done();this.M7._Done();this.AhA._Done();C.Jo._Done.call(this);}
,_ReInit:function(){C.Jo._ReInit.call(this);this.DT._ReInit();this.Yu._ReInit();
this.BT._ReInit();this.M7._ReInit();this.AhA._ReInit();this.DT.ArG(A.aaL(A.fl.Bh
));this.DT.AwA(A.aaL(A.fl.Bh));},_Mark:function(D){var B;C.Jo._Mark.call(this,D);
if((B=this.AGl)&&((B=B[0])._cycle!=D))B._Mark(B._cycle=D);if((B=this.DT)._cycle!=
D)B._Mark(B._cycle=D);if((B=this.Yu)._cycle!=D)B._Mark(B._cycle=D);if((B=this.BT
...
};C.Acr={UE:null,OS:null,A3Y:0,Init:function(aArg){var B;A.zX([this,this.BAe],[B=
A._GetAutoObject(A.aco.Ht),B.ASr,B.ATc],0);A.zX([this,this.AAz],[B=A._GetAutoObject(
A.Device.Device),B.Arr,B.Ata],0);A.pe([this,this.AAz],this);},Ai:function(Ae){C.
Jo.Ai.call(this,Ae);this.OS.Z(!A._GetAutoObject(A.aco.Ht).Axg);},Af6:function(G){
var B;A._GetAutoObject(A.aco.Ht).Bej(this);},AAz:function(G){if(A._GetAutoObject(
A.Device.Device).TemperatureUnit!==this.A3Y){switch(A._GetAutoObject(A.Device.Device
).TemperatureUnit){case 0:this.OS.R(A.abk(A._GetAutoObject(A.aco.Ht).WK/100,0,1)
);break;case 1:{var Auf=A._GetAutoObject(A.Device.Converter).AUS(A._GetAutoObject(
...
).TemperatureUnit);}this.A3Y=A._GetAutoObject(A.Device.Device).TemperatureUnit;}
},BzZ:function(G){var B;var Agl=A.abX(this.OS.String,0);Agl=A._GetAutoObject(A.Device.
Converter).AUS(Agl,A._GetAutoObject(A.Device.Device).TemperatureUnit,0);Agl*=100;
A._GetAutoObject(A.aco.Ht).AFB(Math.round(Agl)|0);},BAe:function(G){this.Am();},
...
);this.UE.A9G(A.aaR(A.acf.A4N));this.OS.H(Ax0);this.OS.R(Aob);this.OS.L(A.jb.Text
);this.OS.Blo(true);this.A3Y=A._GetAutoObject(A.Device.Device).TemperatureUnit;this.
J(this.UE,0);this.J(this.OS,0);this.Yv.Aw(A.aaL(A.ach.Abx));this.UE.At([B=A._GetAutoObject(
A.aco.Ht),B.ASr,B.ATc]);this.UE.OnSetAppearance(A._GetAutoObject(A.acx.AuL));this.
...
call(this);this.UE._ReInit();this.OS._ReInit();this.UE.A9G(A.aaR(A.acf.A4N));},_Mark:
...
};C.Aq7={Q:null,BT:null,Bn:null,AgF:null,Am1:null,Am0:null,Ara:null,Text:null,Hn:
null,Ap:null,CW:null,Aq$:null,Arb:null,Apa:false,Bl:function(aSize){this.Hn.H(A.
abK(this.Hn.M,aSize));this.BT.Axn(1);this.BT.Js(0,40);this.BT.Fk(0,aSize[0]-20,20
,12.5,12.5,-90,90,10);this.BT.Fk(0,20,20,12.5,12.5,90,270,10);this.BT.VJ(0);},Ai:
...
U&0x80)===0x80))this.Il().AML(this);},A7Q:function(G){},Ban:function(s){this.A7Q(
s);},Bjy:function(G){var B;var F;if(!this.Q||!(F=this.Q,F[1].call(F[0])).length)
this.CW.H(A.abM(this.CW.M,A.aaI(this.Text.M)[0]));else{this.CW.H(A.abM(this.CW.M
,this.Text.AOI(0)[2]+2));this.CW.H(A.abO(this.CW.M,this.Text.AOI(0)[1]));this.CW.
H(A.abI(this.CW.M,(B=this.Text.AOI(0))[3]-B[1]));}this.Ap.H(A.abM(this.Ap.M,this.
Text.M[0]-((B=this.Ap.M)[2]-B[0])));},A7O:function(G){},Bam:function(s){this.A7O(
...
,Kd:function(G){this.Am();},Bk2:function(G){var B;if(((this.U&0x80)===0x80))this.
Il().ACw(this);},Ber:function(G){},_Init:function(aArg){A.Core.P._Init.call(this
,aArg);A.Graphics.Hy._Init.call(this.BT={I:this},0);A.Core.Bn._Init.call(this.Bn={
I:this},0);A.acl.TD._Init.call(this.AgF={I:this},0);A.Core.BK._Init.call(this.Am1={
...
JS(J0);this.Bn.Ks(Aoc);this.Bn.DC(IT);this.Bn.DM(Ri);this.AgF.Fp(530);this.AgF.Uj(
...
Hn.H(Afz);this.Hn.L(0xFFB3B3B3);this.Hn.Ng(1);this.Ap.H(Aod);this.CW.H(W$);this.
...
,this.Ban];this.Am1.D1=[this,this.Ban];this.Am0.BL=[this,this.Bam];this.Am0.D1=[
this,this.Bam];this.Ara.BL=[this,this.Bk2];this.Text.Q2([this,this.Bjy]);this.Text.
S(A.aaL(A.fl.Ak));this.Hn.Zr(this.BT);this.Ap.Aw(null);this.Aq$.BL=[this,this.Ber
];this.Arb.BL=[this,this.Ber];},_Done:function(){this.__proto__=A.Core.P;this.BT.
...
P._ReInit.call(this);this.BT._ReInit();this.Bn._ReInit();this.AgF._ReInit();this.
...
A.aco.AgI),B.A8D,B.AFw]);},_Done:function(){this.__proto__=A.Core.P;this.Background.
...
};C.OS={Init:function(aArg){var B;A.zX([this,this.AAz],[B=A._GetAutoObject(A.Device.
Device),B.Arr,B.Ata],0);A.pe([this,this.AAz],this);},Ai:function(Ae){var B;C.Aki.
...
};C.Aki={B6:null,Di:null,IU:null,Cq:null,Amw:null,Sb:null,KK:null,Bn:null,Text:null
,CW:null,Aqq:null,Ar8:null,BT:null,Hn:null,Arn:null,AqV:null,AqD:null,String:A.jV
,D6:0,AQ:0xFFB3B3B3,AvP:15,ANA:false,Lz:false,Bl:function(aSize){this.Hn.H(A.abK(
this.Hn.M,aSize));this.BT.Axn(1);this.BT.Js(0,40);this.BT.Fk(0,aSize[0]-20,20,12.5
,12.5,-90,90,10);this.BT.Fk(0,20,20,12.5,12.5,90,270,10);this.BT.VJ(0);},Ai:function(
Ae){var B;A.acn.Jb.Ai.call(this,Ae);if(((Ae&0x40)===0x40))this.IU.Ar(true);else{
this.IU.Ar(false);this.CW.Z(false);}},A38:function(G){var B;var Bd=this.Text.M;var
...
CW.EC[1]>Bd[3])Nv=Bd[3]-this.CW.EC[1];if(!!Nu||!!Nv)this.Text.Ga(A.abf(this.Text.
...
M)[3]-B[1]))Nv=0;this.Text.Ga([Nu,Nv]);},Ame:function(G){if(!this.B6)return;var A3A=
this.Text.AGH(this.D6);var pos=this.Text.Afc(A3A);this.CW.DM(A.abe(pos,[0,this.B6.
Ascent]));this.CW.DC(A.abf(pos,[0,this.B6.Descent]));if(this.IU.Bw){this.IU.Ar(false
);this.IU.Ar(true);}if(this.Lz){A.pe([this,this.A38],this);this.Lz=false;}},AAv:
function(G){if(!this.A6y(0x80))this.Il().AML(this);var EH=this.Text.ATH(this.Bn.
H0);var Vc=this.Text.AnK(EH);if(Vc!==this.D6){this.D6=Vc;A.pe([this,this.Ame],this
);this.Lz=true;}},AAp:function(G){if(!this.B6)return;var EH=this.Text.AGH(this.D6
);if(this.Cq.CO===6){EH=[EH[0]-1,EH[1]];if(this.Text.AnK(EH)===this.D6){EH=[EH[0
],EH[1]-1];EH=[this.Text.ACU(EH[1]).length,EH[1]];}}if(this.Cq.CO===7){EH=[EH[0]+
...
true;}},Bea:function(G){if(!this.D6)return;this.R(A.ab1(this.String,this.D6-1,1)
);this.D6=this.D6-1;this.Lz=true;A.pe(this.Di,this);},AAq:function(G){if(this.D6>=
this.String.length)return;this.R(A.ab1(this.String,this.D6,1));this.Lz=true;A.pe(
this.Di,this);},Bef:function(G){if(this.String.length>=this.AvP)return;var Byj=this.
...
fromCharCode(0x0A));this.Lz=true;this.Text.Ga(J0);},L:function(E){if(this.AQ===E
)return;this.AQ=E;this.Text.L(E);this.CW.L(E);this.Hn.L(E);},S:function(E){if(this.
B6===E)return;this.B6=E;this.Text.S(E);this.Lz=true;this.Text.Ga(J0);},Bes:function(
...
D6));this.D6=this.D6+1;this.Lz=true;A.pe(this.Di,this);},Ba7:function(s){this.Bes(
s);},Blo:function(E){if(this.ANA===E)return;this.ANA=E;if(E===false){var Be$=this.
String.indexOf(String.fromCharCode(0x2E),0);if(Be$>=0)this.R(A.abV(this.String,Be$
));}this.Lz=true;this.Text.Ga(J0);},Bmu:function(E){if(this.AvP===E)return;this.
AvP=E;this.R(A.abV(this.String,E));this.Lz=true;this.Text.Ga(J0);},Bz7:function(
G){if(this.A6y(0x80)){this.Il().ACw(this);this.Cr(0x10,0x0);}this.Am();},BzV:function(
...
);this.Lz=true;}},_Init:function(aArg){A.acn.Jb._Init.call(this,aArg);A.acl.TD._Init.
call(this.IU={I:this},0);A.Core.BK._Init.call(this.Cq={I:this},0);A.Core.BK._Init.
call(this.Amw={I:this},0);A.Core.BK._Init.call(this.Sb={I:this},0);A.Core.BK._Init.
...
_Init.call(this.BT={I:this},0);A.acg.Hn._Init.call(this.Hn={I:this},0);A.Core.BK.
...
B1=false;this.IU.Cw=true;this.IU.Fp(500);this.IU.Uj(500);this.Cq.Filter=147;this.
Amw.Filter=45;this.Sb.Filter=44;this.KK.Filter=143;this.Bn.AZ(0x3F);this.Bn.JS(Ri
);this.Bn.Ks(IT);this.Bn.DC(Aoc);this.Bn.DM(J0);this.Bn.AFh(3);this.Text.AZ(0x3F
);this.Text.H(Afz);this.Text.KQ(false);this.Text.A5(0x12);this.Text.R(A.jV);this.
Text.L(0xFFB3B3B3);this.CW.DC(AsR);this.CW.DM(Aof);this.CW.A_g(2);this.CW.A_f(2);
...
J(this.Hn,0);this.IU.Q=[B=this.CW,B.Fo,B.Z];this.Cq.BL=[this,this.AAp];this.Cq.D1=[
this,this.AAp];this.Amw.BL=[this,this.Bea];this.Amw.D1=[this,this.Bea];this.Sb.BL=[
this,this.AAq];this.Sb.D1=[this,this.AAq];this.KK.BL=[this,this.Bef];this.KK.D1=[
this,this.Bef];this.Bn.BL=[this,this.AAv];this.Text.Q2([this,this.Ame]);this.Text.
S(A.aaL(A.fl.Ak));this.B6=A.aaL(A.fl.Ak);this.Aqq.BL=[this,this.Ba7];this.Ar8.BL=[
this,this.Ba7];this.Hn.Zr(this.BT);this.Arn.BL=[this,this.Bz7];this.AqV.BL=[this
,this.BzY];this.AqD.BL=[this,this.BzV];},_Done:function(){this.__proto__=A.acn.Jb;
this.IU._Done();this.Cq._Done();this.Amw._Done();this.Sb._Done();this.KK._Done();
this.Bn._Done();this.Text._Done();this.CW._Done();this.Aqq._Done();this.Ar8._Done(
);this.BT._Done();this.Hn._Done();this.Arn._Done();this.AqV._Done();this.AqD._Done(
);A.acn.Jb._Done.call(this);},_ReInit:function(){A.acn.Jb._ReInit.call(this);this.
IU._ReInit();this.Cq._ReInit();this.Amw._ReInit();this.Sb._ReInit();this.KK._ReInit(
);this.Bn._ReInit();this.Text._ReInit();this.CW._ReInit();this.Aqq._ReInit();this.
Ar8._ReInit();this.BT._ReInit();this.Hn._ReInit();this.Arn._ReInit();this.AqV._ReInit(
...
B=this.Amw)._cycle!=D)B._Mark(B._cycle=D);if((B=this.Sb)._cycle!=D)B._Mark(B._cycle=
...
Ar8)._cycle!=D)B._Mark(B._cycle=D);if((B=this.BT)._cycle!=D)B._Mark(B._cycle=D);
...
aaR(A.acf.A5n));this.LabelDataSync.L(A.jb.Text);this.J(this.LabelDataSync,0);this.
Yv.Aw(A.aaL(C.AUJ));this.LabelDataSync.S(A.aaL(A.fl.Af));this.LabelDataSync.A2(A.
...
_ReInit();this.LabelDataSync.R(A.aaR(A.acf.A5n));this.LabelDataSync.S(A.aaL(A.fl.
...
"Demonstrator::SyncAction"};C.AUJ={_class:function(){return A.aci.Al;},0:{FileName:
...
function(aIndex){if(this.AqO()>aIndex)return this.TimespanDaysToString.BR(aIndex
...
BFg={GK:0,AVq:1,Hi:2,Year:3};C.ACt={_class:function(){return A.aci.Al;},0:{FileName:
...
A._GetAutoObject(A.Device.Helper).Du());var A1i=Au.Format(Is);this.Aeb.R(A1i);},
...
}J5=J5+Ax2;J5=J5+A._GetAutoObject(A.acj.VA).ACQ(J5).toFixed();var A1i=A._GetAutoObject(
A.Device.AnE).Be0(J5);A._GetAutoObject(A.aco.Ht).BBk(((B=(A1i|0))<0)?B+0x100000000:
B);},_Init:function(aArg){C.Jo._Init.call(this,aArg);C.ANx._Init.call(this.Aeb={
I:this},0);this.__proto__=C.ZC;this.Aeb.H(Rj);this.Aeb.L(A.jb.Text);this.Aeb.Bmu(
...
)>aIndex)return this.AhB.BR(aIndex);A.ab5("%s",AsS);return A.jV;},AqO:function(){
...
};C.AhB={BR:function(A7){var Bcs=A7;var AKS=A.jV;switch(Bcs){case 2:AKS=A.aaR(A.
acf.VA);break;case 0:AKS=A.aaR(A.acf.Transponder);break;case 1:AKS=A.aaR(A.acf.BhQ
);break;default:throw new Error(Ax3+Bcs.toFixed());}return AKS;},_Init:function(
aArg){A.Device.EnumToString._Init.call(this,aArg);this.__proto__=C.AhB;},_className:
"Demonstrator::ScanTypeToString"};C.ANx={Bes:function(G){var Bfa=0;var O=this.String.
indexOf(String.fromCharCode(0x2E),0);while(O>=0){Bfa++;O++;O=this.String.indexOf(
String.fromCharCode(0x2E),O);}if(Bfa>=2)return;if(this.String.length>=this.AvP)return;
...
C._Init=function(){C.AVk.__proto__=A.acn.Menu;C.AUg.__proto__=A.Core.P;C.AMk.__proto__=
...
_Done(C.AMX[0]._this=null);if((B=C.APX[0]._this)&&(B._cycle!=D))B._Done(C.APX[0].
_this=null);if((B=C.Filter[0]._this)&&(B._cycle!=D))B._Done(C.Filter[0]._this=null
);if((B=C.ARw[0]._this)&&(B._cycle!=D))B._Done(C.ARw[0]._this=null);if((B=C.Ajm[
...
C.Asm[0]._this=null);if((B=C.AUO[0]._this)&&(B._cycle!=D))B._Done(C.AUO[0]._this=
null);if((B=C.AHa[0]._this)&&(B._cycle!=D))B._Done(C.AHa[0]._this=null);if((B=C.
AVB[0]._this)&&(B._cycle!=D))B._Done(C.AVB[0]._this=null);if((B=C.AUJ[0]._this)&&(
B._cycle!=D))B._Done(C.AUJ[0]._this=null);if((B=C.ACt[0]._this)&&(B._cycle!=D))B.
_Done(C.ACt[0]._this=null);if((B=C.AxI[0]._this)&&(B._cycle!=D))B._Done(C.AxI[0].
_this=null);};return C;})();
