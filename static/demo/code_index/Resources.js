...
C.Al={bitmap:null,FrameDelay:0,NoOfFrames:1,FrameSize:A.wf,Ot:false,U0:false,K2:function(
){if(!this.bitmap)return;var handle=this.bitmap;A._FreeBitmap(handle);this.bitmap=
null;this.FrameSize=B9;this.FrameDelay=0;this.NoOfFrames=1;this.U0=false;},Init:
...
noOfFrames;this.FrameSize=frameSize;this.FrameDelay=frameDelay;this.Ot=true;this.
U0=(!!this.bitmap&&(this.FrameDelay>0))&&(this.NoOfFrames>1);},AqQ:function(E){throw new
...
],_this:null}};C.B3={font:null,Leading:0,Descent:0,Ascent:0,K2:function(){this.Bvv(
);},Init:function(aArg){this.Bv9(aArg);},Bvv:function(){if(!this.font)return;var
handle=this.font;A.aal(handle);this.font=null;this.Ascent=0;this.Descent=0;this.
Leading=0;},Bv9:function(aFontResource){if(!aFontResource)return;var handle=null;
...
font=handle;this.Ascent=ascent;this.Descent=descent;this.Leading=leading;},BfR:function(
...
},BfV:function(aString,aOffset,aCount,aX,aMinWidth){if(aOffset<0)aOffset=0;if(!this.
...
var advance=0;advance=A.aav(handle,aFlowString);return advance;},BkG:function(aString
...
result=A.abv(handle,aString,aOffset,aWidth,aMaxNoOfRows,aBidi);return result;},XW:
...
null}};C.BgV="Monday";C.Bmy="Tuesday";C.Bm$="Wednesday";C.Bml="Thursday";C.Bfx="Friday";
C.Blb="Saturday";C.Bl_="Sunday";C.BdS="AM";C.BkE="PM";C.ACl="January";C.ABd="February";
C.ACx="March";C.AAg="April";C.ACA="May";C.ACn="June";C.ACm="July";C.AAo="August";
C.AES="September";C.ACN="October";C.ACL="November";C.AAZ="December";C.BgW="Mon";
C.Bmz="Tue";C.Bna="Wed";C.Bmm="Thu";C.Bfy="Fri";C.Blc="Sat";C.Bl$="Sun";C.Bgr="Jan";
C.Bfl="Feb";C.BgL="Mar";C.Bd_="Apr";C.BgP="May";C.Bgu="Jun";C.Bgt="Jul";C.Bea="Aug";
C.Blh="Sep";C.Bg$="Oct";C.Bg_="Nov";C.BeO="Dec";
C._Init=function(){C.Al.__proto__=A.Core.AgU;C.B3.__proto__=A.Core.AgU;};C._ReInit=
function(){};C.Dz=function(D){var B;if((B=C.Tl[0]._this)&&(B._cycle!=D))B._Done(
