...
A.abC=[1000,740];A.rs=function(){return A.kR.AMs;};A.zU="URBAN VitalControl - Demo App";
...
_ReInit();};A.abA=function(D){A.Core.DF(D);A.acl.DF(D);A.Graphics.DF(D);A.aci.DF(
D);A.acg.DF(D);A.kR.DF(D);A.acf.DF(D);A.ach.DF(D);A.jb.DF(D);A.fl.DF(D);A.acx.DF(
D);A.acn.DF(D);A.acv.DF(D);A.Device.DF(D);A.acs.DF(D);A.aco.DF(D);A.acw.DF(D);A.
acq.DF(D);A.acy.DF(D);A.acj.DF(D);A.acA.DF(D);A.acB.DF(D);A.acr.DF(D);A.acm.DF(D
);A.acz.DF(D);A.acu.DF(D);A.ack.DF(D);A.acp.DF(D);A.act.DF(D);};return A;})();
