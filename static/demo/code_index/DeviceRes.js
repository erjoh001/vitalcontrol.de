...
var EU="ERROR: Unhandled temperature unit: ";var Hc="ERROR: unhandled assessment.";
var I7="%H:%M";var II="Invalid month";var OH="%";var PM="Invalid format code";var
PN=" %Y";var CI="ERROR: Unhandled mass unit: ";
C.A8W={BvT:function(Eb,Q8){if((Q8>=A._GetAutoObject(A.Device.Helper).Aum(Eb))||(Q8<=
A._GetAutoObject(A.Device.Device).Zj))return 1;else return 0;},BvS:function(Eb,Q8
){var Nc=A._GetAutoObject(A.Device.Converter).AiI(Q8,Eb);switch(Nc){case 3:return A.
aaR(A.acf.Aut);case 2:return A.aaR(A.acf.Bf_);case 1:return A.aaR(A.acf.Normal);
case 0:return A.aaR(A.acf.BgH);default:throw new Error(B9+Nc.toFixed());}},BvK:function(
...
aaR(A.acf.Bmj);default:A.ab5("%s%s",EU,A._GetAutoObject(A.Device.Device).TemperatureUnit.
toFixed());}return A.jV;},BvL:function(Eb,Q8){var Nc=A._GetAutoObject(A.Device.Converter
).AiI(Q8,Eb);switch(Nc){case 2:return A.jb.Text;case 3:case 1:case 0:return A.jb.
Bh;default:throw new Error(B9+Nc.toFixed());}},BvN:function(Eb,Q8){var Nc=A._GetAutoObject(
...
Nc.toFixed());}},BvO:function(Eb,Q8){var Nc=A._GetAutoObject(A.Device.Converter).
AiI(Q8,Eb);switch(Nc){case 3:return 16711680;case 2:return 16776960;case 1:return 65280;
case 0:return 255;default:throw new Error(B9+Nc.toFixed());}},BvM:function(Eb,Q8
){var Nc=A._GetAutoObject(A.Device.Converter).AiI(Q8,Eb);switch(Nc){case 3:return A.
...
"%s",Hc);}return BX;},P4:function(M$){var BX=A.jb.AbX;switch(M$){case 3:BX=A.jb.
EX;break;case 2:BX=A.jb.HY;break;case 1:BX=A.jb.FU;break;case 0:case 5:BX=A.jb.CL;
break;case 4:BX=A.jb.AeL;break;default:A.ab5("%s%e",Hc,M$);}return BX;},W0:function(
M$){var BX=A.jb.Text;switch(M$){case 3:case 1:BX=A.jb.Bh;break;case 2:case 0:case
4:case 5:BX=A.jb.Text;break;default:A.ab5("%s",Hc);}return BX;},_Init:function(aArg
...
function(){return this;},_this:null};C.A3v={MonthToString:null,Bft:function(LS){
if(!LS)return A.jV;else{var As=A._NewObject(A.Core.Bt,0);As.Initialize(LS);return As.
Format(A.aaR(A.acf.Bfv));}},Ai$:function(LS){if(!LS)return A.jV;else{var As=A._NewObject(
...
Format(A.aaR(A.acf.Bfu));}},A4d:function(LS){if(!LS)return A.jV;else{var As=A._NewObject(
...
P1.G6){case 1:case 2:case 4:case 6:case 8:case 9:case 11:PZ+=31;break;case 5:case
7:case 10:case 12:PZ+=30;break;case 3:if(this.Bgm(P1.Year))PZ+=29;else PZ+=28;break;
default:A.ab5("%s%i",II,P1.G6);}AoL--;}AoL+=(P1.G6-Dl.G6);if(AoL<0){AoL+=12;Az8--;
...
),index);break;case 0x25:Ij=A.abU(Ij,OH,index);break;default:A.ab5("%s%s",PM,OH+
String.fromCharCode(Ba0));}index=Ij.indexOf(String.fromCharCode(0x25),index+1);}
return Ij;},Bgm:function(Acp){if(!(Acp%4)&&!!(Acp%100))return true;if(!(Acp%400)
)return true;return false;},Bfp:function(LS){if(!LS)return A.jV;else{var As=A._NewObject(
A.Core.Bt,0);As.Initialize(LS);return this.MonthToString.B0(As.G6)+As.Format(PN);
...
return A.aaR(A.acf.AIG);case 1:return A.aaR(A.acf.A47);default:A.ab5("%s%s",CI,A.
_GetAutoObject(A.Device.Device).MassUnit.toFixed());}return A.jV;},BvJ:function(
){switch(A._GetAutoObject(A.Device.Device).MassUnit){case 0:return A.aaL(A.ach.AJ2
);case 1:return A.aaL(A.ach.AJ1);default:A.ab5("%s%s",CI,A._GetAutoObject(A.Device.
...
){case 0:return A.aaR(A.acf.Bf0);case 1:return A.aaR(A.acf.BkL);default:A.ab5("%s%s"
,CI,A._GetAutoObject(A.Device.Device).MassUnit.toFixed());}return A.jV;},Ayt:function(
){switch(A._GetAutoObject(A.Device.Device).MassUnit){case 0:return 10;case 1:return 5;
default:A.ab5("%s%s",CI,A._GetAutoObject(A.Device.Device).MassUnit.toFixed());}return 10;
...
default:A.ab5("%s%s",CI,A._GetAutoObject(A.Device.Device).MassUnit.toFixed());}return Ats;
},Bas:function(){switch(A._GetAutoObject(A.Device.Device).MassUnit){case 0:return A.
aaL(A.ach.AuI);case 1:return A.aaL(A.ach.AuJ);default:A.ab5("%s%s",CI,A._GetAutoObject(
A.Device.Device).MassUnit.toFixed());}return null;},AkQ:function(A_2,Bt7,Btf){if(
!A_2)return 0;return Math.round((Btf-Bt7)/A_2)|0;},_Init:function(aArg){this.__proto__=
...
},_this:null};C.BlK={3:"\u7DA0\u8272",0:"Green",7:"Vihre\xE4",8:"Vert",9:"Gr\xFCn"
,10:"\u03A0\u03C1\u03AC\u03C3\u03B9\u03BD\u03BF",15:"\u0417\u0435\u043B\u0451\u043D\u044B\u0439"
,17:"Ye\u015Fil"};C.BlL={3:"\u7D05\u8272",0:"Red",7:"Punainen",8:"Rouge",9:"Rot"
,10:"\u039A\u03CC\u03BA\u03BA\u03B9\u03BD\u03BF",15:"\u043A\u0440\u0430\u0441\u043D\u044B\u0439"
,17:"K\u0131rm\u0131z\u0131"};C.BlM={3:"\u9EC3\u8272",0:"Yellow",7:"Keltainen",8:
...
))B._ReInit(),C.DI._ReInit.call(B);};C.Dz=function(D){var B;if((B=C.Temperature.
