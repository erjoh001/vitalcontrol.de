...
C.E0={M2:null,timer:null,Qw:null,SC:null,Ahp:null,Tj:0,Aja:0,Vb:0,Pa:0,Az2:0.001,
Qs:0,Ec:0,Dx:0,AN8:0.5,A5G:3,Axq:3,AuM:0.5,VX:3,AVp:0,AVo:0,JR:0,Pu:1000,PD:0,V5:
0,AhS:0,Bw:false,AkY:false,AUz:false,Ap9:false,ALu:false,Mg:function(G){var B;if(
!this.timer)return;if(!this.Aja){if(this.AUz)this.Aja=-1;else this.Aja=1;this.Tj=
this.Aja;this.Dx=this.timer.Bs;this.Ec=0;this.Qs=-1;}var KF;if((this.Aja>0)&&(this.
Tj>0))KF=this.BB4();else if((this.Aja<0)&&(this.Tj<0))KF=this.BB7();else if(this.
Aja>0)KF=this.BB5();else KF=this.BB6();if(KF){this.Ar(false);(B=this.Qw)?B[1].call(
B[0],this):null;(B=this.SC)?B[1].call(B[0],this):null;}},AK0:function(AN){var B;
if(!this.M2&&(((this.AhS===19)||(this.AhS===20))||(this.AhS===21))){var AJB=this.
A5G+1;var Bzs=Math.sqrt(this.AN8);var RM=0.5;var O;this.M2=A._NewObject(C.AG4,0);
this.M2.Pl.Set(0,1);this.M2.Alr.Set(0,1);for(O=1;O<AJB;O=O+1){this.M2.Pl.Set(O,this.
M2.Pl.Get(O-1)*Bzs);this.M2.Alr.Set(O,this.M2.Alr.Get(O-1)*this.AN8);RM=RM+this.
...
var LK=AN;var AAq=1-LK;var Bdj=LK*LK;var BAx=AAq*AAq;AN=(((BAx*LK)*(this.Pa+1))+((
AAq*Bdj)*(this.Vb+2)))+(Bdj*LK);}}this.AuR(AN);(B=this.Ahp)?B[1].call(B[0],this):
null;},BB7:function(){var Av=(this.timer.Bs-this.Dx)|0;if(Av<0)Av=-Av;var LE=this.
V5;var Oq=this.V5+this.Pu;var Hg=this.PD+this.Pu;var KF=false;var Ed=this.Qs;if(
...
Ed);}return KF;},BB6:function(){var Av=(this.Dx-this.timer.Bs)|0;var LE=this.V5;
var Oq=this.V5+this.Pu;var Hg=this.PD+this.Pu;var KF=false;var Ed=this.Qs;if((this.
...
LE=this.V5;var Oq=this.V5+this.Pu;var Hg=this.PD+this.Pu;var KF=false;var Ed=this.
...
Dx)|0;if(Av<0)Av=-Av;var LE=this.V5;var Oq=this.V5+this.Pu;var Hg=this.PD+this.Pu;
var KF=false;var Ed=this.Qs;if(!this.Ec&&(Av>=Oq)){this.Ec=1;Av=Av-Oq;this.Dx=this.
Dx+Oq;}if((this.Ec>0)&&(Av>=Hg)){var If=(Av/Hg)|0;this.Ec=this.Ec+If;Av=Av-(If*Hg
...
this.AUz=E;if(!this.Bw||!this.Aja)return;if(E)this.Tj=-1;else this.Tj=1;this.Dx=(
this.timer.Avu()*2)-this.Dx;},AFc:function(E){if(E<0)E=0;if(E>1)E=1;this.AN8=E;}
...
this.AuM=E;},AwJ:function(E){if(E<1)E=1;if(E>100)E=100;this.VX=E;},AFV:function(
E){if(this.AVp===E)return;this.AVp=E;if(this.AhS===26){this.Vb=E;this.Ap9=(this.
Pa===this.Vb)&&!!this.Pa;this.ALu=!this.Ap9&&(this.Pa!==this.Vb);}},AFU:function(
E){if(this.AVo===E)return;this.AVo=E;if(this.AhS===26){this.Pa=E;this.Ap9=(this.
Pa===this.Vb)&&!!this.Pa;this.ALu=!this.Ap9&&(this.Pa!==this.Vb);}},WH:function(
E){if(this.AhS===E)return;this.AhS=E;this.M2=null;switch(E){case 24:{this.Pa=-1.1;
this.Vb=1.1;}break;case 22:{this.Pa=-1;this.Vb=-2;}break;case 23:{this.Pa=2;this.
Vb=1;}break;case 25:{this.Pa=1.1;this.Vb=-1.1;}break;case 0:{this.Pa=0;this.Vb=0;
}break;default:{this.Pa=this.AVo;this.Vb=this.AVp;}}this.Ap9=(this.Pa===this.Vb)&&
!!this.Pa;this.ALu=!this.Ap9&&(this.Pa!==this.Vb);},HO:function(E){if(E<0)E=0;this.
JR=E;},Fr:function(E){if(E<15)E=15;this.Pu=E;this.Az2=1/E;},Uq:function(E){if(E<
0)E=0;this.PD=E;},AkB:function(E){if(E<0)E=0;this.V5=E;},Ar:function(E){if(this.
...
C.M_;},_className:"Effects::FloatEffect"};C.TJ={timer:null,Q:null,Ec:0,Dx:0,JR:0
,Pu:1000,PD:1000,V5:0,Bw:false,Cx:false,B2:true,Mg:function(G){var F;if(!this.timer
)return;if(this.Ec<0){this.Dx=this.timer.Bs;this.Ec=0;}var Av=(this.timer.Bs-this.
Dx)|0;var Oq=this.V5+this.Pu;var Hg=this.PD+this.Pu;var LE=this.V5;var Jl=this.Ec;
if(!Jl&&(Av>=Oq)){Jl=1;Av=Av-Oq;}if((Jl>0)&&(Av>=Hg)){var If=(Av/Hg)|0;Av=Av-(If
...
E){if(E<0)E=0;this.JR=E;},Fr:function(E){if(E<100)E=100;this.Pu=E;},Uq:function(
E){if(E<0)E=0;this.PD=E;},AkB:function(E){if(E<0)E=0;this.V5=E;},Ar:function(E){
...
this.Bw)this.Ar(false);this.Ar(true);},_Init:function(aArg){this.__proto__=C.TJ;
...
C.Mr={Pm:null,AJ:null,Ah:null,Ab:null,P:null,AKC:null,A3j:null,Aks:null,Dt:true,
Bw:true,AcI:true,Ajm:false,Ajw:true,ZG:true,Q9:true,Mp:function(){if(!!this.Pm)this.
Pm.Mp();},AvV:function(){return true;},Zn:function(){},SL:function(){this.Mp();}
...
P);if(!this.Bw)this.P.Ar(false);},SL:function(){var B;if(this.AcI){if(this.P.Fq(
...
SL:function(){var B;if(this.AcI){if(this.P.Fq()&&!!this.P.Ab)this.Cp.Cx=this.P.G9;
...
};C.AsT={AdN:null,Cp:null,G$:null,Wm:null,FQ:null,Uw:A.wf,AkL:A.wf,MU:false,Aqa:
false,AvV:function(){return this.MU;},Zn:function(){if(this.Dt){this.P.C3(this.Cp.
B2);this.P.H(A.abh(A.abg(this.P.M,A.aaI(this.P.M)),this.Uw));this.P.Z(true);}if(
...
,A.aaI(this.P.M)),this.Uw));this.P.Z(true);}if((!this.Dt&&this.Q9)&&!!this.P.Ab)
this.P.Ab.HP(this.P);this.P.ArJ(this.Aqa);if(!!this.AdN)this.Ab.HP(this.AdN);if(
!this.Bw)this.P.Ar(false);},SL:function(){var B;if(this.AcI){if(this.P.Fq()&&!!this.
...
),this.Uw),[0,0,(B=this.Ab.M)[2]-B[0],B[3]-B[1]]))[0]>=B[2])||(B[1]>=B[3]));if(Az5&&
Az6){this.Cp.Cx=0;this.Cp.B2=0;this.AkL=this.Uw;this.Wm.A7K();}this.Aqa=this.P.ASB(
);if(this.Bw)this.P.Ar(true);if((this.Dt||this.Ajm)&&!this.P.Ab){this.P.Z(false);
this.Ab.J(this.P,0);}if(this.Dt&&this.ZG)this.P.Ab.ZF(this.P);if(this.Dt&&this.Ajw
)this.P.Ab.Bb(this.P);if(!this.Dt&&(this.Ab.AV===this.P))this.Ab.Bb(null);if(this.
Dt&&!this.P.Fq())this.P.C3(this.Cp.Cx);if((!this.Dt&&A.aaX(this.AkL,this.Uw))&&this.
Wm.ADY())this.P.H(A.abh(A.abg(this.P.M,A.aaI(this.P.M)),this.AkL));if(!this.Dt&&(
...
this.Cp.B2))&&A.aaX(A.aaI(this.P.M),this.Uw))&&this.P.Fq()){this.MU=true;this.Mp(
);return;}if(((!this.Dt&&(this.P.G9===this.Cp.B2))&&A.aaX(A.aaI(this.P.M),this.Uw
))&&this.Wm.ADY()){this.MU=true;this.Mp();return;}if(((this.Cp.Cx===this.Cp.B2)&&
A.aaX(this.AkL,this.Uw))&&this.Wm.ADY()){this.MU=true;this.Mp();return;}this.P.ArJ(
...
Cp.SC=[this,this.AiQ];this.Cp.Ahp=null;this.G$.Ar(!A.aaX(this.AkL,this.Uw)||!this.
Wm.ADY());this.Cp.Ar(this.Cp.Cx!==this.Cp.B2);},AiQ:function(G){this.MU=!this.Cp.
Bw&&!this.G$.Bw;this.Mp();},AAz:function(G){var B;var ABn=A.abe(this.Uw,this.AkL
);if(!this.Dt)ABn=[-ABn[0],-ABn[1]];this.FQ.A7K();this.FQ.AgX=this.Wm.AgX;this.FQ.
Bqj(ABn[0],ABn[1],0);this.FQ.BjO(this.Wm,this.FQ,this.G$.A5);if(this.Dt)this.AdN.
Bab(this.AkL,this.FQ);else this.AdN.Bab(this.Uw,this.FQ);},_Init:function(aArg){
C.Mr._Init.call(this,aArg);C.Gm._Init.call(this.Cp={I:this},0);C.M_._Init.call(this.
G$={I:this},0);A.Graphics.Ax3._Init.call(this.Wm={I:this},0);A.Graphics.Ax3._Init.
call(this.FQ={I:this},0);this.__proto__=C.AsT;},_Done:function(){this.__proto__=
C.Mr;this.Cp._Done();this.G$._Done();this.Wm._Done();this.FQ._Done();C.Mr._Done.
call(this);},_ReInit:function(){C.Mr._ReInit.call(this);this.Cp._ReInit();this.G$.
_ReInit();this.Wm._ReInit();this.FQ._ReInit();},_Mark:function(D){var B;C.Mr._Mark.
...
Wm)._cycle!=D)B._Mark(B._cycle=D);if((B=this.FQ)._cycle!=D)B._Mark(B._cycle=D);}
,_className:"Effects::WarpFader"};C.Rh={Sd:function(){return null;},Sc:function(
){return null;},Aed:function(){return this.Sd();},Aec:function(){return this.Sc(
...
};C.AU0={Sd:function(){var Ao=A._NewObject(C.AsS,0);Ao.Dt=true;Ao.Bw=true;Ao.Ajw=
false;Ao.ZG=true;Ao.AcI=false;Ao.Aks=[this,this.ApL];return Ao;},Sc:function(){var
...
C.Aen={ACF:500,Sd:function(){var Ao=A._NewObject(C.Afb,0);Ao.Dt=true;Ao.Bw=true;
Ao.Ajw=false;Ao.ZG=true;Ao.AcI=true;Ao.Ad9=false;Ao.Aks=[this,this.ApL];Ao.Cp.Fr(
this.ACF);Ao.Cp.Cx=0;Ao.Cp.B2=255;Ao.D$.Fr(this.ACF);Ao.D$.WH(23);return Ao;},Sc:
...
},_className:"Effects::FadeInOutTransition"};C.AGR={Kj:0x12,Au6:0,Ad9:false,Sd:function(
...
Cx=0;Ao.Cp.B2=255;Ao.D$.Fr(500);Ao.D$.WH(23);Ao.D$.AFU(0);Ao.D$.AFV(0);Ao.D$.AwJ(
3);Ao.D$.AEW(0.5);Ao.D$.AFE(3);Ao.D$.AE4(3);Ao.D$.AFc(0.5);return Ao;},Sc:function(
...
AkB(0);Ao.D$.Fr(500);Ao.D$.WH(23);Ao.D$.AFU(0);Ao.D$.AFV(0);Ao.D$.AwJ(3);Ao.D$.AEW(
...
,aArg);this.__proto__=C.AGR;},_className:"Effects::SlideTransition"};C.Afj={Sd:function(
...
Ao.G$.Fr(500);Ao.G$.WH(23);Ao.G$.AFU(0);Ao.G$.AFV(0);Ao.G$.AwJ(3);Ao.G$.AEW(0.5);
Ao.G$.AFE(3);Ao.G$.AE4(3);Ao.G$.AFc(0.5);Ao.Wm.Afi(0.5,0.5,1);return Ao;},Sc:function(
...
500);Ao.G$.WH(23);Ao.G$.AFU(0);Ao.G$.AFV(0);Ao.G$.AwJ(3);Ao.G$.AEW(0.5);Ao.G$.AFE(
3);Ao.G$.AE4(3);Ao.G$.AFc(0.5);Ao.Wm.Afi(0.5,0.5,1);return Ao;},Aed:function(){var
...
])/2)|0))-((C5[1]/2)|0)];Ao.Uw=A.abf(pos,[(C5[0]/2)|0,(C5[1]/2)|0]);if(((!Ao.P.Ab||
!Ao.P.Fq())||!Ao.P.G9)||(((B=A.lb(Ao.P.M,[0,0,(B=Ao.Ab.M)[2]-B[0],B[3]-B[1]]))[0
]>=B[2])||(B[1]>=B[3])))Ao.P.H(A.abJ(Ao.P.M,A.abe(Ao.Uw,A.aaI([0,0,(B=Ao.P.M)[2]-
B[0],B[3]-B[1]]))));},A3v:function(G){var Ao=(C.AsT.isPrototypeOf(G)?G:null);Ao.
Uw=A.aaI(Ao.P.M);},_Init:function(aArg){C.Rh._Init.call(this,aArg);this.__proto__=
...
"Effects::TimingList"};C.ACM={B8:null,B7:null,A8m:function(Aty){var Ao=this.B7;while(
!!Ao){Ao.Zn();Ao.P.U=Ao.P.U&~0x40000;Ao=Ao.Ah;}Ao=this.B7;while(!!Ao){A.pe(Ao.A3j
,Ao);Ao=Ao.Ah;}},A8l:function(Aty){var Ao=this.B7;while(!!Ao){A.pe(Ao.AKC,Ao);Ao=
Ao.Ah;}this.B7=null;this.B8=null;},SL:function(Aty){var B;if(!this.B7)this.Mp();
...
C._Init=function(){C.Gm.__proto__=C.E0;C.AGf.__proto__=C.E0;C.ANr.__proto__=C.E0;
C.M_.__proto__=C.E0;C.AsS.__proto__=C.Mr;C.Axm.__proto__=C.Mr;C.Afb.__proto__=C.
Mr;C.AsT.__proto__=C.Mr;C.AU0.__proto__=C.Rh;C.Aen.__proto__=C.Rh;C.AGR.__proto__=
C.Rh;C.Afj.__proto__=C.Rh;C.AN7.__proto__=A.Core.Timer;C.ACM.__proto__=A.Core.AkZ;
