...
Qs:0,Ec:0,Dx:0,AN8:0.5,A5H:3,Axq:3,AuM:0.5,VX:3,AVp:0,AVo:0,JT:0,Pu:1000,PD:0,V6:
...
Tj>0))KF=this.BB6();else if((this.Aja<0)&&(this.Tj<0))KF=this.BB9();else if(this.
Aja>0)KF=this.BB7();else KF=this.BB8();if(KF){this.Ar(false);(B=this.Qw)?B[1].call(
...
A5H+1;var Bzu=Math.sqrt(this.AN8);var RN=0.5;var O;this.M2=A._NewObject(C.AG5,0);
this.M2.Pl.Set(0,1);this.M2.Alr.Set(0,1);for(O=1;O<AJC;O=O+1){this.M2.Pl.Set(O,this.
M2.Pl.Get(O-1)*Bzu);this.M2.Alr.Set(O,this.M2.Alr.Get(O-1)*this.AN8);RN=RN+this.
M2.Pl.Get(O);}var BAi=1/RN;this.M2.Pl.Set(0,0.5);RN=0;for(O=0;O<AJC;O=O+1){this.
M2.Pl.Set(O,this.M2.Pl.Get(O)*BAi);RN=RN+this.M2.Pl.Get(O);}this.M2.Pl.Set(AJC,this.
...
var LK=AN;var AAq=1-LK;var Bdn=LK*LK;var BAz=AAq*AAq;AN=(((BAz*LK)*(this.Pa+1))+((
AAq*Bdn)*(this.Vb+2)))+(Bdn*LK);}}this.AuR(AN);(B=this.Ahp)?B[1].call(B[0],this):
null;},BB9:function(){var Av=(this.timer.Bs-this.Dx)|0;if(Av<0)Av=-Av;var LE=this.
...
if((this.Ec>2)&&!this.JT)this.Ec=1;if(this.Ec>0)LE=this.PD;if((this.Ec>=this.JT)&&(
this.JT>0)){KF=true;Ed=0;}else if(Av>=LE)Ed=1-((Av-LE)*this.Az2);else if(Ed>=0)Ed=
0;if(Ed!==this.Qs){if(Ed<0)Ed=0;if(Ed>1)Ed=1;}if(Ed!==this.Qs){this.Qs=Ed;this.AK0(
Ed);}return KF;},BB8:function(){var Av=(this.Dx-this.timer.Bs)|0;var LE=this.V6;
...
JT>0)){this.Ec=0;Av=Av+Or;this.Dx=this.Dx+Or;}if(((this.Ec===1)&&(Av<0))&&!this.
JT){var If=(((-Av+Hg)-1)/Hg)|0;Av=Av+(If*Hg);this.Dx=this.Dx+(If*Hg);}if(this.Ec>
...
Ed;this.AK0(Ed);}return KF;},BB7:function(){var Av=(this.Dx-this.timer.Bs)|0;var
...
Av<0))&&(this.JT>0)){this.Ec=0;Av=Av+Or;this.Dx=this.Dx+Or;}if(((this.Ec===1)&&(
Av<0))&&!this.JT){var If=(((-Av+Hg)-1)/Hg)|0;Av=Av+(If*Hg);this.Dx=this.Dx+(If*Hg
...
Qs){this.Qs=Ed;this.AK0(Ed);}return KF;},BB6:function(){var Av=(this.timer.Bs-this.
...
);this.Dx=this.Dx+(If*Hg);}if((this.Ec>2)&&!this.JT)this.Ec=1;if(this.Ec>0)LE=this.
PD;if((this.Ec>=this.JT)&&(this.JT>0)){KF=true;Ed=1;}else if(Av>=LE)Ed=(Av-LE)*this.
...
,AE5:function(E){if(E<1)E=1;if(E>10)E=10;this.A5H=E;this.M2=null;},AFF:function(
E){if(E<1)E=1;if(E>10)E=10;this.Axq=E;},AEX:function(E){if(E<0)E=0;if(E>10)E=10;
this.AuM=E;},AwJ:function(E){if(E<1)E=1;if(E>100)E=100;this.VX=E;},AFW:function(
E){if(this.AVp===E)return;this.AVp=E;if(this.AhS===26){this.Vb=E;this.Ap9=(this.
Pa===this.Vb)&&!!this.Pa;this.ALu=!this.Ap9&&(this.Pa!==this.Vb);}},AFV:function(
E){if(this.AVo===E)return;this.AVo=E;if(this.AhS===26){this.Pa=E;this.Ap9=(this.
Pa===this.Vb)&&!!this.Pa;this.ALu=!this.Ap9&&(this.Pa!==this.Vb);}},WI:function(
...
JT=E;},Fr:function(E){if(E<15)E=15;this.Pu=E;this.Az2=1/E;},Uq:function(E){if(E<
...
C.M_;},_className:"Effects::FloatEffect"};C.TJ={timer:null,Q:null,Ec:0,Dx:0,JT:0
...
*Hg);Jl=Jl+If;}if((Jl>2)&&!this.JT)Jl=1;if(Jl!==this.Ec){this.Dx=this.timer.Bs-(((
B=Av)<0)?B+0x100000000:B);this.Ec=Jl;}if(Jl>0)LE=this.PD;var KF=(Jl>=this.JT)&&(
this.JT>0);if(!!this.Q){if(!KF&&(Av>=LE))(F=this.Q,F[2].call(F[0],this.Cx));if(KF||((
Av<LE)&&(Jl>0)))(F=this.Q,F[2].call(F[0],this.B2));}if(KF)this.Ar(false);},HO:function(
E){if(E<0)E=0;this.JT=E;},Fr:function(E){if(E<100)E=100;this.Pu=E;},Uq:function(
...
C.Mr={Pm:null,AJ:null,Ah:null,Ab:null,P:null,AKD:null,A3k:null,Aks:null,Dt:true,
...
E0.JT)this.E0.HO(1);this.E0.Q=[B=this.P,B.Awo,B.A0s];this.E0.Ae$(false);this.E0.
...
}if(!this.Cp.JT)this.Cp.HO(1);if(!this.D$.JT)this.D$.HO(1);if(this.Ad9)this.P.ArJ(
...
};C.AsT={AdN:null,Cp:null,G$:null,Wn:null,FQ:null,Uw:A.wf,AkL:A.wf,MU:false,Aqa:
...
Az6){this.Cp.Cx=0;this.Cp.B2=0;this.AkL=this.Uw;this.Wn.A7M();}this.Aqa=this.P.ASB(
);if(this.Bw)this.P.Ar(true);if((this.Dt||this.Ajm)&&!this.P.Ab){this.P.Z(false);
this.Ab.J(this.P,0);}if(this.Dt&&this.ZG)this.P.Ab.ZF(this.P);if(this.Dt&&this.Ajw
)this.P.Ab.Bb(this.P);if(!this.Dt&&(this.Ab.AV===this.P))this.Ab.Bb(null);if(this.
...
A.aaX(this.AkL,this.Uw))&&this.Wn.ADZ()){this.MU=true;this.Mp();return;}this.P.ArJ(
true);this.P.Z(false);this.AdN=A._NewObject(A.acg.AVQ,0);this.AdN.Bm2(this.P);this.
AdN.C3(this.Cp.Cx);this.AdN.BnX(A.aaI([0,0,(B=this.P.M)[2]-B[0],B[3]-B[1]]));this.
P.Ab.AMb(this.AdN,this.P);if(!this.Cp.JT)this.Cp.HO(1);if(!this.G$.JT)this.G$.HO(
...
Bw&&!this.G$.Bw;this.Mp();},AAz:function(G){var B;var ABo=A.abe(this.Uw,this.AkL
);if(!this.Dt)ABo=[-ABo[0],-ABo[1]];this.FQ.A7M();this.FQ.AgX=this.Wn.AgX;this.FQ.
Bqn(ABo[0],ABo[1],0);this.FQ.BjS(this.Wn,this.FQ,this.G$.A5);if(this.Dt)this.AdN.
Baf(this.AkL,this.FQ);else this.AdN.Baf(this.Uw,this.FQ);},_Init:function(aArg){
...
,BEh:17,BEg:18,BDL:19,BDN:20,BDM:21,BEe:22,BEs:23,BEd:24,BEt:25,BD1:26};C.BD9={A4$:
0x1,A4_:0x2,A5a:0x4,A5d:0x8,A5c:0x10,A5b:0x20};C.AN7={Trigger:function(){A.Core.
...
"Effects::TimingList"};C.ACN={B8:null,B7:null,A8o:function(Aty){var Ao=this.B7;while(
!!Ao){Ao.Zn();Ao.P.U=Ao.P.U&~0x40000;Ao=Ao.Ah;}Ao=this.B7;while(!!Ao){A.pe(Ao.A3k
,Ao);Ao=Ao.Ah;}},A8n:function(Aty){var Ao=this.B7;while(!!Ao){A.pe(Ao.AKD,Ao);Ao=
...
call(this);},BoR:function(FP){if(!FP)return;if(this.ARj())throw new Error(BD);if(
...
FP.P)FP.P.ApQ=null;A.pe(FP.AKD,FP);if(!this.B7)this.AmC();},A45:function(FP){if(
!FP)return;if(this.ARj())throw new Error(Hr);if(!!FP.Pm)throw new Error(IV);FP.AJ=
