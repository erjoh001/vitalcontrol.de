...
var EU="The fader doesn\'t belong to this task";var Hd="Trying to add a fader to a task, which is actually running";
var I7="The fader belongs already to a task";
C.ER={MK:null,timer:null,P9:null,Sa:null,Agz:null,ST:0,Ais:0,UC:0,OP:0,Ayy:0.001,
P5:0,D5:0,Dl:0,AL6:0.5,A27:3,Av5:3,AtB:0.5,Vh:3,ASV:0,ASU:0,Mi:0,O$:1000,Pi:0,Vu:
...
ST>0))MC=this.BxK();else if((this.Ais<0)&&(this.ST<0))MC=this.BxN();else if(this.
Ais>0)MC=this.BxL();else MC=this.BxM();if(MC){this.Ar(false);(B=this.P9)?B[1].call(
...
A27+1;var Bvg=Math.sqrt(this.AL6);var Rm=0.5;var P;this.MK=A._NewObject(C.AFh,0);
this.MK.OZ.Set(0,1);this.MK.AkH.Set(0,1);for(P=1;P<AHN;P=P+1){this.MK.OZ.Set(P,this.
MK.OZ.Get(P-1)*Bvg);this.MK.AkH.Set(P,this.MK.AkH.Get(P-1)*this.AL6);Rm=Rm+this.
MK.OZ.Get(P);}var Bv2=1/Rm;this.MK.OZ.Set(0,0.5);Rm=0;for(P=0;P<AHN;P=P+1){this.
MK.OZ.Set(P,this.MK.OZ.Get(P)*Bv2);Rm=Rm+this.MK.OZ.Get(P);}this.MK.OZ.Set(AHN,this.
MK.OZ.Get(AHN)+(1-Rm));}if(this.Akg){if(AL<0.5)AL=AL*2;else AL=2-(AL*2);}switch(
this.Ag6){case 1:AL=Math.pow(AL,this.Vh);break;case 2:{AL=1-AL;AL=1-Math.pow(AL,
this.Vh);}break;case 3:{AL=AL*2;if(AL<1)AL=Math.pow(AL,this.Vh)/2;else{AL=2-AL;AL=(
2-Math.pow(AL,this.Vh))*0.5;}}break;case 4:AL=(Math.pow(2.718,this.Vh*AL)-1)/(Math.
pow(2.718,this.Vh)-1);break;case 5:{AL=1-AL;AL=1-((Math.pow(2.718,this.Vh*AL)-1)
/(Math.pow(2.718,this.Vh)-1));}break;case 6:{AL=AL*2;if(AL<1)AL=((Math.pow(2.718
,this.Vh*AL)-1)/(Math.pow(2.718,this.Vh)-1))/2;else{AL=2-AL;AL=(2-((Math.pow(2.718
,this.Vh*AL)-1)/(Math.pow(2.718,this.Vh)-1)))*0.5;}}break;case 7:AL=1-Math.cos((
...
A.k$);AL=(2-AL)*0.5;}}break;case 19:{var Bz=this.MK;var P=0;var Gp=0;var KU=Bz.OZ.
Get(0);var D0=1-AL;while(D0>KU){P=P+1;Gp=KU;KU=KU+Bz.OZ.Get(P);}AL=(D0-Gp)/(KU-Gp
);if(!P)AL=1-(AL*AL);else{AL=(2*AL)-1;AL=Bz.AkH.Get(P)*(1-(AL*AL));}}break;case 20:{
var Bz=this.MK;var P=0;var Gp=0;var KU=Bz.OZ.Get(0);while(AL>KU){P=P+1;Gp=KU;KU=
KU+Bz.OZ.Get(P);}AL=(AL-Gp)/(KU-Gp);if(!P)AL=AL*AL;else{AL=(2*AL)-1;AL=1-(Bz.AkH.
Get(P)*(1-(AL*AL)));}}break;case 21:{var Bz=this.MK;var P=0;var Gp=0;var KU=Bz.OZ.
Get(0);var Lv=AL*2;var D0=Lv-1;if(Lv<1)D0=-D0;while(D0>KU){P=P+1;Gp=KU;KU=KU+Bz.
OZ.Get(P);}D0=(D0-Gp)/(KU-Gp);if(!P)D0=D0*D0;else{D0=(2*D0)-1;D0=1-(Bz.AkH.Get(P
)*(1-(D0*D0)));}if(Lv<1)AL=0.5*(1-D0);else AL=0.5*(1+D0);}break;default:if(this.
Apm){var Lv=AL;var AyX=1-Lv;AL=((AyX*Lv)*(this.OP+1))+(Lv*Lv);}else if(this.AJA){
var Lv=AL;var AyX=1-Lv;var A$$=Lv*Lv;var Bwf=AyX*AyX;AL=(((Bwf*Lv)*(this.OP+1))+((
AyX*A$$)*(this.UC+2)))+(A$$*Lv);}}this.AtG(AL);(B=this.Agz)?B[1].call(B[0],this):
null;},BxN:function(){var As=(this.timer.Bt-this.Dl)|0;if(As<0)As=-As;var Lr=this.
Vu;var Oa=this.Vu+this.O$;var G2=this.Pi+this.O$;var MC=false;var D6=this.P5;if(
...
D6);}return MC;},BxM:function(){var As=(this.Dl-this.timer.Bt)|0;var Lr=this.Vu;
var Oa=this.Vu+this.O$;var G2=this.Pi+this.O$;var MC=false;var D6=this.P5;if((this.
...
D6;this.AJb(D6);}return MC;},BxL:function(){var As=(this.Dl-this.timer.Bt)|0;var
Lr=this.Vu;var Oa=this.Vu+this.O$;var G2=this.Pi+this.O$;var MC=false;var D6=this.
...
P5){this.P5=D6;this.AJb(D6);}return MC;},BxK:function(){var As=(this.timer.Bt-this.
Dl)|0;if(As<0)As=-As;var Lr=this.Vu;var Oa=this.Vu+this.O$;var G2=this.Pi+this.O$;
...
this.AtB=E;},Avw:function(E){if(E<1)E=1;if(E>100)E=100;this.Vh=E;},AD$:function(
E){if(this.ASV===E)return;this.ASV=E;if(this.Ag6===26){this.UC=E;this.Apm=(this.
OP===this.UC)&&!!this.OP;this.AJA=!this.Apm&&(this.OP!==this.UC);}},AD_:function(
E){if(this.ASU===E)return;this.ASU=E;if(this.Ag6===26){this.OP=E;this.Apm=(this.
OP===this.UC)&&!!this.OP;this.AJA=!this.Apm&&(this.OP!==this.UC);}},V7:function(
E){if(this.Ag6===E)return;this.Ag6=E;this.MK=null;switch(E){case 24:{this.OP=-1.1;
this.UC=1.1;}break;case 22:{this.OP=-1;this.UC=-2;}break;case 23:{this.OP=2;this.
UC=1;}break;case 25:{this.OP=1.1;this.UC=-1.1;}break;case 0:{this.OP=0;this.UC=0;
}break;default:{this.OP=this.ASU;this.UC=this.ASV;}}this.Apm=(this.OP===this.UC)&&
!!this.OP;this.AJA=!this.Apm&&(this.OP!==this.UC);},ID:function(E){if(E<0)E=0;this.
Mi=E;},Fy:function(E){if(E<15)E=15;this.O$=E;this.Ayy=1/E;},V5:function(E){if(E<
0)E=0;this.Pi=E;},AjU:function(E){if(E<0)E=0;this.Vu=E;},Ar:function(E){if(this.
...
F;var OX=this.Ct&0xFF;var ZS=(this.Ct>>8)&0xFF;var AkN=(this.Ct>>16)&0xFF;var AkG=(
this.Ct>>24)&0xFF;OX=OX+((((this.B1&0xFF)-OX)*ZH)|0);ZS=ZS+(((((this.B1>>8)&0xFF
)-ZS)*ZH)|0);AkN=AkN+(((((this.B1>>16)&0xFF)-AkN)*ZH)|0);AkG=AkG+(((((this.B1>>24
)&0xFF)-AkG)*ZH)|0);if(OX<0)OX=0;if(OX>255)OX=255;if(ZS<0)ZS=0;if(ZS>255)ZS=255;
if(AkN<0)AkN=0;if(AkN>255)AkN=255;if(AkG<0)AkG=0;if(AkG>255)AkG=255;this.A4=(OX&
...
};C.U6={timer:null,R:null,D5:0,Dl:0,O$:1000,Pi:1000,Vu:0,Bw:false,Ct:false,B1:true
,L5:function(H){var F;if(!this.timer)return;if(this.D5<0){this.Dl=this.timer.Bt;
this.D5=0;}var As=(this.timer.Bt-this.Dl)|0;var Oa=this.Vu+this.O$;var G2=this.Pi+
this.O$;var Lr=this.Vu;var Jq=this.D5;if(!Jq&&(As>=Oa)){Jq=1;As=As-Oa;}if((Jq>0)&&(
...
this.R,F[2].call(F[0],this.B1));}},Fy:function(E){if(E<100)E=100;this.O$=E;},V5:
function(E){if(E<0)E=0;this.Pi=E;},AjU:function(E){if(E<0)E=0;this.Vu=E;},Ar:function(
...
L5],this.timer,0);this.D5=-1;}},_Init:function(aArg){this.__proto__=C.U6;A.h7++;
...
D);},I:null,_cycle:0,_observers:null,_className:"Effects::BoolEffect"};C.Md={O0:
null,AH:null,Ag:null,Ab:null,O:null,AIP:null,A0I:null,AjM:null,Dk:true,Bw:true,Ab3:
true,AiG:false,AiP:true,Y1:true,QN:true,Mb:function(){if(!!this.O0)this.O0.Mb();
},AuO:function(){return true;},YL:function(){},Sg:function(){this.Mb();},_Init:function(
aArg){this.__proto__=C.Md;A.h7++;},_Done:function(){this.__proto__=null;A.h7--;}
,_ReInit:function(){},_Mark:function(D){var B;if((B=this.O0)&&(B._cycle!=D))B._Mark(
...
};C.ArR={Arg:A.wf,ME:false,AuO:function(){return this.ME;},YL:function(){if(!this.
...
Dk&&!this.Ab3)this.O.G(A.abJ(this.O.M,this.Arg));if(this.Dk){this.O.Dz(255);this.
...
ME;},YL:function(){if(this.Dk)this.O.Dz(this.ER.B1);if(!this.Dk&&!this.O.GS)this.
...
Fc()){this.O.Dz(this.ER.Ct);this.O.Y(true);}if(!this.Dk&&((!this.O.Ab||!this.O.Fc(
))||!this.O.GS)){this.ME=true;this.Mb();return;}if(!this.Dk&&(this.ER.Ct===this.
ER.B1))this.O.Dz(this.ER.Ct);if(this.O.GS===this.ER.B1){this.ME=true;this.Mb();return;
...
null,D3:null,Ado:false,ME:false,App:false,AuO:function(){return this.ME;},YL:function(
){if(this.Dk){this.O.Dz(this.Ck.B1);this.O.G(A.abJ(this.O.M,this.D3.B1));}if(!this.
...
abJ(this.O.M,this.D3.Ct));this.O.Dz(this.Ck.Ct);this.O.Y(true);}if(!this.Dk&&((!
...
this.Ck.Ct===this.Ck.B1))this.O.Dz(this.Ck.Ct);if((this.O.GS===this.Ck.B1)&&A.aaX(
...
C.ArS={Ac5:null,Ck:null,GU:null,VN:null,FD:null,TY:A.wf,Aj6:A.wf,ME:false,App:false
,AuO:function(){return this.ME;},YL:function(){if(this.Dk){this.O.Dz(this.Ck.B1);
this.O.G(A.abh(A.abg(this.O.M,A.aaI(this.O.M)),this.TY));this.O.Y(true);}if(!this.
Dk&&!this.Ck.B1){this.O.Dz(0);this.O.Y(false);}if(((!this.Dk&&(this.Ck.B1>0))&&!
!this.O.Ab)&&!this.QN){this.O.Dz(this.Ck.B1);this.O.G(A.abh(A.abg(this.O.M,A.aaI(
this.O.M)),this.TY));this.O.Y(true);}if((!this.Dk&&this.QN)&&!!this.O.Ab)this.O.
...
this.TY),[0,0,(B=this.Ab.M)[2]-B[0],B[3]-B[1]]))[0]>=B[2])||(B[1]>=B[3]));if(AyB&&
AyC){this.Ck.Ct=0;this.Ck.B1=0;this.Aj6=this.TY;this.VN.A5b();}this.App=this.O.AQl(
...
Dk&&!this.O.Fc())this.O.Dz(this.Ck.Ct);if((!this.Dk&&A.aaX(this.Aj6,this.TY))&&this.
VN.ACh())this.O.G(A.abh(A.abg(this.O.M,A.aaI(this.O.M)),this.Aj6));if(!this.Dk&&(
this.Ck.Ct===this.Ck.B1))this.O.Dz(this.Ck.Ct);if(!this.Dk&&((!this.O.Ab||!this.
O.Fc())||!this.O.GS)){this.ME=true;this.Mb();return;}if(((this.Dk&&(this.O.GS===
this.Ck.B1))&&A.aaX(A.aaI(this.O.M),this.TY))&&this.O.Fc()){this.ME=true;this.Mb(
);return;}if(((!this.Dk&&(this.O.GS===this.Ck.B1))&&A.aaX(A.aaI(this.O.M),this.TY
))&&this.VN.ACh()){this.ME=true;this.Mb();return;}if(((this.Ck.Ct===this.Ck.B1)&&
A.aaX(this.Aj6,this.TY))&&this.VN.ACh()){this.ME=true;this.Mb();return;}this.O.AqL(
true);this.O.Y(false);this.Ac5=A._NewObject(A.acg.ATg,0);this.Ac5.Bju(this.O);this.
Ac5.Dz(this.Ck.Ct);this.Ac5.Bkj(A.aaI([0,0,(B=this.O.M)[2]-B[0],B[3]-B[1]]));this.
...
B1=0;}this.Ck.R=[B=this.Ac5,B.Ava,B.Dz];this.Ck.Aej(false);this.Ck.Akg=false;this.
Ck.Sa=[this,this.Ah8];this.Ck.Agz=null;this.GU.Ar(!A.aaX(this.Aj6,this.TY)||!this.
VN.ACh());this.Ck.Ar(this.Ck.Ct!==this.Ck.B1);},Ah8:function(H){this.ME=!this.Ck.
Bw&&!this.GU.Bw;this.Mb();},Ay6:function(H){var B;var AzU=A.abe(this.TY,this.Aj6
);if(!this.Dk)AzU=[-AzU[0],-AzU[1]];this.FD.A5b();this.FD.Af9=this.VN.Af9;this.FD.
Bmx(AzU[0],AzU[1],0);this.FD.Bgf(this.VN,this.FD,this.GU.A4);if(this.Dk)this.Ac5.
A9b(this.Aj6,this.FD);else this.Ac5.A9b(this.TY,this.FD);},_Init:function(aArg){
C.Md._Init.call(this,aArg);C.FX._Init.call(this.Ck={I:this},0);C.MS._Init.call(this.
GU={I:this},0);A.Graphics.AwC._Init.call(this.VN={I:this},0);A.Graphics.AwC._Init.
call(this.FD={I:this},0);this.__proto__=C.ArS;},_Done:function(){this.__proto__=
C.Md;this.Ck._Done();this.GU._Done();this.VN._Done();this.FD._Done();C.Md._Done.
call(this);},_ReInit:function(){C.Md._ReInit.call(this);this.Ck._ReInit();this.GU.
_ReInit();this.VN._ReInit();this.FD._ReInit();},_Mark:function(D){var B;C.Md._Mark.
...
VN)._cycle!=D)B._Mark(B._cycle=D);if((B=this.FD)._cycle!=D)B._Mark(B._cycle=D);}
...
Ab.M)[2]-B[0],B[3]-B[1]];var CY=[(B=Ao.O.M)[2]-B[0],B[3]-B[1]];var pos=A9.slice(
0,2);pos=[(A9[0]+(((A9[2]-A9[0])/2)|0))-((CY[0]/2)|0),pos[1]];pos=[pos[0],(A9[1]+(((
A9[3]-A9[1])/2)|0))-((CY[1]/2)|0)];Ao.Arg=pos;},_Init:function(aArg){C.QW._Init.
...
this.AA6);Ao.Ck.Ct=0;Ao.Ck.B1=255;Ao.D3.Fy(this.AA6);Ao.D3.V7(23);return Ao;},RL:
...
1]];var CY=[(B=Ao.O.M)[2]-B[0],B[3]-B[1]];var pos=A9.slice(0,2);pos=[(A9[0]+(((A9[
2]-A9[0])/2)|0))-((CY[0]/2)|0),pos[1]];pos=[pos[0],(A9[1]+(((A9[3]-A9[1])/2)|0))-((
CY[1]/2)|0)];Ao.D3.B1=pos;if(((!Ao.O.Ab||!Ao.O.Fc())||!Ao.O.GS)||(((B=A.lb(Ao.O.
...
Ct=0;Ao.Ck.B1=255;Ao.D3.Fy(500);Ao.D3.V7(23);Ao.D3.AD_(0);Ao.D3.AD$(0);Ao.D3.Avw(
...
AjU(0);Ao.D3.Fy(500);Ao.D3.V7(23);Ao.D3.AD_(0);Ao.D3.AD$(0);Ao.D3.Avw(3);Ao.D3.ADa(
...
2]-B[0],B[3]-B[1]];var CY=[(B=Ao.O.M)[2]-B[0],B[3]-B[1]];var pos=A9.slice(0,2);if(((
Br&0x4)===0x4))pos=[A9[2]-CY[0],pos[1]];else if(((Br&0x2)===0x2))pos=[(A9[0]+(((
A9[2]-A9[0])/2)|0))-((CY[0]/2)|0),pos[1]];if(((Br&0x20)===0x20))pos=[pos[0],A9[3
]-CY[1]];else if(((Br&0x10)===0x10))pos=[pos[0],(A9[1]+(((A9[3]-A9[1])/2)|0))-((
CY[1]/2)|0)];Ao.D3.B1=pos;if(((!Ao.O.Ab||!Ao.O.Fc())||!Ao.O.GS)||(((B=A.lb(Ao.O.
M,[0,0,(B=Ao.Ab.M)[2]-B[0],B[3]-B[1]]))[0]>=B[2])||(B[1]>=B[3]))){var Hq=[(B=Ao.
Ab.M)[2]-B[0],B[3]-B[1]];switch(this.AtY){case 5:pos=[pos[0],-CY[1]];break;case 3:{
...
0],Hq[1]];pos=[-CY[0],pos[1]];}break;default:;}Ao.O.G(A.abJ(Ao.O.M,pos));}},A0U:
...
switch(this.AtY){case 5:pos=[pos[0],Hq[1]];break;case 3:{pos=[pos[0],Hq[1]];pos=[-
...
Ao.GU.Fy(500);Ao.GU.V7(23);Ao.GU.AD_(0);Ao.GU.AD$(0);Ao.GU.Avw(3);Ao.GU.ADa(0.5);
Ao.GU.ADW(3);Ao.GU.ADf(3);Ao.GU.ADq(0.5);Ao.VN.Aet(0.5,0.5,1);return Ao;},RL:function(
...
500);Ao.GU.V7(23);Ao.GU.AD_(0);Ao.GU.AD$(0);Ao.GU.Avw(3);Ao.GU.ADa(0.5);Ao.GU.ADW(
3);Ao.GU.ADf(3);Ao.GU.ADq(0.5);Ao.VN.Aet(0.5,0.5,1);return Ao;},Adu:function(){var
...
B[3]-B[1]];var CY=[(B=Ao.O.M)[2]-B[0],B[3]-B[1]];var pos=A9.slice(0,2);pos=[(A9[
0]+(((A9[2]-A9[0])/2)|0))-((CY[0]/2)|0),pos[1]];pos=[pos[0],(A9[1]+(((A9[3]-A9[1
])/2)|0))-((CY[1]/2)|0)];Ao.TY=A.abf(pos,[(CY[0]/2)|0,(CY[1]/2)|0]);if(((!Ao.O.Ab||
!Ao.O.Fc())||!Ao.O.GS)||(((B=A.lb(Ao.O.M,[0,0,(B=Ao.Ab.M)[2]-B[0],B[3]-B[1]]))[0
]>=B[2])||(B[1]>=B[3])))Ao.O.G(A.abJ(Ao.O.M,A.abe(Ao.TY,A.aaI([0,0,(B=Ao.O.M)[2]-
B[0],B[3]-B[1]]))));},A0U:function(H){var Ao=(C.ArS.isPrototypeOf(H)?H:null);Ao.
TY=A.aaI(Ao.O.M);},_Init:function(aArg){C.QW._Init.call(this,aArg);this.__proto__=
C.Aeu;},_className:"Effects::ScaleTransition"};C.Ag6={BAv:0,BBa:1,BBc:2,BBb:3,BzS:
4,BzU:5,BzT:6,BBG:7,BBI:8,BBH:9,Bzn:10,Bzp:11,Bzo:12,By5:13,By7:14,By6:15,BzJ:16
,BzL:17,BzK:18,Bze:19,Bzg:20,Bzf:21,BzI:22,BzW:23,BzH:24,BzX:25,Bzu:26};C.BzB={A2p:
...
function(){},_variants:function(){return this;},_this:null};C.AFh={OZ:A.abi(12,0
,null),AkH:A.abi(12,0,null),_Init:function(aArg){(this.OZ=[]).__proto__=C.AFh.OZ;(
...
!!Ao){Ao.YL();Ao.O.T=Ao.O.T&~0x40000;Ao=Ao.Ag;}Ao=this.B6;while(!!Ao){A.pe(Ao.A0I
...
call(this);},Bk8:function(FC){if(!FC)return;if(this.AO7())throw new Error(BC);if(
FC.O0!==this)throw new Error(EU);if(!!FC.Ag)FC.Ag.AH=FC.AH;else this.B7=FC.AH;if(
!!FC.AH)FC.AH.Ag=FC.Ag;else this.B6=FC.Ag;FC.O0=null;FC.Ag=null;FC.AH=null;if(!!
FC.O)FC.O.Ao5=null;A.pe(FC.AIP,FC);if(!this.B6)this.AlU();},A2j:function(FC){if(
!FC)return;if(this.AO7())throw new Error(Hd);if(!!FC.O0)throw new Error(I7);FC.AH=
this.B7;FC.Ag=null;if(!!this.B7)this.B7.Ag=FC;else this.B6=FC;this.B7=FC;FC.O0=this;
...
);if((B=C.ArE._this))B._ReInit(),C.ArE._ReInit.call(B);};C.DB=function(D){var B;
