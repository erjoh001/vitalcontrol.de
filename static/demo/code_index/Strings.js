...
"\u043F\u0435\u0440\u0435\u0442\u0432\u043E\u0440\u044E\u0432\u0430\u0447\u0430"
};C.Bdb={0:"(\xD8 {1} {2})",13:"Snitt daglig tilvekst"};C.AJS={1:"prosje\u010Dan prirast, \xD8\nod ro\u0111enja"
,2:"\u0414\u043D\u0435\u0432\u0435\u043D \u043F\u0440\u0438\u0440\u0430\u0441\u0442, "+
...
,18:"\u0412\u0430\u0433\u0430 \u043F\u0440\u0438 \u043D\u0430\u0440\u043E\u0434\u0436\u0435\u043D\u043D\u0456"
};C.AKR={0:"Births",9:"Geburten"};C.BdR={0:"Bovine/cattle",6:"Veised",8:"Bovine"
...
};C.Az$={0:"Bulk recording",9:"Massenzugang"};C.A2J={0:"CSV export",9:"CSV-Export"
...
"\u043F\u0440\u043E \u043D\u0430\u0440\u043E\u0434\u0436\u0435\u043D\u043D\u044F"
};C.A2S={0:"Clear all purchase notices",9:"Alle Meldungen l\xF6schen"};C.AAh={0:
...
,18:"\u041D\u0438\u043D\u0456\u0448\u043D\u0456\u0439"};C.Bec="DSP Herde";C.AAx={
...
};C.A25={0:"Data export for",9:"Datenexport f\xFCr"};C.AAA={0:"Data management",
...
};C.Bee={0:"DDMMYYYY",9:"TTMMJJJJ"};C.AAB={1:"datum i vrijeme",2:"\u0414\u0430\u0442\u0430 \u0438 \u0447\u0430\u0441"
...
};C.A2_={0:"Days on watch",9:"Tage unter Beobacht."};C.AiN={1:"zadane vrijednosti"
...
,18:"\u0421\u0443\u0445\u043E\u0441\u0442\u0456\u0439\u043A\u0456"};C.BeA={1:"upravlja\u010Dki program monitora"
...
,18:"\u0414\u0440\u0430\u0439\u0432\u0435\u0440 \u0435\u043A\u0440\u0430\u043D\u0443"
};C.BeB={1:"suho",0:"Dry",6:"Kinni",7:"Ummessa",8:"Tarie",9:"T",10:"\u03A3\u03C4\u03B5\u03AF\u03C1\u03B1"
...
,18:"\u0417\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u0438"};C.BeC={1:"EEPROM mati\u010Dna plo\u010Da"
...
"EEPROM"};C.BeD={1:"EEPROMplo\u010Da",0:"EEPROM Torchboard",8:"EEPROM carte (lumi\xE8re)"
,10:"\u03A0\u03BB\u03B1\u03BA\u03AD\u03C4\u03B1 \u03C6\u03B1\u03BA\u03BF\u03CD "+
"EEPROM",13:"EEPROM Datakort"};C.BeE="ESC";C.AAL={1:"broj u\u0161ne markice",2:"\u0423\u0448\u043D\u0430 \u043C\u0430\u0440\u043A\u0430"
...
};C.BeG={0:"Enter animal ID manually",8:"Saisir manuellement le n\xB0 de l\'animal"
,9:"Tiernr. manuell eingeben",15:"\u0412\u0432\u0435\u0441\u0442\u0438 ID \u0436\u0438\u0432\u043E\u0442\u043D\u043E\u0433\u043E "+
"\u0432\u0440\u0443\u0447\u043D\u0443\u044E",18:"\u0423\u0432\u0435\u0441\u0442\u0438 ID \u0442\u0432\u0430\u0440\u0438\u043D\u0438 "+
"\u0432\u0440\u0443\u0447\u043D\u0443"};C.BeH={1:"Aparat \u0107e pre\u0107i u modus mirovanja za {#} minute. Za ponovno pokretanje "+
...
};C.A3E={0:"Export animal data (csv)",9:"Tierdaten exportieren (CSV)"};C.AL$={0:
...
};C.BeL={0:"Error while creating backup on USB flash drive!",8:"\xC9chec de sauvegarde de donn\xE9es"
,9:"Bei der Erstellung der Daten~siche~rung auf dem USB-^Stick ist ein Fehler "+
"auf~ge~treten!"};C.BeM={0:"Error while restoring backup from USB flash drive!",
...
"Fehler auf~ge~treten!"};C.BeN={0:"Error when writing CSV file with birth notices to USB flash drive!"
...
"\u043F\u0440\u043E \u043D\u0430\u0440\u043E\u0434\u0436\u0435\u043D\u043D\u044F "+
"\u043D\u0430 USB \u043D\u0430\u043A\u043E\u043F\u0438\u0447\u0443\u0432\u0430\u0447!"
};C.BeO={0:"Error when writing CSV file with animal data to USB flash drive!",9:
"Fehler beim Export der Tierdaten auf den USB-Stick!"};C.BeP={0:"Error when writing CSV file with purchase notices to USB flash drive!"
...
};C.BeR={1:"Konzumacija hrane",2:"\u0418\u0437\u044F\u0434\u0435\u043D\u0430 \u0445\u0440\u0430\u043D\u0430"
...
,13:"%d.%m.%Y",15:"%d-%m-%Y",16:"%d/%m/%Y",17:"%d.%m.%Y",18:"%d.%m.%Y"};C.BeZ={1:
"%d. %m.",2:"%d.%m",4:"%d. %m.",0:"%m-%d",5:"%d-%m",6:"%d.%m",7:"%d.%m",8:"%d/%m"
,9:"%d.%m",10:"%#d/%#m",11:"%d/%m",12:"%m\u6708%d\u65E5",13:"%d.%m",15:"%d-%m",16:
"%d/%m",17:"%d.%m",18:"%d.%m"};C.Be0={1:"%H:%M %d. %m. %Y",2:"%H:%M %d.%m.%Y",4:
...
,18:"\u0406\u043D\u0434\u0438\u043A\u0430\u0442\u043E\u0440 \u0437\u0430\u0440\u044F\u0434\u0443"
};C.Be4={0:"This function is not available in the demo version!",8:"Cette fonction n\'est plus disponible dans la version d\xE9mo\xA0!"
,9:"Diese Funktion ist in der Demo~version nicht ver~f\xFCgbar!"};C.Bfu={1:"gr/dan"
...
};C.Bfw="HI-Tier";C.Bfx="Hardware";C.ANy={1:"krdo",2:"\u0421\u0442\u0430\u0434\u043E"
...
,18:"\u041F\u0440\u0438\u0445\u043E\u0432\u0430\u0442\u0438 \u043F\u0456\u0441\u043B\u044F "+
"\u0434\u0456\u0457"};C.Bfz={1:"Ne prikazu izmjerena grla",2:"\u0421\u043A\u0440\u0438\u0439 \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u0442\u0435 "+
...
,18:"\u0411\u0435\u0437\u043F\u043B\u0456\u0434\u043D\u0456\u0441\u0442\u044C"};
C.Info="Info";C.BfG={0:"Info columns",8:"Colonnes d\'informations",9:"Infospalten"
...
};C.Bf2={1:"kilogram",2:"\u041A\u0438\u043B\u043E\u0433\u0440\u0430\u043C",3:"\u516C\u65A4"
...
};C.Bf3={1:"dan laktacije",0:"Day of lactation",6:"Laktatsiooni p\xE4ev",7:"Lypsyp\xE4iv\xE4"
...
};C.Bf7={0:"Eartag: last 5 digits",8:"Marque auriculaire : 5 derniers chiffres",
9:"Ohrmarke: letzte 5 Ziffern"};C.Bf8={1:"zadnji mjesec",2:"\u041F\u043E\u0441\u043B\u0435\u0434\u0435\u043D \u043C\u0435\u0441\u0435\u0446"
...
};C.Bf9={1:"zadnji kvartal",2:"\u041F\u043E\u0441\u043B\u0435\u0434\u043D\u0430 \u0447\u0435\u0442\u0432\u044A\u0440\u0442"
...
};C.Bf_={1:"zadnja sedmica",2:"\u041F\u043E\u0441\u043B\u0435\u0434\u043D\u0430 \u0441\u0435\u0434\u043C\u0438\u0446\u0430"
...
,16:"Listas",17:"Listeler",18:"\u0421\u043F\u0438\u0441\u043A\u0438"};C.Bgd={1:"Lokacija"
,2:"\u041C\u0435\u0441\u0442\u043E\u043F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u0435"
...
};C.Bge={1:"nisko",2:"\u041D\u0438\u0441\u044A\u043A",3:"\u4F4E",4:"N\xEDzk\xFD"
...
};C.Bgj={1:"Mogu\u0107e pohraniti samo {1} \u017Eivotinja!",0:"Only up to {1} animals can be stored!"
...
};C.Bgk={1:"Mogu\u0107e pohraniti samo {1} neregistrovanih \u017Eivotinja!",0:"Only up to {1} animal unregistrations can be stored!"
...
"\u0437 \u043E\u0431\u043B\u0456\u043A\u0443!"};C.Bgl={1:"Mogu\u0107e pohraniti samo {1} podataka po \u017Eivotinji!"
...
};C.Bgn={1:"mjerenje nije uspjelo",2:"\u041D\u0435\u0443\u0441\u043F. \u0438\u0437\u043C\u0435\u0440\u0432\u0430\u043D\u0435"
...
"\u0432\u0438\u043A\u043E\u043D\u0430\u043D\u043E"};C.Bgo={1:"mjerenje uspjelo",
...
};C.Bgq={1:"Nedostaje ID \u017Eivotinje! Molimo odredite ID \u017Eivotinje koji je "+
...
};C.Bgr={1:"Nedostaje u\u0161na markica! Molimo odredite broj u\u0161ne markice za "+
...
,17:"\xC7oklu",18:"\u0411\u043B\u0438\u0437\u043D\u044E\u043A\u0438"};C.Bgv={1:"prije {1} dana"
...
,18:"{1} \u0456\u0437 4"};C.Bgy={0:"An animal ID is already linked to this animal!\nID reassignment is not "+
...
};C.A41={0:"New on farm, no transponder",9:"Zuk\xE4ufe, kein Transponder"};C.APL={
...
"\u043D\u0435 \u0437\u0430\u0440\u0435\u0454\u0441\u0442\u0440\u043E\u0432\u0430\u043D\u0456!"
};C.BgA={1:"Nema \u017Eivotinja na listi alarma!",2:"\u041D\u044F\u043C\u0430 \u0436\u0438\u0432\u043E\u0442\u043D\u043E/\u0438 "+
"\u0432 \u0441\u043F\u0438\u0441\u044A\u043A\u0430 \u0437\u0430 \u0430\u043B\u0430\u0440\u043C\u0438!"
...
"\u0443 \u0441\u043F\u0438\u0441\u043A\u0443 \u0442\u0440\u0438\u0432\u043E\u0433 "+
"\u043D\u0435\u043C\u0430\u0454!"};C.BgB={1:"Nema \u017Eivotinja na listi za kontrolu!"
,2:"\u041D\u044F\u043C\u0430 \u0436\u0438\u0432\u043E\u0442\u043D\u043E/\u0438 "+
...
"\u0441\u043F\u0438\u0441\u043A\u0443!"};C.BgC={0:"No animal(s) on watch list!",
9:"Keine Tier(e) auf der Beobachtungsliste!"};C.BgD={1:"Prazna lista / svim \u017Eivotinjama su dodijeljeni ID brojevi!"
...
"\u0442\u0432\u0430\u0440\u0438\u043D\u0438 \u043E\u0442\u0440\u0438\u043C\u0430\u043B\u0438 "+
"15-\u0437\u043D\u0430\u0447\u043D\u0456 ID-\u043D\u043E\u043C\u0435\u0440\u0438!"
};C.BgE={1:"Lista prazna / svim \u017Eivotinjama je dodijeljen oda\u0161ilja\u010D!"
,2:"\u041F\u0440\u0430\u0437\u0435\u043D \u0441\u043F\u0438\u0441\u044A\u043A,\n\u0432\u0441\u0438\u0447\u043A\u0438 "+
"\u0436\u0438\u0432\u043E\u0442\u043D\u0438 \u0442\u0440\u044F\u0431\u0432\u0430 "+
"\u0434\u0430 \u0438\u043C\u0430\u0442 \u0440\u0435\u0441\u043F\u043E\u043D\u0434\u0435\u0440\u0438!"
...
,18:"\u0429\u0435 \u0436\u043E\u0434\u043D\u0435 \u0442\u0435\u043B\u044F \u043D\u0435 "+
"\u0437\u043D\u044F\u0442\u043E \u0437 \u043E\u0431\u043B\u0456\u043A\u0443!"};C.
A47={0:"No change",9:"Keine \xC4nderung"};C.BgF={0:"No cow(s) on list!",8:"Aucune vache sur la liste\xA0!"
...
"\u0441\u0443\u0445\u043E\u0441\u0442\u0456\u0439\u043A\u0438\u0445 \u043A\u043E\u0440\u0456\u0432!"
};C.BgG={1:"Nema novih krava na spisku!",2:"\u041D\u044F\u043C\u0430 \u0441\u043A\u043E\u0440\u043E \u043E\u0442\u0435\u043B\u0435\u043D\u0430/\u0438 "+
"\u043A\u0440\u0430\u0432\u0430/\u0438 \u0432 \u0441\u043F\u0438\u0441\u044A\u043A\u0430!"
...
"\u043A\u043E\u0440\u043E\u0432!",18:"\u0423 \u0441\u043F\u0438\u0441\u043A\u0443 \u043D\u0435\u043C\u0430\u0454 "+
"\u043D\u043E\u0432\u043E\u0442\u0456\u043B\u044C\u043D\u0438\u0445 \u043A\u043E\u0440\u0456\u0432!"
};C.BgI={0:"No ratings recorded in the displayed date period!",8:"Aucune \xE9valuation n\'a \xE9t\xE9 enregistr\xE9 pendant la p\xE9riode "+
...
};C.BgJ={1:"Nema novi \u017Eivotinja za registraciju!",0:"Empty list, no registrations pending!"
...
"\u0446\u0438\u0444\u0440, \u043D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u043E!"
};C.BgK={0:"No temperatures and no ratings recorded in the period shown in the graphic!"
...
};C.BgL={1:"Nema sa\u010Duvanih vrijednosti temperature!",2:"\u0412\u0441\u0435 \u043E\u0449\u0435 \u043D\u044F\u043C\u0430 \u0437\u0430\u043F\u0438\u0441\u0438 "+
"\u0437\u0430 \u0442\u0435\u043C\u043F\u0435\u0440\u0430\u0442\u0443\u0440\u0430 "+
...
};C.BgM={1:"Danas nisu sa\u010Duvani podaci o te\u017Eini!",0:"No weights recorded today!"
...
C.BgO={1:"nema",2:"\u043D\u044F\u043C\u0430",3:"\u6C92\u6709",4:"\u017D\xE1dn\xFD"
,0:"None",5:"geen",6:"pole",7:"Ei yht\xE4\xE4n",8:"aucun",9:"Keine",10:"\u039A\u03B1\u03BD\u03AD\u03BD\u03B1"
...
"On watch",9:"Beobachtung"};C.Bkj={1:"Jedan interval za brojeve za \u2642 i \u2640"
,2:"\u0415\u0434\u0438\u043D \u0434\u0438\u0430\u043F\u0430\u0437\u043E\u043D "+
...
,18:"\u041E\u0434\u0438\u043D \u0434\u0456\u0430\u043F\u0430\u0437\u043E\u043D "+
"\u043D\u043E\u043C\u0435\u0440\u0456\u0432 \u0434\u043B\u044F \u2642 \u0442\u0430 "+
"\u2640"};C.Bkk={1:"druga oboljenja",2:"\u0414\u0440\u0443\u0433\u0438 \u0437\u0430\u0431\u043E\u043B\u044F\u0432\u0430\u043D\u0438\u044F"
...
"\u03B1\u03BD\u03B1\u03B3\u03BD\u03C9\u03C1\u03B9\u03C3\u03C4\u03B9\u03BA\u03BF\u03CD"
,13:"Lokale-ID-nummer"};C.Bkt={1:"Problemati\u010Dna prilikom mu\u017Enje",2:"\u041F\u043E\u0432\u0435\u0434\u0435\u043D\u0438\u0435 \u043F\u0440\u0438 "+
...
"\u043F\u0440\u0438 \u0434\u043E\u0457\u043D\u043D\u0456"};C.Bku={1:"Problemati\u010Dno pona\u0161enje u stadu"
...
"\u043F\u043E\u0432\u0435\u0434\u0456\u043D\u043A\u0430"};C.Bkv={0:"Produced",8:
"Produit",9:"Produziert"};C.Bkw={1:"Proizvo\u0111a\u010D",2:"\u041F\u0440\u043E\u0438\u0437\u0432\u043E\u0434\u0438\u0442\u0435\u043B"
,0:"Producer",6:"Tootja",7:"Tuottaja",8:"Producteur",9:"Hersteller",10:"\u03A0\u03B1\u03C1\u03B1\u03B3\u03C9\u03B3\u03CC\u03C2"
,13:"Produsent",15:"\u041F\u0440\u043E\u0438\u0437\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C"
,16:"Fabricante",18:"\u0412\u0438\u0440\u043E\u0431\u043D\u0438\u043A"};C.Bkx={1:
...
};C.Bky={0:"Purchase notices were deleted after export!",9:"Zugangsmeldungen wurden nach Export gel\xF6scht!"
...
};C.BkC={1:"Ukupno stanje \u017Eivotinja",2:"\u041E\u0431\u0449\u043E \u0441\u044A\u0441\u0442\u043E\u044F\u043D\u0438\u0435"
...
,17:"G\xF6r\xFCn\xFCm",18:"\u0421\u0442\u0430\u043D"};C.BkD={1:"Konzistencija izmeta"
...
"\u0424\u0435\u043A\u0430\u043B\u0456\u0457"};C.BkE={1:"Konzumacija hrane",2:"\u0418\u0437\u044F\u0434\u0435\u043D\u0430 \u0445\u0440\u0430\u043D\u0430"
,3:"\u63A1\u98DF",4:"Hodnocen\xED p\u0159\xEDjmu krmen\xED",0:"Feed intake",5:"Voeropname"
,6:"S\xF6\xF6mus",7:"Rehunsy\xF6nti",8:"Consommation",9:"Futteraufnahme",10:"\u03A0\u03C1\u03CC\u03C3\u03BB\u03B7\u03C8\u03B7 \u03C4\u03C1\u03BF\u03C6\u03AE\u03C2"
,13:"F\xF4ropptak",15:"\u041F\u043E\u0442\u0440\u0435\u0431\u043B\u0435\u043D\u0438\u0435 \u043A\u043E\u0440\u043C\u0430"
,16:"Ingesta de alimento",17:"Besin derecelendirmesi",18:"\u0421\u043F\u043E\u0436\u0438\u0432\u0430\u043D\u043D\u044F \u043A\u043E\u0440\u043C\u0443"
};C.BkF={1:"Oboljenja disajnih puteva",2:"\u0420\u0435\u0441\u043F\u0438\u0440\u0430\u0442\u043E\u0440\u043D\u0430 "+
...
"\u0448\u043B\u044F\u0445\u0456\u0432"};C.BkG={1:"Oboljenja disajnih puteva",2:"\u0420\u0435\u0441\u043F\u0438\u0440\u0430\u0442\u043E\u0440\u043D\u0430 "+
...
};C.BkH={2:"\u0414\u0438\u0430\u0440\u0438\u044F",4:"Pr\u016Fjem",0:"Scours",5:"Diarree"
...
};C.BkI={0:"Record {1} of {2}",6:"Salvesta{1} {2}st",7:"Enn\xE4tys {1} / {2}",8:
...
9:"Erfasste Werte"};C.BkK={1:"registrivati",2:"\u0420\u0435\u0433\u0438\u0441\u0442\u044A\u0440"
...
};C.BkL={1:"registrovana",2:"\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u0430\u043D\u0438"
...
,18:"\u041A\u0430\u0440\u0442\u0430 \u043F\u0430\u043C\'\u044F\u0442\u0456 "+"SD"
};C.BkY={1:"skenirati",2:"\u0421\u043A\u0430\u043D\u0438~\u0440\u0430\u043D\u0435"
,3:"\u6383\u63CF",4:"Ske~no~vat",0:"Scan",6:"Skan~neeri",7:"Skan~naa",8:"Scan~ner"
,10:"\u0391\u03BD\u03B9\u03C7~\u03BD\u03B5\u03CD\u03C3\u03C4\u03B5",13:"Skanning"
,15:"\u0421\u043A\u0430\u043D\u0438~\u0440\u043E~\u0432\u0430\u043D\u0438\u0435"
,16:"Esca~neo",17:"Tara",18:"\u0421\u043A\u0430\u043D\u0443\u0432\u0430\u043D\u043D\u044F"
};C.BkZ={0:"Scan ID of animal",8:"Scanner le n\xB0 d\'identification",9:"Ohrmarkennr. einscannen"
,15:"\u0421\u043A\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u0442\u044C ID "+"\u0436\u0438\u0432\u043E\u0442\u043D\u043E\u0433\u043E"
,18:"\u0421\u043A\u0430\u043D\u0443\u0432\u0430\u0442\u0438 ID \u0442\u0432\u0430\u0440\u0438\u043D\u0438"
};C.Bk0={1:"Skeniranje u\u0161ne markice",2:"\u0421\u043A\u0430\u043D\u0438\u0440\u0430\u0439 \u0435\u043B\u0435\u043A\u0442\u0440\u043E\u043D\u043D\u0430 "+
...
};C.Ble={0:"Sex + Type",8:"Sexe + type",9:"Geschlecht + Typ"};C.Blf={1:"Ovca/koza"
...
,8:"\xC9teindre l\'appareil apr\xE8s",9:"Ger\xE4t abschalten nach"};C.Blm={1:"jedno grlo u leglu"
...
};C.A8d={0:"Start-up screen ",9:"Startbildschirm"};C.GN={1:"Dr\u017Eava",2:"\u0421\u044A\u0441\u0442\u043E\u044F\u043D\u0438\u0435"
...
};C.Blw={1:"\u017Divotinja sa ID brojem {1} uspje\u0161no dodana na spisak \u017Eivotinja!"
...
"\u043D\u0430\u043A\u043E\u043F\u0438\u0447\u0443\u0432\u0430\u0447 \u043C\u043E\u0436\u043D\u0430 "+
"\u0431\u0435\u0437\u043F\u0435\u0447\u043D\u043E \u0432\u0438\u0442\u044F\u0433\u043D\u0443\u0442\u0438."
};C.Blz={0:"{1} notices of birth were cleared successfully!",6:"{1} s\xFCnniteavitust t\xFChistatud!"
...
"\u043F\u0440\u043E \u043D\u0430\u0440\u043E\u0434\u0436\u0435\u043D\u043D\u044F "+
"\u0431\u0443\u043B\u043E \u0432\u0438\u0434\u0430\u043B\u0435\u043D\u043E!"};C.
BlA={0:"{1} notices of purchase were cleared successfully!",9:"{1} Zugangs~meldungen wurden erfolg~reich gel\xF6scht!"
...
};C.BlB={0:"Notice of birth for animal {1} was cleared successfully!",6:"Looma {1} s\xFCnniteavitus t\xFChistatud!"
...
"\u0432\u0438\u0434\u0430\u043B\u0435\u043D\u043E!"};C.BlC={0:"Notice of purchase for animal {1} was cleared successfully!"
,9:"Zugangsmeldung f\xFCr Tier {1} wurde erfolgreich gel\xF6scht!"};C.BlD={0:"Backup file \u2019backup.vcb\u2019 with device data and {1}\xA0animal data "+
...
"\u0437 \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u043E\u043C"};C.BlE={1:"\u017Divotinja sa ID brojm {1} uspje\u0161no zasu\u0161ena!"
...
};C.BlF={1:"Sistem je uspje\u0161no a\u017Euriran, mo\u017Eete izvaditi USB.",2:
...
"\u043C\u043E\u0436\u043D\u0430 \u0432\u0438\u0442\u044F\u0433\u0442\u0438!"};C.
BlG={0:"Animal ID was successfully linked to animal with ID {1}!",8:"Un n\xB0 d\'identification a \xE9t\xE9 ajout\xE9 avec succ\xE8s \xE0 l\'animal "+
...
"\u0443\u0441\u043F\u0456\u0448\u043D\u043E \u043F\u0440\u0438\u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0439 "+
"\u0442\u0432\u0430\u0440\u0438\u043D\u0456 \u0437 ID {1}!"};C.BlH={1:"\u017Divotinja sa ID brojem {1} uspje\u0161no ozna\u010Dena - u fazi laktacije!"
...
};C.BlI={1:"\u017Divotinja sa ID brojem {1} uspje\u0161no izbrisana sa liste!",2:
"\u0416\u0438\u0432\u043E\u0442\u043D\u043E \u0441 \u2116 {1} \u0443\u0441\u043F\u0435\u0448\u043D\u043E "+
"\u0435 \u043F\u0440\u0435\u043C\u0430\u0445\u043D\u0430\u0442\u043E \u043A\u044A\u043C "+
"\u0441\u043F\u0438\u0441\u044A\u043A\u0430 \u0441 \u0430\u043B\u0430\u0440\u043C\u0438!"
...
"\u0432\u0438\u0434\u0430\u043B\u0435\u043D\u0430 \u0437\u0456 \u0441\u043F\u0438\u0441\u043A\u0443 "+
"\u0442\u0440\u0438\u0432\u043E\u0433!"};C.BlJ={0:"Animal with ID {1} success~fully removed from watch list!"
...
"\u0432\u0438\u0434\u0430\u043B\u0435\u043D\u0430!"};C.BlK={0:"Animal {1} and corresponding birth notice were deleted successfully!"
...
"{1} \u0443\u0441\u043F\u0456\u0448\u043D\u043E \u0432\u0438\u0434\u0430\u043B\u0435\u043D\u043E!"
};C.BlL={0:"Animal data were successfully written to directory \u2019export-csv\u2019 "+
"on USB flash drive.",9:"Tierdaten wurden erfolgreich auf den USB-Stick exportiert (Verzeichnis "+
"\u2019export-csv\u2019)."};C.BlM={0:"Animal data were successfully written to USB flash drive! Download data "+
"file \u2019animals.csv\u2019  now?",9:"Tierdaten wurden erfolgreich auf den USB-Stick exportiert. Soll die CSV-Tierdaten~datei "+
"jetzt heruntergeladen werden?"};C.BlN={0:"CSV file {1}, containing {2} birth notice(s) was successfully written to "+
...
"\u043D\u0430 USB \u043D\u0430\u043A\u043E\u043F\u0438\u0447\u0443\u0432\u0430\u0447."
};C.BlO={0:"CSV file with birth notices successfully written to USB flash drive! Download "+
...
"CSV \u0444\u0430\u0439\u043B?"};C.BlP={0:"CSV file {1}, containing {2} purchase notice(s) was successfully written "+
"to USB flash drive.",9:"CSV-Datei {1} mit {2} Zugangs~mel~dun~g(en) erfolgreich auf USB-Stick gespeichert."
};C.BlQ={0:"CSV file with purchase notices successfully written to USB flash drive! "+
...
};C.BlV={0:"Sending data",6:"Andmete edastamine",7:"L\xE4hetet\xE4\xE4n tietoja"
,8:"Envoi de donn\xE9es",9:"Sende Daten",10:"\u0391\u03C0\u03BF\u03C3\u03C4\u03BF\u03BB\u03AE \u03B4\u03B5\u03B4\u03BF\u03BC\u03AD\u03BD\u03C9\u03BD"
,13:"Sender data",15:"\u041E\u0442\u043F\u0440\u0430\u0432\u043A\u0430 \u0434\u0430\u043D\u043D\u044B\u0445"
,18:"\u0412\u0456\u0434\u043F\u0440\u0430\u0432\u043A\u0430 \u0434\u0430\u043D\u0438\u0445"
};C.BlW={0:"Synchronization failed",6:"S\xFCnkroniseerimine nurjus",7:"L\xE4hetysSynkronointi ep\xE4onnistui"
...
"\u043D\u0435 \u0432\u0434\u0430\u043B\u0430\u0441\u044C"};C.BlX={0:"Receiving data"
...
,18:"\u041E\u0442\u0440\u0438\u043C\u0430\u043D\u043D\u044F \u0434\u0430\u043D\u0438\u0445"
};C.BlY={0:"Initialising\u2026",6:"Alustamine...",7:"Alustetaan\u2026",8:"Initialiser..."
,9:"Initialisiere\u2026",10:"\u0391\u03C1\u03C7\u03B9\u03BA\u03BF\u03C0\u03BF\u03AF\u03B7\u03C3\u03B7..."
,13:"Initialiserer \u2026",15:"\u0418\u043D\u0438\u0446\u0438\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u044F..."
,18:"\u0406\u043D\u0456\u0446\u0456\u0430\u043B\u0456\u0437\u0430\u0446\u0456\u044F..."
};C.BlZ={0:"Initialising import",6:"Impordi alustamine",7:"Alustetaan tuontia",8:
...
"\u0456\u043C\u043F\u043E\u0440\u0442\u0443"};C.Bl0={0:"Cleaning up\u2026",6:"Impordij\xE4rgne s\xFCnkroniseerimine \u2026"
,7:"Puhdistaa \u2026",8:"Nettoyage",9:"R\xE4ume auf \u2026",10:"\u039A\u03B1\u03B8\u03B1\u03C1\u03B9\u03C3\u03BC\u03CC\u03C2 \u2026"
,13:"Rydder opp\u2026",15:"\u041E\u0447\u0438\u0441\u0442\u043A\u0430...",18:"\u041E\u0447\u0438\u0441\u0442\u043A\u0430..."
};C.Bl1={0:"Data transfer successfully finished",6:"Andmeedastus edukalt l\xF5petatud"
...
};C.AEU={4:"Teplota \xB0C",0:"\xB0C",7:"\xB0 C",17:"Santigrat"};C.Bl2={4:"Teplota \xB0F"
...
};C.Bl$={1:"ukupno",0:"Total",6:"Kokku",7:"Yh~teen~s\xE4",10:"\u03A3\u03CD\u03BD\u03BF\u03BB\u03BF"
,15:"\u0412\u0441\u0435\u0433\u043E",18:"\u0423\u0441\u044C\u043E\u0433\u043E"};
...
"\u043B\u0430\u0441\u043A\u0430, \u0432\u0438\u043A\u043E\u0440\u0438\u0441\u0442\u0430\u0439\u0442\u0435 "+
"\u0456\u043D\u0448\u0438\u0439 \u0442\u0440\u0430\u043D\u0441\u043F\u043E\u043D\u0434\u0435\u0440!"
};C.Bmd={1:"Nepoznat transponder! Skenirani transponder ID broj nije prona\u0111en "+
...
};C.Bme={1:"Ovoj \u017Eivotinji je ve\u0107 dodijeljen transponder! Novi transponder "+
...
,18:"\u0422\u0440\u0456\u0439\u043D\u044F"};C.Bmi={1:"dvojke",2:"\u0411\u043B\u0438\u0437\u043D\u0430\u0446\u0438"
...
,17:"\u0130kiz do\u011Fum",18:"\u0411\u043B\u0438\u0437\u043D\u044E\u043A"};C.Bmj={
...
};C.Bmm={1:"celzijus",2:"\u0426\u0435\u043B\u0437\u0438\u0439",3:"\u651D\u6C0F",
4:"Celsia",0:"Celsius",10:"\u039A\u03B5\u03BB\u03C3\u03AF\u03BF\u03C5",15:"\u0426\u0435\u043B\u044C\u0441\u0438\u0439"
,17:"Santigrat",18:"\u0426\u0435\u043B\u044C\u0441\u0456\u0439"};C.Bmn={1:"farenhajt"
...
,18:"\u0412\u0435\u0440\u0445\u043D\u044F \u043C\u0435\u0436\u0430"};C.Bmr={3:"Urban \u5065\u5EB7\u76E3\u63A7\u7CFB\u7D71\n\xA9 Urban GmbH & Co.KG, 2022"
,0:"Urban VitalControl\n\xA9 Urban GmbH & Co.KG, 2022"};C.Bms={1:"Tov (spostveni)"
,2:"\u0413\u043E\u0432\u0435\u0434\u043E (\u0441\u043E\u0431\u0441\u0442\u0432\u0435\u043D\u0430 "+
...
,18:"\u041F\u043E\u043C\u0435\u0440: \u0437 3-\u0433\u043E \u0434\u043D\u044F"};
C.Bmx={1:"Uginulo: nakon 48 h",2:"\u0423\u043C\u0438\u0440\u044F\u043B\u043E: \u0432 \u0440\u0430\u043C\u043A\u0438\u0442\u0435 "+
...
};C.Bmy={1:"Ostaje kod prodava\u010Da",2:"\u041E\u0441\u0442\u0430\u0432\u0430 \u0432\u044A\u0432 \u0444\u0435\u0440\u043C\u0430\u0442\u0430 "+
...
"\u0444\u0435\u0440\u043C\u0456 \u043F\u0440\u043E\u0434\u0430\u0432\u0446\u044F"
};C.Bmz={1:"Abortirano",2:"\u0410\u0431\u043E\u0440\u0442",0:"Abort",6:"Katkesta"
,7:"Keskeytt\xE4\xE4",8:"Fausse couche",9:"Ver~kalbung",10:"\u03A0\u03C1\u03BF\u03C7\u03C9\u03C1\u03AE\u03C3\u03C4\u03B5 \u03C3\u03B5 "+
"\u03B1\u03C0\u03BF\u03B2\u03BF\u03BB\u03AE",13:"Avbryte",15:"\u0410\u0431\u043E\u0440\u0442"
,18:"\u0410\u0431\u043E\u0440\u0442"};C.BmA={1:"Tov (prodato)",2:"\u0413\u043E\u0432\u0435\u0434\u043E (\u043F\u0440\u043E\u0434\u0430\u0434\u0435\u043D\u043E)"
...
,18:"\u041D\u0430 \u043C\'\u044F\u0441\u043E (\u043F\u0440\u043E\u0434\u0430\u0436)"
};C.BmB={1:"Uzgoj (prodato)",2:"\u0420\u0430\u0437\u0432\u044A\u0436\u0434\u0430\u043D\u0435 (\u043F\u0440\u043E\u0434\u0430\u0434\u0435\u043D\u043E)"
...
};C.BmC={1:"vibrator",0:"Vibration motor",6:"Vibratsioonimootor",8:"Moteur \xE0 vibration"
...
"\u0412\u0456\u0431\u0440\u0430\u0446\u0456\u044F \u043D\u0430\u0442\u0438\u0441\u043D\u0435\u043D\u043D\u044F "+
"\u043A\u043D\u043E\u043F\u043A\u0438"};C.BmF={1:"Demo CitalControl",0:"Demo VitalControl"
,6:"VitalControl demo",10:"\u0395\u03C0\u03AF\u03B4\u03B5\u03B9\u03BE\u03B7 VitalControl"
,15:"\u0414\u0435\u043C\u043E VitalControl",18:"\u0414\u0435\u043C\u043E VitalControl"
};C.BmG={1:"WLAN \u010Dip",0:"WLAN Chip",6:"WLAN kiip",7:"WLAN -siru",8:"Puce WIFI"
,10:"WLAN \u03C4\u03C3\u03AF\u03C0",15:"\u0427\u0438\u043F WiFI",18:"\u0427\u0456\u043F WiFi"
};C.BmH={1:"\u010Cekanje da se vrijednost o\u010Dita",2:"\u0418\u0437\u0447\u0430\u043A\u0432\u0430 \u0441\u0435 \u0441\u0442\u0430\u0431\u0438\u043B\u043D\u0430 "+
"\u0441\u0442\u043E\u0439\u043D\u043E\u0441\u0442",3:"\u7B49\u5F85\u7A69\u5B9A\u7684\u503C"
...
"\u0432\u043F\u0435\u0432\u043D\u0435\u043D\u0456?"};C.BmK={0:"The animal selected as dam does not have a 15-digit animal ID assigned.\nDo "+
...
"\u043C\u0430\u0442\u0435\u0440\u0456?"};C.BmL={0:"No transponder is linked to selected animal, therefore unlinking of trans~ponder "+
...
"\u0431\u0443\u0434\u0435 \u0432\u0438\u0434\u0430\u043B\u0435\u043D\u043E!\n\u0412\u0438 "+
"\u0432\u043F\u0435\u0432\u043D\u0435\u043D\u0456?"};C.BmM={1:"Svi podaci o aparatima i \u017Eivotinjama bi\u0107e izbrisani! Jeste li "+
...
"\u0432\u0438\u0434\u0456\u0432 \u0442\u0432\u0430\u0440\u0438\u043D \u0431\u0443\u0434\u0435 "+
"\u0441\u043A\u0438\u043D\u0443\u0442\u043E!\n\u0412\u0438 \u0432\u043F\u0435\u0432\u043D\u0435\u043D\u0456?"
};C.BmN={1:"Da li stvarno \u017Eelite vratiti na fabri\u010Dke postavke ({1} {2})?"
,2:"\u041D\u0430\u0438\u0441\u0442\u0438\u043D\u0430 \u043B\u0438 \u0438\u0441\u043A\u0430\u0442\u0435 "+
"\u0434\u0430 \u0432\u044A\u0437\u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442\u0435 "+
...
};C.BmO={1:"Ne postoji broj transpondera za tu \u017Eivotinju? Da li \u017Eelite da "+
...
};C.BmP={1:"Da li stvarno \u017Eelite isklju\u010Diti aparat?",2:"\u041D\u0430\u0438\u0441\u0442\u0438\u043D\u0430 \u043B\u0438 \u0436\u0435\u043B\u0430\u0435\u0442\u0435 "+
...
"\u0432\u0438\u043C\u043A\u043D\u0443\u0442\u0438 \u043F\u0440\u0438\u0441\u0442\u0440\u0456\u0439?"
};C.BmQ={1:"Aparat \u0107e se isklju\u010Diti za {1} sekundi!",2:"\u0418\u0437\u043A\u043B\u044E\u0447\u0432\u0430\u043D\u0435 \u043D\u0430 "+
...
,16:"Semana",18:"\u0422\u0438\u0436\u0434\u0435\u043D\u044C"};C.BmU={1:"vaganje \u017Eivotinje"
,2:"\u041F\u0440\u0435\u0442\u0435\u0433\u043B\u0438 \u0436\u0438\u0432\u043E\u0442\u043D\u043E"
...
};C.BmV={1:"Te\u017Eina trupa",2:"\u0422\u0440\u0443\u043F\u043D\u043E \u0442\u0435\u0433\u043B\u043E"
