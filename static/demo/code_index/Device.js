...
AW4="Host MSC";var AW5="Illegal animalIdAutoGenerationMethod: ";var AW6="Unhandled month: ";
var AGA="Illegal transponderAssignmentIdChangeMethod: ";var AW7="Unhandled animal table field: ";
var AW8="Unhandled data export destination: ";var AW9="Listenansicht";var AW_="Einzelansicht";
var AW$="Unhandled list view scope: ";
...
AL;if(!this.B7)this.B7=AL;},AMB:function(){return this.B7;},AMF:function(A_j){if(
!!A_j)return A_j.Af;return null;},D0:function(AG_,EE){var Av=this.B7;while(!!Av){
...
Ku===AI)return;this.Ku=AI;A.aat([this,this.ACy,this.A9z],0);},Yy:function(E){if(
this.K&&this.K.Yy)return this.K.Yy.apply(this,arguments);else return C.DeviceClass.
BqC.apply(this,arguments);},BqC:function(E){},A9z:function(An){this.Yy(An);},UpdateBatteryChargeState:
...
BqU.apply(this,arguments);},BqU:function(E){A.aa8("%s",EV);},Aw0:function(An){this.
ACZ(An);},UpdateScanState:function(AI){var B;if(this.ScanState===AI)return;this.
ScanState=AI;A.aat([this,this.AQr,this.AXE],0);A._GetAutoObject(C.Helper).BwL(this
...
,GS);},AXE:function(An){this.AqD(An);},UpdateMeasureState:function(AI){if(this.MeasureState===
...
Brg.apply(this,arguments);},Brg:function(E){A.aa8("%s",Jt);},AGQ:function(An){this.
...
Avr.apply(this,arguments);else return C.DeviceClass.BrE.apply(this,arguments);},
BrE:function(E){A.aa8("%s",IL);},AGT:function(An){this.Avr(An);},AmH:function(E){
if(this.K&&this.K.AmH)return this.K.AmH.apply(this,arguments);else return C.DeviceClass.
Brb.apply(this,arguments);},Brb:function(E){},A9O:function(An){this.AmH(An);},Avs:
function(E){if(this.K&&this.K.Avs)return this.K.Avs.apply(this,arguments);else return C.
DeviceClass.BrF.apply(this,arguments);},BrF:function(E){},ArU:function(An){this.
Avs(An);},ACX:function(E){if(this.K&&this.K.ACX)return this.K.ACX.apply(this,arguments
);else return C.DeviceClass.BqT.apply(this,arguments);},BqT:function(E){},A9H:function(
...
E){},AXx:function(An){this.ADt(An);},UpdateMonitoring:function(AI){if(this.ACk===
AI)return;this.ACk=AI;A.aat([this,this.AQh,this.AXx],0);},UpdateDataTable:function(
A_k){var B;switch(A_k){case 0:A.ow([B=this.Ao,B.Aju],this);break;case 1:A.ow([B=
...
,A_k);}},Av0:function(){if(this.K&&this.K.Av0)return this.K.Av0.apply(this,arguments
...
,arguments);},Br_:function(){},Am2:function(){if(this.K&&this.K.Am2)return this.
K.Am2.apply(this,arguments);else return C.DeviceClass.Bsb.apply(this,arguments);
...
_SetLanguage(0);}A.aat([this,this.A5K,this.A9O],0);},UpdateTemperatureUnit:function(
...
AI;A.aat([this,this.A5z,this.A9H],0);},SetSystemTime:function(Aho){if(this.K&&this.
K.SetSystemTime)return this.K.SetSystemTime.apply(this,arguments);else return C.
DeviceClass.Br7.apply(this,arguments);},Br7:function(Aho){},AvW:function(){if(this.
K&&this.K.AvW)return this.K.AvW.apply(this,arguments);else return C.DeviceClass.
A9p.apply(this,arguments);},A9p:function(){},AEn:function(){if(this.K&&this.K.AEn
)return this.K.AEn.apply(this,arguments);else return C.DeviceClass.A9n.apply(this
,arguments);},A9n:function(){},BkO:function(){},UpdateOverlayMenu:function(AI){if(
...
else return C.DeviceClass.Brt.apply(this,arguments);},Brt:function(E){},AGS:function(
...
E){},A9X:function(An){this.Avx(An);},UpdateUnderTemp:function(AI){if(this.Y$===AI
)return;this.Y$=AI;A.aat([this,this.A58,this.A9X],0);},UpdateSyncState:function(
AI){if(this.SyncState===AI)return;this.SyncState=AI;A.aat([this,this.AQt,this.AXG
...
,N1);},AXG:function(An){this.Abm(An);},AA_:function(){if(this.K&&this.K.AA_)return this.
K.AA_.apply(this,arguments);else return C.DeviceClass.Bqu.apply(this,arguments);
},Bqu:function(){return A.jm;},UpdatePopup:function(Kn,AYn,AYj,AYq){this.A5(Kn,AYn
,AYj,AYq,[this,this.Bwt]);},PopupStateChanged:function(Kn,Ae){if(this.K&&this.K.
PopupStateChanged)return this.K.PopupStateChanged.apply(this,arguments);else return C.
DeviceClass.Br0.apply(this,arguments);},Br0:function(Kn,Ae){},ADW:function(E){if(
this.K&&this.K.ADW)return this.K.ADW.apply(this,arguments);else return C.DeviceClass.
BrQ.apply(this,arguments);},BrQ:function(E){},A9Y:function(An){this.ADW(An);},UpdateVibrationOnKeypressEnabled:
function(AI){if(this.Arq===AI)return;this.Arq=AI;A.aat([this,this.A59,this.A9Y],
0);},Ad8:function(E){if(this.K&&this.K.Ad8)return this.K.Ad8.apply(this,arguments
);else return C.DeviceClass.BrP.apply(this,arguments);},BrP:function(E){},AGU:function(
An){this.Ad8(An);},UpdateVibrationOn:function(A_M){if(this.AS3===A_M)return;this.
AS3=A_M;A.aat([this,this.ACJ,this.AGU],0);},A5:function(Kn,AYn,AYj,AYq,BtC){var Afy=
A._NewObject(C.PopupContext,0);Afy.Id=Kn;Afy.Show=AYn;Afy.AjP=AYj;Afy.Aj_=AYq;Afy.
AD5=BtC;this.AmS.Trigger(Afy,false);},Bwt:function(H){var Ar=(C.PopupContext.isPrototypeOf(
...
Brx.apply(this,arguments);},Brx:function(E){},AXD:function(An){this.Avo(An);},UpdateRatingMode:
function(AI){if(this.RatingMode===AI)return;this.RatingMode=AI;A.aat([this,this.
AQq,this.AXD],0);},Ad0:function(E){if(this.K&&this.K.Ad0)return this.K.Ad0.apply(
this,arguments);else return C.DeviceClass.Bq5.apply(this,arguments);},Bq5:function(
E){},ArT:function(An){this.Ad0(An);},UpdateFlashLightOn:function(A_s){if(this.AlV===
A_s)return;this.AlV=A_s;A.aat([this,this.Ap$,this.ArT],0);},YI:function(E){if(this.
K&&this.K.YI)return this.K.YI.apply(this,arguments);else return C.DeviceClass.BrI.
apply(this,arguments);},BrI:function(E){},AXH:function(An){this.YI(An);},UpdateTopLightOn:
function(A_H){if(this.ASN===A_H)return;this.ASN=A_H;A.aat([this,this.AQv,this.AXH
...
An){this.Abk(An);},UpdateRGBTopLight:function(A_C){if(this.ARF===A_C)return;this.
ARF=A_C;A.aat([this,this.BhE,this.Bsr],0);},AuU:function(E){if(this.K&&this.K.AuU
)return this.K.AuU.apply(this,arguments);else return C.DeviceClass.BqN.apply(this
,arguments);},BqN:function(E){},Bsj:function(An){this.AuU(An);},UpdateAutoRegistrationMode:
function(A_g){if(this.AutoRegistrationMode===A_g)return;this.AutoRegistrationMode=
A_g;A.aat([this,this.Bg5,this.Bsj],0);},AqE:function(E){if(this.K&&this.K.AqE)return this.
K.AqE.apply(this,arguments);else return C.DeviceClass.Brz.apply(this,arguments);
},Brz:function(E){A.aa8("%s",CJ);},AXF:function(An){this.AqE(An);},UpdateScanTransponder:
function(Kn,A_K,A_J){if(((this.PD.Id===Kn)&&(this.PD.TransponderType===A_K))&&(this.
PD.TransponderProtocol===A_J))return;this.PD.OnSetId(Kn);this.PD.ARi(A_K);this.PD.
ARh(A_J);A.aat([this,this.AQs,this.AXF],0);},Pz:function(E){if(this.K&&this.K.Pz
)return this.K.Pz.apply(this,arguments);else return C.DeviceClass.BqX.apply(this
,arguments);},BqX:function(E){},AbU:function(An){this.Pz(An);},UpdateDigitsID:function(
A_o){if(this.FP===A_o)return;this.FP=A_o;A.aat([this,this.Aa9,this.AbU],0);},Qx:
function(E){if(this.K&&this.K.Qx)return this.K.Qx.apply(this,arguments);else return C.
DeviceClass.Brs.apply(this,arguments);},Brs:function(E){},AbV:function(An){this.
Qx(An);},UpdateOffsetID:function(A_z){if(this.Fx===A_z)return;this.Fx=A_z;A.aat([
this,this.Aa_,this.AbV],0);},AD0:function(E){if(this.K&&this.K.AD0)return this.K.
AD0.apply(this,arguments);else return C.DeviceClass.BrX.apply(this,arguments);},
BrX:function(E){A.aa8("%s",Fn);},AGV:function(An){this.AD0(An);},UpdateWeightValue:
...
else return C.DeviceClass.Bre.apply(this,arguments);},Bre:function(E){},AXw:function(
An){this.Avf(An);},UpdateMassUnit:function(AI){if(this.MassUnit===AI)return;this.
MassUnit=AI;A.aat([this,this.AQg,this.AXw],0);},Aqf:function(E){if(this.K&&this.
K.Aqf)return this.K.Aqf.apply(this,arguments);else return C.DeviceClass.A9j.apply(
this,arguments);},A9j:function(E){},A9w:function(An){this.Aqf(An);},Aqg:function(
E){if(this.K&&this.K.Aqg)return this.K.Aqg.apply(this,arguments);else return C.DeviceClass.
A9k.apply(this,arguments);},A9k:function(E){},AXp:function(An){this.Aqg(An);},UpdateActiveActions:
function(AI){if(this.P7===AI)return;this.P7=AI;A.aat([this,this.A5j,this.A9w],0);
},UpdateActiveActionsOrder:function(AI){if(this.As$===AI)return;this.As$=AI;A.aat([
this,this.AP4,this.AXp],0);},Abb:function(E){if(this.K&&this.K.Abb)return this.K.
Abb.apply(this,arguments);else return C.DeviceClass.A9l.apply(this,arguments);},
A9l:function(E){},A9F:function(An){this.Abb(An);},UpdateAutoActions:function(AI){
if(this.AutoActions===AI)return;this.AutoActions=AI;A.aat([this,this.A5v,this.A9F
],0);},AEO:function(){if(this.K&&this.K.AEO)return this.K.AEO.apply(this,arguments
);else return C.DeviceClass.Br$.apply(this,arguments);},Br$:function(){},Arg:function(
...
Py,this.Bsi],0);},Avy:function(E){if(this.K&&this.K.Avy)return this.K.Avy.apply(
this,arguments);else return C.DeviceClass.BrV.apply(this,arguments);},BrV:function(
E){},A93:function(An){this.Avy(An);},UpdateWeightRecordingMode:function(A_O){if(
this.WeightRecordingMode===A_O)return;this.WeightRecordingMode=A_O;A.aat([this,this.
A6f,this.A93],0);},ADB:function(E){if(this.K&&this.K.ADB)return this.K.ADB.apply(
this,arguments);else return C.DeviceClass.Bru.apply(this,arguments);},Bru:function(
E){A.aa8("%s",Nb);},AXB:function(An){this.ADB(An);},UpdatePredictedTempValue:function(
AI){if(this.AEa===AI)return;this.AEa=AI;A.aat([this,this.AQn,this.AXB],0);},Se:function(
L0){if(this.K&&this.K.Se)return this.K.Se.apply(this,arguments);else return C.DeviceClass.
Br6.apply(this,arguments);},Br6:function(L0){},AC5:function(E){if(this.K&&this.K.
AC5)return this.K.AC5.apply(this,arguments);else return C.DeviceClass.BqW.apply(
this,arguments);},BqW:function(E){},AGO:function(An){this.AC5(An);},UpdateDemoMode:
...
else return C.DeviceClass.BqD.apply(this,arguments);},BqD:function(E){},A9A:function(
An){this.ACO(An);},UpdateAgeRegistration:function(A_y){if(this.Ait===A_y)return;
this.Ait=A_y;A.aat([this,this.A5o,this.A9A],0);},Avz:function(E){if(this.K&&this.
K.Avz)return this.K.Avz.apply(this,arguments);else return C.DeviceClass.BrW.apply(
this,arguments);},BrW:function(E){},A94:function(An){this.Avz(An);},UpdateWeightRecordingScope:
function(A_D){if(this.WeightRecordingScope===A_D)return;this.WeightRecordingScope=
A_D;A.aat([this,this.A6g,this.A94],0);},JM:function(E){if(this.K&&this.K.JM)return this.
K.JM.apply(this,arguments);else return C.DeviceClass.Bq9.apply(this,arguments);}
,Bq9:function(E){},AXv:function(An){this.JM(An);},UpdateGender:function(LY){if(this.
Gender===LY)return;this.Gender=LY;A.aat([this,this.VJ,this.AXv],0);},Aqv:function(
E){if(this.K&&this.K.Aqv)return this.K.Aqv.apply(this,arguments);else return C.DeviceClass.
Bq$.apply(this,arguments);},Bq$:function(E){},Aw4:function(An){this.Aqv(An);},UpdateIDLastUsedMale:
...
);else return C.DeviceClass.Bq_.apply(this,arguments);},Bq_:function(E){},Aw3:function(
...
,arguments);},BqI:function(E){},AGM:function(An){this.Aba(An);},UpdateAnimalListContent:
...
else return C.DeviceClass.BqE.apply(this,arguments);},BqE:function(E){},A9B:function(
An){this.ACQ(An);},UpdateAlarmListAction:function(AI){if(this.AJ6===AI)return;this.
AJ6=AI;A.aat([this,this.A5q,this.A9B],0);},AC8:function(E){if(this.K&&this.K.AC8
)return this.K.AC8.apply(this,arguments);else return C.DeviceClass.Bq4.apply(this
,arguments);},Bq4:function(E){},A9K:function(An){this.AC8(An);},UpdateFlashLightInMeasureState:
function(A_t){if(this.AlU===A_t)return;this.AlU=A_t;A.aat([this,this.A5C,this.A9K
],0);},AdY:function(E){if(this.K&&this.K.AdY)return this.K.AdY.apply(this,arguments
);else return C.DeviceClass.BqH.apply(this,arguments);},BqH:function(E){},AXr:function(
An){this.AdY(An);},UpdateAnimalInfoContent:function(AI){if(this.D3===AI)return;this.
D3=AI;A.aat([this,this.AP6,this.AXr],0);},ADZ:function(E){if(this.K&&this.K.ADZ)
return this.K.ADZ.apply(this,arguments);else return C.DeviceClass.BrR.apply(this
,arguments);},BrR:function(E){},A9Z:function(An){this.ADZ(An);},UpdateWatchListAction:
function(AI){if(this.AS5===AI)return;this.AS5=AI;A.aat([this,this.A6b,this.A9Z],
0);},AC9:function(E){if(this.K&&this.K.AC9)return this.K.AC9.apply(this,arguments
);else return C.DeviceClass.Bq6.apply(this,arguments);},Bq6:function(E){},A9M:function(
An){this.AC9(An);},UpdateFreshCowListAction:function(AI){if(this.AMs===AI)return;
this.AMs=AI;A.aat([this,this.A5E,this.A9M],0);},AqZ:function(H){if(this.K&&this.
K.AqZ)return this.K.AqZ.apply(this,arguments);else return C.DeviceClass.Br1.apply(
this,arguments);},Br1:function(H){},BBO:function(s){this.AqZ(s);},Aq1:function(H
){if(this.K&&this.K.Aq1)return this.K.Aq1.apply(this,arguments);else return C.DeviceClass.
Br3.apply(this,arguments);},Br3:function(H){},BBQ:function(s){this.Aq1(s);},AuS:
function(E){if(this.K&&this.K.AuS)return this.K.AuS.apply(this,arguments);else return C.
DeviceClass.BqL.apply(this,arguments);},BqL:function(E){},A9D:function(An){this.
AuS(An);},AqF:function(E){if(this.K&&this.K.AqF)return this.K.AqF.apply(this,arguments
);else return C.DeviceClass.BrG.apply(this,arguments);},BrG:function(E){},A9U:function(
...
E){},A9V:function(An){this.AqG(An);},Aq3:function(H){if(this.K&&this.K.Aq3)return this.
K.Aq3.apply(this,arguments);else return C.DeviceClass.Br4.apply(this,arguments);
},Br4:function(H){},BBR:function(s){this.Aq3(s);},UpdateTemperaturesLowString:function(
AI){if(this.AEY===AI)return;this.AEY=AI;A.aat([this,this.A54,this.A9V],0);},UpdateTemperaturesHighString:
function(AI){if(this.AEX===AI)return;this.AEX=AI;A.aat([this,this.A53,this.A9U],
0);},UpdateAnimalTypesString:function(AI){if(this.AzR===AI)return;this.AzR=AI;A.
aat([this,this.A5t,this.A9D],0);},ADw:function(E){if(this.K&&this.K.ADw)return this.
K.ADw.apply(this,arguments);else return C.DeviceClass.Brr.apply(this,arguments);
},Brr:function(E){},AXz:function(An){this.ADw(An);},UpdateNoTransponderListAction:
function(AI){if(this.APT===AI)return;this.APT=AI;A.aat([this,this.AQk,this.AXz],
...
this.AlY=AI;A.aat([this,this.Bhm,this.Bsn],0);},Aqz:function(E){if(this.K&&this.
K.Aqz)return this.K.Aqz.apply(this,arguments);else return C.DeviceClass.Bro.apply(
this,arguments);},Bro:function(E){},A9R:function(An){this.Aqz(An);},UpdateNaisIdLastUsedMale:
function(Ws){if(this.ACm===Ws)return;this.ACm=Ws;A.aat([this,this.A5R,this.A9R],
0);},Aqy:function(E){if(this.K&&this.K.Aqy)return this.K.Aqy.apply(this,arguments
);else return C.DeviceClass.Brn.apply(this,arguments);},Brn:function(E){},A9Q:function(
An){this.Aqy(An);},UpdateNaisIdLastUsedFemale:function(Ws){if(this.ACl===Ws)return;
this.ACl=Ws;A.aat([this,this.A5Q,this.A9Q],0);},Avk:function(E){if(this.K&&this.
K.Avk)return this.K.Avk.apply(this,arguments);else return C.DeviceClass.Brl.apply(
this,arguments);},Brl:function(E){},Aw6:function(An){this.Avk(An);},UpdateNaisIdIncrementMale:
...
);else return C.DeviceClass.Brk.apply(this,arguments);},Brk:function(E){},Aw5:function(
...
return C.DeviceClass.A9q.apply(this,arguments);},A9q:function(){},AmD:function(E
){if(this.K&&this.K.AmD)return this.K.AmD.apply(this,arguments);else return C.DeviceClass.
BqQ.apply(this,arguments);},BqQ:function(E){},A9G:function(An){this.AmD(An);},UpdateBootloaderMessage:
function(AI){if(this.Ape===AI)return;this.Ape=AI;A.aat([this,this.A5y,this.A9G],
0);},ACM:function(E){if(this.K&&this.K.ACM)return this.K.ACM.apply(this,arguments
);else return C.DeviceClass.Bqy.apply(this,arguments);},Bqy:function(E){},A9v:function(
An){this.ACM(An);},UpdateActionListAction:function(AI){if(this.AzK===AI)return;this.
AzK=AI;A.aat([this,this.A5i,this.A9v],0);},AuQ:function(E){if(this.K&&this.K.AuQ
)return this.K.AuQ.apply(this,arguments);else return C.DeviceClass.Bqz.apply(this
,arguments);},Bqz:function(E){},Bsh:function(An){this.AuQ(An);},UpdateActionListHideMeasured:
function(AI){if(this.Alx===AI)return;this.Alx=AI;A.aat([this,this.Bg1,this.Bsh],
0);},TA:function(E){if(this.K&&this.K.TA)return this.K.TA.apply(this,arguments);
else return C.DeviceClass.BqG.apply(this,arguments);},BqG:function(E){},Anx:function(
An){this.TA(An);},UpdateAnimalIdGenerationMethod:function(A_T){if(this.Ia===A_T)
return;this.Ia=A_T;A.aat([this,this.Amu,this.Anx],0);},Au4:function(E){if(this.K&&
this.K.Au4)return this.K.Au4.apply(this,arguments);else return C.DeviceClass.BqY.
apply(this,arguments);},BqY:function(E){},AXt:function(An){this.Au4(An);},UpdateDirectionOfCountingFemale:
function(Akq){if(this.AAG===Akq)return;this.AAG=Akq;A.aat([this,this.AP$,this.AXt
],0);},Au5:function(E){if(this.K&&this.K.Au5)return this.K.Au5.apply(this,arguments
);else return C.DeviceClass.BqZ.apply(this,arguments);},BqZ:function(E){},AXu:function(
An){this.Au5(An);},UpdateDirectionOfCountingMale:function(Akq){if(this.AAH===Akq
)return;this.AAH=Akq;A.aat([this,this.AQa,this.AXu],0);},Au6:function(E){if(this.
K&&this.K.Au6)return this.K.Au6.apply(this,arguments);else return C.DeviceClass.
Bq0.apply(this,arguments);},Bq0:function(E){},Aw1:function(An){this.Au6(An);},UpdateDirectionOfCountingUnisex:
...
);else return C.DeviceClass.Bra.apply(this,arguments);},Bra:function(E){},Any:function(
...
)return this.K.AqA.apply(this,arguments);else return C.DeviceClass.Brp.apply(this
,arguments);},Brp:function(E){},AXy:function(An){this.AqA(An);},UpdateNaisIdLastUsedUnisex:
function(Ws){if(this.Aux===Ws)return;this.Aux=Ws;A.aat([this,this.AQi,this.AXy],
0);},Avl:function(E){if(this.K&&this.K.Avl)return this.K.Avl.apply(this,arguments
);else return C.DeviceClass.Brm.apply(this,arguments);},Brm:function(E){},Aw7:function(
...
this,arguments);},Bq2:function(E){},Aw2:function(An){this.AjA(An);},UpdateEartagNrAssignmentMode:
...
,BqS:function(E){},Bsl:function(An){this.NP(An);},UpdateBreed:function(Ab2){if(this.
Breed===Ab2)return;this.Breed=Ab2;A.aat([this,this.AuB,this.Bsl],0);},ADq:function(
E){if(this.K&&this.K.ADq)return this.K.ADq.apply(this,arguments);else return C.DeviceClass.
Brh.apply(this,arguments);},Brh:function(E){},Bsp:function(An){this.ADq(An);},UpdateMiddlewareVersions:
function(PO,AYf,AYg,AYm,AX6){this.R3.OnSetTimestamp(PO);this.R3.ADl(AYf);this.R3.
ADs(AYg);this.R3.ADE(AYm);this.R3.AC3(AX6);A.aat([this,this.Bhz,this.Bsp],0);},ADk:
...
ADk(An);},UpdateMainboardVersions:function(PO,AYd,AYe,AYc,AYs,AYt,AYr){this.Qs.OnSetTimestamp(
PO);this.Qs.ADi(AYd);this.Qs.ADj(AYe);this.Qs.ADh(AYc);this.Qs.ADR(AYs);this.Qs.
ADS(AYt);this.Qs.ADQ(AYr);A.aat([this,this.Bhx,this.Bso],0);},ADT:function(E){if(
this.K&&this.K.ADT)return this.K.ADT.apply(this,arguments);else return C.DeviceClass.
BrJ.apply(this,arguments);},BrJ:function(E){},Bsv:function(An){this.ADT(An);},UpdateTorchboardVersions:
function(PO,AYd,AYe,AYc,AYs,AYt,AYr){this.Sj.OnSetTimestamp(PO);this.Sj.ADi(AYd);
this.Sj.ADj(AYe);this.Sj.ADh(AYc);this.Sj.ADR(AYs);this.Sj.ADS(AYt);this.Sj.ADQ(
AYr);A.aat([this,this.BhW,this.Bsv],0);},ACT:function(E){if(this.K&&this.K.ACT)return this.
K.ACT.apply(this,arguments);else return C.DeviceClass.BqR.apply(this,arguments);
},BqR:function(E){},Bsk:function(An){this.ACT(An);},UpdateBootloaderVersions:function(
PO,AYf,AYg,AYm,AX6){this.Rt.OnSetTimestamp(PO);this.Rt.ADl(AYf);this.Rt.ADs(AYg);
this.Rt.ADE(AYm);this.Rt.AC3(AX6);A.aat([this,this.Bg7,this.Bsk],0);},AC6:function(
E){if(this.K&&this.K.AC6)return this.K.AC6.apply(this,arguments);else return C.DeviceClass.
Bq1.apply(this,arguments);},Bq1:function(E){},A9J:function(An){this.AC6(An);},UpdateDryCowListAction:
function(AI){if(this.ALO===AI)return;this.ALO=AI;A.aat([this,this.A5A,this.A9J],
0);},AHL:function(AX8){if(this.K&&this.K.AHL)return this.K.AHL.apply(this,arguments
);else return C.DeviceClass.BsH.apply(this,arguments);},BsH:function(AX8){return false;
},ADv:function(E){if(this.K&&this.K.ADv)return this.K.ADv.apply(this,arguments);
else return C.DeviceClass.Brq.apply(this,arguments);},Brq:function(E){},A9S:function(
An){this.ADv(An);},UpdateNoNaisIdListAction:function(AI){if(this.APO===AI)return;
this.APO=AI;A.aat([this,this.A5S,this.A9S],0);},ACS:function(E){if(this.K&&this.
K.ACS)return this.K.ACS.apply(this,arguments);else return C.DeviceClass.BqP.apply(
this,arguments);},BqP:function(E){},AGN:function(An){this.ACS(An);},UpdateBirthListView:
...
this,this.AQw,this.AXI],0);},ADU:function(E){if(this.K&&this.K.ADU)return this.K.
ADU.apply(this,arguments);else return C.DeviceClass.BrK.apply(this,arguments);},
BrK:function(E){A.aa8("%s",OL);},AXI:function(An){this.ADU(An);},UpdateTransferTarget:
function(AI){if(this.AeC===AI)return;this.AeC=AI;A.aat([this,this.A57,this.A9W],
...
,KH);},A9W:function(An){this.AqH(An);},Arf:function(){if(this.K&&this.K.Arf)return this.
K.Arf.apply(this,arguments);else return C.DeviceClass.Bsc.apply(this,arguments);
},Bsc:function(){},Avn:function(E){if(this.K&&this.K.Avn)return this.K.Avn.apply(
this,arguments);else return C.DeviceClass.Brv.apply(this,arguments);},Brv:function(
E){},AXC:function(An){this.Avn(An);},UpdatePremisesID:function(QY){if(this.YK===
QY)return;this.YK=QY;A.aat([this,this.AQo,this.AXC],0);},Avi:function(E){if(this.
K&&this.K.Avi)return this.K.Avi.apply(this,arguments);else return C.DeviceClass.
Brj.apply(this,arguments);},Brj:function(E){},AGR:function(An){this.Avi(An);},UpdateMotherSelectionDriedOffFilter:
...
);else return C.DeviceClass.Bq7.apply(this,arguments);},Bq7:function(E){},A9N:function(
An){this.AC_(An);},UpdateFreshCowSpan:function(AI){if(this.Apy===AI)return;this.
Apy=AI;A.aat([this,this.A5F,this.A9N],0);},UpdateUSBState:function(A_L){if(this.
Akc===A_L)return;this.Akc=A_L;A.aat([this,this.Aa$,this.AbW],0);},ADV:function(E
){if(this.K&&this.K.ADV)return this.K.ADV.apply(this,arguments);else return C.DeviceClass.
BrN.apply(this,arguments);},BrN:function(E){A.aa8("%s",EV);},AbW:function(An){this.
...
AgX=AI;A.aat([this,this.BhK,this.Bss],0);},AuR:function(E){if(this.K&&this.K.AuR
)return this.K.AuR.apply(this,arguments);else return C.DeviceClass.BqF.apply(this
,arguments);},BqF:function(E){},AXq:function(An){this.AuR(An);},UpdateAnimalIdAutoGenerationMethod:
function(A_S){if(this.AfK===A_S)return;this.AfK=A_S;A.aat([this,this.AP5,this.AXq
...
BrB.apply(this,arguments);},BrB:function(E){},A9T:function(An){this.ADJ(An);},UpdateShutdownTimer:
function(AI){if(this.ASk===AI)return;this.ASk=AI;A.aat([this,this.A50,this.A9T],
0);},Aqm:function(E){if(this.K&&this.K.Aqm)return this.K.Aqm.apply(this,arguments
);else return C.DeviceClass.BqJ.apply(this,arguments);},BqJ:function(E){},A9C:function(
An){this.Aqm(An);},UpdateAnimalListInfoItemMode:function(AI){if(this.AlC===AI)return;
this.AlC=AI;A.aat([this,this.A5r,this.A9C],0);},Aq4:function(H){if(this.K&&this.
K.Aq4)return this.K.Aq4.apply(this,arguments);else return C.DeviceClass.Br5.apply(
this,arguments);},Br5:function(H){},BBS:function(s){this.Aq4(s);},AqK:function(E
){if(this.K&&this.K.AqK)return this.K.AqK.apply(this,arguments);else return C.DeviceClass.
BrT.apply(this,arguments);},BrT:function(E){},A91:function(An){this.AqK(An);},AqL:
function(E){if(this.K&&this.K.AqL)return this.K.AqL.apply(this,arguments);else return C.
DeviceClass.BrU.apply(this,arguments);},BrU:function(E){},A92:function(An){this.
AqL(An);},UpdateWeightGainsLowString:function(AI){if(this.AFg===AI)return;this.AFg=
AI;A.aat([this,this.A6e,this.A92],0);},UpdateWeightGainsHighString:function(AI){
if(this.AFf===AI)return;this.AFf=AI;A.aat([this,this.A6d,this.A91],0);},AuT:function(
E){if(this.K&&this.K.AuT)return this.K.AuT.apply(this,arguments);else return C.DeviceClass.
BqM.apply(this,arguments);},BqM:function(E){},A9E:function(An){this.AuT(An);},UpdateAnimalTypesWeightGainsString:
function(AI){if(this.AzS===AI)return;this.AzS=AI;A.aat([this,this.A5u,this.A9E],
0);},AqJ:function(E){if(this.K&&this.K.AqJ)return this.K.AqJ.apply(this,arguments
);else return C.DeviceClass.BrS.apply(this,arguments);},BrS:function(E){},A90:function(
...
E){},A95:function(An){this.AqM(An);},UpdateWeightValueBirthString:function(AI){if(
this.AFi===AI)return;this.AFi=AI;A.aat([this,this.A6h,this.A95],0);},UpdateWeightGainsAverageString:
function(AI){if(this.AFe===AI)return;this.AFe=AI;A.aat([this,this.A6c,this.A90],
...
this.AAO=Ee;A.aat([this,this.Bhf,this.Bsm],0);},UpdateStartScreen:function(AI){if(
this.Av1===AI)return;this.Av1=AI;A.aat([this,this.BhM,this.Bst],0);},Avq:function(
E){if(this.K&&this.K.Avq)return this.K.Avq.apply(this,arguments);else return C.DeviceClass.
BrC.apply(this,arguments);},BrC:function(E){},Bst:function(An){this.Avq(An);},ABY:
function(){if(this.K&&this.K.ABY)return this.K.ABY.apply(this,arguments);else return C.
DeviceClass.Bqv.apply(this,arguments);},Bqv:function(){return 1;},ABZ:function(){
...
){return A.kh.Bd0;},GetVersionMajor:function(){return 0;},GetVersionMinor:function(
){return 9;},GetVersionRev:function(){return 9;},ADp:function(E){if(this.K&&this.
K.ADp)return this.K.ADp.apply(this,arguments);else return C.DeviceClass.Brf.apply(
this,arguments);},Brf:function(E){},A9P:function(An){this.ADp(An);},UpdateMaximumAgeNewOnFarm:
function(AI){if(this.ACd===AI)return;this.ACd=AI;A.aat([this,this.A5P,this.A9P],
0);},Avw:function(E){if(this.K&&this.K.Avw)return this.K.Avw.apply(this,arguments
);else return C.DeviceClass.BrM.apply(this,arguments);},BrM:function(E){},AXJ:function(
An){this.Avw(An);},UpdateTransponderAssignmentIdChangeMethod:function(A_I){if(this.
Ag6===A_I)return;this.Ag6=A_I;A.aat([this,this.AQx,this.AXJ],0);},BatchResetPurchasedNoticePending:
...
K.AC4.apply(this,arguments);else return C.DeviceClass.BqV.apply(this,arguments);
},BqV:function(E){},AXs:function(An){this.AC4(An);},UpdateDataExportDestination:
function(AI){if(this.U4===AI)return;this.U4=AI;A.aat([this,this.AP_,this.AXs],0);
},BjD:function(E){},UpdateMassRecordingAutomatic:function(AI){if(this.APn===AI)return;
this.APn=AI;A.aat([this,this.Bhy,this.BjD],0);},M7:function(E){if(this.K&&this.K.
...
this.AuO,this.Bsw],0);},Aqi:function(E){if(this.K&&this.K.Aqi)return this.K.Aqi.
apply(this,arguments);else return C.DeviceClass.BqA.apply(this,arguments);},BqA:
function(E){},A9x:function(An){this.Aqi(An);},Aqj:function(E){if(this.K&&this.K.
Aqj)return this.K.Aqj.apply(this,arguments);else return C.DeviceClass.BqB.apply(
this,arguments);},BqB:function(E){},A9y:function(An){this.Aqj(An);},UpdateActiveMassRecordingFields:
function(AI){if(this.AzL===AI)return;this.AzL=AI;A.aat([this,this.A5k,this.A9x],
0);},UpdateActiveMassRecordingFieldsOrder:function(AI){if(this.AzM===AI)return;this.
AzM=AI;A.aat([this,this.A5l,this.A9y],0);},Aq0:function(H){if(this.K&&this.K.Aq0
)return this.K.Aq0.apply(this,arguments);else return C.DeviceClass.Br2.apply(this
,arguments);},Br2:function(H){},BBP:function(s){this.Aq0(s);},ADn:function(E){if(
this.K&&this.K.ADn)return this.K.ADn.apply(this,arguments);else return C.DeviceClass.
Brd.apply(this,arguments);},Brd:function(E){},AGP:function(An){this.ADn(An);},UpdateMassRecordingDateOfBirthMandatory:
...
function(AI){if(this.Aus===AI)return;this.Aus=AI;A.aat([this,this.A5O,this.ADm],
...
MeasureState;},ACI:function(){return this.Kj;},A5K:function(){return this.Language;
},Aqc:function(){return this.TemperatureUnit;},A5z:function(){return this.AKW;},
AQh:function(){return this.ACk;},ACH:function(){return this.OverlayMenu;},A58:function(
){return this.Y$;},AQt:function(){return this.SyncState;},A59:function(){return this.
Arq;},ACJ:function(){return this.AS3;},AQq:function(){return this.RatingMode;},Ap$:
function(){return this.AlV;},AQv:function(){return this.ASN;},BhE:function(){return this.
ARF;},Bg5:function(){return this.AutoRegistrationMode;},AQs:function(){return this.
PD;},Aa9:function(){return this.FP;},Aa_:function(){return this.Fx;},ACK:function(
){return this.IK;},AQg:function(){return this.MassUnit;},A5j:function(){return this.
P7;},AP4:function(){return this.As$;},A5v:function(){return this.AutoActions;},Py:
function(){return this.AnimalType;},A6f:function(){return this.WeightRecordingMode;
},AQn:function(){return this.AEa;},ACC:function(){return this.Hv;},A5o:function(
){return this.Ait;},A6g:function(){return this.WeightRecordingScope;},VJ:function(
){return this.Gender;},AuI:function(){return this.ApJ;},AuH:function(){return this.
ApI;},ACz:function(){return this.JD;},A5q:function(){return this.AJ6;},A5C:function(
){return this.AlU;},AP6:function(){return this.D3;},A6b:function(){return this.AS5;
},A5E:function(){return this.AMs;},A5t:function(){return this.AzR;},A53:function(
){return this.AEX;},A54:function(){return this.AEY;},AQk:function(){return this.
APT;},Bhm:function(){return this.AlY;},A5R:function(){return this.ACm;},A5Q:function(
){return this.ACl;},AuL:function(){return this.APB;},AuK:function(){return this.
APA;},A5y:function(){return this.Ape;},A5i:function(){return this.AzK;},Bg1:function(
...
Breed;},Bhz:function(){return this.R3;},Bhx:function(){return this.Qs;},BhW:function(
){return this.Sj;},Bg7:function(){return this.Rt;},A5A:function(){return this.ALO;
},A5S:function(){return this.APO;},ACA:function(){return this.Apc;},AQw:function(
){return this.Av7;},A57:function(){return this.AeC;},AQo:function(){return this.
YK;},ACG:function(){return this.Aa5;},A5F:function(){return this.Apy;},Aa$:function(
){return this.Akc;},BhK:function(){return this.AgX;},AP5:function(){return this.
AfK;},A50:function(){return this.ASk;},A5r:function(){return this.AlC;},A6d:function(
){return this.AFf;},A6e:function(){return this.AFg;},A5u:function(){return this.
AzS;},A6c:function(){return this.AFe;},A6h:function(){return this.AFi;},Bhf:function(
){return this.AAO;},BhM:function(){return this.Av1;},A5P:function(){return this.
ACd;},AQx:function(){return this.Ag6;},AP_:function(){return this.U4;},Bhy:function(
){return this.APn;},AuO:function(){return this.WhereAbouts;},A5k:function(){return this.
AzL;},A5l:function(){return this.AzM;},ACD:function(){return this.AdM;},A5O:function(
...
Core.A8e._Init.call(this.AmS={I:this},0);C.Table._Init.call(this.Pa={I:this},0);
...
ConverterClass={MQ:null,Aj8:function(AnH){var A$q;var AsY=this.ASD(AnH/100,0,A._GetAutoObject(
C.Device).TemperatureUnit);A$q=A.aap(AsY,0,1);return A$q;},A8n:function(Ne){if(Ne<=
...
B;},Bd4:function(ArY){var Dk;switch(ArY){case 36:Dk=ON;break;case 40:Dk=Ss;break;
...
N0(N5,AnX,false);},N0:function(N5,AnX,BvK){var B;var AkL=A.jm;switch(A._GetAutoObject(
C.Device).MassUnit){case 0:if(BvK)AkL=A.aaq(N5,0,0);else{var BaI=N5<0;if(AnX<3)N5=
N5+(((BaI?-1:1)*5)*(Math.pow(10,2-AnX)|0));AkL=(((((B=N5)>-2147483648)?Math.abs(
B):B)/1000)|0).toFixed();if(AnX>0)AkL=AkL+(Li+A.aaX(A.aaq((((B=N5)>-2147483648)?
Math.abs(B):B)%1000,3,10),AnX));if(BaI)AkL=Ag$+AkL;}break;case 1:AkL=A.aap(N5/453.592
,0,AnX);break;default:A.aa8("%s%s",Anf,A._GetAutoObject(C.Device).MassUnit.toFixed(
));}return AkL;},TY:function(L1){var A1w=L1.toFixed();var BcR=A1w.length;if((BcR>=
14)&&(BcR<=15)){var AZC=this.Av9(L1);var BuC=A._GetAutoObject(C.Converter).Bd4(AZC
);A1w=(BuC+N2)+A.aar(A._GetAutoObject(C.Helper).U8(L1,0,12),12,10);}return A1w;}
...
}}},A2d:function(Bt$){switch(Bt$){case 0:return A.zW(A.abi.At$);case 1:return A.
...
AHs.toFixed());}},Bdo:function(Axl){switch(Axl){case 0:return A.zW(A.abi.ABL);case
3:return A.zW(A.abi.Al8);case 1:return A.zW(A.abi.AaL);case 2:return A._GetAutoObject(
A.abk.DM).A$O();default:throw new Error(Ahb+Axl.toFixed());}},Bd3:function(ArY){
...
return Awk;default:return A.z2(A.abg.Unknown);}},Bem:function(Ab4){switch(Ab4){case
...
!L1)return-1;return(L1%100000000)|0;},BeR:function(AnG,aFilter){var B;if(!aFilter
)return AeR;var An8=Arw;var Av=aFilter.AMB();while(!!Av){An8=An8+A._GetAutoObject(
C.Helper).A3W(AnG,Av);Av=aFilter.AMF(Av);if(!!Av)An8=An8+OP;}An8=An8+Sv;return An8;
},A4z:function(A_u){var Mz=0;switch(A_u){case 14:Mz=2;break;case 13:Mz=4;break;case
...
case 7:Mz=35;break;case 16:Mz=37;break;default:A.aa8("%s%e",Awl,A_u);}return Mz;
},Bdn:function(Axl){switch(Axl){case 0:return 1;case 3:return 0;case 1:return 2;
...
default:throw new Error(Ahb+Axl.toFixed());}},Bdp:function(AnO){switch(AnO){case
...
case 826:return 38;case 840:return 39;default:return 0;}},AeF:function(L1){var AZC=
this.Av9(L1);return this.ALs(AZC);},Av9:function(L1){return A._GetAutoObject(C.Helper
).U8(L1,12,3)|0;},A8F:function(AnL,Ee){if(AnL<A._GetAutoObject(C.Helper).ABc(Ee)
)return 1;else if(AnL<A._GetAutoObject(C.Helper).ABb(Ee))return 2;else return 3;
},AMx:function(BtR){switch(BtR){case 1:return 1;case 2:return 2;case 3:return 3;
...
Error(((Arx+AHf.toFixed())+Awm)+AHg.toFixed());},A3H:function(EE){switch(EE){case
...
}},A2G:function(Ab2){return this.MQ.Adk(Ab2);},Bfz:function(Ab2){return this.MQ.
AlL(Ab2);},BdN:function(ArX){var Ayw=0;switch(ArX){case 0:Ayw=1;break;case 1:Ayw=
2;break;case 2:Ayw=3;break;case 3:Ayw=4;break;default:A.aa8("%s%e",KI,ArX);}return Ayw;
},Aiu:function(AX0,Ee){if(AX0>=A._GetAutoObject(C.Helper).A3S(Ee))return 3;else if(
AX0>=A._GetAutoObject(C.Helper).AtY(Ee))return 2;else if(AX0<A._GetAutoObject(C.
...
AF.CE(Ab,3));this.R8(AF.Hy(Ab,4));this.JM(AF.AMD(Ab,7));this.Ajy(AF.Be_(Ab,6));this.
...
AF.A34(Ab,5));this.AQT(AF.IW(Ab,17));this.TD(AF.HV(Ab,11));this.ARb(AF.Hy(Ab,16)
...
));this.Aqx(AF.HV(Ab,38));this.NP(AF.Be$(Ab,32));this.AjB(AF.Bfc(Ab,33));this.AmK(
AF.LD(Ab,35));this.M7(AF.AMM(Ab,34));this.Ad3(AF.HV(Ab,37));this.ADC(AF.Bfm(Ab,36
...
Bk8(this.CH,7,this.Gender);AF.Bk4(this.CH,6,this.BirthType);AF.Bk2(this.CH,14,this.
...
IsDry);AF.Bk6(this.CH,32,this.Breed);AF.Bk7(this.CH,33,this.EaseOfDelivery);AF.TO(
this.CH,35,this.NaisIdMother);AF.Blc(this.CH,34,this.WhereAbouts);AF.M_(this.CH,
37,this.IsRegistrationNoticePending);AF.Bla(this.CH,36,this.ReasonOfLeaving);Hs=
...
},Abg:function(E){if(this.GroupId===E)return;this.GroupId=E;A.aat([this,this.Bhn
...
this.LocationId===E)return;this.LocationId=E;A.aat([this,this.A5N,this.AmI],0);}
,Ad6:function(E){if(this.LastTemperature===E)return;this.LastTemperature=E;A.aat([
this,this.A5M,this.Ad6],0);},Ad1:function(E){if(this.IsAlarm===E)return;this.IsAlarm=
E;A.aat([this,this.A5H,this.Ad1],0);},AjG:function(E){if(this.IsControl===E)return;
this.IsControl=E;A.aat([this,this.Bhq,this.AjG],0);},AgG:function(E){if(this.IsRegistered===
E)return;this.IsRegistered=E;A.aat([this,this.Bht,this.AgG],0);},Ad4:function(E){
if(this.IsWatch===E)return;this.IsWatch=E;A.aat([this,this.A5J,this.Ad4],0);},AvA:
function(E){if(this.WorstAssessment===E)return;this.WorstAssessment=E;A.aat([this
,this.A6i,this.AvA],0);},TD:function(E){if(this.IsFever===E)return;this.IsFever=
E;A.aat([this,this.A5I,this.TD],0);},ARd:function(E){if(this.TimestampLastControl===
E)return;this.TimestampLastControl=E;A.aat([this,this.BhT,this.ARd],0);},Avv:function(
E){if(this.TimestampLastWatch===E)return;this.TimestampLastWatch=E;A.aat([this,this.
BhV,this.Avv],0);},AQT:function(E){if(this.LastRatingTemperature===E)return;this.
LastRatingTemperature=E;A.aat([this,this.Bhw,this.AQT],0);},ARb:function(E){if(this.
TimestampExpirationFeverAlarm===E)return;this.TimestampExpirationFeverAlarm=E;A.
aat([this,this.BhR,this.ARb],0);},Avt:function(E){if(this.TimestampAlarm===E)return;
this.TimestampAlarm=E;A.aat([this,this.BhQ,this.Avt],0);},DV:function(E){if(this.
AnimalType===E)return;this.AnimalType=E;A.aat([this,this.Py,this.DV],0);},ADg:function(
E){if(this.LastBodyWeight===E)return;this.LastBodyWeight=E;A.aat([this,this.A5L,
this.ADg],0);},ADM:function(E){if(this.TimestampLastWeighing===E)return;this.TimestampLastWeighing=
E;A.aat([this,this.A56,this.ADM],0);},M6:function(E){if(this.TransponderId===E)return;
...
Bu,0);SG.Initialize(this.DateOfBirth);var AZp=A._NewObject(A.Core.Bu,0);AZp.Initialize(
this.TimestampFirstWeighing);if(((SG.Year===AZp.Year)&&(SG.Aa8()===AZp.Aa8()))&&(
...
Bhl,this.AQK],0);},AmZ:function(A_R){this.Ad1(A_R);if(A_R){if(!this.TimestampAlarm
...
A_N){this.Ad4(A_N);if(A_N){if(!this.TimestampLastWatch)this.Avv(A._GetAutoObject(
C.Helper).DB());}else this.Avv(0);},Au1:function(E){if(this.DateOfLastCalving===
E)return;this.DateOfLastCalving=E;A.aat([this,this.Bhb,this.Au1],0);},Avd:function(
E){if(this.LactationNumber===E)return;this.LactationNumber=E;A.aat([this,this.Bhv
,this.Avd],0);},Avc:function(E){if(this.IsPerished===E)return;this.IsPerished=E;
A.aat([this,this.Bhs,this.Avc],0);},ARe:function(E){if(this.TimestampLastTemperature===
E)return;this.TimestampLastTemperature=E;A.aat([this,this.BhU,this.ARe],0);},ARc:
function(E){if(this.TimestampLastAssessment===E)return;this.TimestampLastAssessment=
E;A.aat([this,this.BhS,this.ARc],0);},NP:function(E){if(this.Breed===E)return;this.
...
this.ReasonOfLeaving=E;A.aat([this,this.BhG,this.ADC],0);},Ad3:function(E){if(this.
IsRegistrationNoticePending===E)return;this.IsRegistrationNoticePending=E;A.aat([
this,this.Bhu,this.Ad3],0);},Aqx:function(E){if(this.IsDry===E)return;this.IsDry=
E;A.aat([this,this.Bhr,this.Aqx],0);},Qv:function(){return this.Id;},Aqd:function(
){return this.VisualId;},Bhn:function(){return this.GroupId;},AuD:function(){return this.
DateOfBirth;},VJ:function(){return this.Gender;},AP8:function(){return this.BirthType;
},A5N:function(){return this.LocationId;},A5M:function(){return this.LastTemperature;
},A5H:function(){return this.IsAlarm;},Bhq:function(){return this.IsControl;},Bht:
function(){return this.IsRegistered;},A5J:function(){return this.IsWatch;},A6i:function(
){return this.WorstAssessment;},A5I:function(){return this.IsFever;},BhT:function(
){return this.TimestampLastControl;},BhV:function(){return this.TimestampLastWatch;
},Bhw:function(){return this.LastRatingTemperature;},BhR:function(){return this.
TimestampExpirationFeverAlarm;},BhQ:function(){return this.TimestampAlarm;},Py:function(
){return this.AnimalType;},A5L:function(){return this.LastBodyWeight;},A56:function(
...
},Bhl:function(){return this.FirstBodyWeightId;},Amy:function(){return this.NaisId;
},Bhb:function(){return this.DateOfLastCalving;},Bhv:function(){return this.LactationNumber;
},Bhs:function(){return this.IsPerished;},BhU:function(){return this.TimestampLastTemperature;
},BhS:function(){return this.TimestampLastAssessment;},AuB:function(){return this.
Breed;},AQb:function(){return this.EaseOfDelivery;},AuO:function(){return this.WhereAbouts;
},AQj:function(){return this.NaisIdMother;},BhG:function(){return this.ReasonOfLeaving;
},Bhu:function(){return this.IsRegistrationNoticePending;},Bhr:function(){return this.
...
!==-2;},A5U:function(){return this.CH;},A69:function(E){this.CH=E;},_Init:function(
...
OnSetTemperature(AF.A34(Ab,7));this.OnSetBodyWeight(AF.AA8(Ab,8));this.OnSetRatingTemperature(
AF.IW(Ab,9));}return Hs;},Cr:function(AF){if(this.K&&this.K.Cr)return this.K.Cr.
apply(this,arguments);else return C.Rating.A9o.apply(this,arguments);},A9o:function(
...
,this.Respiratory);AF.AjZ(this.CH,5,this.Faeces);AF.A70(this.CH,7,this.Temperature
...
A4t(this));if((this.Temperature>0)&&A._GetAutoObject(C.Helper).AEg(this)){var Oa=
...
E;A.aat([this,this.BhP,this.OnSetTemperature],0);},OnSetId:function(E){if(this.Id===
E)return;this.Id=E;A.aat([this,this.Qv,this.OnSetId],0);},OnSetAnimalId:function(
E){if(this.AnimalId===E)return;this.AnimalId=E;A.aat([this,this.Bg2,this.OnSetAnimalId
],0);},OnSetFeed:function(E){if(this.Feed===E)return;this.Feed=E;A.aat([this,this.
Bhi,this.OnSetFeed],0);},OnSetAppearance:function(E){if(this.Appearance===E)return;
this.Appearance=E;A.aat([this,this.Bg3,this.OnSetAppearance],0);},OnSetRespiratory:
function(E){if(this.Respiratory===E)return;this.Respiratory=E;A.aat([this,this.BhH
,this.OnSetRespiratory],0);},OnSetFaeces:function(E){if(this.Faeces===E)return;this.
Faeces=E;A.aat([this,this.Bhg,this.OnSetFaeces],0);},OnSetTimestamp:function(E){
if(this.Timestamp===E)return;this.Timestamp=E;A.aat([this,this.A55,this.OnSetTimestamp
],0);},Bk3:function(Nf,A1){switch(Nf){case 2:this.OnSetAppearance(A1);break;case
1:this.OnSetFeed(A1);break;case 4:this.OnSetFaeces(A1);break;case 3:this.OnSetRespiratory(
A1);break;default:;}},Be8:function(Nf){switch(Nf){case 2:return this.Appearance;
...
E)return;this.RatingTemperature=E;A.aat([this,this.BhF,this.OnSetRatingTemperature
],0);},OnSetBodyWeight:function(E){if(this.BodyWeight===E)return;this.BodyWeight=
E;A.aat([this,this.Bg6,this.OnSetBodyWeight],0);},BhP:function(){return this.Temperature;
},Qv:function(){return this.Id;},Bg2:function(){return this.AnimalId;},Bhi:function(
){return this.Feed;},Bg3:function(){return this.Appearance;},BhH:function(){return this.
Respiratory;},Bhg:function(){return this.Faeces;},A55:function(){return this.Timestamp;
},BhF:function(){return this.RatingTemperature;},Bg6:function(){return this.BodyWeight;
...
A5V,this.ADF],0);},BwL:function(H){switch(A._GetAutoObject(C.Device).ScanState){
...
return this.K.ADK.apply(this,arguments);else return C.HelperClass.A9m.apply(this
,arguments);},A9m:function(E){A.aat([this,this.Ud,this.Ue],0);A._GetAutoObject(C.
Device).SetSystemTime(E);},Ue:function(An){this.ADK(An);},DB:function(){if(this.
K&&this.K.DB)return this.K.DB.apply(this,arguments);else return C.HelperClass.A9i.
apply(this,arguments);},A9i:function(){var B;return((B=(this.Aq.A$M()|0))<0)?B+0x100000000:
B;},Ud:function(){return this.DB();},Aq2:function(){A._GetAutoObject(C.Device).Se(-
1);this.V.G9();A.vv(this.V,0);},A4H:function(L1){if(!L1){A.aa8("%s%U",ATq,L1);return false;
...
z2(A.abg.BkK);case 12:return A.z2(A.abg.AqN);case 29:return A.z2(A.abg.AO_);case
18:return A.z2(A.abg.Weighing);case 17:return ATr;case 5:return A.z2(A.abg.Temperature
);case 3:return A.z2(A.abg.Bgc);case 26:return A.z2(A.abg.Yr);case 35:return A.z2(
...
jm;},A3W:function(AnG,AL){var result=A.jm;if(!!AL){result=this.Al1(AnG,AL.ET);result=((
result+N2)+A._GetAutoObject(C.Converter).A3H(AL.Operator))+N2;if(!!(C.Int32FilterCriterion.
...
AL)?AL:null).A4);}else A.aa8("%s",ATz);}return result;},NV:function(aString,A_A,
Bts){var result=A.jm;var Bb9=false;var index=0;var Btu=A_A.length;while(!Bb9){var
A0X=aString.indexOf(A_A,index);if(A0X!==-1){result=(result+A.aaY(aString,index,A0X-
index))+Bts;index=A0X+Btu;}else{var A_E=aString.length;if(index<A_E)result=result+
A.aa4(aString,A_E-index);Bb9=true;}}return result;},AQ4:function(E){this.AR0=E;A.
aat([this,this.BhI,this.AQ4],0);},AQ5:function(E){this.AR1=E;A.aat([this,this.BhJ
,this.AQ5],0);},Baa:function(){return((A._GetAutoObject(C.Device).ScanState===2)&&
!!A._GetAutoObject(C.Device).PD)&&(A._GetAutoObject(C.Device).PD.TransponderType===
1);},Afj:function(H){if(!this.V.Amb()&&!!this.V.Id)this.Bgb(this.V.Id);},AtY:function(
Ee){return A._GetAutoObject(C.Helper).TS.Get(Ee);},A3S:function(Ee){return A._GetAutoObject(
C.Helper).TR.Get(Ee);},A30:function(){var P=0;var min=32767;while(P<A._GetAutoObject(
...
C.Device).Ao,0);},AOT:function(DW){if(!DW)return false;var BfL=(((this.Ax8(DW.Faeces
)||this.Ax8(DW.Feed))||this.Ax8(DW.Appearance))||this.Ax8(DW.Respiratory))||this.
Ax8(DW.RatingTemperature);return BfL||this.A4t(DW);},Ax8:function(A_e){return(A_e===
2)||(A_e===1);},A4t:function(DW){return!!DW&&(DW.Temperature>A._GetAutoObject(C.
Helper).AtY(A._GetAutoObject(C.Helper).V.AnimalType));},HY:function(L0){var AZ1=
false;if(L0>=0){if(L0!==this.V.CH)A._GetAutoObject(C.Device).Se(L0);AZ1=this.V.EK(
L0,A._GetAutoObject(C.Device).Ao);if(AZ1)A.vv(this.V,0);}else{A._GetAutoObject(C.
Device).Se(-1);this.V.G9();A.vv(this.V,0);}return AZ1;},Ag2:function(Ahk){var B;
return(((B=(this.Aq.A$M()|0))<0)?B+0x100000000:B)-this.Atu(Ahk);},Arf:function(){
var B;A.ow([B=this.Kr,B.Av2],this);},BxT:function(H){A._GetAutoObject(C.Device).
A5(16,false,AbS,0,null);A._GetAutoObject(C.Device).A5(5,true,A.jm,0,null);},Bke:
function(H){var Ar=(C.PopupContext.isPrototypeOf(H)?H:null);if(!!Ar&&(Ar.PopupState===
5))this.Arf();},Bj4:function(E){if(this.AES===E)return;this.AES=E;A._GetAutoObject(
C.Device).A5(16,true,this.AES.toFixed(),0,[this,this.Bke]);},ME:function(Bs4,BtJ
){var D2;var BcE=A._NewObject(A.Core.Am7,0);var Gp=A._NewObject(A.Core.Bu,0);var
KV=A._NewObject(A.Core.Bu,0);Gp.Initialize(Bs4);KV.Initialize(BtJ);D2=KV.Bel(Gp);
BcE.Initialize2(0,D2.ABy,D2.ACj,D2.AEt);if(Gp.J(BcE).Gt===Gp.Gt)return D2.J9;else
...
).Ao.Bk(A._GetAutoObject(C.Device).Ao.Filter);}},AI8:function(H){var Bds=A._GetAutoObject(
C.Helper).AtY(A._GetAutoObject(C.Helper).V.AnimalType);var Bdm=A._GetAutoObject(
C.Helper).A3S(A._GetAutoObject(C.Helper).V.AnimalType);var AsX=A.aaC(Bds-100,Bdm+
100);this.A$r(AsX);},Atu:function(Ahk){return Ahk*86400;},Aka:function(Kn){var B;
...
AYa,A_G,AG$,Ee){var B;var AoK;if((AYa<650000)&&(A_G<this.DB())){var A_3=this.AfQ.
At0(Ee);var A_2=0;if(A_3>=0)A_2=this.AeI.Get(A_3);AoK=AYa+(this.ME(A_G,this.DB()
)*A_2);if(AG$>0){var AY9=this.Ay0(AG$);AoK=(Math.trunc(((((B=AoK)<0)?B+0x10000000000000000:
B)+Math.trunc(AY9/2))/AY9)*AY9)|0;}if(AoK>650000)AoK=650000;}else AoK=AYa;return AoK;
...
C.Converter).A8n(Ao6);},AvQ:function(DW,Ne){if(!!DW){DW.OnSetFaeces(Ne);DW.OnSetFeed(
Ne);DW.OnSetAppearance(Ne);DW.OnSetRespiratory(Ne);}},Be6:function(AF,AHe,Ab_,Wt
...
Ahk){var B;var Gp=A._NewObject(A.Core.Bu,0);var BcD=A._NewObject(A.Core.Am7,0);Gp.
Initialize(A._GetAutoObject(C.Converter).Ag4());BcD.Initialize2(Ahk,0,0,0);Gp=Gp.
Blu(BcD);return((B=(Gp.JL()|0))<0)?B+0x100000000:B;},A3T:function(AF,Ab_,AeY,Wt){
...
,0);var AY1;for(P=0;P<AF.Cj();P=P+1){AnV.EK(P,AF);if(A._GetAutoObject(C.Helper).
AEg(AnV)){AY1=A._GetAutoObject(C.Helper).ABd(AnV);L2.Set(AY1,L2.Get(AY1)+1);}}AF.
Bk(Aov);return L2;},AZx:function(AF,Ab_,BuN){if(!AF)throw new Error(ArA);var Bb=
...
).Ag4()+A._GetAutoObject(C.Helper).Atu(BuN);var AeY=Wt+A._GetAutoObject(C.Helper
...
Device).WeightRecordingScope===1))return true;else return false;},A4w:function(){
if((A._GetAutoObject(C.Device).WeightRecordingScope===2)||!A._GetAutoObject(C.Device
).WeightRecordingScope)return true;else return false;},Be7:function(AF,AHe,Ab_,Wt
,AeY){if(!AF)throw new Error(ArA);var Bb=A._NewObject(C.Filter,0);var Aov=AF.Filter;
var N6=A._NewObject(C.Int32FilterCriterion,0);N6.Operator=0;N6.ET=1;N6.A4=Ab_;Bb.
C0(N6);if(Wt>0){var Oj=A._NewObject(C.UInt32FilterCriterion,0);Oj.Operator=2;Oj.
ET=6;Oj.A4=Wt;Bb.C0(Oj);}if(AeY>0){var N$=A._NewObject(C.UInt32FilterCriterion,0
...
0);Gp.AmJ(0);Gp.AmM(0);return((B=(Gp.JL()|0))<0)?B+0x100000000:B;},Be9:function(
BxS,BuY,Aln,AkM){var A$m=A._GetAutoObject(C.Helper).ME(BxS,BuY);if(A$m>0)return((
AkM-Aln)/A$m)|0;return 0;},Bl5:function(Bs5,BtK){var Gp=A._NewObject(A.Core.Bu,0
);var KV=A._NewObject(A.Core.Bu,0);Gp.Initialize(Bs5);KV.Initialize(BtK);return(
Gp.Year===KV.Year)&&(Gp.Aa8()===KV.Aa8());},A3Y:function(){var Bb=A._GetAutoObject(
C.Helper).MX();var Ban=A._NewObject(C.UInt32FilterCriterion,0);var BtT=A._GetAutoObject(
C.Helper).Y0(A._GetAutoObject(C.Device).Apy)-1;Ban.Initialize(28,2,BtT,true);Bb.
C0(Ban);var Ui=A._NewObject(C.AnimalTypeFilterCriterion,0);Ui.Initialize(14,0,1,
true);Bb.C0(Ui);if(A._GetAutoObject(C.Device).AlY){var Ayl=A._NewObject(C.UInt32FilterCriterion
,0);var AZW=A._GetAutoObject(C.Helper).DB()-21600;Ayl.Initialize(30,3,AZW,true);
Bb.C0(Ayl);}return Bb;},BkN:function(){var Jg=A._GetAutoObject(C.Device).Ao.Op();
...
C.Device).Pa.Or(Jg);}},Bgb:function(Ab_){var A9=A._GetAutoObject(C.Device).Ao.K4(
...
Aih);return Bb;},AMA:function(AnO,BuV,Sz){var Zx=-1;switch(AnO){case 2:Zx=30;break;
...
C.Helper).DB()-BuV,Sz);return Acl;},BkM:function(aFilter){var AL=aFilter.D0(30,3
);if(!!AL)aFilter.QD(AL);AL=aFilter.D0(31,3);if(!!AL)aFilter.QD(AL);AL=aFilter.D0(
19,3);if(!!AL)aFilter.QD(AL);},AYS:function(Ae7,Axa,AF){if(AF.K8())return 5;if(Ae7.
...
);}return GE;},A8u:function(Akr,LY,BsR,A_i,Btn){var B;var PY=null;var WF=null;switch(
Akr){case 0:{PY=[B=A._GetAutoObject(C.Device),B.AQi,B.AXy];WF=[B=A._GetAutoObject(
C.Device),B.AuM,B.Aw7];}break;case 1:switch(LY){case 1:{PY=[B=A._GetAutoObject(C.
Device),B.A5Q,B.A9Q];WF=[B=A._GetAutoObject(C.Device),B.AuK,B.Aw5];}break;case 0:{
PY=[B=A._GetAutoObject(C.Device),B.A5R,B.A9R];WF=[B=A._GetAutoObject(C.Device),B.
AuL,B.Aw6];}break;case 2:{PY=[B=A._GetAutoObject(C.Device),B.AQi,B.AXy];WF=[B=A.
...
PY[0],BsR);if((WF[1].call(WF[0])>0)&&(A_i<Btn))PY[2].call(PY[0],PY[1].call(PY[0]
)+WF[1].call(WF[0]));else if((WF[1].call(WF[0])<0)&&(A_i>0))PY[2].call(PY[0],PY[
1].call(PY[0])+WF[1].call(WF[0]));return PY[1].call(PY[0]);}return 0;},ASW:function(
Eu,Akr,BsY){if(!Eu||(BsY===true))return;switch(Akr){case 0:Eu.M5(A._GetAutoObject(
...
throw new Error(AFu+Akr.toFixed());}},BfM:function(QZ,Eu){var result=false;switch(
...
);}return result;},AIp:function(Eu,A_d,Axa,Ar7,Ae1){switch(A_d){case 2:if(Ar7<=0
...
0:break;default:throw new Error(ATA+A_d.toFixed());}},A$Q:function(A_p,LY){var B;
var Ayp=null;switch(A_p){case 0:Ayp=[B=A._GetAutoObject(C.Device),B.AuM,B.Aw7];break;
...
throw new Error(ATB+A_p.toFixed());}return Ayp;},A38:function(PO,BtA){var ZV=A._NewObject(
...
C.Device).Pa);Ul.Au3(Ul.Deregistrations+1);if(BtA)Ul.Au2(Ul.Deaths+1);Ul.Cr(A._GetAutoObject(
...
},A$r:function(BtS){var B;if(A._GetAutoObject(C.Device).MeasureState===1){this.Sh.
Cv=A._GetAutoObject(C.Device).Y$;this.Sh.B0=BtS;this.Sh.AEN(this);}},AA4:function(
){var Bb=this.AMz();var Bac=A._NewObject(C.BoolFilterCriterion,0);Bac.Initialize(
38,0,true,true);Bb.C0(Bac);return Bb;},A3R:function(JU){var Bb=A._GetAutoObject(
C.Helper).MX();if(A._GetAutoObject(C.Device).Alx){var AZA=A._GetAutoObject(C.Helper
).AMA(JU,21600,true);Bb.C0(AZA);}return Bb;},A32:function(){var Bb=A._GetAutoObject(
C.Helper).MX();var BaC=A._NewObject(C.UInt64FilterCriterion,0);BaC.Initialize(26
,0,0,true);Bb.C0(BaC);return Bb;},A35:function(){var B;var Bb=A._GetAutoObject(C.
Helper).MX();var Ayv=(C.WhereAboutsFilterCriterion.isPrototypeOf(B=Bb.D0(34,3))?
B:null);if(!!Ayv)Bb.QD(Ayv);var BbR=A._NewObject(C.BoolFilterCriterion,0);BbR.Initialize(
37,0,true,true);Bb.C0(BbR);return Bb;},U8:function(A1,Btt,AYb){var B;A1=Math.trunc(
A1/this.Ay0(Btt));A1%=this.Ay0(AYb);return A1;},Ay0:function(A_q){switch(A_q){case
...
case 15:return 1000000000000000;default:throw new Error(ATC+A_q.toFixed());}},MX:
function(){var Bb=A._NewObject(C.Filter,0);var Bcb=A._NewObject(C.BoolFilterCriterion
,0);Bcb.Initialize(10,0,true,true);Bb.C0(Bcb);var Ayv=A._NewObject(C.WhereAboutsFilterCriterion
...
1,true);Bb.C0(Ui);return Bb;},ABa:function(){var B;var A1n;var N8=this.Bfn();A1n=(((
B=A._GetAutoObject(C.Converter).Atq(N8))<0)?B+0x10000000000000000:B)*this.Ay0(12
);if((N8===10)&&(A._GetAutoObject(C.Device).YK>0)){var Bvh=A._GetAutoObject(C.Helper
).U8(A._GetAutoObject(C.Device).YK,10,2)*this.Ay0(8);A1n+=Bvh;}return A1n;},Bfn:
function(){var N8=0;if(A._GetAutoObject(C.Device).YK>0)N8=A._GetAutoObject(C.Converter
).AeF(A._GetAutoObject(C.Device).YK);if(!N8)N8=A._GetAutoObject(C.Converter).A4z(
...
default:throw new Error(ATD+Ae2.toFixed());}},Bdk:function(QZ,Eu){var GE=0;switch(
...
ATE+QZ.toFixed());}return GE;},BeV:function(){var B;var Ax6=(((((((A.z2(A.abg.AgX
)+A.z2(A.abg.Colon))+OQ)+A._GetAutoObject(C.Device).AgX)+Awy)+A.z2(A.abg.Bku))+A.
z2(A.abg.Colon))+OQ)+A._GetAutoObject(A.abk.K1).BeT(((B=A._GetAutoObject(C.Device
).Qs.Timestamp)<0)?B+0x100000000:B);return Ax6;},BeW:function(){var B;var Ax6=((((((((((((((((((((((((((((
...
OQ)+ATH)+A._GetAutoObject(C.Helper).Bfq())+OP)+A._GetAutoObject(C.Device).GetCommitHash(
))+OP)+A._GetAutoObject(C.Device).GetCommitCount().toFixed())+OP)+A._GetAutoObject(
A.abk.K1).AiZ(A._GetAutoObject(C.Device).GetCommitEpoch());return Ax6;},BeU:function(
...
).Qs.APi.toFixed())+OQ)+A.z2(A.abg.A3K))+A.z2(A.abg.Colon))+N2)+A._GetAutoObject(
...
abg.A3K))+A.z2(A.abg.Colon))+N2)+A._GetAutoObject(A.abk.K1).AiZ(((B=A._GetAutoObject(
C.Device).Sj.Timestamp)<0)?B+0x100000000:B);return Ax6;},A33:function(AYb){var B;
var P;var Ay5=A.jm;for(P=1;P<=AYb;P=P+1)if(!!A.aaC(0,2))Ay5=Ay5+String.fromCharCode(
A.aaC(97,104)&0xFFFF);else Ay5=Ay5+String.fromCharCode(A.aaC(48,57)&0xFFFF);return Ay5;
},Aax:function(Ee){var Axq=0;if(Ee===1)Ee=0;var A_8=this.AfQ.At0(Ee);if(A_8>=0)Axq=
this.AeL.Get(A_8);return Axq;},ABc:function(Ee){var FK=0;var AzD=this.AfQ.At0(Ee
);if(AzD>=0)FK=this.AeK.Get(AzD);return FK;},ABb:function(Ee){var FK=0;var AzD=this.
AfQ.At0(Ee);if(AzD>=0)FK=this.AeJ.Get(AzD);return FK;},A3V:function(){var Bb=this.
...
C.Converter).ALs(BN))return 2;else return 3;},A37:function(){var Bb=A._GetAutoObject(
C.Helper).AMG();var Aku=A._GetAutoObject(C.Helper).Be5(3,A._GetAutoObject(C.Device
).ACd);Aku.AaQ=true;Bb.C0(Aku);return Bb;},Be5:function(EE,A_c){var Av=A._NewObject(
C.UInt32FilterCriterion,0);Av.ET=4;switch(EE){case 2:{Av.Operator=3;Av.A4=A._GetAutoObject(
C.Helper).Y0(A_c);}break;case 3:{Av.Operator=2;Av.A4=A._GetAutoObject(C.Helper).
Y0(A_c-1);}break;default:A.aa8("%s%e",ATK,EE);}return Av;},Bfq:function(){return(((
...
);},Bdl:function(QZ,Eu){var GE=0;switch(QZ){case 0:GE=Eu.VisualId;break;case 2:GE=
...
}return GE;},A8v:function(){var B;var IP=null;var SI=0;if(!A._GetAutoObject(C.Device
...
V.VisualId+1);break;default:;}},A4x:function(Ws,Eu){return(Eu.NaisId!==Ws)&&this.
AOW(Ws);},BfV:function(L1,Eu){return(Eu.TransponderId!==L1)&&this.AOY(L1);},AMy:
function(){var Bb=A._GetAutoObject(C.Helper).A35();var Ayn=A._NewObject(C.UInt64FilterCriterion
,0);Ayn.Initialize(35,5,0,true);Bb.C0(Ayn);return Bb;},AMI:function(){var Bb=A._GetAutoObject(
C.Helper).A35();var Ayn=A._NewObject(C.UInt64FilterCriterion,0);Ayn.Initialize(35
,0,0,true);Bb.C0(Ayn);return Bb;},Mw:function(AX4,Ahj){AX4.Ai(Ahj);AX4.Ap(Ahj);AX4.
X(Ahj);},A2W:function(Ahl){var B;var Z;var A0b=false;var Wz=Ahl.U9(null,0x1);while(
!!Wz&&(((B=Wz)?B.__proto__:null)!==A.Core.Y)){Z=(A.kh.Ck.isPrototypeOf(Wz)?Wz:null
);if(!!Z){Z.Be(A0b);A0b=!A0b;}Wz=Ahl.U9(Wz,0x1);}},Aqb:function(){return this.TN;
},A5V:function(){return this.AgU;},BhI:function(){return this.AR0;},BhJ:function(
){return this.AR1;},BhN:function(){return this.AES;},_Init:function(aArg){C.AlS.
...
100);this.Kr.R5=[this,this.BxT];this.Kr.Q=[this,this.BhN,this.Bj4];this.Sh.R5=[this
,this.BxV];this.Sh.Q=[B=A._GetAutoObject(C.Device),B.ACI,B.AGT];this.Adm.Q=[B=A.
...
){var BbN=A6;var Oe=A.jm;switch(BbN){case 0:Oe=AFR;break;case 1:Oe=AwA;break;case
...
throw new Error(AUP+BbN.toFixed());}return Oe;},_Init:function(aArg){C.EnumToString.
_Init.call(this,aArg);this.__proto__=C.OverlayMenuToString;},_className:"Device::OverlayMenuToString"
};C.ScanStateToString={BZ:function(A6){var Bcj=A6;var Bp=A.jm;switch(Bcj){case 4:
Bp=AwF;break;case 0:Bp=ArJ;break;case 2:Bp=AFU;break;case 3:Bp=AUQ;break;case 1:
Bp=AFV;break;default:throw new Error(AFW+Bcj.toFixed());}return Bp;},_Init:function(
...
var Baw=A6;var Bp=A.jm;switch(Baw){case 4:Bp=AwF;break;case 0:Bp=ArJ;break;case 2:
Bp=AUR;break;case 1:Bp=AFV;break;case 3:Bp=AFX;break;default:throw new Error(AUS+
Baw.toFixed());}return Bp;},_Init:function(aArg){C.EnumToString._Init.call(this,
...
function(A6){var BcI=A6;var Ao0=A.jm;switch(BcI){case 0:Ao0=A.z2(A.abg.Bml);break;
case 1:Ao0=A.z2(A.abg.Bmm);break;default:throw new Error(AUT+BcI.toFixed());}return Ao0;
...
1,SheepLamb:2,LAST:3};C.AnimalTypeToString={BZ:function(A6){var Bcz=A6;var type=
A.jm;switch(Bcz){case 0:type=A.z2(A.abg.BdS);break;case 1:type=A.z2(A.abg.Bd5);break;
case 2:type=A.z2(A.abg.Bf3);break;default:throw new Error(AUU+Bcz.toFixed());}return type;
...
A6){var BcC=A6;var Bp=A.jm;switch(BcC){case 7:Bp=AwF;break;case 0:Bp=ArJ;break;case
6:Bp=AFX;break;case 2:Bp=AVb;break;case 5:Bp=AVc;break;case 3:Bp=AVd;break;case 4:
Bp=AVe;break;case 1:Bp=AVf;break;default:throw new Error(AVg+BcC.toFixed());}return Bp;
...
A6){var Ay6=A6;switch(Ay6){case 0:return A.jm;case 1:return A.z2(A.abg.BkD);case
4:return A.z2(A.abg.BkC);case 3:return A.z2(A.abg.BkE);case 2:return A.z2(A.abg.
BkB);default:throw new Error(AF3+Ay6.toFixed());}},Lh:function(A6){var Ay6=A6;switch(
...
9};C.PopupContext={AD5:null,AjP:A.jm,Aj_:0,PopupState:1,Id:0,Show:false,BjQ:function(
...
this.GroupName=E;A.aat([this,this.Bho,this.ADa],0);},Qv:function(){return this.Id;
},Bho:function(){return this.GroupName;},_Init:function(aArg){C.Row._Init.call(this
...
);break;case 58:Az=A.z2(A.abg.BeI);break;case 2:Az=A.z2(A.abg.BeG);break;case 3:
Az=A.z2(A.abg.Bmq);break;case 77:Az=A._GetAutoObject(C.Helper).BeW();break;case 78:
Az=A._GetAutoObject(C.Helper).BeU();break;case 79:Az=A._GetAutoObject(C.Helper).
BeV();break;case 9:Az=A.z2(A.abg.BmO);break;case 5:Az=A.z2(A.abg.SuccessDataSync
...
break;case 82:Az=A.z2(A.abg.BeK);break;case 83:Az=A.z2(A.abg.BeL);break;case 80:
Az=A.z2(A.abg.BlC);break;case 81:Az=A.z2(A.abg.SuccessRestoreBackup);break;case 92:
Az=A.z2(A.abg.BdI);break;case 93:Az=A.z2(A.abg.BkP);break;case 4:Az=A.z2(A.abg.WarningDataSync
...
A.z2(A.abg.APr))+OQ)+A.z2(A.abg.Bgi);break;case 50:Az=((AH1+A.z2(A.abg.APr))+OQ)+
A.z2(A.abg.Bgk);break;case 51:Az=((AH1+A.z2(A.abg.APr))+OQ)+A.z2(A.abg.Bgj);break;
...
z2(A.abg.Bdt);break;case 36:Az=A.z2(A.abg.Bmc);break;case 14:Az=A.z2(A.abg.AnimalNotFound
...
abg.SuccessCreationNewAnimals);break;case 24:Az=A.z2(A.abg.Bd8);break;case 49:Az=
A.z2(A.abg.EvaluationInProgress);break;case 16:Az=A.z2(A.abg.Bec);break;case 17:
...
55:Az=A.z2(A.abg.BlG);break;case 21:Az=A.z2(A.abg.A2a);break;case 48:Az=(A.z2(A.
abg.A2a)+OQ)+A.z2(A.abg.A2Y);break;case 22:Az=A.z2(A.abg.Bgp);break;case 63:Az=A.
z2(A.abg.BmJ);break;case 85:Az=A.z2(A.abg.BmK);break;case 43:Az=A.z2(A.abg.Bgq);
break;case 25:Az=A.z2(A.abg.A8k);break;case 47:Az=(A.z2(A.abg.A8k)+OQ)+A.z2(A.abg.
A2Y);break;case 31:{var BvG=(((((((((((((((((((A.z2(A.abg.BdZ)+Awy)+A.z2(A.abg.ALn
))+A.z2(A.abg.Colon))+N2)+A.z2(A.abg.Bd1))+OQ)+A.z2(A.abg.AMl))+A.z2(A.abg.Colon
))+N2)+A.z2(A.abg.BeQ))+OQ)+A.z2(A.abg.ARL))+A.z2(A.abg.Colon))+N2)+A.z2(A.abg.BkG
))+OQ)+A.z2(A.abg.ARK))+A.z2(A.abg.Colon))+N2)+A.z2(A.abg.BkF);Az=BvG;}break;case
32:Az=A.z2(A.abg.Bmd);break;case 69:Az=A.z2(A.abg.Bgx);break;case 44:Az=A.z2(A.abg.
BmM);break;case 37:Az=A.z2(A.abg.WarningResetWeightSettings);break;case 38:Az=A.
z2(A.abg.WarningResetTempThresholds);break;case 39:Az=A.z2(A.abg.Bkw);break;case
76:Az=(A.z2(A.abg.A2z)+OQ)+A.z2(A.abg.ARN);break;case 40:Az=A.z2(A.abg.BlE);break;
...
abg.BlF);break;case 70:Az=A.z2(A.abg.BeM);break;case 71:Az=A.z2(A.abg.BlM);break;
case 72:Az=A.z2(A.abg.BlN);break;case 98:Az=A.z2(A.abg.BeO);break;case 101:Az=A.
z2(A.abg.BlO);break;case 100:Az=A.z2(A.abg.BlP);break;case 88:Az=A.z2(A.abg.BeN);
...
A.abg.WarningNoBackupFilePresent);break;case 84:Az=A.z2(A.abg.Be3);break;case 87:
...
,HDX:2,HDX_URBAN:3,LAST:4};C.TransponderTypeToString={BZ:function(A6){var BcT=A6;
var type=A.jm;switch(BcT){case 1:type=AWl;break;case 2:type=AWm;break;case 3:type=
AGn;break;case 4:type=Anr;break;case 0:type=Awz;break;default:throw new Error(AGo+
BcT.toFixed());}return type;},_Init:function(aArg){C.EnumToString._Init.call(this
,aArg);this.__proto__=C.TransponderTypeToString;},_className:"Device::TransponderTypeToString"
};C.TransponderProtocolToString={BZ:function(A6){var BcS=A6;var Ay3=A.jm;switch(
BcS){case 1:Ay3=AWn;break;case 2:Ay3=AGp;break;case 3:Ay3=AGq;break;case 0:Ay3=Awz;
break;default:throw new Error(Ako+BcS.toFixed());}return Ay3;},_Init:function(aArg
...
E;A.aat([this,this.BhZ,this.ARi],0);},ARh:function(E){if(this.TransponderProtocol===
E)return;this.TransponderProtocol=E;A.aat([this,this.BhY,this.ARh],0);},OnSetId:
function(E){if(this.Id===E)return;this.Id=E;A.aat([this,this.Qv,this.OnSetId],0);
},AMK:function(){return A._GetAutoObject(C.Converter).Bmb(this.Id);},Bfa:function(
){return A._GetAutoObject(C.Converter).Av9(this.Id);},BhZ:function(){return this.
TransponderType;},BhY:function(){return this.TransponderProtocol;},Qv:function(){
...
Bat=A6;var Ao0=A.jm;switch(Bat){case 0:Ao0=A.z2(A.abg.Bf1);break;case 1:Ao0=A.z2(
A.abg.Pound);break;default:throw new Error(Ans+Bat.toFixed());}return Ao0;},_Init:
...
P=P+1)HR=HR+this.Get(P);return HR;},toString:function(){var AZ$=this.Array.Get(0
).toFixed();var P;for(P=1;P<this.Mx;P=P+1)AZ$=(AZ$+OP)+this.Array.Get(P).toFixed(
);return AZ$;},EK:function(aString){var IM=aString.indexOf(String.fromCharCode(0x2C
),0);var AY0=A.jm;var P=0;while(P<10){if(aString===A.jm)this.Array.Set(P,0);else{
if(IM===-1){AY0=aString;aString=A.jm;}else{AY0=A.aaX(aString,IM);aString=A.aa3(aString
,0,IM+1);}this.Array.Set(P,A.vQ(AY0,0,10));IM=aString.indexOf(String.fromCharCode(
...
A.abg.A3w);break;case 16:EL=A.z2(A.abg.AKg);break;case 1:EL=A.z2(A.abg.Temperature
...
A.z2(A.abg.A4E);break;case 32768:EL=A.z2(A.abg.AAh);break;case 524288:EL=A.z2(A.
abg.AAj);break;case 65536:EL=A.z2(A.abg.Delete);break;case 131072:EL=A.z2(A.abg.
A4F);break;case 0:EL=A.z2(A.abg.A42);break;default:throw new Error(AGs+AxT.toFixed(
...
A3w);break;case 16:EL=A.z2(A.abg.AKg);break;case 1:EL=A.z2(A.abg.Temperature);break;
...
z2(A.abg.A4D);break;case 32768:EL=A.z2(A.abg.AAh);break;case 524288:EL=A.z2(A.abg.
AAj);break;case 65536:EL=A.z2(A.abg.Delete);break;case 131072:EL=A.z2(A.abg.A4D);
break;case 0:EL=A.z2(A.abg.A42);break;default:throw new Error(AGs+AxT.toFixed());
...
C.Converter).A8n(Bxa);},Vb:function(Ab,AX){return 0;},RQ:function(Ab,AX){return 0;
},A34:function(Ab,AX){return this.CE(Ab,AX);},Op:function(){var Jg=0;var BxU=this.
Id;return Jg;},Or:function(AnJ){var Hs=0;var BxU=this.Id;return Hs===1;},XS:function(
...
Ab,AX,CX){var Bxb=A._GetAutoObject(C.Converter).Ac1(CX);return this.YV(Ab,AX,Bxb
);},A70:function(Ab,AX,CX){return this.G_(Ab,AX,CX);},AMD:function(Ab,AX){return this.
CE(Ab,AX);},Be_:function(Ab,AX){return this.CE(Ab,AX);},Bk8:function(Ab,AX,CX){return this.
G_(Ab,AX,CX);},Bk4:function(Ab,AX,CX){return this.G_(Ab,AX,CX);},K4:function(aColumn
,A1){return-1;},Al0:function(Ab,AX){return this.CE(Ab,AX);},Bk2:function(Ab,AX,CX
...
function(aColumn,A1){return-1;},G9:function(){return false;},Be$:function(Ab,AX){
var Bxc=this.CE(Ab,AX);return A._GetAutoObject(C.Converter).Bfz(Bxc);},Bfc:function(
Ab,AX){return this.CE(Ab,AX);},AMM:function(Ab,AX){return this.CE(Ab,AX);},Bk6:function(
Ab,AX,CX){var Bxd=A._GetAutoObject(C.Converter).A2G(CX);return this.G_(Ab,AX,Bxd
);},Bk7:function(Ab,AX,CX){return this.G_(Ab,AX,CX);},Blc:function(Ab,AX,CX){return this.
G_(Ab,AX,CX);},AiV:function(aColumn,A1){return false;},Af5:function(aColumn,A1){
return false;},Bfm:function(Ab,AX){return this.CE(Ab,AX);},Bla:function(Ab,AX,CX
...
BZ:function(A6){var Bck=A6;var Aze=A.jm;switch(Bck){case 0:Aze=A.z2(A.abg.Bd_);break;
case 1:Aze=A.z2(A.abg.BdO);break;case 2:Aze=A.z2(A.abg.BdL);break;case 3:Aze=A.z2(
A.abg.BgN);break;default:throw new Error(AGt+Bck.toFixed());}return Aze;},_Init:
...
0,Normal:1,Elevated:2,Fever:3,LAST:4};C.JD={AcU:0,Temperature:1,Rating:2,Ag9:3,Byq:
4,By6:5,BBI:6,BzH:7,BAt:8,Bzf:9,BAs:10,BAS:11,LAST:12};C.AnimalListContentToString={
BZ:function(A6){var A_X=A6;var Wv=A.jm;switch(A_X){case 0:Wv=AWr;break;case 2:Wv=
...
A_X.toFixed());}return Wv;},_Init:function(aArg){C.EnumToString._Init.call(this,
...
},_className:"Device::AnimalTypeFilterCriterion"};C.ByC={Ain:0,ByB:1,BAe:2,A7I:3
,A2P:4,BBr:5,By5:6,BBq:7,LinkTransponder:8,O7:9,Weighing:10,Calving:11,LinkNaisId:
...
Uu){case 0:Nm=A.z2(A.abg.Bd2);break;case 1:Nm=A.z2(A.abg.BfD);break;case 2:Nm=A.
...
){case 0:return A.z2(A.abg.Bdi);case 1:return A.z2(A.abg.AnimalDataOnly);default:
...
aArg){var B;A.za([this,this.Bbx],[B=A._GetAutoObject(C.Device),B.A54,B.A9V],0);this.
Bbx(this);},Bbx:function(H){this.EK(A._GetAutoObject(C.Device).AEY);A.vv(this,0);
...
ASE={Init:function(aArg){var B;A.za([this,this.Bbv],[B=A._GetAutoObject(C.Device
),B.A53,B.A9U],0);this.Bbv(this);},Cr:function(){A._GetAutoObject(C.Device).AqF(
this.toString());},Bbv:function(H){this.EK(A._GetAutoObject(C.Device).AEX);A.vv(
...
AKz={Init:function(aArg){var B;A.za([this,this.Ba1],[B=A._GetAutoObject(C.Device
...
Bdj);default:return Akn+A6.toFixed();}},_Init:function(aArg){C.EnumToString._Init.
...
BAA:29,BAP:30,BAQ:31,BA6:32,BA7:33,BA8:34,BBk:35,BBl:36,BBB:37,A8o:38,BBC:39,LAST:
40};C.CountryToString={BZ:function(A6){var N8=A6;var Fq=A.jm;switch(N8){case 1:Fq=
A.z2(A.abn.Bdx);break;case 2:Fq=A.z2(A.abn.BdP);break;case 3:Fq=A.z2(A.abn.BdK);
break;case 4:Fq=A.abn.BdR;break;case 5:Fq=A.z2(A.abn.BdT);break;case 6:Fq=A.z2(A.
abn.BlT);break;case 7:Fq=A.z2(A.abn.BdW);break;case 8:Fq=A.z2(A.abn.Bd$);break;case
9:Fq=A.z2(A.abn.Bea);break;case 10:Fq=A.z2(A.abn.Be4);break;case 11:Fq=A.z2(A.abn.
Beh);break;case 12:Fq=A.z2(A.abn.BeJ);break;case 13:Fq=A.z2(A.abn.Blo);break;case
14:Fq=A.z2(A.abn.BeS);break;case 15:Fq=A.z2(A.abn.Be0);break;case 16:Fq=A.z2(A.abn.
Bfu);break;case 17:Fq=A.z2(A.abn.Bd9);break;case 18:Fq=A.z2(A.abn.BfA);break;case
19:Fq=A.z2(A.abn.BfK);break;case 20:Fq=A.z2(A.abn.BfW);break;case 21:Fq=A.z2(A.abn.
BfY);break;case 22:Fq=A.z2(A.abn.Bga);break;case 23:Fq=A.z2(A.abn.Bge);break;case
24:Fq=A.z2(A.abn.Bf_);break;case 25:Fq=A.abn.Bgg;break;case 26:Fq=A.z2(A.abn.Bgy
);break;case 27:Fq=A.z2(A.abn.BgO);break;case 28:Fq=A.z2(A.abn.Bkp);break;case 29:
Fq=A.z2(A.abn.Bkq);break;case 30:Fq=A.z2(A.abn.BkQ);break;case 31:Fq=A.z2(A.abn.
BkS);break;case 32:Fq=A.z2(A.abn.BlS);break;case 33:Fq=A.z2(A.abn.Bln);break;case
34:Fq=A.z2(A.abn.Blm);break;case 35:Fq=A.z2(A.abn.Bmg);break;case 36:Fq=A.z2(A.abn.
Bl2);break;case 37:Fq=A.z2(A.abn.Bmk);break;case 38:Fq=A.z2(A.abn.A8o);break;case
...
BZ:function(A6){var A$u=A6;var Asg=A.jm;switch(A$u){case 0:Asg=A.z2(A.abg.Unspecified
...
throw new Error(AwP+A$u.toFixed());}return Asg;},_Init:function(aArg){C.EnumToString.
...
10,LAST:11};C.WhereAboutsToString={BZ:function(A6){var Bc_=A6;var ZY=A.jm;switch(
Bc_){case 0:ZY=A.z2(A.abg.Unknown);break;case 1:ZY=A.z2(A.abg.Bms);break;case 2:
...
break;case 10:ZY=A.z2(A.abg.Bmy);break;default:throw new Error(AWE+Bc_.toFixed()
...
};C.Ia={AnimalId:0,TransponderId:1,Bz$:2,Bz_:3,BAc:4,BAb:5};C.Aty={ByF:0,Bza:1};
...
};C.DirectionOfCountingToString={BZ:function(A6){var AxS=A6;var AY7=A.jm;switch(
AxS){case 0:AY7=AWI;break;case 1:AY7=AWJ;break;default:throw new Error(ArP+AxS.toFixed(
));}return AY7;},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.
...
};C.Ph={UNDEFINED:0,SH:1,AMP:2,APv:3,AMO:4,A4W:5,HE:6,A7G:7,A2q:8,AKK:9,ARX:10,BE:
11,BB:12,A4K:13,ARY:14,ARZ:15,ASx:16};C.GermanStateToString={BZ:function(A6){var
...
Go=A.z2(A.abp.A4W);break;case 6:Go=A.z2(A.abp.HE);break;case 7:Go=A.z2(A.abp.A7G
);break;case 8:Go=A.z2(A.abp.A2q);break;case 9:Go=A.z2(A.abp.AKK);break;case 10:
Go=A.z2(A.abp.ARX);break;case 11:Go=A.z2(A.abp.BE);break;case 12:Go=A.z2(A.abp.BB
);break;case 13:Go=A.z2(A.abp.A4K);break;case 14:Go=A.z2(A.abp.ARY);break;case 15:
Go=A.z2(A.abp.ARZ);break;case 16:Go=A.z2(A.abp.ASx);break;case 0:Go=Ant;break;default:
throw new Error(Ahe+Bp.toFixed());}return Go;},Lh:function(A6){var Bp=A6;var Go=
A.jm;switch(Bp){case 1:Go=A.z2(A.abp.BkT);break;case 2:Go=A.z2(A.abp.AMP);break;
case 3:Go=A.z2(A.abp.APv);break;case 4:Go=A.z2(A.abp.AMO);break;case 5:Go=A.z2(A.
abp.Bgv);break;case 6:Go=A.z2(A.abp.HE);break;case 7:Go=A.z2(A.abp.BkA);break;case
8:Go=A.z2(A.abp.BdA);break;case 9:Go=A.z2(A.abp.AKK);break;case 10:Go=A.z2(A.abp.
ARX);break;case 11:Go=A.z2(A.abp.BE);break;case 12:Go=A.z2(A.abp.BB);break;case 13:
Go=A.z2(A.abp.Bgf);break;case 14:Go=A.z2(A.abp.ARY);break;case 15:Go=A.z2(A.abp.
ARZ);break;case 16:Go=A.z2(A.abp.ASx);break;case 0:Go=Ant;break;default:throw new
Error(Ahe+Bp.toFixed());}return Go;},Bl7:function(A6){var Bp=A6;var FX=-1;switch(
...
throw new Error(Ahe+Bp.toFixed());}return FX;},Bl8:function(A6){var Bp=A6;var FX=
A.jm;switch(Bp){case 1:FX=ArQ;break;case 2:FX=AwQ;break;case 3:FX=Anv;break;case
...
16:FX=AWU;break;case 0:FX=Ant;break;default:throw new Error(Ahe+Bp.toFixed());}return FX;
...
Uu){case 0:Nm=A.z2(A.abg.Bki);break;case 1:Nm=A.z2(A.abg.Bmi);break;default:throw new
...
};C.Byz={BAq:0,BAg:1,Bzq:2,Bzr:3,Bzs:4,BBm:5};C.EnumToCodeset={AlL:function(Ahh){
...
},_className:"Device::BreedToHitCodeset"};C.ReasonOfLeaving={Unknown:0,A8a:1,SW:
2,A7B:3,A4o:4,BAy:5,A8p:6,A4S:7,A2O:8,A7x:9,A4Q:10,A2S:11,BAN:12,BAO:13,LAST:14};
C.ReasonOfLeavingToString={BZ:function(A6){var AcE=A6;var SQ=A.jm;switch(AcE){case
0:SQ=A.z2(A.abg.Unknown);break;case 1:SQ=A.z2(A.abg.A8a);break;case 2:SQ=A.z2(A.
abg.SW);break;case 3:SQ=A.z2(A.abg.A7B);break;case 4:SQ=A.z2(A.abg.A4o);break;case
5:SQ=A.z2(A.abg.Bkj);break;case 6:SQ=A.z2(A.abg.A8p);break;case 7:SQ=A.z2(A.abg.
A4S);break;case 8:SQ=A.z2(A.abg.A2O);break;case 9:SQ=A.z2(A.abg.A7x);break;case 10:
SQ=A.z2(A.abg.A4Q);break;case 11:SQ=A.z2(A.abg.A2S);break;case 12:SQ=A.z2(A.abg.
Bkt);break;case 13:SQ=A.z2(A.abg.Bks);break;default:throw new Error(AwT+AcE.toFixed(
...
E)return;this.Deregistrations=E;A.aat([this,this.Bhe,this.Au3],0);},Au2:function(
E){if(this.Deaths===E)return;this.Deaths=E;A.aat([this,this.Bhc,this.Au2],0);},AjN:
function(E){if(this.Year===E)return;this.Year=E;A.aat([this,this.Aqe,this.AjN],0
);},Bhe:function(){return this.Deregistrations;},Bhc:function(){return this.Deaths;
...
};C.Atw={Undefined:0,Display:1,A7F:2,A7R:3,A8H:4,BzL:5,BAX:6,BBx:7,Bz9:8,By1:9,Byo:
10,A3Q:11,A7H:12,BBE:13,A4V:14,BBH:15};C.DeviceComponentToString={BZ:function(A6
){var A$o=A6;var PU=A.jm;switch(A$o){case 0:PU=AWX;break;case 10:PU=A.z2(A.abg.Bc$
);break;case 9:PU=A.z2(A.abg.BdV);break;case 1:PU=A.z2(A.abg.Bez);break;case 11:
PU=A.z2(A.abg.A3Q);break;case 5:PU=A.z2(A.abg.BmB);break;case 8:PU=A.z2(A.abg.BeB
);break;case 14:PU=A.z2(A.abg.A4V);break;case 2:PU=A.z2(A.abg.A7F);break;case 12:
PU=A.z2(A.abg.A7H);break;case 6:PU=A.z2(A.abg.Bkz);break;case 3:PU=A.z2(A.abg.A7R
);break;case 7:PU=A.z2(A.abg.BeC);break;case 13:PU=A.z2(A.abg.Bek);break;case 15:
PU=A.z2(A.abg.BmF);break;case 4:PU=A.z2(A.abg.A8H);break;default:throw new Error(
AWY+A$o.toFixed());}return PU;},_Init:function(aArg){C.EnumToString._Init.call(this
...
};C.AdT={Arl:function(A6){return A.zW(A.abi.ANW);},Arm:function(A6){var A$y=A6;var
Q$=-1;switch(A$y){case 0:Q$=0;break;case 1:Q$=1;break;case 2:Q$=2;break;default:
throw new Error(AGz+A$y.toFixed());}return Q$;},_Init:function(aArg){C.EnumToIcon.
...
};C.BAj={ALN:0,By8:1,ANy:2,LAST:3};C.BBo={Gt:0,AS9:1,G5:2,Year:3,LAST:4};C.TimespanDaysToString={
BZ:function(A6){var BcL=A6;var Azs=A.jm;switch(BcL){case 0:Azs=A.z2(A.abg.A27);break;
case 1:Azs=A.z2(A.abg.AS9);break;case 2:Azs=A.z2(A.abg.G5);break;case 3:Azs=A.z2(
A.abg.Year);break;default:throw new Error(AWZ+BcL.toFixed());}return Azs;},_Init:
...
4,LAST:5};C.USBStateToString={BZ:function(A6){var Bc5=A6;var Bp=A.jm;switch(Bc5){
case 0:Bp=AW0;break;case 1:Bp=AW1;break;case 2:Bp=AW2;break;case 4:Bp=AW3;break;
case 3:Bp=AW4;break;default:throw new Error(AFW+Bc5.toFixed());}return Bp;},_Init:
function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=C.USBStateToString;
},_className:"Device::USBStateToString"};C.AAz={BzP:0,ByA:1,BzQ:2,BzN:3};C.AvZ={
AAv:A.jm,Timestamp:0,ACa:0,ACi:0,AEp:0,OnSetTimestamp:function(E){if(this.Timestamp===
E)return;this.Timestamp=E;},ADl:function(E){if(this.ACa===E)return;this.ACa=E;},
ADs:function(E){if(this.ACi===E)return;this.ACi=E;},ADE:function(E){if(this.AEp===
E)return;this.AEp=E;},AC3:function(E){if(this.AAv===E)return;this.AAv=E;},_Init:
function(aArg){this.__proto__=C.AvZ;A.hJ++;},_Done:function(){this.__proto__=null;
A.hJ--;},_ReInit:function(){},_Mark:function(D){var B;if((B=this.I)&&(B._cycle!=
D))B._Mark(B._cycle=D);},I:null,_cycle:0,_observers:null,_className:"Device::SoftwareVersionInformation"
};C.At2={Timestamp:0,APj:0,APk:0,ASP:0,ASQ:0,ASO:0,APi:0,OnSetTimestamp:function(
E){if(this.Timestamp===E)return;this.Timestamp=E;},ADi:function(E){if(this.APj===
E)return;this.APj=E;},ADj:function(E){if(this.APk===E)return;this.APk=E;},ADR:function(
E){if(this.ASP===E)return;this.ASP=E;},ADS:function(E){if(this.ASQ===E)return;this.
ASQ=E;},ADQ:function(E){if(this.ASO===E)return;this.ASO=E;},ADh:function(E){if(this.
APi===E)return;this.APi=E;},_Init:function(aArg){this.__proto__=C.At2;A.hJ++;},_Done:
function(){this.__proto__=null;A.hJ--;},_ReInit:function(){},_Mark:function(D){var
B;if((B=this.I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null,_cycle:0,_observers:
null,_className:"Device::HardwareVersionInformation"};C.Ape={Undefined:0,BzB:1,ByN:
2};C.AfK={Manual:0,TransponderId:1,LAST:2};C.AnimalIdAutoGenerationMethodToString={
BZ:function(A6){var A_V=A6;var AYA=A.jm;switch(A_V){case 0:AYA=A.z2(A.abg.A2X);break;
case 1:AYA=A.z2(A.abg.A3b);break;default:throw new Error(AW5+A_V.toFixed());}return AYA;
},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=C.AnimalIdAutoGenerationMethodToString;
},_className:"Device::AnimalIdAutoGenerationMethodToString"};C.G5={A2E:0,AB1:1,AAS:
2,ACb:3,AzT:4,ACe:5,AB3:6,AB2:7,Az1:8,AEw:9,ACs:10,ACq:11,AAC:12,LAST:13};C.MonthToString={
BZ:function(A6){var Bay=A6;var WK=A.jm;switch(Bay){case 1:WK=A.z2(A.abu.AB1);break;
...
12:WK=A.z2(A.abu.AAC);break;default:throw new Error(AW6+Bay.toFixed());}return WK;
...
};C.AlC={BzI:0,BBd:1};C.ATe={Init:function(aArg){var B;A.za([this,this.BbH],[B=A.
_GetAutoObject(C.Device),B.A6e,B.A92],0);this.BbH(this);},Cr:function(){A._GetAutoObject(
C.Device).AqL(this.toString());},BbH:function(H){this.EK(A._GetAutoObject(C.Device
...
};C.ATd={Init:function(aArg){var B;A.za([this,this.BbF],[B=A._GetAutoObject(C.Device
),B.A6d,B.A91],0);this.BbF(this);},Cr:function(){A._GetAutoObject(C.Device).AqK(
this.toString());},BbF:function(H){this.EK(A._GetAutoObject(C.Device).AFf);A.vv(
this,0);},_Init:function(aArg){C.Int32ArrayWrapper._Init.call(this,aArg);this.__proto__=
C.ATd;this.YH(2);this.Init(aArg);},_className:"Device::WeightGainsHighClass"};C.
ATg={Init:function(aArg){var B;A.za([this,this.BbJ],[B=A._GetAutoObject(C.Device
),B.A6h,B.A95],0);this.BbJ(this);},Cr:function(){A._GetAutoObject(C.Device).AqM(
this.toString());},BbJ:function(H){this.EK(A._GetAutoObject(C.Device).AFi);A.vv(
this,0);},_Init:function(aArg){C.Int32ArrayWrapper._Init.call(this,aArg);this.__proto__=
C.ATg;this.YH(2);this.Init(aArg);},_className:"Device::WeightValuesBirthClass"};
C.ATc={Init:function(aArg){var B;A.za([this,this.BbD],[B=A._GetAutoObject(C.Device
),B.A6c,B.A90],0);this.BbD(this);},Cr:function(){A._GetAutoObject(C.Device).AqJ(
this.toString());},BbD:function(H){this.EK(A._GetAutoObject(C.Device).AFe);A.vv(
this,0);},_Init:function(aArg){C.Int32ArrayWrapper._Init.call(this,aArg);this.__proto__=
C.ATc;this.YH(2);this.Init(aArg);},_className:"Device::WeightGainsAverageClass"};
C.AKA={Init:function(aArg){var B;A.za([this,this.Ba2],[B=A._GetAutoObject(C.Device
...
4};C.Ag6={A46:0,Manual:1,TransponderId:2,LAST:3};C.TransponderAssignmentIdChangeMethodToString={
BZ:function(A6){var BcP=A6;var AJi=A.jm;switch(BcP){case 0:AJi=A.z2(A.abg.A46);break;
case 1:AJi=A.z2(A.abg.A2X);break;case 2:AJi=A.z2(A.abg.A3b);break;default:throw new
Error(AGA+BcP.toFixed());}return AJi;},_Init:function(aArg){C.EnumToString._Init.
call(this,aArg);this.__proto__=C.TransponderAssignmentIdChangeMethodToString;},_className:
"Device::TransponderAssignmentIdChangeMethodToString"};C.A7y={Bw6:function(A_x){
var Nn=A.aa2(A.aaX(A_x,15),0,10);if(!A._GetAutoObject(C.Converter).AeF(Nn))return 0;
return A.aa2(A.aaX(A_x,15),0,10);},Bw5:function(AHV){if(AHV.length<8)return 0;var
AyW=A._NewObject(A.Core.Bu,0);var Bxu=A.aaY(AHV,4,4);var AZF=A.vQ(Bxu,0,10);if((
AZF<2000)||(AZF>2100))return 0;AyW.Year=AZF;var Bxt=A.aaY(AHV,2,2);var AZE=A.vQ(
Bxt,0,10);if((AZE<1)||(AZE>12))return 0;AyW.TE(AZE);var Bxs=A.aaX(AHV,2);var AZD=
A.vQ(Bxs,0,10);if((AZD<1)||(AZD>AyW.Yx()))return 0;AyW.Lb(AZD);return AyW.JL();}
,_Init:function(aArg){this.__proto__=C.A7y;A.hJ++;},_Done:function(){this.__proto__=
null;A.hJ--;},_ReInit:function(){},_Mark:function(D){var B;if((B=this.I)&&(B._cycle
!=D))B._Mark(B._cycle=D);},I:null,_cycle:0,_observers:null,_className:"Device::ParserClass"
};C.AvI={_Init:function(){C.A7y._Init.call(this,0);},_variants:function(){return this;
...
A.abg.Breed);break;case 4:FE=A.z2(A.abg.AfW);break;case 28:FE=A.z2(A.abg.A2K);break;
...
case 38:FE=A.z2(A.abg.BeA);break;case 11:FE=A.z2(A.abg.Fever);break;case 27:FE=A.
...
default:throw new Error(AW7+A6.toFixed());}return FE;},_Init:function(aArg){C.EnumToString.
...
BuL=A6;var AY2=A.jm;switch(BuL){case 0:AY2=A.abg.Bfv;break;case 1:AY2=A.abg.Beb;
break;default:throw new Error(AW8+A6.toFixed());}return AY2;},_Init:function(aArg
){C.EnumToString._Init.call(this,aArg);this.__proto__=C.DataExportDestinationToString;
},_className:"Device::DataExportDestinationToString"};C.AB_={Bc:0,BBh:1,LAST:2};
C.ListViewScopeToString={BZ:function(A6){var BvR=A6;var AZ0=A.jm;switch(BvR){case
0:AZ0=AW9;break;case 1:AZ0=AW_;break;default:throw new Error(AW$+A6.toFixed());}
return AZ0;},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=
