...
var MQ="AU";var Te="AT";var U0="BE";var Aab="BA";var Xe="BG";var Ix="CA";var U1=
"CN";var Aac="TW";var U2="HR";var Aad="CY";var Xf="CZ";var Aae="DK";var Aaf="EE";
var U3="FI";var Xg="FR";var Pa="DE";var Aag="GR";var Oi="HU";var Rp="IE";var Xh=
"IT";var Xi="JP";var Tf="LV";var Xj="LT";var Aah="LU";var Xk="MT";var Xl="NL";var
Tg="NO";var Th="PL";var Ti="PT";var Aai="RO";var Tj="RU";var Aaj="SK";var AfE="SI";
var Aak="ES";var Xm="SE";var Aal="CH";var Xn="TR";var AhX="UA";var K4="UK";var AcQ=
"US";var LB=".";var AhY="-";var Aoi="ERROR: Unhandled mass unit: ";var Oj=" ";var
Xo="Unhandled gender";var Aam="Unhandled animal type";var AfF="Unhandled Device::MassUnit.";
var AhZ="Unhandled Device::AnimalListContent.";var AcR="Avid";var U4="Ordicam / IER SA";
...
var Rq=" ]";var Ayd="Unhandled language";var U5="Unhandled Device::AnimalListAction.";
var As6="Temperature unit conversion not supported: ";var Aye="->";var Ayf="=";var
Ale=">";var Ayg="<";var AfG="!=";var Aon="WARNING: Unhandled operator.";var I1="Unknown birth type";
var Aoo="Unhandled country: ";var As7="Unhandled Device::Action: ";var Xp="ERROR: Cannot start transaction";
...
var AfH="Time alarm";var Aoq="Time first weighing";var AWr="Time control";var AHF=
...
var AWu="ERROR: Unhandled RatingTable filter field:";var AcS="ERROR: Unhandled table ";
...
"NewAnimalManualData";var AHY="MassRecording";var AfI="NewAnimalTransponderData";
...
var Ah3="AnimalSearchUnfiltered";var U7="AnimalSearchDriedOff";var AXH="MeasurementReady";
var Aao="AnimalMultiInfoMenu";var AXI="MassRecordingDefaults";var AXJ="MassRecordingFields";
var Alk="MassRecordingMenu";var AfJ="BirthRegistrationsListMenu";var Ah4="Unhandled overlay menu: ";
...
var U8="FailedCreateBackup";var Ati="FailedRestoreBackup";var AYv="TechnicalDetails";
...
"EarTagNumberTooShort";var AYH="NoValidCountryCode";var AcT="WarningOutdatedAnimalWeight";
...
"SuccessChangeTransponder";var AcU="SuccessUnlinkTransponder";var AIB="SuccessLinkNaisId";
...
AI)throw new Error(Cf);Aw=Aw.Ah;}AI.AJ=this.B9;if(!!this.B9)this.B9.Ah=AI;this.B9=
AI;if(!this.B8)this.B8=AI;},AOX:function(){return this.B8;},AO2:function(Bco){if(
!!Bco)return Bco.Ah;return null;},DM:function(AJk,Eb){var Aw=this.B8;while(!!Aw){
if(Aw.EJ===AJk){if(Eb===1)return Aw;else if(Aw.Operator===Eb)return Aw;}Aw=Aw.Ah;
}return null;},Nw:function(AI){var Aw=this.B8;while(!!Aw){if(Aw===AI){if(!!Aw.AJ
...
Bf=A._NewObject(C.Filter,0);var Aw=this.B8;while(!!Aw){Bf.CX(Aw.Abs());Aw=Aw.Ah;
...
1,YQ:false,Abs:function(){return null;},E$:function(AI){if(!AI)return;this.EJ=AI.
EJ;this.Operator=AI.Operator;this.YQ=AI.YQ;},_Init:function(aArg){this.__proto__=
...
};C.Int32FilterCriterion={A5:0,Abs:function(){var Aw=A._NewObject(C.Int32FilterCriterion
...
function(A4,Eb,A8,Qi){this.EJ=A4;this.Operator=Eb;this.A5=A8;this.YQ=Qi;return this;
...
AEC:0,AEB:0,Av_:0,OZ:0,O0:null,SG:null,Q3:null,S5:null,R7:null,P7:null,Gg:null,An:
...
jV,ASr:A.jV,ASw:A.jV,AWk:A.jV,Abc:100,Lz:0,ANe:75,AcK:3600,AUu:0,A3:5,AF:0,K2:50000
,Pr:0,AGt:0,AdU:0,Arb:0,Ara:0,ASe:1,ASd:1,AjV:0,ASf:1,AxY:0,Afu:0,AqZ:10,AVg:5,Av5:
60,Av3:0,An_:0,OT:1,WhereAbouts:0,Ak6:0,AxQ:3,ACZ:0,AgC:1,Ab1:0,Aqy:0,AOb:11,Breed:
...
0,Language:0,MeasureState:0,ScanState:0,In:3,AUt:false,AM9:false,AeR:true,AR2:false
...
K.Zv.apply(this,arguments);else return C.DeviceClass.Bu$.apply(this,arguments);}
,Bu$:function(E){},Bbx:function(Aq){this.Zv(Aq);},UpdateBatteryChargeState:function(
AK){if(this.Abc===AK)return;this.Abc=AK;A.abo([this,this.Awe,this.AyX],0);},AwC:
function(E){if(this.K&&this.K.AwC)return this.K.AwC.apply(this,arguments);else return C.
DeviceClass.Bvk.apply(this,arguments);},Bvk:function(E){A.ab5("%s",BD);},AyX:function(
...
)return this.K.AFj.apply(this,arguments);else return C.DeviceClass.Bvr.apply(this
,arguments);},Bvr:function(E){A.ab5("%s",E8);},AyY:function(Aq){this.AFj(Aq);},UpdateScanState:
function(AK){var B;if(this.ScanState===AK)return;this.ScanState=AK;A.abo([this,this.
AS4,this.A0Q],0);A._GetAutoObject(C.Helper).BBB(this);},Ar$:function(E){if(this.
K&&this.K.Ar$)return this.K.Ar$.apply(this,arguments);else return C.DeviceClass.
Bv8.apply(this,arguments);},Bv8:function(E){A.ab5("%s",Hs);},A0Q:function(Aq){this.
...
K.Aw1)return this.K.Aw1.apply(this,arguments);else return C.DeviceClass.BvP.apply(
this,arguments);},BvP:function(E){A.ab5("%s",I0);},AI6:function(Aq){this.Aw1(Aq);
...
this,arguments);else return C.DeviceClass.Bwc.apply(this,arguments);},Bwc:function(
E){A.ab5("%s",Iw);},AI8:function(Aq){this.Axd(Aq);},AnH:function(E){if(this.K&&this.
K.AnH)return this.K.AnH.apply(this,arguments);else return C.DeviceClass.BvJ.apply(
this,arguments);},BvJ:function(E){},BbN:function(Aq){this.AnH(Aq);},Axe:function(
E){if(this.K&&this.K.Axe)return this.K.Axe.apply(this,arguments);else return C.DeviceClass.
Bwd.apply(this,arguments);},Bwd:function(E){},Atu:function(Aq){this.Axe(Aq);},AFh:
function(E){if(this.K&&this.K.AFh)return this.K.AFh.apply(this,arguments);else return C.
DeviceClass.Bvq.apply(this,arguments);},Bvq:function(E){},BbF:function(Aq){this.
AFh(Aq);},AFP:function(E){if(this.K&&this.K.AFP)return this.K.AFP.apply(this,arguments
);else return C.DeviceClass.BvR.apply(this,arguments);},BvR:function(E){},A0K:function(
...
BwN.apply(this,arguments);},BwN:function(){},AhP:function(){if(this.K&&this.K.AhP
)return this.K.AhP.apply(this,arguments);else return C.DeviceClass.BwQ.apply(this
,arguments);},BwQ:function(){},AhM:function(){if(this.K&&this.K.AhM)return this.
K.AhM.apply(this,arguments);else return C.DeviceClass.BwO.apply(this,arguments);
},BwO:function(){},An4:function(){if(this.K&&this.K.An4)return this.K.An4.apply(
...
apply(this,arguments);else return C.DeviceClass.BwL.apply(this,arguments);},BwL:
...
return C.DeviceClass.Bbj.apply(this,arguments);},Bbj:function(){},Bpb:function(){
...
K.Dw.apply(this,arguments);else return C.DeviceClass.Bv2.apply(this,arguments);}
,Bv2:function(E){},Ay5:function(Aq){this.Dw(Aq);},Axl:function(E){if(this.K&&this.
K.Axl)return this.K.Axl.apply(this,arguments);else return C.DeviceClass.Bwn.apply(
this,arguments);},Bwn:function(E){},BbZ:function(Aq){this.Axl(Aq);},UpdateUnderTemp:
function(AK){if(this.AcK===AK)return;this.AcK=AK;A.abo([this,this.A9M,this.BbZ],
0);},UpdateSyncState:function(AK){if(this.SyncState===AK)return;this.SyncState=AK;
A.abo([this,this.AS6,this.A0S],0);},Acd:function(E){if(this.K&&this.K.Acd)return this.
K.Acd.apply(this,arguments);else return C.DeviceClass.Bwb.apply(this,arguments);
},Bwb:function(E){A.ab5("%s",Qc);},A0S:function(Aq){this.Acd(Aq);},ADm:function(
){if(this.K&&this.K.ADm)return this.K.ADm.apply(this,arguments);else return C.DeviceClass.
Bu3.apply(this,arguments);},Bu3:function(){return A.jV;},UpdatePopup:function(Ka
,A1C,A1x,A1F){this.AY(Ka,A1C,A1x,A1F,[this,this.BBh]);},PopupStateChanged:function(
Ka,Ae){if(this.K&&this.K.PopupStateChanged)return this.K.PopupStateChanged.apply(
this,arguments);else return C.DeviceClass.BwA.apply(this,arguments);},BwA:function(
Ka,Ae){},AGe:function(E){if(this.K&&this.K.AGe)return this.K.AGe.apply(this,arguments
);else return C.DeviceClass.Bwp.apply(this,arguments);},Bwp:function(E){},Bb0:function(
Aq){this.AGe(Aq);},UpdateVibrationOnKeypressEnabled:function(AK){if(this.AsZ===AK
)return;this.AsZ=AK;A.abo([this,this.A9N,this.Bb0],0);},Afb:function(E){if(this.
K&&this.K.Afb)return this.K.Afb.apply(this,arguments);else return C.DeviceClass.
Bwo.apply(this,arguments);},Bwo:function(E){},AI9:function(Aq){this.Afb(Aq);},UpdateVibrationOn:
function(BcT){if(this.AV5===BcT)return;this.AV5=BcT;A.abo([this,this.AE1,this.AI9
],0);},AY:function(Ka,A1C,A1x,A1F,A1y){var Agr=A._NewObject(C.PopupContext,0);Agr.
Id=Ka;Agr.Show=A1C;Agr.AkJ=A1x;Agr.Ak5=A1F;Agr.AGm=A1y;this.AnS.Trigger(Agr,false
);},BBh:function(G){var Ar=(C.PopupContext.isPrototypeOf(G)?G:null);if(!!Ar)this.
PopupStateChanged(Ar.Id,Ar.PopupState);},Aw$:function(E){if(this.K&&this.K.Aw$)return this.
K.Aw$.apply(this,arguments);else return C.DeviceClass.Bv7.apply(this,arguments);
},Bv7:function(E){},A0P:function(Aq){this.Aw$(Aq);},UpdateRatingMode:function(AK
...
);else return C.DeviceClass.BvB.apply(this,arguments);},BvB:function(E){},Att:function(
Aq){this.Ae3(Aq);},UpdateFlashLightOn:function(Bcz){if(this.AmW===Bcz)return;this.
AmW=Bcz;A.abo([this,this.ArF,this.Att],0);},UA:function(E){if(this.K&&this.K.UA)
return this.K.UA.apply(this,arguments);else return C.DeviceClass.Bwg.apply(this,
arguments);},Bwg:function(E){},A0T:function(Aq){this.UA(Aq);},UpdateTopLightOn:function(
BcO){if(this.AVJ===BcO)return;this.AVJ=BcO;A.abo([this,this.AS8,this.A0T],0);},WQ:
function(E){if(this.K&&this.K.WQ)return this.K.WQ.apply(this,arguments);else return C.
DeviceClass.Bv6.apply(this,arguments);},Bv6:function(E){},Bw4:function(Aq){this.
WQ(Aq);},UpdateRGBTopLight:function(BcJ){if(this.AUu===BcJ)return;this.AUu=BcJ;A.
abo([this,this.BlS,this.Bw4],0);},AwA:function(E){if(this.K&&this.K.AwA)return this.
K.AwA.apply(this,arguments);else return C.DeviceClass.Bvj.apply(this,arguments);
},Bvj:function(E){},BwX:function(Aq){this.AwA(Aq);},UpdateAutoRegistrationMode:function(
Bcm){if(this.AutoRegistrationMode===Bcm)return;this.AutoRegistrationMode=Bcm;A.abo([
this,this.Blg,this.BwX],0);},Asa:function(E){if(this.K&&this.K.Asa)return this.K.
Asa.apply(this,arguments);else return C.DeviceClass.Bv9.apply(this,arguments);},
Bv9:function(E){A.ab5("%s",CR);},A0R:function(Aq){this.Asa(Aq);},UpdateScanTransponder:
...
)return this.K.OU.apply(this,arguments);else return C.DeviceClass.Bvt.apply(this
,arguments);},Bvt:function(E){},U_:function(Aq){this.OU(Aq);},UpdateDigitsID:function(
Bcu){if(this.A3===Bcu)return;this.A3=Bcu;A.abo([this,this.Ur,this.U_],0);},PY:function(
E){if(this.K&&this.K.PY)return this.K.PY.apply(this,arguments);else return C.DeviceClass.
Bv1.apply(this,arguments);},Bv1:function(E){},U$:function(Aq){this.PY(Aq);},UpdateOffsetID:
function(BcF){if(this.AF===BcF)return;this.AF=BcF;A.abo([this,this.Us,this.U$],0
);},AGi:function(E){if(this.K&&this.K.AGi)return this.K.AGi.apply(this,arguments
);else return C.DeviceClass.Bww.apply(this,arguments);},Bww:function(E){A.ab5("%s"
,Fe);},AI_:function(Aq){this.AGi(Aq);},UpdateWeightValue:function(AK){if(this.K2===
AK)return;this.K2=AK;A.abo([this,this.AE2,this.AI_],0);},AwY:function(E){if(this.
K&&this.K.AwY)return this.K.AwY.apply(this,arguments);else return C.DeviceClass.
BvM.apply(this,arguments);},BvM:function(E){},A0J:function(Aq){this.AwY(Aq);},UpdateMassUnit:
...
this.K.AG6)return this.K.AG6.apply(this,arguments);else return C.DeviceClass.BwP.
apply(this,arguments);},BwP:function(){},AsP:function(){if(this.K&&this.K.AsP)return this.
K.AsP.apply(this,arguments);else return C.DeviceClass.BwT.apply(this,arguments);
},BwT:function(){},EC:function(E){if(this.K&&this.K.EC)return this.K.EC.apply(this
,arguments);else return C.DeviceClass.Bvg.apply(this,arguments);},Bvg:function(E
){},BwW:function(Aq){this.EC(Aq);},UpdateAnimalType:function(Eo){if(this.AnimalType===
Eo)return;this.AnimalType=Eo;A.abo([this,this.PX,this.BwW],0);},Axm:function(E){
if(this.K&&this.K.Axm)return this.K.Axm.apply(this,arguments);else return C.DeviceClass.
Bwu.apply(this,arguments);},Bwu:function(E){},Bb5:function(Aq){this.Axm(Aq);},UpdateWeightRecordingMode:
...
K.AFU.apply(this,arguments);else return C.DeviceClass.Bv3.apply(this,arguments);
},Bv3:function(E){A.ab5("%s",L9);},A0N:function(Aq){this.AFU(Aq);},UpdatePredictedTempValue:
function(AK){if(this.AGt===AK)return;this.AGt=AK;A.abo([this,this.AS0,this.A0N],
0);},SW:function(Md){if(this.K&&this.K.SW)return this.K.SW.apply(this,arguments);
else return C.DeviceClass.BwK.apply(this,arguments);},BwK:function(Md){},AFo:function(
E){if(this.K&&this.K.AFo)return this.K.AFo.apply(this,arguments);else return C.DeviceClass.
Bvs.apply(this,arguments);},Bvs:function(E){},AI3:function(Aq){this.AFo(Aq);},UpdateDemoMode:
...
else return C.DeviceClass.Bva.apply(this,arguments);},Bva:function(E){},Bby:function(
Aq){this.AE8(Aq);},UpdateAgeRegistration:function(BcE){if(this.AdU===BcE)return;
this.AdU=BcE;A.abo([this,this.A8S,this.Bby],0);},Axn:function(E){if(this.K&&this.
K.Axn)return this.K.Axn.apply(this,arguments);else return C.DeviceClass.Bwv.apply(
this,arguments);},Bwv:function(E){},Bb6:function(Aq){this.Axn(Aq);},UpdateWeightRecordingScope:
...
K.J0.apply(this,arguments);else return C.DeviceClass.BvF.apply(this,arguments);}
,BvF:function(E){},A0I:function(Aq){this.J0(Aq);},UpdateGender:function(Ma){if(this.
Gender===Ma)return;this.Gender=Ma;A.abo([this,this.WJ,this.A0I],0);},Ar1:function(
E){if(this.K&&this.K.Ar1)return this.K.Ar1.apply(this,arguments);else return C.DeviceClass.
BvH.apply(this,arguments);},BvH:function(E){},Ay1:function(Aq){this.Ar1(Aq);},UpdateIDLastUsedMale:
...
);else return C.DeviceClass.BvG.apply(this,arguments);},BvG:function(E){},Ay0:function(
...
K.Zw.apply(this,arguments);else return C.DeviceClass.Bvf.apply(this,arguments);}
,Bvf:function(E){},AI1:function(Aq){this.Zw(Aq);},UpdateAnimalListContent:function(
...
Bvb.apply(this,arguments);},Bvb:function(E){},Bbz:function(Aq){this.AE_(Aq);},UpdateAlarmListAction:
...
);else return C.DeviceClass.BvA.apply(this,arguments);},BvA:function(E){},BbI:function(
Aq){this.AFr(Aq);},UpdateFlashLightInMeasureState:function(BcA){if(this.AmV===BcA
)return;this.AmV=BcA;A.abo([this,this.A87,this.BbI],0);},AeY:function(E){if(this.
K&&this.K.AeY)return this.K.AeY.apply(this,arguments);else return C.DeviceClass.
Bve.apply(this,arguments);},Bve:function(E){},AI0:function(Aq){this.AeY(Aq);},UpdateAnimalInfoContent:
...
else return C.DeviceClass.Bwq.apply(this,arguments);},Bwq:function(E){},Bb1:function(
...
)return this.K.AFt.apply(this,arguments);else return C.DeviceClass.BvC.apply(this
,arguments);},BvC:function(E){},BbK:function(Aq){this.AFt(Aq);},UpdateFreshCowListAction:
...
K.ResetActiveActions.apply(this,arguments);else return C.DeviceClass.BwC.apply(this
,arguments);},BwC:function(G){},BGZ:function(s){this.ResetActiveActions(s);},ResetAutoActions:
function(G){if(this.K&&this.K.ResetAutoActions)return this.K.ResetAutoActions.apply(
this,arguments);else return C.DeviceClass.BwE.apply(this,arguments);},BwE:function(
G){},BG1:function(s){this.ResetAutoActions(s);},Awy:function(E){if(this.K&&this.
K.Awy)return this.K.Awy.apply(this,arguments);else return C.DeviceClass.Bvh.apply(
this,arguments);},Bvh:function(E){},BbA:function(Aq){this.Awy(Aq);},Asd:function(
E){if(this.K&&this.K.Asd)return this.K.Asd.apply(this,arguments);else return C.DeviceClass.
Bwe.apply(this,arguments);},Bwe:function(E){},BbW:function(Aq){this.Asd(Aq);},Ase:
function(E){if(this.K&&this.K.Ase)return this.K.Ase.apply(this,arguments);else return C.
DeviceClass.Bwf.apply(this,arguments);},Bwf:function(E){},BbX:function(Aq){this.
Ase(Aq);},AsA:function(G){if(this.K&&this.K.AsA)return this.K.AsA.apply(this,arguments
);else return C.DeviceClass.BwH.apply(this,arguments);},BwH:function(G){},BG4:function(
...
);else return C.DeviceClass.BvE.apply(this,arguments);},BvE:function(E){},BbM:function(
...
K.Ar7)return this.K.Ar7.apply(this,arguments);else return C.DeviceClass.BvX.apply(
this,arguments);},BvX:function(E){},BbR:function(Aq){this.Ar7(Aq);},UpdateNaisIdLastUsedMale:
...
);else return C.DeviceClass.BvW.apply(this,arguments);},BvW:function(E){},BbQ:function(
...
K.Aw5)return this.K.Aw5.apply(this,arguments);else return C.DeviceClass.BvU.apply(
this,arguments);},BvU:function(E){},Ay3:function(Aq){this.Aw5(Aq);},UpdateNaisIdIncrementMale:
...
);else return C.DeviceClass.BvT.apply(this,arguments);},BvT:function(E){},Ay2:function(
...
Bvn.apply(this,arguments);},Bvn:function(E){},BbE:function(Aq){this.AnB(Aq);},UpdateBootloaderMessage:
...
);else return C.DeviceClass.Bu7.apply(this,arguments);},Bu7:function(E){},Bbs:function(
...
)return this.K.Aww.apply(this,arguments);else return C.DeviceClass.Bu8.apply(this
,arguments);},Bu8:function(E){},Bbt:function(Aq){this.Aww(Aq);},UpdateActionListHideMeasured:
...
else return C.DeviceClass.Bvd.apply(this,arguments);},Bvd:function(E){},AoD:function(
Aq){this.Uu(Aq);},UpdateAnimalIdGenerationMethod:function(Bc0){if(this.Io===Bc0)
return;this.Io=Bc0;A.abo([this,this.Anu,this.AoD],0);},AwK:function(E){if(this.K&&
this.K.AwK)return this.K.AwK.apply(this,arguments);else return C.DeviceClass.Bvu.
apply(this,arguments);},Bvu:function(E){},A0G:function(Aq){this.AwK(Aq);},UpdateDirectionOfCountingFemale:
...
);else return C.DeviceClass.Bvv.apply(this,arguments);},Bvv:function(E){},A0H:function(
...
Bvw.apply(this,arguments);},Bvw:function(E){},AI4:function(Aq){this.AwM(Aq);},UpdateDirectionOfCountingUnisex:
...
);else return C.DeviceClass.BvI.apply(this,arguments);},BvI:function(E){},AoE:function(
...
)return this.K.Ar8.apply(this,arguments);else return C.DeviceClass.BvY.apply(this
,arguments);},BvY:function(E){},A0L:function(Aq){this.Ar8(Aq);},UpdateNaisIdLastUsedUnisex:
...
);else return C.DeviceClass.BvV.apply(this,arguments);},BvV:function(E){},Ay4:function(
...
K.Akx)return this.K.Akx.apply(this,arguments);else return C.DeviceClass.Bvy.apply(
this,arguments);},Bvy:function(E){},AyZ:function(Aq){this.Akx(Aq);},UpdateEartagNrAssignmentMode:
...
K.N7.apply(this,arguments);else return C.DeviceClass.Bvp.apply(this,arguments);}
,Bvp:function(E){},BwZ:function(Aq){this.N7(Aq);},UpdateBreed:function(Ac1){if(this.
Breed===Ac1)return;this.Breed=Ac1;A.abo([this,this.Awg,this.BwZ],0);},AFN:function(
E){if(this.K&&this.K.AFN)return this.K.AFN.apply(this,arguments);else return C.DeviceClass.
BvQ.apply(this,arguments);},BvQ:function(E){},Bw2:function(Aq){this.AFN(Aq);},UpdateMiddlewareVersions:
function(Ql,A1t,A1u,A1B,A1i){this.SG.OnSetTimestamp(Ql);this.SG.AFI(A1t);this.SG.
AFO(A1u);this.SG.AFY(A1B);this.SG.AFn(A1i);A.abo([this,this.BlM,this.Bw2],0);},AFH:
function(E){if(this.K&&this.K.AFH)return this.K.AFH.apply(this,arguments);else return C.
DeviceClass.BvK.apply(this,arguments);},BvK:function(E){},Bw1:function(Aq){this.
...
AGb(A1I);this.Q3.AF$(A1G);A.abo([this,this.BlK,this.Bw1],0);},AGc:function(E){if(
this.K&&this.K.AGc)return this.K.AGc.apply(this,arguments);else return C.DeviceClass.
Bwh.apply(this,arguments);},Bwh:function(E){},Bw8:function(Aq){this.AGc(Aq);},UpdateTorchboardVersions:
function(Ql,A1r,A1s,A1q,A1H,A1I,A1G){this.S5.OnSetTimestamp(Ql);this.S5.AFF(A1r);
this.S5.AFG(A1s);this.S5.AFE(A1q);this.S5.AGa(A1H);this.S5.AGb(A1I);this.S5.AF$(
A1G);A.abo([this,this.Bl_,this.Bw8],0);},AFd:function(E){if(this.K&&this.K.AFd)return this.
K.AFd.apply(this,arguments);else return C.DeviceClass.Bvo.apply(this,arguments);
},Bvo:function(E){},BwY:function(Aq){this.AFd(Aq);},UpdateBootloaderVersions:function(
Ql,A1t,A1u,A1B,A1i){this.R7.OnSetTimestamp(Ql);this.R7.AFI(A1t);this.R7.AFO(A1u);
this.R7.AFY(A1B);this.R7.AFn(A1i);A.abo([this,this.Blj,this.BwY],0);},AFp:function(
E){if(this.K&&this.K.AFp)return this.K.AFp.apply(this,arguments);else return C.DeviceClass.
Bvx.apply(this,arguments);},Bvx:function(E){},BbH:function(Aq){this.AFp(Aq);},UpdateDryCowListAction:
...
);else return C.DeviceClass.Bxi.apply(this,arguments);},Bxi:function(A1j){return false;
},AFb:function(E){if(this.K&&this.K.AFb)return this.K.AFb.apply(this,arguments);
else return C.DeviceClass.Bvl.apply(this,arguments);},Bvl:function(E){},AI2:function(
...
){var O;var AiZ=0;var Adk=A._GetAutoObject(C.Device).An.Filter;var Bf=A._GetAutoObject(
C.Helper).AOT();A._GetAutoObject(C.Device).An.Bk(Bf);for(O=0;O<A._GetAutoObject(
C.Device).An.B_();O++){A._GetAutoObject(C.Helper).GS(O);A._GetAutoObject(C.Helper
).W.Ae7(false);A._GetAutoObject(C.Helper).W.Ci(A._GetAutoObject(C.Device).An);AiZ++;
}A._GetAutoObject(C.Device).An.Bk(Adk);return AiZ;},UpdateTransferProgress:function(
...
DeviceClass.Bwi.apply(this,arguments);},Bwi:function(E){A.ab5("%s",Qd);},A0U:function(
Aq){this.AGd(Aq);},UpdateTransferTarget:function(AK){if(this.Afu===AK)return;this.
Afu=AK;A.abo([this,this.A9L,this.BbY],0);},Asf:function(E){if(this.K&&this.K.Asf
)return this.K.Asf.apply(this,arguments);else return C.DeviceClass.Bwj.apply(this
,arguments);},Bwj:function(E){A.ab5("%s",J9);},BbY:function(Aq){this.Asf(Aq);},AsO:
function(){if(this.K&&this.K.AsO)return this.K.AsO.apply(this,arguments);else return C.
DeviceClass.BwS.apply(this,arguments);},BwS:function(){},Aw_:function(E){if(this.
K&&this.K.Aw_)return this.K.Aw_.apply(this,arguments);else return C.DeviceClass.
Bv4.apply(this,arguments);},Bv4:function(E){},A0O:function(Aq){this.Aw_(Aq);},UpdatePremisesID:
...
else return C.DeviceClass.BvS.apply(this,arguments);},BvS:function(E){},AI7:function(
Aq){this.Aw3(Aq);},UpdateMotherSelectionDriedOffFilter:function(AK){if(this.Ab1===
AK)return;this.Ab1=AK;A.abo([this,this.AEY,this.AI7],0);},AFu:function(E){if(this.
K&&this.K.AFu)return this.K.AFu.apply(this,arguments);else return C.DeviceClass.
BvD.apply(this,arguments);},BvD:function(E){},BbL:function(Aq){this.AFu(Aq);},UpdateFreshCowSpan:
...
BcI);A.abo([this,this.Ut,this.Vb],0);},Axk:function(E){if(this.K&&this.K.Axk)return this.
K.Axk.apply(this,arguments);else return C.DeviceClass.Bwm.apply(this,arguments);
},Bwm:function(E){A.ab5("%s",E8);},Vb:function(Aq){this.Axk(Aq);},AxO:function(){
if(this.K&&this.K.AxO)return this.K.AxO.apply(this,arguments);else return C.DeviceClass.
BwM.apply(this,arguments);},BwM:function(){},Arp:function(){if(this.K&&this.K.Arp
)return this.K.Arp.apply(this,arguments);else return C.DeviceClass.Bu6.apply(this
,arguments);},Bu6:function(){return false;},AqK:function(){if(this.K&&this.K.AqK
)return this.K.AqK.apply(this,arguments);else return C.DeviceClass.Bu1.apply(this
,arguments);},Bu1:function(){},AF1:function(E){if(this.K&&this.K.AF1)return this.
K.AF1.apply(this,arguments);else return C.DeviceClass.Bv_.apply(this,arguments);
},Bv_:function(E){},Bw5:function(Aq){this.AF1(Aq);},UpdateSerialNumber:function(
AK){if(this.AhL===AK)return;this.AhL=AK;A.abo([this,this.BlZ,this.Bw5],0);},Awx:
function(E){if(this.K&&this.K.Awx)return this.K.Awx.apply(this,arguments);else return C.
DeviceClass.Bvc.apply(this,arguments);},Bvc:function(E){},A0F:function(Aq){this.
...
apply(this,arguments);else return C.DeviceClass.Bv$.apply(this,arguments);},Bv$:
...
BwI.apply(this,arguments);},BwI:function(G){},BG5:function(s){this.AsB(s);},Asi:
function(E){if(this.K&&this.K.Asi)return this.K.Asi.apply(this,arguments);else return C.
DeviceClass.Bws.apply(this,arguments);},Bws:function(E){},Bb3:function(Aq){this.
Asi(Aq);},Asj:function(E){if(this.K&&this.K.Asj)return this.K.Asj.apply(this,arguments
);else return C.DeviceClass.Bwt.apply(this,arguments);},Bwt:function(E){},Bb4:function(
...
DeviceClass.Bvi.apply(this,arguments);},Bvi:function(E){},BbB:function(Aq){this.
...
K.Ash)return this.K.Ash.apply(this,arguments);else return C.DeviceClass.Bwr.apply(
this,arguments);},Bwr:function(E){},Bb2:function(Aq){this.Ash(Aq);},Ask:function(
E){if(this.K&&this.K.Ask)return this.K.Ask.apply(this,arguments);else return C.DeviceClass.
Bwx.apply(this,arguments);},Bwx:function(E){},Bb7:function(Aq){this.Ask(Aq);},UpdateWeightValueBirthString:
...
K.AwN.apply(this,arguments);else return C.DeviceClass.Bvz.apply(this,arguments);
},Bvz:function(E){},Bw0:function(Aq){this.AwN(Aq);},UpdateEvaluationAnimalType:function(
Eo){if(this.ACZ===Eo)return;this.ACZ=Eo;A.abo([this,this.Blt,this.Bw0],0);},UpdateStartScreen:
function(AK){if(this.AxQ===AK)return;this.AxQ=AK;A.abo([this,this.Bl0,this.Bw6],
0);},Axc:function(E){if(this.K&&this.K.Axc)return this.K.Axc.apply(this,arguments
);else return C.DeviceClass.Bwa.apply(this,arguments);},Bwa:function(E){},Bw6:function(
Aq){this.Axc(Aq);},AEd:function(){if(this.K&&this.K.AEd)return this.K.AEd.apply(
this,arguments);else return C.DeviceClass.Bu4.apply(this,arguments);},Bu4:function(
){return 1;},AEe:function(){if(this.K&&this.K.AEe)return this.K.AEe.apply(this,arguments
);else return C.DeviceClass.Bu5.apply(this,arguments);},Bu5:function(){return 1;
},GetCommitCount:function(){return 2202;},GetCommitEpoch:function(){return 1734018704;
},GetCommitHash:function(){return A.kR.Bii;},GetVersionMajor:function(){return 0;
},GetVersionMinor:function(){return 9;},GetVersionRev:function(){return 11;},AFM:
function(E){if(this.K&&this.K.AFM)return this.K.AFM.apply(this,arguments);else return C.
DeviceClass.BvO.apply(this,arguments);},BvO:function(E){},BbP:function(Aq){this.
...
K.Axi.apply(this,arguments);else return C.DeviceClass.Bwk.apply(this,arguments);
},Bwk:function(E){},A0V:function(Aq){this.Axi(Aq);},UpdateTransponderAssignmentIdChangeMethod:
function(Azh){if(this.Ak6===Azh)return;this.Ak6=Azh;A.abo([this,this.AS_,this.A0V
],0);},BatchResetPurchasedNoticePending:function(){var O;var AiZ=0;var Adk=A._GetAutoObject(
C.Device).An.Filter;var Bf=A._GetAutoObject(C.Helper).AvA();A._GetAutoObject(C.Device
).An.Bk(Bf);for(O=0;O<A._GetAutoObject(C.Device).An.B_();O++){A._GetAutoObject(C.
Helper).GS(O);A._GetAutoObject(C.Helper).W.Ae7(false);A._GetAutoObject(C.Helper).
W.Ci(A._GetAutoObject(C.Device).An);AiZ++;}A._GetAutoObject(C.Device).An.Bk(Adk);
return AiZ;},BnN:function(E){},UpdateMassRecordingAutomatic:function(AK){if(this.
AR2===AK)return;this.AR2=AK;A.abo([this,this.BlL,this.BnN],0);},Nt:function(E){if(
this.K&&this.K.Nt)return this.K.Nt.apply(this,arguments);else return C.DeviceClass.
Bwy.apply(this,arguments);},Bwy:function(E){},Bw9:function(Aq){this.Nt(Aq);},UpdateWhereAbouts:
function(AfQ){if(this.WhereAbouts===AfQ)return;this.WhereAbouts=AfQ;A.abo([this,
this.Awu,this.Bw9],0);},ArP:function(E){if(this.K&&this.K.ArP)return this.K.ArP.
...
ArQ)return this.K.ArQ.apply(this,arguments);else return C.DeviceClass.Bu_.apply(
this,arguments);},Bu_:function(E){},Bbw:function(Aq){this.ArQ(Aq);},UpdateActiveMassRecordingFields:
...
)return this.K.Asy.apply(this,arguments);else return C.DeviceClass.BwD.apply(this
,arguments);},BwD:function(G){},BG0:function(s){this.Asy(s);},AFK:function(E){if(
this.K&&this.K.AFK)return this.K.AFK.apply(this,arguments);else return C.DeviceClass.
BvL.apply(this,arguments);},BvL:function(E){},AI5:function(Aq){this.AFK(Aq);},UpdateMassRecordingDateOfBirthMandatory:
function(AK){if(this.AeR===AK)return;this.AeR=AK;A.abo([this,this.AEV,this.AI5],
...
return C.DeviceClass.BuZ.apply(this,arguments);},BuZ:function(){return false;},Aqv:
function(){if(this.K&&this.K.Aqv)return this.K.Aqv.apply(this,arguments);else return C.
DeviceClass.BuY.apply(this,arguments);},BuY:function(){return false;},Aqu:function(
){if(this.K&&this.K.Aqu)return this.K.Aqu.apply(this,arguments);else return C.DeviceClass.
BuX.apply(this,arguments);},BuX:function(){return false;},Aqw:function(){if(this.
K&&this.K.Aqw)return this.K.Aqw.apply(this,arguments);else return C.DeviceClass.
Bu0.apply(this,arguments);},Bu0:function(){return false;},Aw0:function(E){if(this.
K&&this.K.Aw0)return this.K.Aw0.apply(this,arguments);else return C.DeviceClass.
BvN.apply(this,arguments);},BvN:function(E){},BbO:function(Aq){this.Aw0(Aq);},UpdateMaxWeightValuePrecision:
...
apply(this,arguments);else return C.DeviceClass.BwF.apply(this,arguments);},BwF:
function(G){},BG2:function(s){this.ResetNoNaisIdListActions(s);},Aw8:function(E){
if(this.K&&this.K.Aw8)return this.K.Aw8.apply(this,arguments);else return C.DeviceClass.
Bv0.apply(this,arguments);},Bv0:function(E){},BbT:function(Aq){this.Aw8(Aq);},UpdateNoTransponderListActions:
...
DeviceClass.BwG.apply(this,arguments);},BwG:function(G){},BG3:function(s){this.ResetNoTransponderListActions(
s);},Axp:function(E){if(this.K&&this.K.Axp)return this.K.Axp.apply(this,arguments
);else return C.DeviceClass.Bwz.apply(this,arguments);},Bwz:function(E){},Bb8:function(
...
function(G){},BG6:function(s){this.ResetYoungNoTransponderListActions(s);},Axj:function(
E){if(this.K&&this.K.Axj)return this.K.Axj.apply(this,arguments);else return C.DeviceClass.
Bwl.apply(this,arguments);},Bwl:function(E){},A0W:function(Aq){this.Axj(Aq);},UpdateTransponderUnlinkIdChangeMethod:
...
arguments);else return C.DeviceClass.BwB.apply(this,arguments);},BwB:function(AoJ
,AJq){this.Gg.E7();this.Gg.AgP=AoJ;this.Gg.AVf=AJq;this.Gg.E5(1);A._GetAutoObject(
C.Device).AY(110,true,A.jV,0,[this,this.BA2]);},BA2:function(G){var Ar=(C.PopupContext.
isPrototypeOf(G)?G:null);if(!!Ar&&(Ar.PopupState===9))A.aaS([this,this.BCF],this
);},BCF:function(G){this.Gg.E5(2);this.AxO();A._GetAutoObject(C.Device).AY(110,false
,A.jV,0,null);},AFc:function(E){if(this.K&&this.K.AFc)return this.K.AFc.apply(this
,arguments);else return C.DeviceClass.Bvm.apply(this,arguments);},Bvm:function(E
...
DeviceClass.Bv5.apply(this,arguments);},Bv5:function(E){},BbU:function(Aq){this.
AFV(Aq);},UpdatePurchasedListResetOnExport:function(AK){if(this.AUt===AK)return;
this.AUt=AK;A.abo([this,this.A9t,this.BbU],0);},Bo$:function(){},AEO:function(){
return this.In;},Awe:function(){return this.Abc;},Awh:function(){return this.AmI;
...
AcK;},AS6:function(){return this.SyncState;},A9N:function(){return this.AsZ;},AE1:
function(){return this.AV5;},AS3:function(){return this.RatingMode;},ArF:function(
){return this.AmW;},AS8:function(){return this.AVJ;},BlS:function(){return this.
AUu;},Blg:function(){return this.AutoRegistrationMode;},AS5:function(){return this.
O0;},Ur:function(){return this.A3;},Us:function(){return this.AF;},AE2:function(
){return this.K2;},ASU:function(){return this.MassUnit;},A8N:function(){return this.
...
){return this.AdU;},A9W:function(){return this.WeightRecordingScope;},WJ:function(
...
EartagNrAssignmentMode;},Awg:function(){return this.Breed;},BlM:function(){return this.
SG;},BlK:function(){return this.Q3;},Bl_:function(){return this.S5;},Blj:function(
){return this.R7;},A85:function(){return this.AOb;},AER:function(){return this.Aqy;
},AS9:function(){return this.AxY;},A9L:function(){return this.Afu;},AS1:function(
){return this.OZ;},AEY:function(){return this.Ab1;},A8_:function(){return this.AqZ;
},Ut:function(){return this.P7;},BlZ:function(){return this.AhL;},ASI:function(){
...
){return this.AHw;},A9X:function(){return this.AHB;},Blt:function(){return this.
ACZ;},Bl0:function(){return this.AxQ;},A9n:function(){return this.Av5;},AS_:function(
){return this.Ak6;},BlL:function(){return this.AR2;},Awu:function(){return this.
WhereAbouts;},A8O:function(){return this.ABV;},A8P:function(){return this.ABW;},
AEV:function(){return this.AeR;},A9l:function(){return this.Av3;},A9m:function(){
...
,0);this.SG=A._NewObject(C.AxN,0);this.Q3=A._NewObject(C.AvD,0);this.S5=A._NewObject(
C.AvD,0);this.R7=A._NewObject(C.AxN,0);this.P7=A._NewObject(C.AV0,0);this.Gg=A._NewObject(
C.V1,0);var J_=this._variants();if(J_){this.K={};J_._Init.call(this,aArg);}A.h7++;
...
this.S5)&&(B._cycle!=D))B._Mark(B._cycle=D);if((B=this.R7)&&(B._cycle!=D))B._Mark(
...
A5:A.jV,Abs:function(){var Aw=A._NewObject(C.StringFilterCriterion,0);Aw.E$(this
...
);else return C.ITable.CC.apply(this,arguments);},V9:function(Ad,A4){if(this.K&&
this.K.V9)return this.K.V9.apply(this,arguments);else return C.ITable.V9.apply(this
...
Bk.apply(this,arguments);},V_:function(Ad,A4){if(this.K&&this.K.V_)return this.K.
V_.apply(this,arguments);else return C.ITable.V_.apply(this,arguments);},Sq:function(
...
OI.apply(this,arguments);},YO:function(){if(this.K&&this.K.YO)return this.K.YO.apply(
this,arguments);else return C.ITable.YO.apply(this,arguments);},ZS:function(Ad,A4
...
ITable.KT.apply(this,arguments);},UI:function(Ad,A4,C1){if(this.K&&this.K.UI)return this.
K.UI.apply(this,arguments);else return C.ITable.UI.apply(this,arguments);},Aeu:function(
aColumn,A8){if(this.K&&this.K.Aeu)return this.K.Aeu.apply(this,arguments);else return C.
ITable.Aeu.apply(this,arguments);},E7:function(){if(this.K&&this.K.E7)return this.
...
ITable.AjL.apply(this,arguments);},Aen:function(aColumn,A8){if(this.K&&this.K.Aen
)return this.K.Aen.apply(this,arguments);else return C.ITable.Aen.apply(this,arguments
...
else if(NA<=8)return 4;else return 0;},Ad3:function(NA){var a=0;switch(NA){case 3:
...
AnG(0);D8.AnJ(0);D8.AnM(0);return((B=(D8.JY()|0))<0)?B+0x100000000:B;},Bim:function(
Atw){var CO;switch(Atw){case 36:CO=MQ;break;case 40:CO=Te;break;case 56:CO=U0;break;
case 70:CO=Aab;break;case 100:CO=Xe;break;case 124:CO=Ix;break;case 156:CO=U1;break;
case 158:CO=Aac;break;case 191:CO=U2;break;case 196:CO=Aad;break;case 203:CO=Xf;
break;case 208:CO=Aae;break;case 233:CO=Aaf;break;case 246:CO=U3;break;case 250:
CO=Xg;break;case 276:CO=Pa;break;case 300:CO=Aag;break;case 348:CO=Oi;break;case
372:CO=Rp;break;case 380:CO=Xh;break;case 392:CO=Xi;break;case 428:CO=Tf;break;case
440:CO=Xj;break;case 442:CO=Aah;break;case 470:CO=Xk;break;case 528:CO=Xl;break;
case 578:CO=Tg;break;case 616:CO=Th;break;case 620:CO=Ti;break;case 642:CO=Aai;break;
case 643:CO=Tj;break;case 703:CO=Aaj;break;case 705:CO=AfE;break;case 724:CO=Aak;
break;case 752:CO=Xm;break;case 756:CO=Aal;break;case 792:CO=Xn;break;case 804:CO=
AhX;break;case 826:CO=K4;break;case 840:CO=AcQ;break;default:CO=Atw.toFixed();}return CO;
},Ala:function(MV){var AaA;if((MV<10000)&&(A._GetAutoObject(C.Device).OT===2))AaA=
2;else if((MV<100000)&&!!A._GetAutoObject(C.Device).OT)AaA=1;else AaA=0;return this.
Td(MV,AaA,false);},Ax$:function(MV,AaA){return this.Td(MV,AaA,false);},Td:function(
MV,AaA,BAu){var B;var AlJ=A.jV;switch(A._GetAutoObject(C.Device).MassUnit){case 0:
if(BAu)AlJ=A.abl(MV,0,0);else{var BeW=MV<0;if(AaA<3)MV=MV+(((BeW?-1:1)*5)*(Math.
pow(10,2-AaA)|0));AlJ=(((((B=MV)>-2147483648)?Math.abs(B):B)/1000)|0).toFixed();
if(AaA>0)AlJ=AlJ+(LB+A.abV(A.abl((((B=MV)>-2147483648)?Math.abs(B):B)%1000,3,10)
,AaA));if(BeW)AlJ=AhY+AlJ;}break;case 1:AlJ=A.abk(MV/453.592,0,AaA);break;default:
...
A2P=this.Ax1(IA);var Bzj=A._GetAutoObject(C.Converter).Bim(A2P);A40=(Bzj+Oj)+A.abm(
A._GetAutoObject(C.Helper).V5(IA,0,12),12,10);}return A40;},AmZ:function(Ma){switch(
Ma){case 0:return A.aaL(A.ach.AQO);case 1:return A.aaL(A.ach.ADW);case 2:return A.
aaL(A.ach.AD0);default:{A.ab5("%s%e",Xo,Ma);return null;}}},A5C:function(ByR){switch(
ByR){case 0:return A.aaL(A.ach.AvL);case 1:return A.aaL(A.ach.ADS);case 2:return A.
aaL(A.ach.AQH);default:throw new Error(Aam);}},Ad1:function(AJA){switch(AJA){case
...
aaL(A.ach.AD6);case 1:return A.aaL(A.ach.AD7);default:throw new Error(AfF+A._GetAutoObject(
...
throw new Error(AhZ+AJA.toFixed());}},BhO:function(Azl){switch(Azl){case 0:return A.
...
));}},Bil:function(Atw){switch(Atw){case 977:return AcR;case 978:return U4;case 980:
return Aoj;case 981:return Aok;case 982:return Aol;case 983:return Aom;case 984:
return Ald;case 985:return As5;default:return A.aaR(A.acf.Unknown);}},BiG:function(
Ac3){switch(Ac3){case 1:return 0x278A;case 2:return 0x278B;case 3:return 0x278C;
...
}},BqD:function(IA){if(!IA)return-1;return(IA%100000000)|0;},Bji:function(AoS,aFilter
...
},BhN:function(Azl){switch(Azl){case 0:return 1;case 3:return 0;case 1:return 2;
case 2:switch(A._GetAutoObject(C.Device).MassUnit){case 0:return 3;case 1:return 4;
default:throw new Error(AfF+A._GetAutoObject(C.Device).MassUnit.toFixed());}break;
...
1:return A.aaL(A.ach.AP1);default:throw new Error(AfF+A._GetAutoObject(C.Device).
...
TW);default:throw new Error(U5+Ao3.toFixed());}},ANN:function(Atw){switch(Atw){case
...
case 804:return 37;case 826:return 38;case 840:return 39;default:return 0;}},S8:
function(IA){var A2P=this.Ax1(IA);return this.ANN(A2P);},Ax1:function(IA){return A.
_GetAutoObject(C.Helper).V5(IA,12,3)|0;},BaE:function(AoX,Eo){if(AoX<A._GetAutoObject(
C.Helper).ADp(Eo))return 1;else if(AoX<A._GetAutoObject(C.Helper).ADo(Eo))return 2;
else return 3;},ADb:function(Byu){switch(Byu){case 1:return 1;case 2:return 2;case
...
4:return A.aaR(A.acf.Contains);case 5:return AfG;default:{A.ab5("%s%e",Aon,Eb);return A.
jV;}}},A51:function(Ac1){return this.Na.Aem(Ac1);},Bj2:function(Ac1){return this.
Na.AmK(Ac1);},Bh5:function(Atv){var AAE=0;switch(Atv){case 0:AAE=1;break;case 1:
...
C.Device).AcK)return 0;else return 1;},AqH:function(HU){var BN=-1;switch(HU){case
...
C.Helper).V5(IA,8,2)|0;},AVP:function(IA){var BAp=this.Baj(IA);return this.ADb(BAp
...
toFixed());}return Rz;},Bai:function(IA){return A._GetAutoObject(C.Helper).V5(IA
...
!AH){this.OnSetId(AH.CC(Ad,0));this.SP(AH.CC(Ad,1));this.Ab_(AH.CC(Ad,2));this.AnI(
AH.CC(Ad,3));this.Q8(AH.Hw(Ad,4));this.J0(AH.AOZ(Ad,7));this.Akw(AH.BjA(Ad,6));this.
EC(AH.Am0(Ad,14));this.P0(AH.KT(Ad,22));this.Nr(AH.KT(Ad,26));this.Axo(AH.Ja(Ad,
13));this.Ae4(AH.H7(Ad,8));this.Axf(AH.Hw(Ad,15));this.AT2(AH.Hw(Ad,31));this.Ae_(
AH.A7m(Ad,5));this.ATz(AH.Ja(Ad,17));this.Uy(AH.H7(Ad,11));this.AT1(AH.Hw(Ad,16)
);this.AT4(AH.Hw(Ad,30));this.AkC(AH.H7(Ad,9));this.Ae8(AH.H7(Ad,12));this.AT3(AH.
Hw(Ad,20));this.Axh(AH.Hw(Ad,21));this.Ae6(AH.H7(Ad,10));this.AwV(AH.H7(Ad,27));
...
));this.Ar3(AH.H7(Ad,38));this.N7(AH.BjB(Ad,32));this.Aky(AH.BjG(Ad,33));this.AnK(
AH.KT(Ad,35));this.Nt(AH.AO7(Ad,34));this.Ae7(AH.H7(Ad,37));this.AFW(AH.BjP(Ad,36
));}return G1;},Ci:function(AH){var G1=C.Row.Ci.call(this,AH);if(G1&&!!AH){var Jt=
AH.OG();if(Jt<0)A.ab5("%s",Xp);else{var AAi=this.Am$();if(AAi)this.CI=AH.YO();else
AH.HB(this.CI,0,this.Id);AH.HB(this.CI,1,this.VisualId);AH.HB(this.CI,2,this.GroupId
);AH.HB(this.CI,3,this.LocationId);AH.Acs(this.CI,4,this.DateOfBirth);AH.Bpx(this.
CI,7,this.Gender);AH.Bpt(this.CI,6,this.BirthType);AH.Bpr(this.CI,14,this.AnimalType
);AH.UI(this.CI,22,this.TransponderId);AH.UI(this.CI,26,this.NaisId);AH.AkU(this.
CI,13,this.WorstAssessment);AH.Ob(this.CI,8,this.IsAlarm);AH.Acs(this.CI,15,this.
TimestampAlarm);AH.Ob(this.CI,11,this.IsFever);AH.Acs(this.CI,16,this.TimestampExpirationFeverAlarm
);AH.Ob(this.CI,9,this.IsControl);AH.Ob(this.CI,12,this.IsWatch);AH.Acs(this.CI,
20,this.TimestampLastControl);AH.Acs(this.CI,21,this.TimestampLastWatch);AH.Ob(this.
CI,10,this.IsRegistered);AH.Ob(this.CI,27,this.IsPerished);AH.Acs(this.CI,28,this.
DateOfLastCalving);AH.HB(this.CI,29,this.LactationNumber);AH.Ob(this.CI,38,this.
IsDry);AH.Bpv(this.CI,32,this.Breed);AH.Bpw(this.CI,33,this.EaseOfDelivery);AH.UI(
this.CI,35,this.NaisIdMother);AH.BpC(this.CI,34,this.WhereAbouts);AH.Ob(this.CI,
37,this.IsRegistrationNoticePending);AH.BpB(this.CI,36,this.ReasonOfLeaving);G1=
AH.OI(Jt);if(AAi&&G1)this.OnSetId(AH.CC(this.CI,0));}}return G1;},Gs:function(){
C.Row.Gs.call(this);this.OnSetId(-2);this.Ae6(true);},E7:function(){C.Row.E7.call(
this);this.OnSetId(-1);this.SP(0);this.Ab_(0);this.AnI(0);this.Q8(0);this.J0(A._GetAutoObject(
C.Device).Gender);this.Akw(0);this.EC(A._GetAutoObject(C.Device).AnimalType);this.
P0(0);this.Nr(0);this.Axo(0);this.Ae4(false);this.Axf(0);this.AT2(0);this.Ae_(0);
this.ATz(0);this.Uy(false);this.AT4(0);this.AT1(0);this.AkC(false);this.Ae8(false
);this.AT3(0);this.Axh(0);this.Ae6(false);this.AwV(false);this.AFD(0);this.AF7(0
);this.AwQ(0);this.Axg(0);this.ATr(-1);this.AwH(0);this.AwW(0);this.Ar3(false);this.
N7(0);this.Aky(0);this.AnK(0);this.Nt(0);this.Ae7(false);this.AFW(0);},OnSetId:function(
E){if(this.Id===E)return;this.Id=E;A.abo([this,this.Q6,this.OnSetId],0);},SP:function(
E){if(this.VisualId===E)return;this.VisualId=E;A.abo([this,this.ArK,this.SP],0);
},Ab_:function(E){if(this.GroupId===E)return;this.GroupId=E;A.abo([this,this.BlA
,this.Ab_],0);},Q8:function(E){if(this.DateOfBirth===E)return;this.DateOfBirth=E;
A.abo([this,this.Awi,this.Q8],0);},J0:function(E){if(this.Gender===E)return;this.
Gender=E;A.abo([this,this.WJ,this.J0],0);},Akw:function(E){if(this.BirthType===E
...
,Ae_:function(E){if(this.LastTemperature===E)return;this.LastTemperature=E;A.abo([
this,this.A9j,this.Ae_],0);},Ae4:function(E){if(this.IsAlarm===E)return;this.IsAlarm=
E;A.abo([this,this.A9b,this.Ae4],0);},AkC:function(E){if(this.IsControl===E)return;
this.IsControl=E;A.abo([this,this.BlD,this.AkC],0);},Ae6:function(E){if(this.IsRegistered===
E)return;this.IsRegistered=E;A.abo([this,this.BlG,this.Ae6],0);},Ae8:function(E){
if(this.IsWatch===E)return;this.IsWatch=E;A.abo([this,this.A9f,this.Ae8],0);},Axo:
function(E){if(this.WorstAssessment===E)return;this.WorstAssessment=E;A.abo([this
,this.A9Y,this.Axo],0);},Uy:function(E){if(this.IsFever===E)return;this.IsFever=
E;A.abo([this,this.A9c,this.Uy],0);},AT3:function(E){if(this.TimestampLastControl===
E)return;this.TimestampLastControl=E;A.abo([this,this.Bl7,this.AT3],0);},Axh:function(
E){if(this.TimestampLastWatch===E)return;this.TimestampLastWatch=E;A.abo([this,this.
Bl9,this.Axh],0);},ATz:function(E){if(this.LastRatingTemperature===E)return;this.
LastRatingTemperature=E;A.abo([this,this.BlJ,this.ATz],0);},AT1:function(E){if(this.
TimestampExpirationFeverAlarm===E)return;this.TimestampExpirationFeverAlarm=E;A.
abo([this,this.Bl5,this.AT1],0);},Axf:function(E){if(this.TimestampAlarm===E)return;
this.TimestampAlarm=E;A.abo([this,this.Bl4,this.Axf],0);},EC:function(E){if(this.
...
this.TimestampFirstWeighing);if(((Ph.Year===A2B.Year)&&(Ph.Ab6()===A2B.Ab6()))&&(
...
LastBodyWeight;}else{AuD=this.DateOfBirth;AaK=A._GetAutoObject(C.Helper).Abz(this.
...
A.abo([this,this.Blz,this.ATr],0);},AnZ:function(BcY){this.Ae4(BcY);if(BcY){if(!
...
Nr],0);},AGU:function(BcU){this.Ae8(BcU);if(BcU){if(!this.TimestampLastWatch)this.
Axh(A._GetAutoObject(C.Helper).Dv());}else this.Axh(0);},AwH:function(E){if(this.
DateOfLastCalving===E)return;this.DateOfLastCalving=E;A.abo([this,this.Blp,this.
AwH],0);},AwW:function(E){if(this.LactationNumber===E)return;this.LactationNumber=
E;A.abo([this,this.BlI,this.AwW],0);},AwV:function(E){if(this.IsPerished===E)return;
this.IsPerished=E;A.abo([this,this.BlF,this.AwV],0);},AT4:function(E){if(this.TimestampLastTemperature===
E)return;this.TimestampLastTemperature=E;A.abo([this,this.Bl8,this.AT4],0);},AT2:
function(E){if(this.TimestampLastAssessment===E)return;this.TimestampLastAssessment=
E;A.abo([this,this.Bl6,this.AT2],0);},N7:function(E){if(this.Breed===E)return;this.
...
this.ReasonOfLeaving=E;A.abo([this,this.BlU,this.AFW],0);},Ae7:function(E){if(this.
IsRegistrationNoticePending===E)return;this.IsRegistrationNoticePending=E;A.abo([
this,this.BlH,this.Ae7],0);},Ar3:function(E){if(this.IsDry===E)return;this.IsDry=
E;A.abo([this,this.BlE,this.Ar3],0);},Q6:function(){return this.Id;},ArK:function(
){return this.VisualId;},BlA:function(){return this.GroupId;},Awi:function(){return this.
DateOfBirth;},WJ:function(){return this.Gender;},ASL:function(){return this.BirthType;
},A9k:function(){return this.LocationId;},A9j:function(){return this.LastTemperature;
},A9b:function(){return this.IsAlarm;},BlD:function(){return this.IsControl;},BlG:
function(){return this.IsRegistered;},A9f:function(){return this.IsWatch;},A9Y:function(
){return this.WorstAssessment;},A9c:function(){return this.IsFever;},Bl7:function(
){return this.TimestampLastControl;},Bl9:function(){return this.TimestampLastWatch;
},BlJ:function(){return this.LastRatingTemperature;},Bl5:function(){return this.
TimestampExpirationFeverAlarm;},Bl4:function(){return this.TimestampAlarm;},PX:function(
...
},Blz:function(){return this.FirstBodyWeightId;},Any:function(){return this.NaisId;
},Blp:function(){return this.DateOfLastCalving;},BlI:function(){return this.LactationNumber;
},BlF:function(){return this.IsPerished;},Bl8:function(){return this.TimestampLastTemperature;
},Bl6:function(){return this.TimestampLastAssessment;},Awg:function(){return this.
Breed;},ASP:function(){return this.EaseOfDelivery;},Awu:function(){return this.WhereAbouts;
},ASX:function(){return this.NaisIdMother;},BlU:function(){return this.ReasonOfLeaving;
},BlH:function(){return this.IsRegistrationNoticePending;},BlE:function(){return this.
...
Id!==this.TableId)throw new Error(As_);else if((Ad<0)||(Ad>=AH.B_())){A.ab5("%s"
,(((Aop+this.CI.toFixed())+As$)+AH.B_().toFixed())+Alf);return false;}this.CI=Ad;
return true;},Ci:function(AH){if(!AH){A.ab5("%s",(As8+this.CI.toFixed())+As9);return false;
}else if(AH.Id!==this.TableId)throw new Error(As_);else if(this.Am$()&&AH.Lm()){
A.ab5("%s",Ayh+AH.HM().toFixed());return false;}else if(!this.Am$()&&((this.CI<0
)||(this.CI>=AH.B_()))){A.ab5("%s",(((Aop+this.CI.toFixed())+As$)+AH.B_().toFixed(
...
Jt<0)A.ab5("%s",Xp);else{var AAi=this.Am$();if(AAi)this.CI=AH.YO();else AH.HB(this.
CI,0,this.Id);AH.HB(this.CI,1,this.AnimalId);AH.Acs(this.CI,6,this.Timestamp);AH.
...
C.Animal,0);Cz.E3(Ad,RB);if(this.Temperature>0)Cz.Uy(A._GetAutoObject(C.Helper).
...
E;A.abo([this,this.Bl3,this.OnSetTemperature],0);},OnSetId:function(E){if(this.Id===
E)return;this.Id=E;A.abo([this,this.Q6,this.OnSetId],0);},OnSetAnimalId:function(
E){if(this.AnimalId===E)return;this.AnimalId=E;A.abo([this,this.Bld,this.OnSetAnimalId
],0);},OnSetFeed:function(E){if(this.Feed===E)return;this.Feed=E;A.abo([this,this.
Blw,this.OnSetFeed],0);},OnSetAppearance:function(E){if(this.Appearance===E)return;
this.Appearance=E;A.abo([this,this.Ble,this.OnSetAppearance],0);},OnSetRespiratory:
function(E){if(this.Respiratory===E)return;this.Respiratory=E;A.abo([this,this.BlV
,this.OnSetRespiratory],0);},OnSetFaeces:function(E){if(this.Faeces===E)return;this.
Faeces=E;A.abo([this,this.Blu,this.OnSetFaeces],0);},OnSetTimestamp:function(E){
if(this.Timestamp===E)return;this.Timestamp=E;A.abo([this,this.A9J,this.OnSetTimestamp
],0);},Bps:function(NB,A8){switch(NB){case 2:this.OnSetAppearance(A8);break;case
1:this.OnSetFeed(A8);break;case 4:this.OnSetFaeces(A8);break;case 3:this.OnSetRespiratory(
A8);break;default:;}},Bjy:function(NB){switch(NB){case 2:return this.Appearance;
...
E)return;this.RatingTemperature=E;A.abo([this,this.BlT,this.OnSetRatingTemperature
],0);},OnSetBodyWeight:function(E){if(this.BodyWeight===E)return;this.BodyWeight=
E;A.abo([this,this.Bli,this.OnSetBodyWeight],0);},Bl3:function(){return this.Temperature;
},Q6:function(){return this.Id;},Bld:function(){return this.AnimalId;},Blw:function(
){return this.Feed;},Ble:function(){return this.Appearance;},BlV:function(){return this.
Respiratory;},Blu:function(){return this.Faeces;},A9J:function(){return this.Timestamp;
},BlT:function(){return this.RatingTemperature;},Bli:function(){return this.BodyWeight;
...
C.HelperClass={UH:null,AhI:null,AUU:null,AUV:null,W:null,Av:null,KN:null,SZ:null
,Ad2:null,UO:null,UN:null,Aep:null,AfB:null,AfA:null,Afz:null,AfC:null,AgI:null,
AG9:0,Init:function(aArg){A.pe([this,this.AUm],this);},AkF:function(E){this.UH=E;
A.abo([this,this.ArH,this.AkF],0);},AFZ:function(E){this.AhI=E;A.abo([this,this.
A9z,this.AFZ],0);},BBB:function(G){switch(A._GetAutoObject(C.Device).ScanState){
...
Ayj);}}break;case 4:A._GetAutoObject(C.Device).AY(11,true,A.jV,2000,null);break;
case 3:A._GetAutoObject(C.Device).AY(12,true,A.jV,2000,null);break;case 0:case 1:
...
},Bbi:function(E){A.abo([this,this.U9,this.Va],0);A._GetAutoObject(C.Device).SetSystemTime(
E);},Va:function(Aq){this.AF4(Aq);},Dv:function(){if(this.K&&this.K.Dv)return this.
K.Dv.apply(this,arguments);else return C.HelperClass.Bbe.apply(this,arguments);}
,Bbe:function(){var B;return((B=(this.Av.BdV()|0))<0)?B+0x100000000:B;},U9:function(
){return this.Dv();},Asz:function(){A._GetAutoObject(C.Device).SW(-1);this.W.E7(
);A.we(this.W,0);},A74:function(IA){if(!IA){A.ab5("%s%U",Ayk,IA);return false;}var
Bd=A._GetAutoObject(C.Device).An.Aeu(22,IA);return this.GS(Bd);},Am1:function(AoS
,AJk){switch(AoS){case 0:{var Apj=AJk;switch(Apj){case 14:return A.aaR(A.acf.Afw
);case 6:return Pc;case 4:return A.aaR(A.acf.Aeh);case 28:return Ayl;case 7:return A.
aaR(A.acf.Afr);case 2:return A.aaR(A.acf.P);case 0:return A.aaR(A.acf.GN);case 37:
...
10:return A.aaR(A.acf.Bo5);case 12:return A.aaR(A.acf.Asl);case 29:return A.aaR(
A.acf.ARL);case 18:return A.aaR(A.acf.Weighing);case 17:return AWp;case 5:return A.
aaR(A.acf.Temperature);case 3:return AWq;case 26:return A.aaR(A.acf.Uo);case 35:
return A.aaR(A.acf.Uo)+AHD;case 36:return AHE;case 15:return AfH;case 24:return Aoq;
...
aaR(A.acf.Animal);case 3:return A.aaR(A.acf.AGz);case 8:return A.aaR(A.acf.Afy);
...
"%s",(AcS+AoS.toFixed())+AWv);}return A.jV;},A7c:function(AoS,AI){var result=A.jV;
...
!!(C.GenderFilterCriterion.isPrototypeOf(AI)?AI:null)){var BzY=A._NewObject(C.GenderToString
,0);result=result+BzY.LA((C.GenderFilterCriterion.isPrototypeOf(AI)?AI:null).A5);
}else if(!!(C.AnimalTypeFilterCriterion.isPrototypeOf(AI)?AI:null)){var ByT=A._NewObject(
C.AnimalTypeToString,0);result=result+ByT.LA((C.AnimalTypeFilterCriterion.isPrototypeOf(
AI)?AI:null).A5);}else if(!!(C.AssessmentFilterCriterion.isPrototypeOf(AI)?AI:null
)){var ByW=A._NewObject(C.AssesmentToString,0);result=result+ByW.LA((C.AssessmentFilterCriterion.
...
isPrototypeOf(AI)?AI:null)){var BDl=A._NewObject(C.WhereAboutsToString,0);result=
result+BDl.LA((C.WhereAboutsFilterCriterion.isPrototypeOf(AI)?AI:null).A5);}else
A.ab5("%s",AWx);}return result;},MN:function(aString,BcG,Bx8){var result=A.jV;var
Bgs=false;var index=0;var Bx_=BcG.length;while(!Bgs){var A4i=aString.indexOf(BcG
,index);if(A4i!==-1){result=(result+A.abW(aString,index,A4i-index))+Bx8;index=A4i+
Bx_;}else{var BcL=aString.length;if(index<BcL)result=result+A.ab2(aString,BcL-index
);Bgs=true;}}return result;},ATS:function(E){this.AUU=E;A.abo([this,this.BlX,this.
ATS],0);},ATT:function(E){this.AUV=E;A.abo([this,this.BlY,this.ATT],0);},Bej:function(
){return((A._GetAutoObject(C.Device).ScanState===2)&&!!A._GetAutoObject(C.Device
).O0)&&(A._GetAutoObject(C.Device).O0.TransponderType===1);},Agc:function(G){if(
!this.W.Am$()&&(this.W.Id>=0))this.BkA(this.W.Id);},ADc:function(Eo){return A._GetAutoObject(
C.Helper).UO.Get(Eo);},A69:function(Eo){return A._GetAutoObject(C.Helper).UN.Get(
Eo);},A7i:function(){var O=0;var min=32767;while(O<A._GetAutoObject(C.Helper).UO.
MM){if(A._GetAutoObject(C.Helper).UO.Get(O)<min)min=A._GetAutoObject(C.Helper).UO.
Get(O);O=O+1;}return min;},AUm:function(G){A.zV([this,this.Agc],A._GetAutoObject(
C.Device).An,0);},ARr:function(D3){if(!D3)return false;var Bkb=(((this.AAe(D3.Faeces
)||this.AAe(D3.Feed))||this.AAe(D3.Appearance))||this.AAe(D3.Respiratory))||this.
AAe(D3.RatingTemperature);return Bkb||this.A7O(D3);},AAe:function(Bck){return(Bck===
...
false;if(Md>=0){if(Md!==this.W.CI)A._GetAutoObject(C.Device).SW(Md);A3b=this.W.E3(
Md,A._GetAutoObject(C.Device).An);if(A3b)A.we(this.W,0);}else{A._GetAutoObject(C.
Device).SW(-1);this.W.E7();A.we(this.W,0);}return A3b;},AhR:function(Ah9){var B;
return(((B=(this.Av.BdV()|0))<0)?B+0x100000000:B)-this.AmN(Ah9);},AsO:function(){
var B;A.pe([B=this.KN,B.An3],this);},BCM:function(G){A._GetAutoObject(C.Device).
AY(16,false,AHJ,0,null);A._GetAutoObject(C.Device).AY(5,true,A.jV,0,null);},Boy:
function(G){var Ar=(C.PopupContext.isPrototypeOf(G)?G:null);if(!!Ar&&(Ar.PopupState===
5))this.AsO();},Boi:function(E){if(this.AG9===E)return;this.AG9=E;A._GetAutoObject(
C.Device).AY(16,true,this.AG9.toFixed(),0,[this,this.Boy]);},Mf:function(BxI,Bym
){var D8;var Bg0=A._NewObject(A.Core.An9,0);var GG=A._NewObject(A.Core.Bs,0);var
La=A._NewObject(A.Core.Bs,0);GG.Initialize(BxI);La.Initialize(Bym);D8=La.BiF(GG);
Bg0.Initialize2(0,D8.ADN,D8.AEz,D8.AGN);if(GG.J(Bg0).GL===GG.GL)return D8.Kq;else
return D8.Kq+1;},BCO:function(G){A._GetAutoObject(C.Device).UpdateMeasureState(3
);},ALi:function(G){var BhP=A._GetAutoObject(C.Helper).ADc(A._GetAutoObject(C.Helper
).W.AnimalType);var BhM=A._GetAutoObject(C.Helper).A69(A._GetAutoObject(C.Helper
).W.AnimalType);var Agt=A.abz(BhP-100,BhM+100);this.Bdz(Agt);},AmN:function(Ah9){
...
_GetAutoObject(C.Helper).V5(Ka,A._GetAutoObject(C.Device).AF&0xFF,A._GetAutoObject(
...
Bc$>=0)Bc_=this.Afz.Get(Bc$);ApX=A1o+(this.Mf(BcN,this.Dv())*Bc_);if(AJl>0){var A2j=
...
D3){var Aqj=A._GetAutoObject(C.Converter).Ad3(D3.Faeces);if(Aqj<A._GetAutoObject(
C.Converter).Ad3(D3.Feed))Aqj=A._GetAutoObject(C.Converter).Ad3(D3.Feed);if(Aqj<
A._GetAutoObject(C.Converter).Ad3(D3.Appearance))Aqj=A._GetAutoObject(C.Converter
).Ad3(D3.Appearance);if(Aqj<A._GetAutoObject(C.Converter).Ad3(D3.Respiratory))Aqj=
A._GetAutoObject(C.Converter).Ad3(D3.Respiratory);return A._GetAutoObject(C.Converter
).Bal(Aqj);},AxD:function(D3,NA){if(!!D3){D3.OnSetFaeces(NA);D3.OnSetFeed(NA);D3.
OnSetAppearance(NA);D3.OnSetRespiratory(NA);}},Bjw:function(AH,AJr,Ac9,Xw,AfM){if(
!AH)throw new Error(Atb);var Bf=A._NewObject(C.Filter,0);var ApK=AH.Filter;var On=
A._NewObject(C.Int32FilterCriterion,0);On.Operator=0;On.EJ=1;On.A5=Ac9;Bf.CX(On);
if(Xw>0){var Oz=A._NewObject(C.UInt32FilterCriterion,0);Oz.Operator=2;Oz.EJ=6;Oz.
A5=Xw;Bf.CX(Oz);}if(AfM>0){var Or=A._NewObject(C.UInt32FilterCriterion,0);Or.Operator=
3;Or.EJ=6;Or.A5=AfM;Bf.CX(Or);}AH.Bk(Bf);var Me=A._NewObject(C.Int32ArrayWrapper
,0);Me.ZG(6);var O;for(O=0;O<Me.MM;O=O+1)Me.Set(O,0);var Vh;for(O=0;O<AH.B_();O=
O+1){Vh=AH.Ja(O,AJr);Me.Set(Vh,Me.Get(Vh)+1);}AH.Bk(ApK);return Me;},ZY:function(
...
BpU(BgZ);return((B=(GG.JY()|0))<0)?B+0x100000000:B;},A6_:function(AH,Ac9,AfM,Xw){
if(!AH)throw new Error(Atb);var Bf=A._NewObject(C.Filter,0);var ApK=AH.Filter;var
On=A._NewObject(C.Int32FilterCriterion,0);On.Operator=0;On.EJ=1;On.A5=Ac9;Bf.CX(
On);if(Xw>0){var Oz=A._NewObject(C.UInt32FilterCriterion,0);Oz.Operator=2;Oz.EJ=
6;Oz.A5=Xw;Bf.CX(Oz);}if(AfM>0){var Or=A._NewObject(C.UInt32FilterCriterion,0);Or.
Operator=3;Or.EJ=6;Or.A5=AfM;Bf.CX(Or);}AH.Bk(Bf);var Me=A._NewObject(C.Int32ArrayWrapper
,0);Me.ZG(6);var O;for(O=0;O<Me.MM;O=O+1)Me.Set(O,0);var Ao_=A._NewObject(C.Rating
,0);var A2b;for(O=0;O<AH.B_();O=O+1){Ao_.E3(O,AH);if(A._GetAutoObject(C.Helper).
AGA(Ao_)){A2b=A._GetAutoObject(C.Helper).ADq(Ao_);Me.Set(A2b,Me.Get(A2b)+1);}}AH.
Bk(ApK);return Me;},A2K:function(AH,Ac9,Bzs){if(!AH)throw new Error(Atb);var Bf=
A._NewObject(C.Filter,0);var ApK=AH.Filter;var On=A._NewObject(C.Int32FilterCriterion
,0);On.Operator=0;On.EJ=1;On.A5=Ac9;Bf.CX(On);var Xw=A._GetAutoObject(C.Converter
).AhT()+A._GetAutoObject(C.Helper).AmN(Bzs);var AfM=Xw+A._GetAutoObject(C.Helper
).AmN(1);var Oz=A._NewObject(C.UInt32FilterCriterion,0);Oz.Operator=2;Oz.EJ=6;Oz.
A5=Xw;Bf.CX(Oz);var Or=A._NewObject(C.UInt32FilterCriterion,0);Or.Operator=3;Or.
EJ=6;Or.A5=AfM;Bf.CX(Or);AH.Bk(Bf);var Ao_=A._NewObject(C.Rating,0);var Vh;var LW=
0;var O;for(O=0;O<AH.B_();O=O+1){Ao_.E3(O,AH);if(A._GetAutoObject(C.Helper).AGA(
Ao_)){Vh=A._GetAutoObject(C.Helper).ADq(Ao_);if(A._GetAutoObject(C.Converter).Ad3(
Vh)>A._GetAutoObject(C.Converter).Ad3(LW))LW=Vh;}}AH.Bk(ApK);return LW;},Am_:function(
...
).WeightRecordingScope)return true;else return false;},Bjx:function(AH,AJr,Ac9,Xw
,AfM){if(!AH)throw new Error(Atb);var Bf=A._NewObject(C.Filter,0);var ApK=AH.Filter;
var On=A._NewObject(C.Int32FilterCriterion,0);On.Operator=0;On.EJ=1;On.A5=Ac9;Bf.
CX(On);if(Xw>0){var Oz=A._NewObject(C.UInt32FilterCriterion,0);Oz.Operator=2;Oz.
EJ=6;Oz.A5=Xw;Bf.CX(Oz);}if(AfM>0){var Or=A._NewObject(C.UInt32FilterCriterion,0
);Or.Operator=3;Or.EJ=6;Or.A5=AfM;Bf.CX(Or);}AH.Bk(Bf);var Me=A._NewObject(C.Int32ArrayWrapper
,0);Me.ZG(6);var O;for(O=0;O<Me.MM;O=O+1)Me.Set(O,0);if(AH.B_()>0){var Vh=AH.Ja(
0,AJr);var Ap2=AH.Hw(O,6);var Ac=A._NewObject(A.Core.Bs,0);Ac.Initialize(Ap2);var
Aqi=Vh;var AKk=A._NewObject(A.Core.Bs,0);AKk.Initialize(Ac.JY());for(O=1;O<AH.B_(
);O=O+1){Vh=AH.Ja(O,AJr);Ap2=AH.Hw(O,6);Ac.Initialize(Ap2);if((Ac.Ab6()!==AKk.Ab6(
))||(Ac.Year!==AKk.Year)){Me.Set(Aqi,Me.Get(Aqi)+1);AKk.Initialize(Ac.JY());Aqi=
Vh;}else if(!!Vh&&(Vh<Aqi))Aqi=Vh;}Me.Set(Aqi,Me.Get(Aqi)+1);}AH.Bk(ApK);return Me;
...
0);GG.AnJ(0);GG.AnM(0);return((B=(GG.JY()|0))<0)?B+0x100000000:B;},Bjz:function(
BCK,BzE,Aml,AlK){var Bdu=A._GetAutoObject(C.Helper).Mf(BCK,BzE);if(Bdu>0)return((
AlK-Aml)/Bdu)|0;return 0;},Bqv:function(BxJ,Byn){var GG=A._NewObject(A.Core.Bs,0
);var La=A._NewObject(A.Core.Bs,0);GG.Initialize(BxJ);La.Initialize(Byn);return(
GG.Year===La.Year)&&(GG.Ab6()===La.Ab6());},A7e:function(){var Bf=A._GetAutoObject(
C.Helper).MB();var Bey=A._NewObject(C.UInt32FilterCriterion,0);var Byw=A._GetAutoObject(
C.Helper).ZY(A._GetAutoObject(C.Device).AqZ)-1;Bey.Initialize(28,2,Byw,true);Bf.
CX(Bey);var Vd=A._NewObject(C.AnimalTypeFilterCriterion,0);Vd.Initialize(14,0,1,
true);Bf.CX(Vd);if(A._GetAutoObject(C.Device).Aq0){var AAt=A._NewObject(C.UInt32FilterCriterion
,0);var A27=A._GetAutoObject(C.Helper).Dv()-21600;AAt.Initialize(30,3,A27,true);
Bf.CX(AAt);}return Bf;},Bpa:function(){var Jt=A._GetAutoObject(C.Device).An.OG();
if(Jt<=0)A.ab5("%s",Xp);else{A._GetAutoObject(C.Device).An.E7();A._GetAutoObject(
C.Device).An.OI(Jt);}Jt=A._GetAutoObject(C.Device).AgA.OG();if(Jt<=0)A.ab5("%s",
Xp);else{A._GetAutoObject(C.Device).AgA.E7();A._GetAutoObject(C.Device).AgA.OI(Jt
);}Jt=A._GetAutoObject(C.Device).Bt.OG();if(Jt<=0)A.ab5("%s",Xp);else{A._GetAutoObject(
C.Device).Bt.E7();A._GetAutoObject(C.Device).Bt.OI(Jt);}Jt=A._GetAutoObject(C.Device
).Pv.OG();if(Jt<=0)A.ab5("%s",Xp);else{A._GetAutoObject(C.Device).Pv.E7();A._GetAutoObject(
C.Device).Pv.OI(Jt);}},BkA:function(Ac9){var Bd=A._GetAutoObject(C.Device).An.LZ(
0,Ac9);return this.GS(Bd);},ARz:function(IA){var AiB=A._GetAutoObject(C.Device).
An.Aen(22,IA);return AiB;},ADh:function(){var Bf=A._GetAutoObject(C.Helper).MB();
var Ajd=A._NewObject(C.UInt64FilterCriterion,0);Ajd.Initialize(22,0,0,true);Bf.CX(
Ajd);return Bf;},AOW:function(Ao3,BzB,Qi){var Aaw=-1;switch(Ao3){case 2:Aaw=30;break;
case 3:Aaw=31;break;case 10:Aaw=19;break;default:A.ab5("%s%e",U5,Ao3);}if(Aaw<0)
return null;var Adl=A._NewObject(C.UInt32FilterCriterion,0);Adl.Initialize(Aaw,3
,A._GetAutoObject(C.Helper).Dv()-BzB,Qi);return Adl;},Bo8:function(aFilter){var AI=
aFilter.DM(30,3);if(!!AI)aFilter.Nw(AI);AI=aFilter.DM(31,3);if(!!AI)aFilter.Nw(AI
);AI=aFilter.DM(19,3);if(!!AI)aFilter.Nw(AI);},A14:function(AfW,Ay_,AH){if(AH.Lm(
))return 5;if(AfW.VisualId<=0)switch(Ay_){case 0:if(!AfW.NaisId)return 1;break;case
1:if(!AfW.TransponderId)return 1;break;case 3:case 2:case 5:case 4:return 1;default:
throw new Error(AHK+Ay_.toFixed());}if((!AfW.NaisId&&!AfW.TransponderId)&&A._GetAutoObject(
C.Device).An.AjL(1,AfW.VisualId))return 2;if(!!AfW.NaisId&&A._GetAutoObject(C.Helper
).ARw(AfW.NaisId))return 3;if(!!AfW.TransponderId&&A._GetAutoObject(C.Helper).ARz(
AfW.TransponderId))return 4;return 0;},Aqo:function(En){En.EC(A._GetAutoObject(C.
Device).AnimalType);En.N7(A._GetAutoObject(C.Device).Breed);En.Q8(A._GetAutoObject(
C.Helper).Dv()-A._GetAutoObject(C.Helper).AmN(A._GetAutoObject(C.Device).AdU));En.
...
throw new Error(AHL+Ru.toFixed());}return FK;},Bas:function(Alr,Ma,Bcp,Bxu,Bx3){
var B;var Qw=null;var XH=null;switch(Alr){case 0:{Qw=[B=A._GetAutoObject(C.Device
),B.ASW,B.A0L];XH=[B=A._GetAutoObject(C.Device),B.Awr,B.Ay4];}break;case 1:switch(
Ma){case 1:{Qw=[B=A._GetAutoObject(C.Device),B.A9o,B.BbQ];XH=[B=A._GetAutoObject(
C.Device),B.Awp,B.Ay2];}break;case 0:{Qw=[B=A._GetAutoObject(C.Device),B.A9p,B.BbR
];XH=[B=A._GetAutoObject(C.Device),B.Awq,B.Ay3];}break;case 2:{Qw=[B=A._GetAutoObject(
C.Device),B.ASW,B.A0L];XH=[B=A._GetAutoObject(C.Device),B.Awr,B.Ay4];}break;default:
throw new Error(Aym+Ma.toFixed());}break;default:throw new Error(AHM+Alr.toFixed(
));}if(!!Qw&&!!XH){Qw[2].call(Qw[0],Bcp);if(Bcp>0){if((XH[1].call(XH[0])>0)&&(Bxu<
Bx3))Qw[2].call(Qw[0],Qw[1].call(Qw[0])+XH[1].call(XH[0]));else if(XH[1].call(XH[
0])<0)Qw[2].call(Qw[0],Qw[1].call(Qw[0])+XH[1].call(XH[0]));}return Qw[1].call(Qw[
0]);}return 0;},AVV:function(En,Alr,BxC){if(!En||(BxC===true))return;switch(Alr){
...
}},Bkc:function(Ru,En){var result=false;switch(Ru){case 0:result=!!En.NaisId;break;
...
,Bci,Ay_,AtJ,AfP){switch(Bci){case 2:if(AtJ<=0)A._GetAutoObject(C.Device).AY(21,
true,En.VisualId.toFixed(),0,AfP);else A._GetAutoObject(C.Device).AY(48,true,(En.
VisualId.toFixed()+Ayn)+AtJ.toFixed(),0,AfP);break;case 3:if(AtJ<=0)A._GetAutoObject(
C.Device).AY(21,true,A._GetAutoObject(C.Converter).Rl(En.NaisId),0,AfP);else A._GetAutoObject(
C.Device).AY(48,true,(A._GetAutoObject(C.Converter).Rl(En.NaisId)+Ayn)+AtJ.toFixed(
),0,AfP);break;case 4:if(AtJ<=0)A._GetAutoObject(C.Device).AY(25,true,A._GetAutoObject(
C.Converter).Rl(En.TransponderId),0,AfP);else A._GetAutoObject(C.Device).AY(47,true
,(A._GetAutoObject(C.Converter).Rl(En.TransponderId)+Ayn)+AtJ.toFixed(),0,AfP);break;
case 1:switch(Ay_){case 1:A._GetAutoObject(C.Device).AY(42,true,A.jV,0,AfP);break;
case 0:A._GetAutoObject(C.Device).AY(43,true,A.jV,0,AfP);break;case 3:case 2:case
5:case 4:A._GetAutoObject(C.Device).AY(22,true,A.jV,0,AfP);break;default:throw new
Error(AHK+Ay_.toFixed());}break;case 5:A._GetAutoObject(C.Device).AY(41,true,A._GetAutoObject(
C.Device).An.HM().toFixed(),0,AfP);break;case 0:break;default:throw new Error(AWy+
...
toFixed());}return AAx;},A7q:function(Ql,Bye){var AaX=A._NewObject(A.Core.Bs,0);
AaX.Initialize(Ql);var ABR=AaX.Year;var Bd=A._GetAutoObject(C.Device).Pv.LZ(0,ABR
);var Vg=A._NewObject(C.CalfDeregistrations,0);if(Bd<0){if(A._GetAutoObject(C.Device
).Pv.Lm())A._GetAutoObject(C.Device).AY(51,true,A._GetAutoObject(C.Device).Pv.HM(
).toFixed(),0,null);else{Vg.Gs();Vg.AkH(ABR);}}else Vg.E3(Bd,A._GetAutoObject(C.
Device).Pv);Vg.AwJ(Vg.Deregistrations+1);if(Bye)Vg.AwI(Vg.Deaths+1);Vg.Ci(A._GetAutoObject(
...
},Bdz:function(Byv){var B;if(A._GetAutoObject(C.Device).MeasureState===1){this.SZ.
Cx=A._GetAutoObject(C.Device).AcK;this.SZ.B3=Byv;this.SZ.An1(this);}},ADe:function(
...
C.Helper).MB();if(A._GetAutoObject(C.Device).Aqk){var A2N=A._GetAutoObject(C.Helper
).AOW(Eh,21600,true);Bf.CX(A2N);}return Bf;},A7k:function(){var Bf=A._GetAutoObject(
C.Helper).MB();var BeP=A._NewObject(C.UInt64FilterCriterion,0);BeP.Initialize(26
,0,0,true);Bf.CX(BeP);return Bf;},A7n:function(){var B;var Bf=A._GetAutoObject(C.
Helper).MB();var AAD=(C.WhereAboutsFilterCriterion.isPrototypeOf(B=Bf.DM(34,3))?
B:null);if(!!AAD)Bf.Nw(AAD);var Bf$=A._NewObject(C.BoolFilterCriterion,0);Bf$.Initialize(
37,0,true,true);Bf.CX(Bf$);return Bf;},V5:function(A8,AtC,A1p){var B;A8=Math.trunc(
...
case 15:return 1000000000000000;default:throw new Error(AWA+Bcx.toFixed());}},MB:
...
Aw){if(Aw.YQ===false)Jp++;Aw=aFilter.AO2(Aw);}return Jp;},AOV:function(){var Bf=
this.MB();var Vd=A._NewObject(C.AnimalTypeFilterCriterion,0);Vd.Initialize(14,0,
1,true);Bf.CX(Vd);return Bf;},ADn:function(){var B;var A4R;var Kc=this.BjQ();A4R=(((
B=A._GetAutoObject(C.Converter).AqH(Kc))<0)?B+0x10000000000000000:B)*this.ApW(12
);if((Kc===10)&&(A._GetAutoObject(C.Device).OZ>0)){var BzZ=A._GetAutoObject(C.Helper
).V5(A._GetAutoObject(C.Device).OZ,10,2)*this.ApW(8);A4R+=BzZ;}return A4R;},BjQ:
function(){var Kc=0;if(A._GetAutoObject(C.Device).OZ>0)Kc=A._GetAutoObject(C.Converter
).S8(A._GetAutoObject(C.Device).OZ);if(!Kc)Kc=A._GetAutoObject(C.Converter).A7U(
A._GetAutoObject(C.Device).Language);return Kc;},ARw:function(Qj){var AiB=A._GetAutoObject(
C.Device).An.Aen(26,Qj);return AiB;},Aj7:function(AfQ){switch(AfQ){case 0:case 1:
case 2:case 3:case 4:case 5:return false;case 6:case 7:case 8:case 9:case 10:return true;
default:throw new Error(AWB+AfQ.toFixed());}},BhL:function(Ru,En){var FK=0;switch(
...
AWC+Ru.toFixed());}return FK;},Bjm:function(){var B;var AAa=(((((((A.aaR(A.acf.AhL
)+A.aaR(A.acf.Colon))+MR)+A._GetAutoObject(C.Device).AhL)+Ayo)+A.aaR(A.acf.BoQ))+
A.aaR(A.acf.Colon))+MR)+A._GetAutoObject(A.acj.KR).Bjk(((B=A._GetAutoObject(C.Device
).Q3.Timestamp)<0)?B+0x100000000:B);return AAa;},Bjn:function(){var B;var AAa=((((((((((((((((((((((((((((
...
).R7.Timestamp)<0)?B+0x100000000:B))+MR)+AWE)+A._GetAutoObject(C.Device).SG.AEt.
...
MR)+AWF)+A._GetAutoObject(C.Helper).BjT())+Pb)+A._GetAutoObject(C.Device).GetCommitHash(
))+Pb)+A._GetAutoObject(C.Device).GetCommitCount().toFixed())+Pb)+A._GetAutoObject(
A.acj.KR).AjN(A._GetAutoObject(C.Device).GetCommitEpoch());return AAa;},Bjl:function(
...
).Q3.ARX.toFixed())+MR)+A.aaR(A.acf.A60))+A.aaR(A.acf.Colon))+Oj)+A._GetAutoObject(
A.acj.KR).AjN(((B=A._GetAutoObject(C.Device).Q3.Timestamp)<0)?B+0x100000000:B))+
Ayo)+AWH)+A._GetAutoObject(C.Device).S5.AVL.toFixed())+LB)+A._GetAutoObject(C.Device
).S5.AVM.toFixed())+LB)+A._GetAutoObject(C.Device).S5.AVK.toFixed())+MR)+A.aaR(A.
acf.A60))+A.aaR(A.acf.Colon))+Oj)+A._GetAutoObject(A.acj.KR).AjN(((B=A._GetAutoObject(
C.Device).S5.Timestamp)<0)?B+0x100000000:B);return AAa;},A7l:function(A1p){var B;
...
},Abz:function(Eo){var Azs=0;if(Eo===1)Eo=0;var Bde=this.AgI.Avz(Eo);if(Bde>=0)Azs=
this.AfC.Get(Bde);return Azs;},ADp:function(Eo){var FX=0;var ABP=this.AgI.Avz(Eo
);if(ABP>=0)FX=this.AfB.Get(ABP);return FX;},ADo:function(Eo){var FX=0;var ABP=this.
AgI.Avz(Eo);if(ABP>=0)FX=this.AfA.Get(ABP);return FX;},A7b:function(){var Bf=this.
MB();var Vd=A._NewObject(C.AnimalTypeFilterCriterion,0);Vd.Initialize(14,0,A._GetAutoObject(
C.Device).ACZ,true);Bf.CX(Vd);return Bf;},ARA:function(Ka){var BN=Math.trunc(Ka/
1000000000000)|0;if(!BN)return 0;else if(BN>=900)return 1;else if(!A._GetAutoObject(
C.Converter).ANN(BN))return 2;else return 3;},A7p:function(BAF){var Bf=A._GetAutoObject(
C.Helper).ADh();var AfV=A._GetAutoObject(C.Helper).A68(3,BAF);AfV.YQ=true;Bf.CX(
AfV);return Bf;},A68:function(Eb,Bch){var Aw=A._NewObject(C.UInt32FilterCriterion
...
default:A.ab5("%s%e",AHO,Eb);}return Aw;},BjT:function(){return(((A._GetAutoObject(
...
}return FK;},Bat:function(){var B;var I3=null;var Tr=0;if(!A._GetAutoObject(C.Device
).EartagNrAssignmentMode){I3=[B=A._GetAutoObject(C.Device),B.Anx,B.AoE];Tr=A._GetAutoObject(
C.Device).Ava;}else switch(A._GetAutoObject(C.Helper).W.Gender){case 1:{I3=[B=A.
_GetAutoObject(C.Device),B.Awl,B.Ay0];Tr=A._GetAutoObject(C.Device).ACR;}break;case
0:{I3=[B=A._GetAutoObject(C.Device),B.Awm,B.Ay1];Tr=A._GetAutoObject(C.Device).ACS;
}break;case 2:{I3=[B=A._GetAutoObject(C.Device),B.Anx,B.AoE];Tr=A._GetAutoObject(
C.Device).Ava;}break;default:;}if(!!I3)switch(Tr){case 1:I3[2].call(I3[0],A._GetAutoObject(
...
ARw(Qj);},Bkl:function(IA,En){return(En.TransponderId!==IA)&&this.ARz(IA);},AOT:
...
Z(Ah8);},ANH:function(Ah_){var B;var Aa;var A3q=false;var XB=Ah_.TX(null,0x1);while(
!!XB&&(((B=XB)?B.__proto__:null)!==A.Core.Y)){Aa=(A.kR.Co.isPrototypeOf(XB)?XB:null
);if(!!Aa){Aa.Bi(A3q);A3q=!A3q;}XB=Ah_.TX(XB,0x1);}},Bo_:function(IA){var Xy=A._GetAutoObject(
C.Device).An.Filter;A._GetAutoObject(C.Device).An.Bk(null);var A4x=A._GetAutoObject(
C.Device).An.Aeu(22,IA);var Cz=A._NewObject(C.Animal,0);Cz.E3(A4x,A._GetAutoObject(
C.Device).An);Cz.P0(0);Cz.Ci(A._GetAutoObject(C.Device).An);A._GetAutoObject(C.Device
).An.Bk(Xy);},A6$:function(AtB,AoI){var Bf=null;switch(AtB){case 0:Bf=this.BjE(AoI
);break;case 1:Bf=this.ADh();break;default:throw new Error(Ayp+AtB.toFixed());}return Bf;
},BjE:function(Bxo){var Bf=A._GetAutoObject(C.Helper).MB();var AfV=this.A68(2,Bxo
);Bf.CX(AfV);return Bf;},ByV:function(AtB,AoI){var Xy=A._GetAutoObject(C.Device).
An.Filter;A._GetAutoObject(C.Device).An.Bk(this.A6$(AtB,AoI));var CB=A._GetAutoObject(
C.Device).An.B_();var O;for(O=CB-1;O>=0;O--){A._GetAutoObject(C.Helper).GS(O);A.
_GetAutoObject(C.Helper).W.Ae6(false);A._GetAutoObject(C.Helper).W.Ci(A._GetAutoObject(
C.Device).An);}A._GetAutoObject(C.Device).An.Bk(Xy);},BjF:function(AtB,AoI){var Xy=
A._GetAutoObject(C.Device).An.Filter;A._GetAutoObject(C.Device).An.Bk(this.A6$(AtB
,AoI));var Gi=A._GetAutoObject(C.Device).An.B_();A._GetAutoObject(C.Device).An.Bk(
Xy);return Gi;},A7h:function(AH){var Xy=AH.Filter;AH.Bk(this.AvA());var O;var A3g=
4294967295;for(O=0;O<AH.B_();O++){var Ph=AH.Hw(O,4);if(Ph<A3g)A3g=Ph;}AH.Bk(Xy);
...
return false;},BkB:function(Qj){if(!Qj){A.ab5("%s%U",AWJ,Qj);return false;}var Bd=
A._GetAutoObject(C.Device).An.Aeu(26,Qj);return this.GS(Bd);},ArH:function(){return this.
UH;},A9z:function(){return this.AhI;},BlX:function(){return this.AUU;},BlY:function(
){return this.AUV;},Bl1:function(){return this.AG9;},_Init:function(aArg){C.AmS.
...
this.SZ={I:this},0);C.AMS._Init.call(this.Ad2={I:this},0);C.AVB._Init.call(this.
UO={I:this},0);C.AVA._Init.call(this.UN={I:this},0);C.TQ._Init.call(this.Aep={I:
this},0);C.AWf._Init.call(this.AfB={I:this},0);C.AWe._Init.call(this.AfA={I:this
},0);C.AWd._Init.call(this.Afz={I:this},0);C.AWh._Init.call(this.AfC={I:this},0);
C.AMT._Init.call(this.AgI={I:this},0);this.__proto__=C.HelperClass;var B;this.KN.
HQ(1);this.KN.Fq(3000);this.KN.B3=100;this.SZ.AwO(10);this.SZ.WR(5);this.SZ.HQ(1
);this.SZ.Fq(4000);this.Aep.B3=false;this.Aep.Cx=true;this.Aep.HQ(1);this.Aep.Fq(
100);this.KN.SI=[this,this.BCM];this.KN.Q=[this,this.Bl1,this.Boi];this.SZ.SI=[this
,this.BCO];this.SZ.Q=[B=A._GetAutoObject(C.Device),B.AE0,B.AI8];this.Aep.Q=[B=A.
...
SZ._Done();this.Ad2._Done();this.UO._Done();this.UN._Done();this.Aep._Done();this.
AfB._Done();this.AfA._Done();this.Afz._Done();this.AfC._Done();this.AgI._Done();
C.AmS._Done.call(this);},_ReInit:function(){C.AmS._ReInit.call(this);this.W._ReInit(
);this.Av._ReInit();this.KN._ReInit();this.SZ._ReInit();this.Ad2._ReInit();this.
UO._ReInit();this.UN._ReInit();this.Aep._ReInit();this.AfB._ReInit();this.AfA._ReInit(
);this.Afz._ReInit();this.AfC._ReInit();this.AgI._ReInit();if(this.K)this.K._ReInit.
call(this);},_Mark:function(D){var B;C.AmS._Mark.call(this,D);if((B=this.UH)&&(B.
...
B=this.SZ)._cycle!=D)B._Mark(B._cycle=D);if((B=this.Ad2)._cycle!=D)B._Mark(B._cycle=
D);if((B=this.UO)._cycle!=D)B._Mark(B._cycle=D);if((B=this.UN)._cycle!=D)B._Mark(
B._cycle=D);if((B=this.Aep)._cycle!=D)B._Mark(B._cycle=D);if((B=this.AfB)._cycle
!=D)B._Mark(B._cycle=D);if((B=this.AfA)._cycle!=D)B._Mark(B._cycle=D);if((B=this.
Afz)._cycle!=D)B._Mark(B._cycle=D);if((B=this.AfC)._cycle!=D)B._Mark(B._cycle=D);
...
,Abs:function(){var Aw=A._NewObject(C.BoolFilterCriterion,0);Aw.E$(this);return Aw;
...
Qi){this.EJ=A4;this.Operator=Eb;this.A5=A8;this.YQ=Qi;return this;},_Init:function(
aArg){C.FilterCriterion._Init.call(this,aArg);this.__proto__=C.BoolFilterCriterion;
},_className:"Device::BoolFilterCriterion"};C.UInt32FilterCriterion={A5:0,Abs:function(
...
this.Operator=Eb;this.A5=A8;this.YQ=Qi;return this;},_Init:function(aArg){C.FilterCriterion.
...
aaR(A.acf.TF);break;case 35:BC=A.aaR(A.acf.VD);break;case 43:BC=A.aaR(A.acf.AOS);
break;default:BC=this.Bqw(A9);}return BC;},Bqw:function(A9){var AJ_=A9;var BC=A.
...
65:BC=Rr;break;case 3:BC=U6;break;case 6:BC=AWP;break;case 16:BC=AWQ;break;case 22:
...
31:BC=AfI;break;case 78:BC=AHZ;break;case 34:BC=Aan;break;case 35:BC=Alj;break;case
...
var Bf5=A9;var Pk=A.jV;switch(Bf5){case 0:Pk=AXC;break;case 1:Pk=U6;break;case 8:
...
Pk=U7;break;case 9:Pk=AXH;break;case 10:Pk=Aao;break;case 14:Pk=AXI;break;case 15:
Pk=AXJ;break;case 13:Pk=Alk;break;case 16:Pk=AfJ;break;default:throw new Error(Ah4+
...
function(A9){var Bg4=A9;var Aqb=A.jV;switch(Bg4){case 0:Aqb=A.aaR(A.acf.BqN);break;
case 1:Aqb=A.aaR(A.acf.BqO);break;default:throw new Error(AXM+Bg4.toFixed());}return Aqb;
...
A.jV;switch(ALj){case 0:type=A.aaR(A.acf.Bh$);break;case 1:type=A.aaR(A.acf.Bin);
break;case 2:type=A.aaR(A.acf.Bkt);break;default:throw new Error(AXN+ALj.toFixed(
...
){case 14:CO=AX9;break;case 13:CO=Xe;break;case 6:CO=AX_;break;case 25:CO=U2;break;
case 11:CO=AX$;break;case 17:CO=AYa;break;case 0:CO=AYb;break;case 10:CO=Xl;break;
case 12:CO=AYc;break;case 5:CO=U3;break;case 3:CO=Xg;break;case 1:CO=Pa;break;case
8:CO=AYd;break;case 18:CO=Oi;break;case 4:CO=Xh;break;case 19:CO=AYe;break;case 20:
CO=Tf;break;case 26:CO=Xj;break;case 15:CO=Tg;break;case 21:CO=Th;break;case 22:
CO=Ti;break;case 23:CO=Aai;break;case 9:CO=Tj;break;case 27:CO=AIg;break;case 2:
CO=Aak;break;case 24:CO=AYf;break;case 7:CO=Xn;break;case 16:CO=K4;break;default:
...
function(A9){var type=A9;var AfZ=A.jV;switch(type){case 0:AfZ=A.aaR(A.acf.BpL);break;
case 1:AfZ=A.aaR(A.acf.BqJ);break;case 2:AfZ=A.aaR(A.acf.Triplets);break;case 3:
AfZ=A.aaR(A.acf.Quadruplets);break;default:throw new Error(AIh+type.toFixed());}
return AfZ;},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=
...
jV;case 1:return A.aaR(A.acf.BoX);case 4:return A.aaR(A.acf.BoW);case 3:return A.
aaR(A.acf.BoY);case 2:return A.aaR(A.acf.BoV);default:throw new Error(AIm+ABb.toFixed(
...
A.aaR(A.acj.BpR);break;case 2:Azz=A.aaR(A.acj.BpT);break;case 1:Azz=A.aaR(A.acj.
BpS);break;default:throw new Error(AIn+AlA.toFixed());}return Azz;},_Init:function(
...
Id:0,Show:false,Bn2:function(E){var B;if(this.PopupState===E)return;this.PopupState=
...
!AH){this.OnSetId(AH.CC(Ad,0));this.AFw(AH.V9(Ad,1));}return G1;},Ci:function(AH
){var G1=C.Row.Ci.call(this,AH);if(G1&&!!AH){var Jt=AH.OG();if(Jt<0)A.ab5("%s",Xp
);else{if(this.Am$())this.CI=AH.YO();AH.HB(this.CI,0,this.Id);AH.ZQ(this.CI,1,this.
...
BlB,this.AFw],0);},Q6:function(){return this.Id;},BlB:function(){return this.GroupName;
...
A9){var AdF=A9;var At=A.jV;var AJ8;AJ8=A.aaR(A.acf.Bq7)+MR;switch(AdF){case 0:At=
A.aaR(A.acf.Unknown);break;case 1:At=A.aaR(A.acf.SevereError);break;case 58:At=A.
aaR(A.acf.Bi$);break;case 2:At=A.aaR(A.acf.Bi9);break;case 3:At=A.aaR(A.acf.BqT);
break;case 77:At=A._GetAutoObject(C.Helper).Bjn();break;case 78:At=A._GetAutoObject(
C.Helper).Bjl();break;case 79:At=A._GetAutoObject(C.Helper).Bjm();break;case 9:At=
A.aaR(A.acf.Brj);break;case 5:At=A.aaR(A.acf.SuccessDataSync);break;case 8:At=A.
aaR(A.acf.SuccessResetFactorySettings);break;case 116:At=A.aaR(A.acf.Bp$);break;
case 34:At=A.aaR(A.acf.SuccessResetAnimalData);break;case 10:At=A._GetAutoObject(
C.Device).ADm();break;case 82:At=A.aaR(A.acf.Bjb);break;case 83:At=A.aaR(A.acf.Bjc
);break;case 80:At=A.aaR(A.acf.Bp3);break;case 81:At=A.aaR(A.acf.SuccessRestoreBackup
);break;case 91:At=A.aaR(A.acf.BhY);break;case 92:At=A.aaR(A.acf.Bpc);break;case
4:At=A.aaR(A.acf.WarningDataSync);break;case 7:At=A.aaR(A.acf.Brh);break;case 33:
...
A.aaR(A.acf.AR6))+MR)+A.aaR(A.acf.BkH);break;case 50:At=((AJ8+A.aaR(A.acf.AR6))+
MR)+A.aaR(A.acf.BkJ);break;case 51:At=((AJ8+A.aaR(A.acf.AR6))+MR)+A.aaR(A.acf.BkI
);break;case 42:At=A.aaR(A.acf.Brf);break;case 45:At=A.aaR(A.acf.Bq$);break;case
...
);break;case 13:At=A.aaR(A.acf.BhQ);break;case 36:At=A.aaR(A.acf.BqE);break;case
117:At=A.aaR(A.acf.Brl);break;case 14:At=A.aaR(A.acf.AnimalNotFound);break;case 15:
...
A.acf.SuccessCreationNewAnimals);break;case 24:At=A.aaR(A.acf.Biq);break;case 49:
At=A.aaR(A.acf.EvaluationInProgress);break;case 16:At=A.aaR(A.acf.Biv);break;case
17:At=A.aaR(A.acf.BpV);break;case 18:At=A.aaR(A.acf.Bp9);break;case 19:At=A.aaR(
A.acf.BpW);break;case 20:At=A.aaR(A.acf.Bp_);break;case 54:At=A.aaR(A.acf.Bp4);break;
case 55:At=A.aaR(A.acf.Bp7);break;case 21:At=A.aaR(A.acf.Bax);break;case 48:At=(
A.aaR(A.acf.Bax)+MR)+A.aaR(A.acf.A6f);break;case 22:At=A.aaR(A.acf.Brb);break;case
63:At=A.aaR(A.acf.Brc);break;case 85:At=A.aaR(A.acf.Bre);break;case 43:At=A.aaR(
A.acf.Brd);break;case 25:At=A.aaR(A.acf.Bag);break;case 47:At=(A.aaR(A.acf.Bag)+
MR)+A.aaR(A.acf.A6f);break;case 107:At=A.aaR(A.acf.BqP);break;case 31:{var BAo=(((((((((((((((((((
A.aaR(A.acf.Bih)+Ayo)+A.aaR(A.acf.ANJ))+A.aaR(A.acf.Colon))+Oj)+A.aaR(A.acf.Bij)
)+MR)+A.aaR(A.acf.AOI))+A.aaR(A.acf.Colon))+Oj)+A.aaR(A.acf.Bjh))+MR)+A.aaR(A.acf.
AUE))+A.aaR(A.acf.Colon))+Oj)+A.aaR(A.acf.Bo0))+MR)+A.aaR(A.acf.AUD))+A.aaR(A.acf.
Colon))+Oj)+A.aaR(A.acf.BoZ);At=BAo;}break;case 32:At=A.aaR(A.acf.BqF);break;case
69:At=A.aaR(A.acf.BkU);break;case 44:At=A.aaR(A.acf.Bri);break;case 37:At=A.aaR(
A.acf.WarningResetWeightSettings);break;case 38:At=A.aaR(A.acf.WarningResetTempThresholds
);break;case 39:At=A.aaR(A.acf.BoR);break;case 76:At=(A.aaR(A.acf.A5U)+MR)+A.aaR(
A.acf.AUG);break;case 40:At=A.aaR(A.acf.Bp5);break;case 75:At=A.aaR(A.acf.BpX);break;
case 59:At=A.aaR(A.acf.QuestionAddAnotherCalfMultiples);break;case 62:At=A.aaR(A.
acf.BpZ);break;case 96:At=A.aaR(A.acf.Bp0);break;case 60:At=A.aaR(A.acf.Bp1);break;
case 98:At=A.aaR(A.acf.Bp2);break;case 61:At=A.aaR(A.acf.Bqa);break;case 104:At=
A.aaR(A.acf.Bqb);break;case 65:At=A.aaR(A.acf.SuccessClearAnimalLoss);break;case
66:At=A.aaR(A.acf.WarningNoActionsForAnimalLoss);break;case 67:At=A.aaR(A.acf.SuccessLinkTransponder
);break;case 106:At=A.aaR(A.acf.BpY);break;case 86:At=A.aaR(A.acf.SuccessUnlinkTransponder
);break;case 68:At=A.aaR(A.acf.Bp6);break;case 70:At=A.aaR(A.acf.Bjd);break;case
71:At=A.aaR(A.acf.A$_);break;case 72:At=A.aaR(A.acf.Bqe);break;case 113:At=(A.aaR(
A.acf.A$_)+MR)+A.aaR(A.acf.A78);break;case 97:At=A.aaR(A.acf.Bjf);break;case 100:
At=(A.aaR(A.acf.A$$)+MR)+A.aaR(A.acf.A$w);break;case 114:At=(A.aaR(A.acf.A$$)+MR
)+A.aaR(A.acf.A78);break;case 99:At=A.aaR(A.acf.Bqf);break;case 88:At=A.aaR(A.acf.
Bje);break;case 89:At=A.aaR(A.acf.Bqc);break;case 90:At=A.aaR(A.acf.Bqd);break;case
...
A.acf.WarningNoBackupFilePresent);break;case 84:At=A.aaR(A.acf.Bju);break;case 87:
At=A.aaR(A.acf.Brm);break;case 95:At=A.aaR(A.acf.Bq_);break;case 108:At=A.aaR(A.
acf.Bra);break;case 109:At=A.aaR(A.acf.SuccessMassDeregistration);break;case 102:
...
aaR(A.acf.Brg);break;case 110:At=A.aaR(A.acf.Bh_);break;case 111:At=A.aaR(A.acf.
Bpn);break;case 112:At=A.aaR(A.acf.Bpo);break;default:throw new Error(AyD+AdF.toFixed(
));}return At;},LA:function(A9){var AdF=A9;var At=A.jV;switch(AdF){case 0:At=AYh;
...
Ath;break;case 82:At=U8;break;case 83:At=Ati;break;case 10:At=AYv;break;case 4:At=
...
57:At=AcT;break;case 52:At=AYI;break;case 53:At=AYJ;break;case 56:At=AYK;break;case
...
case 106:At=AIA;break;case 86:At=AcU;break;case 68:At=AIB;break;case 70:At=AZg;break;
...
Error(AyD+AdF.toFixed());}return At;},_Init:function(aArg){C.EnumToString._Init.
...
E;A.abo([this,this.Bmb,this.AT8],0);},AT7:function(E){if(this.TransponderProtocol===
E)return;this.TransponderProtocol=E;A.abo([this,this.Bma,this.AT7],0);},OnSetId:
function(E){if(this.Id===E)return;this.Id=E;A.abo([this,this.Q6,this.OnSetId],0);
},AO5:function(){return A._GetAutoObject(C.Converter).BqD(this.Id);},BjC:function(
){return A._GetAutoObject(C.Converter).Ax1(this.Id);},Bmb:function(){return this.
TransponderType;},Bma:function(){return this.TransponderProtocol;},Q6:function(){
...
Vo=A9;var NF=A.jV;switch(Vo){case 0:NF=A.aaR(A.acf.Basic);break;case 1:NF=A.aaR(
A.acf.Extended);break;default:throw new Error(AZD+Vo.toFixed());}return NF;},_Init:
...
BeF=A9;var Aqb=A.jV;switch(BeF){case 0:Aqb=A.aaR(A.acf.Bkr);break;case 1:Aqb=A.aaR(
...
C.WeightGainStep=10;C.Int32ArrayWrapper={MM:10,Array:A.abi(10,0,null),ZG:function(
E){if(this.MM===E)return;if(E>10)throw new Error(AZF);this.MM=E;},Set:function(aIndex
,AK){if((aIndex<0)||(aIndex>=this.MM))throw new Error(AyJ);this.Array.Set(aIndex
,AK);},Get:function(aIndex){if((aIndex<0)||(aIndex>=this.MM))throw new Error(AyJ
);return this.Array.Get(aIndex);},Am2:function(){var QC=0;var O;for(O=0;O<this.MM;
O=O+1)QC=QC+this.Get(O);return QC;},toString:function(){var A3o=this.Array.Get(0
).toFixed();var O;for(O=1;O<this.MM;O=O+1)A3o=(A3o+Pb)+this.Array.Get(O).toFixed(
...
){var O;for(O=0;O<this.MM;O=O+1)this.Set(O,0);},Avz:function(A8){var O=0;while(O<
this.MM){if(this.Array.Get(O)===A8)return O;O=O+1;}return-1;},H8:function(){var O=
0;var max=-1;while(O<this.MM){if(this.Array.Get(O)>max)max=this.Array.Get(O);O=O+
...
E_=A.aaR(A.acf.UnlinkTransponder);break;case 2048:E_=A.aaR(A.acf.TF);break;case 4096:
...
aaR(A.acf.Delete);break;case 16384:case 131072:E_=A.aaR(A.acf.Bky);break;case 0:
...
ITable={Filter:null,Id:2,CC:function(Ad,A4){return 0;},V9:function(Ad,A4){return A.
...
this.Id===E)return;this.Id=E;},B_:function(){return 0;},Bk:function(E){if(this.Filter===
E)return;this.Filter=E;A.abo([this,this.Fo,this.Fs],0);},Fs:function(Aq){this.Bk(
Aq);},Ja:function(Ad,A4){var BB3=this.V_(Ad,A4);return A._GetAutoObject(C.Converter
).Bal(BB3);},V_:function(Ad,A4){return 0;},Sq:function(Ad,A4){return 0;},A7m:function(
Ad,A4){return this.CC(Ad,A4);},OG:function(){var Jt=0;var BCN=this.Id;return Jt;
},OI:function(AoV){var G1=0;var BCN=this.Id;return G1===1;},YO:function(){return-
...
Ad,A4,C1){return false;},Acs:function(Ad,A4,C1){return this.ZR(Ad,A4,C1);},AkU:function(
Ad,A4,C1){var BB4=A._GetAutoObject(C.Converter).Ad3(C1);return this.ZS(Ad,A4,BB4
);},A$U:function(Ad,A4,C1){return this.HB(Ad,A4,C1);},AOZ:function(Ad,A4){return this.
CC(Ad,A4);},BjA:function(Ad,A4){return this.CC(Ad,A4);},Bpx:function(Ad,A4,C1){return this.
HB(Ad,A4,C1);},Bpt:function(Ad,A4,C1){return this.HB(Ad,A4,C1);},LZ:function(aColumn
,A8){return-1;},Am0:function(Ad,A4){return this.CC(Ad,A4);},Bpr:function(Ad,A4,C1
){return this.HB(Ad,A4,C1);},ADk:function(Ad,A4){return this.CC(Ad,A4);},AU1:function(
Ad,A4,MV){return this.HB(Ad,A4,MV);},DX:function(G){this.By4();},By4:function(){
return-1;},KT:function(Ad,A4){return 0;},UI:function(Ad,A4,C1){return false;},Aeu:
function(aColumn,A8){return-1;},E7:function(){return false;},BjB:function(Ad,A4){
var BB5=this.CC(Ad,A4);return A._GetAutoObject(C.Converter).Bj2(BB5);},BjG:function(
Ad,A4){return this.CC(Ad,A4);},AO7:function(Ad,A4){return this.CC(Ad,A4);},Bpv:function(
Ad,A4,C1){var BB6=A._GetAutoObject(C.Converter).A51(C1);return this.HB(Ad,A4,BB6
);},Bpw:function(Ad,A4,C1){return this.HB(Ad,A4,C1);},BpC:function(Ad,A4,C1){return this.
HB(Ad,A4,C1);},AjL:function(aColumn,A8){return false;},Aen:function(aColumn,A8){
return false;},BjP:function(Ad,A4){return this.CC(Ad,A4);},BpB:function(Ad,A4,C1
){return this.HB(Ad,A4,C1);},Lm:function(){return this.QM()>=this.HM();},HM:function(
...
Automatic:0,Manual:1,LAST:2};C.WeightRecordingModeToString={BT:function(A9){var Vo=
A9;var NF=A.jV;switch(Vo){case 0:NF=A.aaR(A.acf.Automatic);break;case 1:NF=A.aaR(
A.acf.Manual);break;default:throw new Error(AyK+Vo.toFixed());}return NF;},_Init:
...
A9){switch(A9){case 0:return A.aaR(A.acf.Off);case 1:return A.aaR(A.acf.Aba);default:
...
BgF=A9;var ABn=A.jV;switch(BgF){case 0:ABn=A.aaR(A.acf.Bis);break;case 1:ABn=A.aaR(
A.acf.Bh6);break;case 2:ABn=A.aaR(A.acf.Bh2);break;case 3:ABn=A.aaR(A.acf.Bk1);break;
...
0,Normal:1,Elevated:2,Fever:3,LAST:4};C.Ko={A5y:0,Temperature:1,Rating:2,Afy:3,BDq:
4,BD7:5,BGS:6,BEL:7,BFv:8,BEj:9,BFt:10,BFW:11,BFX:12,BGX:13,BDB:14,LAST:15};C.AnimalListContentToString={
...
Abs:function(){var Aw=A._NewObject(C.GenderFilterCriterion,0);Aw.E$(this);return Aw;
...
};C.AnimalTypeFilterCriterion={A5:0,Abs:function(){var Aw=A._NewObject(C.AnimalTypeFilterCriterion
,0);Aw.E$(this);return Aw;},E$:function(AI){C.FilterCriterion.E$.call(this,AI);var
Aw=(C.AnimalTypeFilterCriterion.isPrototypeOf(AI)?AI:null);if(!!Aw)this.A5=Aw.A5;
},Initialize:function(A4,Eb,A8,Qi){this.EJ=A4;this.Operator=Eb;this.A5=A8;this.YQ=
...
};C.BDD={AuL:0,BDC:1,BFf:2,A$B:3,A59:4,BGx:5,BD6:6,BGw:7,LinkTransponder:8,TF:9,
Weighing:10,Calving:11,LinkNaisId:12,BFV:13,ClearBirthNoticePending:14,DeleteAnimal:
15,ScanNaisId:16,Edit:17,ClearPurchaseNoticePending:18,UNDEFINED:19};C.AutoRegistrationModeToString={
BT:function(A9){var Vo=A9;var NF=A.jV;switch(Vo){case 0:NF=A.aaR(A.acf.Bik);break;
case 1:NF=A.aaR(A.acf.Bj6);break;case 2:NF=A.aaR(A.acf.Off);break;default:throw new
Error(AZR+Vo.toFixed());}return NF;},_Init:function(aArg){C.EnumToString._Init.call(
...
A5:0,Abs:function(){var Aw=A._NewObject(C.AssessmentFilterCriterion,0);Aw.E$(this
...
},_className:"Device::AssessmentFilterCriterion"};C.D9={AdW:0,Temperature:1,Afy:
...
};C.UInt64FilterCriterion={A5:0,Abs:function(){var Aw=A._NewObject(C.UInt64FilterCriterion
,0);Aw.E$(this);return Aw;},E$:function(AI){C.FilterCriterion.E$.call(this,AI);var
...
acf.BhJ);default:return AyC+A9.toFixed();}},_Init:function(aArg){C.EnumToString.
_Init.call(this,aArg);this.__proto__=C.BooleanToAssignedUnassignedString;},_className:
"Device::BooleanToAssignedUnassignedString"};C.C9={UNDEFINED:0,AT:1,BA:2,BE:3,BDI:
4,BDX:5,BDY:6,BDZ:7,BD0:8,BD1:9,BD$:10,BEa:11,BEk:12,BEl:13,BEA:14,FR:15,GR:16,BEM:
17,BEN:18,BEU:19,BEV:20,BE0:21,BE1:22,BE2:23,BE3:24,BE9:25,BFl:26,BFm:27,BFB:28,
BFC:29,BFT:30,BFU:31,BGa:32,BGb:33,BGc:34,BGq:35,BGr:36,BGL:37,Bam:38,BGM:39,LAST:
40};C.CountryToString={BT:function(A9){var Kc=A9;var FH=A.jV;switch(Kc){case 1:FH=
A.aaR(A.acm.BhU);break;case 2:FH=A.aaR(A.acm.Bh7);break;case 3:FH=A.aaR(A.acm.Bh1
);break;case 4:FH=A.aaR(A.acm.Bh9);break;case 5:FH=A.aaR(A.acm.Bia);break;case 6:
FH=A.aaR(A.acm.Bqj);break;case 7:FH=A.aaR(A.acm.Bid);break;case 8:FH=A.aaR(A.acm.
Bit);break;case 9:FH=A.aaR(A.acm.Biu);break;case 10:FH=A.aaR(A.acm.Bjv);break;case
11:FH=A.aaR(A.acm.BiB);break;case 12:FH=A.aaR(A.acm.Bja);break;case 13:FH=A.aaR(
A.acm.BpO);break;case 14:FH=A.aaR(A.acm.Bjj);break;case 15:FH=A.aaR(A.acm.Bjr);break;
case 16:FH=A.aaR(A.acm.BjX);break;case 17:FH=A.aaR(A.acm.Bir);break;case 18:FH=A.
aaR(A.acm.Bj3);break;case 19:FH=A.aaR(A.acm.Bka);break;case 20:FH=A.aaR(A.acm.Bkm
);break;case 21:FH=A.aaR(A.acm.Bko);break;case 22:FH=A.aaR(A.acm.Bkz);break;case
23:FH=A.aaR(A.acm.BkD);break;case 24:FH=A.aaR(A.acm.Bkw);break;case 25:FH=A.aaR(
A.acm.BkF);break;case 26:FH=A.aaR(A.acm.BkV);break;case 27:FH=A.aaR(A.acm.Bk2);break;
case 28:FH=A.aaR(A.acm.BoK);break;case 29:FH=A.aaR(A.acm.BoL);break;case 30:FH=A.
aaR(A.acm.Bpd);break;case 31:FH=A.aaR(A.acm.Bpf);break;case 32:FH=A.aaR(A.acm.Bqi
);break;case 33:FH=A.aaR(A.acm.BpN);break;case 34:FH=A.aaR(A.acm.BpM);break;case
35:FH=A.aaR(A.acm.BqI);break;case 36:FH=A.aaR(A.acm.Bqs);break;case 37:FH=A.aaR(
A.acm.BqM);break;case 38:FH=A.aaR(A.acm.Bam);break;case 39:FH=A.aaR(A.acm.BqL);break;
case 0:FH=AoB;break;default:throw new Error(Aoo+Kc.toFixed());}return FH;},LA:function(
A9){var Kc=A9;var BN=A.jV;switch(Kc){case 1:BN=Te;break;case 2:BN=Aab;break;case
3:BN=U0;break;case 4:BN=Xe;break;case 5:BN=Ix;break;case 6:BN=Aal;break;case 7:BN=
U1;break;case 8:BN=Aad;break;case 9:BN=Xf;break;case 10:BN=Pa;break;case 11:BN=Aae;
break;case 12:BN=Aaf;break;case 13:BN=Aak;break;case 14:BN=U3;break;case 15:BN=Xg;
break;case 16:BN=Aag;break;case 17:BN=U2;break;case 18:BN=Oi;break;case 19:BN=Rp;
break;case 20:BN=Xh;break;case 21:BN=Xi;break;case 22:BN=Xj;break;case 23:BN=Aah;
break;case 24:BN=Tf;break;case 25:BN=Xk;break;case 26:BN=Xl;break;case 27:BN=Tg;
break;case 28:BN=Th;break;case 29:BN=Ti;break;case 30:BN=Aai;break;case 31:BN=Tj;
break;case 32:BN=Xm;break;case 33:BN=AfE;break;case 34:BN=Aaj;break;case 35:BN=Xn;
break;case 36:BN=Aac;break;case 37:BN=AhX;break;case 38:BN=K4;break;case 39:BN=AcQ;
...
10,LAST:11};C.WhereAboutsToString={BT:function(A9){var Bhx=A9;var Aa0=A.jV;switch(
Bhx){case 0:Aa0=A.aaR(A.acf.Unknown);break;case 1:Aa0=A.aaR(A.acf.BqV);break;case
2:Aa0=A.aaR(A.acf.BqU);break;case 3:Aa0=A.aaR(A.acf.Bq3);break;case 4:Aa0=A.aaR(
A.acf.Bq2);break;case 5:Aa0=A.aaR(A.acf.Bq0);break;case 6:Aa0=A.aaR(A.acf.BqX);break;
case 7:Aa0=A.aaR(A.acf.BqZ);break;case 8:Aa0=A.aaR(A.acf.BqY);break;case 9:Aa0=A.
aaR(A.acf.BqW);break;case 10:Aa0=A.aaR(A.acf.Bq1);break;default:throw new Error(
AZU+Bhx.toFixed());}return Aa0;},_Init:function(aArg){C.EnumToString._Init.call(
...
"Device::BreedToString"};C.TQ={timer:null,Q:null,Ec:0,Dx:0,JX:0,Py:1000,PH:1000,
...
JX=E;},Fq:function(E){if(E<100)E=100;this.Py=E;},Ux:function(E){if(E<0)E=0;this.
...
acl.Aek);A.zV([this,this.Mm],this.timer,0);this.Ec=-1;}},_Init:function(aArg){this.
__proto__=C.TQ;A.h7++;},_Done:function(){this.__proto__=null;A.h7--;},_ReInit:function(
...
};C.Io={AnimalId:0,TransponderId:1,BFa:2,BE$:3,BFd:4,BFc:5};C.Au$={BDG:0,BEd:1};
C.AnimalIdGenerationMethodToString={BT:function(A9){var Aly=A9;var Ao4=A.jV;switch(
Aly){case 0:Ao4=A.aaR(A.acf.Uo);break;case 1:Ao4=A.aaR(A.acf.Transponder);break;
...
A.h7++;},_Done:function(){this.__proto__=null;A.h7--;},_ReInit:function(){},_Mark:
function(D){var B;if((B=this.I)&&(B._cycle!=D))B._Mark(B._cycle=D);},I:null,_cycle:
0,_observers:null,_className:"Device::EnumToIcon"};C.Aej={AsS:function(A9){return A.
...
function(aArg){C.EnumToIcon._Init.call(this,aArg);this.__proto__=C.Aej;},_className:
"Device::DirectionOfCountingToIcon"};C.Ad0={AsS:function(A9){return A.aaL(A.ach.
...
_Init.call(this,aArg);this.__proto__=C.Ad0;},_className:"Device::AnimalIdGenerationMethodToIcon"
...
Bp=A9;var GF=A.jV;switch(Bp){case 1:GF=A.aaR(A.acp.Bpg);break;case 2:GF=A.aaR(A.
acp.AO_);break;case 3:GF=A.aaR(A.acp.AR_);break;case 4:GF=A.aaR(A.acp.AO9);break;
case 5:GF=A.aaR(A.acp.BkS);break;case 6:GF=A.aaR(A.acp.HE);break;case 7:GF=A.aaR(
A.acp.BoU);break;case 8:GF=A.aaR(A.acp.BhX);break;case 9:GF=A.aaR(A.acp.AM3);break;
case 10:GF=A.aaR(A.acp.AUQ);break;case 11:GF=A.aaR(A.acp.BE);break;case 12:GF=A.
aaR(A.acp.BB);break;case 13:GF=A.aaR(A.acp.BkE);break;case 14:GF=A.aaR(A.acp.AUR
);break;case 15:GF=A.aaR(A.acp.AUS);break;case 16:GF=A.aaR(A.acp.AVt);break;case
0:GF=AoB;break;default:throw new Error(Alm+Bp.toFixed());}return GF;},Bqx:function(
...
},Bqy:function(A9){var Bp=A9;var Gj=A.jV;switch(Bp){case 1:Gj=AyN;break;case 2:Gj=
...
AIg;break;case 11:Gj=U0;break;case 12:Gj=AZ7;break;case 13:Gj=AZ8;break;case 14:
...
LA:function(A9){var Vo=A9;var NF=A.jV;switch(Vo){case 0:NF=AZ$;break;case 1:NF=A0a;
break;default:throw new Error(AIO+Vo.toFixed());}return NF;},BT:function(A9){var
Vo=A9;var NF=A.jV;switch(Vo){case 0:NF=A.aaR(A.acf.BoD);break;case 1:NF=A.aaR(A.
acf.BqK);break;default:throw new Error(AIO+Vo.toFixed());}return NF;},_Init:function(
aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=C.EartagNrAssignmentModeToString;
},_className:"Device::EartagNrAssignmentModeToString"};C.BDz={BFr:0,BFh:1,BEu:2,
BEv:3,BEw:4,BGs:5};C.EnumToCodeset={AmK:function(Ah7){throw new Error(A0b+Ah7.toFixed(
));},Aem:function(A9){throw new Error(Atc+A9.toFixed());},Aq2:function(){A.ab5("%s"
...
Bv=0;}return Bv;},Aem:function(A9){var Bv=A9;var BM=0;switch(Bv){case 0:BM=0;break;
...
};C.ReasonOfLeaving={Unknown:0,A$6:1,RU:2,A$s:3,A7J:4,BFA:5,Ban:6,A8f:7,A58:8,A$o:
9,A8d:10,A6a:11,BFQ:12,BFR:13,LAST:14};C.ReasonOfLeavingToString={BT:function(A9
){var AdG=A9;var Tz=A.jV;switch(AdG){case 0:Tz=A.aaR(A.acf.Unknown);break;case 1:
Tz=A.aaR(A.acf.A$6);break;case 2:Tz=A.aaR(A.acf.RU);break;case 3:Tz=A.aaR(A.acf.
A$s);break;case 4:Tz=A.aaR(A.acf.A7J);break;case 5:Tz=A.aaR(A.acf.BoE);break;case
6:Tz=A.aaR(A.acf.Ban);break;case 7:Tz=A.aaR(A.acf.A8f);break;case 8:Tz=A.aaR(A.acf.
A58);break;case 9:Tz=A.aaR(A.acf.A$o);break;case 10:Tz=A.aaR(A.acf.A8d);break;case
11:Tz=A.aaR(A.acf.A6a);break;case 12:Tz=A.aaR(A.acf.BoP);break;case 13:Tz=A.aaR(
A.acf.BoO);break;default:throw new Error(A0d+AdG.toFixed());}return Tz;},_Init:function(
...
break;default:Pn=0;}return Pn;},Aem:function(A9){var Pn=A9;var Jo=0;switch(Pn){case
...
};C.K3={AmK:function(Ah7){var Ld;switch(Ah7){case 1:Ld=1;break;case 2:Ld=2;break;
...
},Aem:function(A9){var Ld=A9;var Jo=0;switch(Ld){case 0:Jo=0;break;case 2:Jo=2;break;
...
default:throw new Error(AyO+Ld.toFixed());}return Jo;},Aq2:function(){return 0;}
...
Jt=AH.OG();if(Jt<0)A.ab5("%s",Xp);else{if(this.Am$())this.CI=AH.YO();AH.HB(this.
...
this.Deregistrations===E)return;this.Deregistrations=E;A.abo([this,this.Bls,this.
AwJ],0);},AwI:function(E){if(this.Deaths===E)return;this.Deaths=E;A.abo([this,this.
Blq,this.AwI],0);},AkH:function(E){if(this.Year===E)return;this.Year=E;A.abo([this
,this.ArL,this.AkH],0);},Bls:function(){return this.Deregistrations;},Blq:function(
...
3,BaG:4,BEO:5,BF3:6,BGE:7,BE_:8,BD2:9,BDo:10,A66:11,A$A:12,BGO:13,A8i:14,BGR:15};
C.DeviceComponentToString={BT:function(A9){var Bdw=A9;var Qq=A.jV;switch(Bdw){case
0:Qq=A0e;break;case 10:Qq=A.aaR(A.acf.Bhy);break;case 9:Qq=A.aaR(A.acf.Bic);break;
case 1:Qq=A.aaR(A.acf.Bi2);break;case 11:Qq=A.aaR(A.acf.A66);break;case 5:Qq=A.aaR(
A.acf.Bq4);break;case 8:Qq=A.aaR(A.acf.Bi4);break;case 14:Qq=A.aaR(A.acf.A8i);break;
case 2:Qq=A.aaR(A.acf.A$y);break;case 12:Qq=A.aaR(A.acf.A$A);break;case 6:Qq=A.aaR(
A.acf.BoT);break;case 3:Qq=A.aaR(A.acf.A$L);break;case 7:Qq=A.aaR(A.acf.Bi5);break;
case 13:Qq=A.aaR(A.acf.BiE);break;case 15:Qq=A.aaR(A.acf.Bq8);break;case 4:Qq=A.
...
},Aem:function(A9){return A9;},Aq2:function(){return 0;},H8:function(){return 4;
},_Init:function(aArg){C.EnumToCodeset._Init.call(this,aArg);this.__proto__=C.AgV;
},_className:"Device::EaseOfDeliveryToCodeset"};C.AeW={AsS:function(A9){return A.
...
C.AeW;},_className:"Device::MotherSelectionFilterModeToIcon"};C.WhereAboutsFilterCriterion={
A5:0,Abs:function(){var Aw=A._NewObject(C.WhereAboutsFilterCriterion,0);Aw.E$(this
...
},_className:"Device::WhereAboutsFilterCriterion"};C.BFk={AOa:0,BD9:1,APV:2,LAST:
3};C.BGu={GL:0,AV_:1,Hm:2,Year:3,LAST:4};C.TimespanDaysToString={BT:function(A9){
...
},_className:"Device::TimespanDaysToString"};C.Z8={BFx:0,BEe:1,BEQ:2,BET:3,BES:4
,BEf:5,BER:6,LAST:7};C.USBStateToString={BT:function(A9){var Bhs=A9;var Bp=A.jV;
switch(Bhs){case 0:Bp=Atq;break;case 2:Bp=AyP;break;case 1:Bp=AyQ;break;case 5:Bp=
A0h;break;case 3:Bp=A0i;break;case 4:Bp=A0j;break;case 6:Bp=AIQ;break;default:throw new
Error(AH$+Bhs.toFixed());}return Bp;},_Init:function(aArg){C.EnumToString._Init.
call(this,aArg);this.__proto__=C.USBStateToString;},_className:"Device::USBStateToString"
};C.AgP={BEP:0,BDA:1,BFS:2};C.AxN={ACG:A.jV,Timestamp:0,AEt:0,AEy:0,AGI:0,OnSetTimestamp:
...
};C.AqA={Undefined:0,BEF:1,BDO:2};C.AgC={Manual:0,TransponderId:1,LAST:2};C.AnimalIdAutoGenerationMethodToString={
...
,ACO:12,LAST:13};C.MonthToString={BT:function(A9){var BeL=A9;var XL=A.jV;switch(
BeL){case 1:XL=A.aaR(A.act.AEi);break;case 2:XL=A.aaR(A.act.AC3);break;case 3:XL=
A.aaR(A.act.AEu);break;case 4:XL=A.aaR(A.act.AB4);break;case 5:XL=A.aaR(A.act.AEw
);break;case 6:XL=A.aaR(A.act.AEk);break;case 7:XL=A.aaR(A.act.AEj);break;case 8:
XL=A.aaR(A.act.AB$);break;case 9:XL=A.aaR(A.act.AGQ);break;case 10:XL=A.aaR(A.act.
AEJ);break;case 11:XL=A.aaR(A.act.AEH);break;case 12:XL=A.aaR(A.act.ACO);break;default:
throw new Error(Aln+BeL.toFixed());}return XL;},_Init:function(aArg){C.EnumToString.
_Init.call(this,aArg);this.__proto__=C.MonthToString;},_className:"Device::MonthToString"
};C.V1={FileName:A.jV,AGK:0,EN:0,AgP:0,AVf:false,E7:function(){this.E5(0);this.AgP=
1;this.FileName=A.jV;this.AGK=0;this.AVf=false;},E5:function(E){if(this.EN===E)return;
this.EN=E;A.abo([this,this.SK,this.E5],0);},SK:function(){return this.EN;},_Init:
function(aArg){this.__proto__=C.V1;A.h7++;},_Done:function(){this.__proto__=null;
A.h7--;},_ReInit:function(){},_Mark:function(D){var B;if((B=this.I)&&(B._cycle!=
...
};C.BFn={BFq:0,BFe:1,BD8:2,BGP:3,Unknown:4};C.BDM={None:0,BFy:1,BFs:2,BFo:3,BFp:
4};C.BGJ={A8x:0,Manual:1,TransponderId:2,NaisId:3,LAST:4};C.TransponderLinkageIdChangeMethodToString={
...
ABC=A.aaR(A.acf.BiC);break;default:throw new Error(A0k+Bha.toFixed());}return ABC;
...
AoP){var Js=A.ab0(A.abV(AoP,15),0,10);var Kc=A._GetAutoObject(C.Converter).S8(Js
);if(!!Kc){if(Kc===10){if((((AoP.length!==16)||!A._GetAutoObject(A.acj.VN).AV1(AoP
...
).S8(A._GetAutoObject(C.Device).OZ);if(!!Kc&&(Kc===10)){if(!A._GetAutoObject(A.acj.
VN).AV1(AoP))return 0;if(AoP.length===12){var Bc2=A.ab0(A.abV(AoP,10),0,10);var AKr=
...
function(JI){if(!((JI.length===8)||((JI.length===10)&&A._GetAutoObject(A.acj.VN).
...
ALb,0,10);}if((Az$<1)||(Az$>12))return 0;AA4.Uz(Az$);var ALa;var Az_;if(A4t){ALa=
A.abW(JI,6,2);Az_=A.wz(ALa,0,10);}else{ALa=A.abV(JI,2);Az_=A.wz(ALa,0,10);}if((Az_<
1)||(Az_>AA4.Zu()))return 0;AA4.Lv(Az_);return AA4.JY();},_Init:function(aArg){this.
...
},_this:null};C.AnimalTableFieldsToString={BT:function(A9){var Aaw=A9;var MY=A.jV;
switch(Aaw){case 14:MY=A.aaR(A.acf.Afw);break;case 32:MY=A.aaR(A.acf.Breed);break;
case 4:MY=A.aaR(A.acf.Aeh);break;case 28:MY=A.aaR(A.acf.A54);break;case 33:MY=A.
aaR(A.acf.AgM);break;case 23:MY=A.aaR(A.acf.KP);break;case 7:MY=A.aaR(A.acf.Afr);
break;case 2:MY=A.aaR(A.acf.P);break;case 0:MY=A.aaR(A.acf.GN);break;case 8:MY=A.
aaR(A.acf.Alarm);break;case 9:MY=A.aaR(A.acf.ACz);break;case 38:MY=A.aaR(A.acf.Bi3
);break;case 11:MY=A.aaR(A.acf.Fever);break;case 29:MY=A.aaR(A.acf.ARL);break;case
18:MY=A.aaR(A.acf.Nc);break;case 26:MY=A.aaR(A.acf.Uo);break;case 22:MY=A.aaR(A.
acf.Transponder);break;case 1:MY=A.aaR(A.acf.GI);break;case 34:MY=A.aaR(A.acf.Jm
...
MY=A.jV;break;default:throw new Error(A0l+A9.toFixed());}return MY;},_Init:function(
aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=C.AnimalTableFieldsToString;
},_className:"Device::AnimalTableFieldsToString"};C.AEr={Bg:0,BGm:1,LAST:2};C.ListViewScopeToString={
BT:function(A9){var BAB=A9;var A3a=A.jV;switch(BAB){case 0:A3a=A.aaR(A.acf.Bg);break;
case 1:A3a=A.aaR(A.acf.BpK);break;default:throw new Error(A0m+A9.toFixed());}return A3a;
},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=C.ListViewScopeToString;
},_className:"Device::ListViewScopeToString"};C.AHA={BHg:0,BHf:1,BHe:2,LAST:3};C.
WeightValuePrecisionToString={BT:function(A9){var BDk=A9;var ALO=A.jV;switch(BDk
...
A9;if(ALj===1)return A.aaR(A.acf.BjZ);else return C.AnimalTypeToString.BT.call(this
,A9);},_Init:function(aArg){C.AnimalTypeToString._Init.call(this,aArg);this.__proto__=
C.AgH;},_className:"Device::AnimalTypeToStringHeifer"};C.Wt={RU:0,BFu:1,LAST:2};
C.MassDeregistrationCriterionToString={BT:function(A9){var BAE=A9;var A3f=A.jV;switch(
BAE){case 0:A3f=A.aaR(A.acf.Bk5);break;case 1:A3f=A.aaR(A.acf.ASv);break;default:
...
A.jV,Zs:0,OK:0,Abs:function(){var Aw=A._NewObject(C.UInt64PartialFilterCriterion
,0);Aw.E$(this);return Aw;},E$:function(AI){C.FilterCriterion.E$.call(this,AI);var
...
EJ=A4;this.Operator=Eb;this.A5=A8;this.YQ=Qi;this.Zs=AtC;this.OK=AJi;return this;
},_Init:function(aArg){C.FilterCriterion._Init.call(this,aArg);this.__proto__=C.
UInt64PartialFilterCriterion;},_className:"Device::UInt64PartialFilterCriterion"
};C.BEb={Idle:0,BFZ:1,BF_:2,BGp:3,Error:4};C.AV0={Asr:0,AsY:0,Z8:0,AT9:function(
E){if(this.Z8===E)return;this.Z8=E;A.abo([this,this.Bmc,this.AT9],0);},AT$:function(
E){if(this.AsY===E)return;this.AsY=E;A.abo([this,this.Bme,this.AT$],0);},ATL:function(
E){if(this.Asr===E)return;this.Asr=E;A.abo([this,this.BlQ,this.ATL],0);},Bmc:function(
){return this.Z8;},Bme:function(){return this.AsY;},BlQ:function(){return this.Asr;
...
C.DirectionOfCountingToString.__proto__=C.EnumToString;C.Aej.__proto__=C.EnumToIcon;
C.Ad0.__proto__=C.EnumToIcon;C.GermanStateToString.__proto__=C.EnumToString;C.EartagNrAssignmentModeToString.
__proto__=C.EnumToString;C.Na.__proto__=C.EnumToCodeset;C.ReasonOfLeavingToString.
__proto__=C.EnumToString;C.AhD.__proto__=C.EnumToCodeset;C.K3.__proto__=C.EnumToCodeset;
C.CalfDeregistrations.__proto__=C.Row;C.DeviceComponentToString.__proto__=C.EnumToString;
C.AgV.__proto__=C.EnumToCodeset;C.AeW.__proto__=C.EnumToIcon;C.WhereAboutsFilterCriterion.
