...
var AW_="Listenansicht";var AW$="Einzelansicht";var AXa="Unhandled list view scope: ";
...
AL;if(!this.B7)this.B7=AL;},AMB:function(){return this.B7;},AMF:function(A_k){if(
!!A_k)return A_k.Af;return null;},D0:function(AG_,EE){var Av=this.B7;while(!!Av){
...
Ku===AI)return;this.Ku=AI;A.aat([this,this.ACy,this.A9A],0);},Yy:function(E){if(
this.K&&this.K.Yy)return this.K.Yy.apply(this,arguments);else return C.DeviceClass.
BqC.apply(this,arguments);},BqC:function(E){},A9A:function(An){this.Yy(An);},UpdateBatteryChargeState:
...
ScanState=AI;A.aat([this,this.AQr,this.AXF],0);A._GetAutoObject(C.Helper).BwL(this
...
,GS);},AXF:function(An){this.AqD(An);},UpdateMeasureState:function(AI){if(this.MeasureState===
...
Brb.apply(this,arguments);},Brb:function(E){},A9P:function(An){this.AmH(An);},Avs:
...
);else return C.DeviceClass.BqT.apply(this,arguments);},BqT:function(E){},A9I:function(
...
E){},AXy:function(An){this.ADt(An);},UpdateMonitoring:function(AI){if(this.ACk===
AI)return;this.ACk=AI;A.aat([this,this.AQh,this.AXy],0);},UpdateDataTable:function(
A_l){var B;switch(A_l){case 0:A.ow([B=this.Ao,B.Aju],this);break;case 1:A.ow([B=
...
,A_l);}},Av0:function(){if(this.K&&this.K.Av0)return this.K.Av0.apply(this,arguments
...
AI;A.aat([this,this.A5A,this.A9I],0);},SetSystemTime:function(Aho){if(this.K&&this.
...
,arguments);},A9o:function(){},BkP:function(){},UpdateOverlayMenu:function(AI){if(
...
E){},A9Y:function(An){this.Avx(An);},UpdateUnderTemp:function(AI){if(this.Y$===AI
)return;this.Y$=AI;A.aat([this,this.A59,this.A9Y],0);},UpdateSyncState:function(
AI){if(this.SyncState===AI)return;this.SyncState=AI;A.aat([this,this.AQt,this.AXH
...
,N1);},AXH:function(An){this.Abm(An);},AA_:function(){if(this.K&&this.K.AA_)return this.
K.AA_.apply(this,arguments);else return C.DeviceClass.Bqu.apply(this,arguments);
},Bqu:function(){return A.jm;},UpdatePopup:function(Kn,AYo,AYk,AYr){this.A5(Kn,AYo
,AYk,AYr,[this,this.Bwt]);},PopupStateChanged:function(Kn,Ae){if(this.K&&this.K.
...
BrQ.apply(this,arguments);},BrQ:function(E){},A9Z:function(An){this.ADW(An);},UpdateVibrationOnKeypressEnabled:
...
An){this.Ad8(An);},UpdateVibrationOn:function(A_N){if(this.AS3===A_N)return;this.
AS3=A_N;A.aat([this,this.ACJ,this.AGU],0);},A5:function(Kn,AYo,AYk,AYr,BtC){var Afy=
A._NewObject(C.PopupContext,0);Afy.Id=Kn;Afy.Show=AYo;Afy.AjP=AYk;Afy.Aj_=AYr;Afy.
...
Brx.apply(this,arguments);},Brx:function(E){},AXE:function(An){this.Avo(An);},UpdateRatingMode:
function(AI){if(this.RatingMode===AI)return;this.RatingMode=AI;A.aat([this,this.
AQq,this.AXE],0);},Ad0:function(E){if(this.K&&this.K.Ad0)return this.K.Ad0.apply(
this,arguments);else return C.DeviceClass.Bq5.apply(this,arguments);},Bq5:function(
E){},ArT:function(An){this.Ad0(An);},UpdateFlashLightOn:function(A_t){if(this.AlV===
A_t)return;this.AlV=A_t;A.aat([this,this.Ap$,this.ArT],0);},YI:function(E){if(this.
K&&this.K.YI)return this.K.YI.apply(this,arguments);else return C.DeviceClass.BrI.
apply(this,arguments);},BrI:function(E){},AXI:function(An){this.YI(An);},UpdateTopLightOn:
function(A_I){if(this.ASN===A_I)return;this.ASN=A_I;A.aat([this,this.AQv,this.AXI
...
An){this.Abk(An);},UpdateRGBTopLight:function(A_D){if(this.ARF===A_D)return;this.
ARF=A_D;A.aat([this,this.BhF,this.Bsr],0);},AuU:function(E){if(this.K&&this.K.AuU
...
A_h;A.aat([this,this.Bg6,this.Bsj],0);},AqE:function(E){if(this.K&&this.K.AqE)return this.
K.AqE.apply(this,arguments);else return C.DeviceClass.Brz.apply(this,arguments);
},Brz:function(E){A.aa8("%s",CJ);},AXG:function(An){this.AqE(An);},UpdateScanTransponder:
function(Kn,A_L,A_K){if(((this.PD.Id===Kn)&&(this.PD.TransponderType===A_L))&&(this.
PD.TransponderProtocol===A_K))return;this.PD.OnSetId(Kn);this.PD.ARi(A_L);this.PD.
ARh(A_K);A.aat([this,this.AQs,this.AXG],0);},Pz:function(E){if(this.K&&this.K.Pz
...
A_p){if(this.FP===A_p)return;this.FP=A_p;A.aat([this,this.Aa9,this.AbU],0);},Qx:
...
Qx(An);},UpdateOffsetID:function(A_A){if(this.Fx===A_A)return;this.Fx=A_A;A.aat([
...
else return C.DeviceClass.Bre.apply(this,arguments);},Bre:function(E){},AXx:function(
An){this.Avf(An);},UpdateMassUnit:function(AI){if(this.MassUnit===AI)return;this.
MassUnit=AI;A.aat([this,this.AQg,this.AXx],0);},Aqf:function(E){if(this.K&&this.
...
function(AI){if(this.P7===AI)return;this.P7=AI;A.aat([this,this.A5k,this.A9x],0);
},UpdateActiveActionsOrder:function(AI){if(this.As$===AI)return;this.As$=AI;A.aat([
this,this.AP4,this.AXq],0);},Abb:function(E){if(this.K&&this.K.Abb)return this.K.
Abb.apply(this,arguments);else return C.DeviceClass.A9m.apply(this,arguments);},
A9m:function(E){},A9G:function(An){this.Abb(An);},UpdateAutoActions:function(AI){
...
E){},A94:function(An){this.Avy(An);},UpdateWeightRecordingMode:function(A_P){if(
...
E){A.aa8("%s",Nb);},AXC:function(An){this.ADB(An);},UpdatePredictedTempValue:function(
AI){if(this.AEa===AI)return;this.AEa=AI;A.aat([this,this.AQn,this.AXC],0);},Se:function(
...
else return C.DeviceClass.BqD.apply(this,arguments);},BqD:function(E){},A9B:function(
An){this.ACO(An);},UpdateAgeRegistration:function(A_z){if(this.Ait===A_z)return;
this.Ait=A_z;A.aat([this,this.A5p,this.A9B],0);},Avz:function(E){if(this.K&&this.
K.Avz)return this.K.Avz.apply(this,arguments);else return C.DeviceClass.BrW.apply(
this,arguments);},BrW:function(E){},A95:function(An){this.Avz(An);},UpdateWeightRecordingScope:
...
,Bq9:function(E){},AXw:function(An){this.JM(An);},UpdateGender:function(LY){if(this.
...
else return C.DeviceClass.BqE.apply(this,arguments);},BqE:function(E){},A9C:function(
An){this.ACQ(An);},UpdateAlarmListAction:function(AI){if(this.AJ6===AI)return;this.
AJ6=AI;A.aat([this,this.A5r,this.A9C],0);},AC8:function(E){if(this.K&&this.K.AC8
)return this.K.AC8.apply(this,arguments);else return C.DeviceClass.Bq4.apply(this
,arguments);},Bq4:function(E){},A9L:function(An){this.AC8(An);},UpdateFlashLightInMeasureState:
function(A_u){if(this.AlU===A_u)return;this.AlU=A_u;A.aat([this,this.A5D,this.A9L
],0);},AdY:function(E){if(this.K&&this.K.AdY)return this.K.AdY.apply(this,arguments
);else return C.DeviceClass.BqH.apply(this,arguments);},BqH:function(E){},AXs:function(
An){this.AdY(An);},UpdateAnimalInfoContent:function(AI){if(this.D3===AI)return;this.
D3=AI;A.aat([this,this.AP6,this.AXs],0);},ADZ:function(E){if(this.K&&this.K.ADZ)
return this.K.ADZ.apply(this,arguments);else return C.DeviceClass.BrR.apply(this
,arguments);},BrR:function(E){},A90:function(An){this.ADZ(An);},UpdateWatchListAction:
function(AI){if(this.AS5===AI)return;this.AS5=AI;A.aat([this,this.A6c,this.A90],
0);},AC9:function(E){if(this.K&&this.K.AC9)return this.K.AC9.apply(this,arguments
);else return C.DeviceClass.Bq6.apply(this,arguments);},Bq6:function(E){},A9N:function(
An){this.AC9(An);},UpdateFreshCowListAction:function(AI){if(this.AMs===AI)return;
this.AMs=AI;A.aat([this,this.A5F,this.A9N],0);},AqZ:function(H){if(this.K&&this.
K.AqZ)return this.K.AqZ.apply(this,arguments);else return C.DeviceClass.Br1.apply(
this,arguments);},Br1:function(H){},BBP:function(s){this.AqZ(s);},Aq1:function(H
){if(this.K&&this.K.Aq1)return this.K.Aq1.apply(this,arguments);else return C.DeviceClass.
Br3.apply(this,arguments);},Br3:function(H){},BBR:function(s){this.Aq1(s);},AuS:
function(E){if(this.K&&this.K.AuS)return this.K.AuS.apply(this,arguments);else return C.
DeviceClass.BqL.apply(this,arguments);},BqL:function(E){},A9E:function(An){this.
AuS(An);},AqF:function(E){if(this.K&&this.K.AqF)return this.K.AqF.apply(this,arguments
);else return C.DeviceClass.BrG.apply(this,arguments);},BrG:function(E){},A9V:function(
...
},Br4:function(H){},BBS:function(s){this.Aq3(s);},UpdateTemperaturesLowString:function(
...
},Brr:function(E){},AXA:function(An){this.ADw(An);},UpdateNoTransponderListAction:
function(AI){if(this.APT===AI)return;this.APT=AI;A.aat([this,this.AQk,this.AXA],
...
this.AlY=AI;A.aat([this,this.Bhn,this.Bsn],0);},Aqz:function(E){if(this.K&&this.
K.Aqz)return this.K.Aqz.apply(this,arguments);else return C.DeviceClass.Bro.apply(
this,arguments);},Bro:function(E){},A9S:function(An){this.Aqz(An);},UpdateNaisIdLastUsedMale:
function(Ws){if(this.ACm===Ws)return;this.ACm=Ws;A.aat([this,this.A5S,this.A9S],
0);},Aqy:function(E){if(this.K&&this.K.Aqy)return this.K.Aqy.apply(this,arguments
);else return C.DeviceClass.Brn.apply(this,arguments);},Brn:function(E){},A9R:function(
An){this.Aqy(An);},UpdateNaisIdLastUsedFemale:function(Ws){if(this.ACl===Ws)return;
this.ACl=Ws;A.aat([this,this.A5R,this.A9R],0);},Avk:function(E){if(this.K&&this.
...
return C.DeviceClass.A9r.apply(this,arguments);},A9r:function(){},AmD:function(E
){if(this.K&&this.K.AmD)return this.K.AmD.apply(this,arguments);else return C.DeviceClass.
BqQ.apply(this,arguments);},BqQ:function(E){},A9H:function(An){this.AmD(An);},UpdateBootloaderMessage:
...
);else return C.DeviceClass.Bqy.apply(this,arguments);},Bqy:function(E){},A9w:function(
An){this.ACM(An);},UpdateActionListAction:function(AI){if(this.AzK===AI)return;this.
AzK=AI;A.aat([this,this.A5j,this.A9w],0);},AuQ:function(E){if(this.K&&this.K.AuQ
...
function(AI){if(this.Alx===AI)return;this.Alx=AI;A.aat([this,this.Bg2,this.Bsh],
...
An){this.TA(An);},UpdateAnimalIdGenerationMethod:function(A_U){if(this.Ia===A_U)
return;this.Ia=A_U;A.aat([this,this.Amu,this.Anx],0);},Au4:function(E){if(this.K&&
this.K.Au4)return this.K.Au4.apply(this,arguments);else return C.DeviceClass.BqY.
apply(this,arguments);},BqY:function(E){},AXu:function(An){this.Au4(An);},UpdateDirectionOfCountingFemale:
function(Akq){if(this.AAG===Akq)return;this.AAG=Akq;A.aat([this,this.AP$,this.AXu
],0);},Au5:function(E){if(this.K&&this.K.Au5)return this.K.Au5.apply(this,arguments
);else return C.DeviceClass.BqZ.apply(this,arguments);},BqZ:function(E){},AXv:function(
An){this.Au5(An);},UpdateDirectionOfCountingMale:function(Akq){if(this.AAH===Akq
)return;this.AAH=Akq;A.aat([this,this.AQa,this.AXv],0);},Au6:function(E){if(this.
...
,arguments);},Brp:function(E){},AXz:function(An){this.AqA(An);},UpdateNaisIdLastUsedUnisex:
function(Ws){if(this.Aux===Ws)return;this.Aux=Ws;A.aat([this,this.AQi,this.AXz],
...
ADs(AYh);this.R3.ADE(AYn);this.R3.AC3(AX7);A.aat([this,this.BhA,this.Bsp],0);},ADk:
...
ADk(An);},UpdateMainboardVersions:function(PO,AYe,AYf,AYd,AYt,AYu,AYs){this.Qs.OnSetTimestamp(
PO);this.Qs.ADi(AYe);this.Qs.ADj(AYf);this.Qs.ADh(AYd);this.Qs.ADR(AYt);this.Qs.
ADS(AYu);this.Qs.ADQ(AYs);A.aat([this,this.Bhy,this.Bso],0);},ADT:function(E){if(
...
AYs);A.aat([this,this.BhX,this.Bsv],0);},ACT:function(E){if(this.K&&this.K.ACT)return this.
...
this.Rt.ADE(AYn);this.Rt.AC3(AX7);A.aat([this,this.Bg8,this.Bsk],0);},AC6:function(
E){if(this.K&&this.K.AC6)return this.K.AC6.apply(this,arguments);else return C.DeviceClass.
Bq1.apply(this,arguments);},Bq1:function(E){},A9K:function(An){this.AC6(An);},UpdateDryCowListAction:
function(AI){if(this.ALO===AI)return;this.ALO=AI;A.aat([this,this.A5B,this.A9K],
0);},AHL:function(AX9){if(this.K&&this.K.AHL)return this.K.AHL.apply(this,arguments
);else return C.DeviceClass.BsH.apply(this,arguments);},BsH:function(AX9){return false;
},ADv:function(E){if(this.K&&this.K.ADv)return this.K.ADv.apply(this,arguments);
else return C.DeviceClass.Brq.apply(this,arguments);},Brq:function(E){},A9T:function(
An){this.ADv(An);},UpdateNoNaisIdListAction:function(AI){if(this.APO===AI)return;
this.APO=AI;A.aat([this,this.A5T,this.A9T],0);},ACS:function(E){if(this.K&&this.
...
this,this.AQw,this.AXJ],0);},ADU:function(E){if(this.K&&this.K.ADU)return this.K.
ADU.apply(this,arguments);else return C.DeviceClass.BrK.apply(this,arguments);},
BrK:function(E){A.aa8("%s",OL);},AXJ:function(An){this.ADU(An);},UpdateTransferTarget:
...
this,arguments);else return C.DeviceClass.Brv.apply(this,arguments);},Brv:function(
E){},AXD:function(An){this.Avn(An);},UpdatePremisesID:function(QY){if(this.YK===
QY)return;this.YK=QY;A.aat([this,this.AQo,this.AXD],0);},Avi:function(E){if(this.
...
);else return C.DeviceClass.Bq7.apply(this,arguments);},Bq7:function(E){},A9O:function(
...
Akc===A_M)return;this.Akc=A_M;A.aat([this,this.Aa$,this.AbW],0);},ADV:function(E
...
AgX=AI;A.aat([this,this.BhL,this.Bss],0);},AuR:function(E){if(this.K&&this.K.AuR
)return this.K.AuR.apply(this,arguments);else return C.DeviceClass.BqF.apply(this
,arguments);},BqF:function(E){},AXr:function(An){this.AuR(An);},UpdateAnimalIdAutoGenerationMethod:
function(A_T){if(this.AfK===A_T)return;this.AfK=A_T;A.aat([this,this.AP5,this.AXr
...
BrB.apply(this,arguments);},BrB:function(E){},A9U:function(An){this.ADJ(An);},UpdateShutdownTimer:
function(AI){if(this.ASk===AI)return;this.ASk=AI;A.aat([this,this.A51,this.A9U],
0);},Aqm:function(E){if(this.K&&this.K.Aqm)return this.K.Aqm.apply(this,arguments
);else return C.DeviceClass.BqJ.apply(this,arguments);},BqJ:function(E){},A9D:function(
An){this.Aqm(An);},UpdateAnimalListInfoItemMode:function(AI){if(this.AlC===AI)return;
this.AlC=AI;A.aat([this,this.A5s,this.A9D],0);},Aq4:function(H){if(this.K&&this.
K.Aq4)return this.K.Aq4.apply(this,arguments);else return C.DeviceClass.Br5.apply(
this,arguments);},Br5:function(H){},BBT:function(s){this.Aq4(s);},AqK:function(E
){if(this.K&&this.K.AqK)return this.K.AqK.apply(this,arguments);else return C.DeviceClass.
BrT.apply(this,arguments);},BrT:function(E){},A92:function(An){this.AqK(An);},AqL:
function(E){if(this.K&&this.K.AqL)return this.K.AqL.apply(this,arguments);else return C.
DeviceClass.BrU.apply(this,arguments);},BrU:function(E){},A93:function(An){this.
...
if(this.AFf===AI)return;this.AFf=AI;A.aat([this,this.A6e,this.A92],0);},AuT:function(
E){if(this.K&&this.K.AuT)return this.K.AuT.apply(this,arguments);else return C.DeviceClass.
BqM.apply(this,arguments);},BqM:function(E){},A9F:function(An){this.AuT(An);},UpdateAnimalTypesWeightGainsString:
function(AI){if(this.AzS===AI)return;this.AzS=AI;A.aat([this,this.A5v,this.A9F],
0);},AqJ:function(E){if(this.K&&this.K.AqJ)return this.K.AqJ.apply(this,arguments
);else return C.DeviceClass.BrS.apply(this,arguments);},BrS:function(E){},A91:function(
...
this.AAO=Ee;A.aat([this,this.Bhg,this.Bsm],0);},UpdateStartScreen:function(AI){if(
this.Av1===AI)return;this.Av1=AI;A.aat([this,this.BhN,this.Bst],0);},Avq:function(
...
this,arguments);},Brf:function(E){},A9Q:function(An){this.ADp(An);},UpdateMaximumAgeNewOnFarm:
function(AI){if(this.ACd===AI)return;this.ACd=AI;A.aat([this,this.A5Q,this.A9Q],
0);},Avw:function(E){if(this.K&&this.K.Avw)return this.K.Avw.apply(this,arguments
);else return C.DeviceClass.BrM.apply(this,arguments);},BrM:function(E){},AXK:function(
An){this.Avw(An);},UpdateTransponderAssignmentIdChangeMethod:function(A_J){if(this.
Ag6===A_J)return;this.Ag6=A_J;A.aat([this,this.AQx,this.AXK],0);},BatchResetPurchasedNoticePending:
...
},BqV:function(E){},AXt:function(An){this.AC4(An);},UpdateDataExportDestination:
function(AI){if(this.U4===AI)return;this.U4=AI;A.aat([this,this.AP_,this.AXt],0);
},BjE:function(E){},UpdateMassRecordingAutomatic:function(AI){if(this.APn===AI)return;
this.APn=AI;A.aat([this,this.Bhz,this.BjE],0);},M7:function(E){if(this.K&&this.K.
...
this,arguments);},BqB:function(E){},A9z:function(An){this.Aqj(An);},UpdateActiveMassRecordingFields:
function(AI){if(this.AzL===AI)return;this.AzL=AI;A.aat([this,this.A5l,this.A9y],
0);},UpdateActiveMassRecordingFieldsOrder:function(AI){if(this.AzM===AI)return;this.
AzM=AI;A.aat([this,this.A5m,this.A9z],0);},Aq0:function(H){if(this.K&&this.K.Aq0
)return this.K.Aq0.apply(this,arguments);else return C.DeviceClass.Br2.apply(this
,arguments);},Br2:function(H){},BBQ:function(s){this.Aq0(s);},ADn:function(E){if(
...
function(AI){if(this.Aus===AI)return;this.Aus=AI;A.aat([this,this.A5P,this.ADm],
...
},Aqc:function(){return this.TemperatureUnit;},A5A:function(){return this.AKW;},
AQh:function(){return this.ACk;},ACH:function(){return this.OverlayMenu;},A59:function(
){return this.Y$;},AQt:function(){return this.SyncState;},A5_:function(){return this.
Arq;},ACJ:function(){return this.AS3;},AQq:function(){return this.RatingMode;},Ap$:
function(){return this.AlV;},AQv:function(){return this.ASN;},BhF:function(){return this.
ARF;},Bg6:function(){return this.AutoRegistrationMode;},AQs:function(){return this.
PD;},Aa9:function(){return this.FP;},Aa_:function(){return this.Fx;},ACK:function(
){return this.IK;},AQg:function(){return this.MassUnit;},A5k:function(){return this.
P7;},AP4:function(){return this.As$;},A5w:function(){return this.AutoActions;},Py:
function(){return this.AnimalType;},A6g:function(){return this.WeightRecordingMode;
},AQn:function(){return this.AEa;},ACC:function(){return this.Hv;},A5p:function(
){return this.Ait;},A6h:function(){return this.WeightRecordingScope;},VJ:function(
){return this.Gender;},AuI:function(){return this.ApJ;},AuH:function(){return this.
ApI;},ACz:function(){return this.JD;},A5r:function(){return this.AJ6;},A5D:function(
){return this.AlU;},AP6:function(){return this.D3;},A6c:function(){return this.AS5;
},A5F:function(){return this.AMs;},A5u:function(){return this.AzR;},A54:function(
){return this.AEX;},A55:function(){return this.AEY;},AQk:function(){return this.
APT;},Bhn:function(){return this.AlY;},A5S:function(){return this.ACm;},A5R:function(
){return this.ACl;},AuL:function(){return this.APB;},AuK:function(){return this.
APA;},A5z:function(){return this.Ape;},A5j:function(){return this.AzK;},Bg2:function(
...
Breed;},BhA:function(){return this.R3;},Bhy:function(){return this.Qs;},BhX:function(
){return this.Sj;},Bg8:function(){return this.Rt;},A5B:function(){return this.ALO;
},A5T:function(){return this.APO;},ACA:function(){return this.Apc;},AQw:function(
){return this.Av7;},A58:function(){return this.AeC;},AQo:function(){return this.
YK;},ACG:function(){return this.Aa5;},A5G:function(){return this.Apy;},Aa$:function(
){return this.Akc;},BhL:function(){return this.AgX;},AP5:function(){return this.
AfK;},A51:function(){return this.ASk;},A5s:function(){return this.AlC;},A6e:function(
){return this.AFf;},A6f:function(){return this.AFg;},A5v:function(){return this.
AzS;},A6d:function(){return this.AFe;},A6i:function(){return this.AFi;},Bhg:function(
){return this.AAO;},BhN:function(){return this.Av1;},A5Q:function(){return this.
ACd;},AQx:function(){return this.Ag6;},AP_:function(){return this.U4;},Bhz:function(
){return this.APn;},AuO:function(){return this.WhereAbouts;},A5l:function(){return this.
AzL;},A5m:function(){return this.AzM;},ACD:function(){return this.AdM;},A5P:function(
...
Core.A8f._Init.call(this.AmS={I:this},0);C.Table._Init.call(this.Pa={I:this},0);
...
ConverterClass={MQ:null,Aj8:function(AnH){var A$r;var AsY=this.ASD(AnH/100,0,A._GetAutoObject(
C.Device).TemperatureUnit);A$r=A.aap(AsY,0,1);return A$r;},A8o:function(Ne){if(Ne<=
...
B;},Bd5:function(ArY){var Dk;switch(ArY){case 36:Dk=ON;break;case 40:Dk=Ss;break;
...
C.Device).MassUnit){case 0:if(BvK)AkL=A.aaq(N5,0,0);else{var BaJ=N5<0;if(AnX<3)N5=
N5+(((BaJ?-1:1)*5)*(Math.pow(10,2-AnX)|0));AkL=(((((B=N5)>-2147483648)?Math.abs(
B):B)/1000)|0).toFixed();if(AnX>0)AkL=AkL+(Li+A.aaX(A.aaq((((B=N5)>-2147483648)?
Math.abs(B):B)%1000,3,10),AnX));if(BaJ)AkL=Ag$+AkL;}break;case 1:AkL=A.aap(N5/453.592
,0,AnX);break;default:A.aa8("%s%s",Anf,A._GetAutoObject(C.Device).MassUnit.toFixed(
));}return AkL;},TY:function(L1){var A1x=L1.toFixed();var BcS=A1x.length;if((BcS>=
14)&&(BcS<=15)){var AZD=this.Av9(L1);var BuC=A._GetAutoObject(C.Converter).Bd5(AZD
);A1x=(BuC+N2)+A.aar(A._GetAutoObject(C.Helper).U8(L1,0,12),12,10);}return A1x;}
...
}}},A2e:function(Bt$){switch(Bt$){case 0:return A.zW(A.abi.At$);case 1:return A.
...
AHs.toFixed());}},Bdp:function(Axl){switch(Axl){case 0:return A.zW(A.abi.ABL);case
3:return A.zW(A.abi.Al8);case 1:return A.zW(A.abi.AaL);case 2:return A._GetAutoObject(
A.abk.DM).A$P();default:throw new Error(Ahb+Axl.toFixed());}},Bd4:function(ArY){
...
return Awk;default:return A.z2(A.abg.Unknown);}},Ben:function(Ab4){switch(Ab4){case
...
9:return 0x2792;case 10:return 0x2793;default:return 0x20;}},Bmc:function(L1){if(
!L1)return-1;return(L1%100000000)|0;},BeS:function(AnG,aFilter){var B;if(!aFilter
)return AeR;var An8=Arw;var Av=aFilter.AMB();while(!!Av){An8=An8+A._GetAutoObject(
C.Helper).A3X(AnG,Av);Av=aFilter.AMF(Av);if(!!Av)An8=An8+OP;}An8=An8+Sv;return An8;
...
case 7:Mz=35;break;case 16:Mz=37;break;default:A.aa8("%s%e",Awl,A_v);}return Mz;
},Bdo:function(Axl){switch(Axl){case 0:return 1;case 3:return 0;case 1:return 2;
...
default:throw new Error(Ahb+Axl.toFixed());}},Bdq:function(AnO){switch(AnO){case
...
this.Av9(L1);return this.ALs(AZD);},Av9:function(L1){return A._GetAutoObject(C.Helper
).U8(L1,12,3)|0;},A8G:function(AnL,Ee){if(AnL<A._GetAutoObject(C.Helper).ABc(Ee)
...
Error(((Arx+AHf.toFixed())+Awm)+AHg.toFixed());},A3I:function(EE){switch(EE){case
...
}},A2H:function(Ab2){return this.MQ.Adk(Ab2);},BfA:function(Ab2){return this.MQ.
AlL(Ab2);},BdO:function(ArX){var Ayw=0;switch(ArX){case 0:Ayw=1;break;case 1:Ayw=
2;break;case 2:Ayw=3;break;case 3:Ayw=4;break;default:A.aa8("%s%e",KI,ArX);}return Ayw;
},Aiu:function(AX1,Ee){if(AX1>=A._GetAutoObject(C.Helper).A3T(Ee))return 3;else if(
...
AF.CE(Ab,3));this.R8(AF.Hy(Ab,4));this.JM(AF.AMD(Ab,7));this.Ajy(AF.Be$(Ab,6));this.
...
AF.A35(Ab,5));this.AQT(AF.IW(Ab,17));this.TD(AF.HV(Ab,11));this.ARb(AF.Hy(Ab,16)
...
));this.Aqx(AF.HV(Ab,38));this.NP(AF.Bfa(Ab,32));this.AjB(AF.Bfd(Ab,33));this.AmK(
AF.LD(Ab,35));this.M7(AF.AMM(Ab,34));this.Ad3(AF.HV(Ab,37));this.ADC(AF.Bfn(Ab,36
...
Bk9(this.CH,7,this.Gender);AF.Bk5(this.CH,6,this.BirthType);AF.Bk3(this.CH,14,this.
...
IsDry);AF.Bk7(this.CH,32,this.Breed);AF.Bk8(this.CH,33,this.EaseOfDelivery);AF.TO(
this.CH,35,this.NaisIdMother);AF.Bld(this.CH,34,this.WhereAbouts);AF.M_(this.CH,
37,this.IsRegistrationNoticePending);AF.Blb(this.CH,36,this.ReasonOfLeaving);Hs=
...
},Abg:function(E){if(this.GroupId===E)return;this.GroupId=E;A.aat([this,this.Bho
...
this.LocationId===E)return;this.LocationId=E;A.aat([this,this.A5O,this.AmI],0);}
...
E;A.aat([this,this.A5I,this.Ad1],0);},AjG:function(E){if(this.IsControl===E)return;
this.IsControl=E;A.aat([this,this.Bhr,this.AjG],0);},AgG:function(E){if(this.IsRegistered===
E)return;this.IsRegistered=E;A.aat([this,this.Bhu,this.AgG],0);},Ad4:function(E){
if(this.IsWatch===E)return;this.IsWatch=E;A.aat([this,this.A5K,this.Ad4],0);},AvA:
function(E){if(this.WorstAssessment===E)return;this.WorstAssessment=E;A.aat([this
,this.A6j,this.AvA],0);},TD:function(E){if(this.IsFever===E)return;this.IsFever=
E;A.aat([this,this.A5J,this.TD],0);},ARd:function(E){if(this.TimestampLastControl===
E)return;this.TimestampLastControl=E;A.aat([this,this.BhU,this.ARd],0);},Avv:function(
E){if(this.TimestampLastWatch===E)return;this.TimestampLastWatch=E;A.aat([this,this.
BhW,this.Avv],0);},AQT:function(E){if(this.LastRatingTemperature===E)return;this.
LastRatingTemperature=E;A.aat([this,this.Bhx,this.AQT],0);},ARb:function(E){if(this.
TimestampExpirationFeverAlarm===E)return;this.TimestampExpirationFeverAlarm=E;A.
aat([this,this.BhS,this.ARb],0);},Avt:function(E){if(this.TimestampAlarm===E)return;
this.TimestampAlarm=E;A.aat([this,this.BhR,this.Avt],0);},DV:function(E){if(this.
...
E;A.aat([this,this.A57,this.ADM],0);},M6:function(E){if(this.TransponderId===E)return;
...
this.TimestampFirstWeighing);if(((SG.Year===AZq.Year)&&(SG.Aa8()===AZq.Aa8()))&&(
...
Bhm,this.AQK],0);},AmZ:function(A_S){this.Ad1(A_S);if(A_S){if(!this.TimestampAlarm
...
A_O){this.Ad4(A_O);if(A_O){if(!this.TimestampLastWatch)this.Avv(A._GetAutoObject(
C.Helper).DB());}else this.Avv(0);},Au1:function(E){if(this.DateOfLastCalving===
E)return;this.DateOfLastCalving=E;A.aat([this,this.Bhc,this.Au1],0);},Avd:function(
E){if(this.LactationNumber===E)return;this.LactationNumber=E;A.aat([this,this.Bhw
,this.Avd],0);},Avc:function(E){if(this.IsPerished===E)return;this.IsPerished=E;
A.aat([this,this.Bht,this.Avc],0);},ARe:function(E){if(this.TimestampLastTemperature===
E)return;this.TimestampLastTemperature=E;A.aat([this,this.BhV,this.ARe],0);},ARc:
function(E){if(this.TimestampLastAssessment===E)return;this.TimestampLastAssessment=
E;A.aat([this,this.BhT,this.ARc],0);},NP:function(E){if(this.Breed===E)return;this.
...
this.ReasonOfLeaving=E;A.aat([this,this.BhH,this.ADC],0);},Ad3:function(E){if(this.
IsRegistrationNoticePending===E)return;this.IsRegistrationNoticePending=E;A.aat([
this,this.Bhv,this.Ad3],0);},Aqx:function(E){if(this.IsDry===E)return;this.IsDry=
E;A.aat([this,this.Bhs,this.Aqx],0);},Qv:function(){return this.Id;},Aqd:function(
){return this.VisualId;},Bho:function(){return this.GroupId;},AuD:function(){return this.
...
},A5I:function(){return this.IsAlarm;},Bhr:function(){return this.IsControl;},Bhu:
function(){return this.IsRegistered;},A5K:function(){return this.IsWatch;},A6j:function(
){return this.WorstAssessment;},A5J:function(){return this.IsFever;},BhU:function(
){return this.TimestampLastControl;},BhW:function(){return this.TimestampLastWatch;
},Bhx:function(){return this.LastRatingTemperature;},BhS:function(){return this.
TimestampExpirationFeverAlarm;},BhR:function(){return this.TimestampAlarm;},Py:function(
...
},Bhm:function(){return this.FirstBodyWeightId;},Amy:function(){return this.NaisId;
},Bhc:function(){return this.DateOfLastCalving;},Bhw:function(){return this.LactationNumber;
},Bht:function(){return this.IsPerished;},BhV:function(){return this.TimestampLastTemperature;
},BhT:function(){return this.TimestampLastAssessment;},AuB:function(){return this.
Breed;},AQb:function(){return this.EaseOfDelivery;},AuO:function(){return this.WhereAbouts;
},AQj:function(){return this.NaisIdMother;},BhH:function(){return this.ReasonOfLeaving;
},Bhv:function(){return this.IsRegistrationNoticePending;},Bhs:function(){return this.
...
OnSetTemperature(AF.A35(Ab,7));this.OnSetBodyWeight(AF.AA8(Ab,8));this.OnSetRatingTemperature(
...
,this.Respiratory);AF.AjZ(this.CH,5,this.Faeces);AF.A71(this.CH,7,this.Temperature
...
E;A.aat([this,this.BhQ,this.OnSetTemperature],0);},OnSetId:function(E){if(this.Id===
E)return;this.Id=E;A.aat([this,this.Qv,this.OnSetId],0);},OnSetAnimalId:function(
E){if(this.AnimalId===E)return;this.AnimalId=E;A.aat([this,this.Bg3,this.OnSetAnimalId
],0);},OnSetFeed:function(E){if(this.Feed===E)return;this.Feed=E;A.aat([this,this.
Bhj,this.OnSetFeed],0);},OnSetAppearance:function(E){if(this.Appearance===E)return;
this.Appearance=E;A.aat([this,this.Bg4,this.OnSetAppearance],0);},OnSetRespiratory:
function(E){if(this.Respiratory===E)return;this.Respiratory=E;A.aat([this,this.BhI
,this.OnSetRespiratory],0);},OnSetFaeces:function(E){if(this.Faeces===E)return;this.
Faeces=E;A.aat([this,this.Bhh,this.OnSetFaeces],0);},OnSetTimestamp:function(E){
if(this.Timestamp===E)return;this.Timestamp=E;A.aat([this,this.A56,this.OnSetTimestamp
],0);},Bk4:function(Nf,A1){switch(Nf){case 2:this.OnSetAppearance(A1);break;case
1:this.OnSetFeed(A1);break;case 4:this.OnSetFaeces(A1);break;case 3:this.OnSetRespiratory(
A1);break;default:;}},Be9:function(Nf){switch(Nf){case 2:return this.Appearance;
...
E)return;this.RatingTemperature=E;A.aat([this,this.BhG,this.OnSetRatingTemperature
],0);},OnSetBodyWeight:function(E){if(this.BodyWeight===E)return;this.BodyWeight=
E;A.aat([this,this.Bg7,this.OnSetBodyWeight],0);},BhQ:function(){return this.Temperature;
},Qv:function(){return this.Id;},Bg3:function(){return this.AnimalId;},Bhj:function(
){return this.Feed;},Bg4:function(){return this.Appearance;},BhI:function(){return this.
Respiratory;},Bhh:function(){return this.Faeces;},A56:function(){return this.Timestamp;
},BhG:function(){return this.RatingTemperature;},Bg7:function(){return this.BodyWeight;
...
A5W,this.ADF],0);},BwL:function(H){switch(A._GetAutoObject(C.Device).ScanState){
...
,arguments);},A9n:function(E){A.aat([this,this.Ud,this.Ue],0);A._GetAutoObject(C.
...
1);this.V.G9();A.vv(this.V,0);},A4I:function(L1){if(!L1){A.aa8("%s%U",ATq,L1);return false;
...
z2(A.abg.BkL);case 12:return A.z2(A.abg.AqN);case 29:return A.z2(A.abg.AO_);case
18:return A.z2(A.abg.Weighing);case 17:return ATr;case 5:return A.z2(A.abg.Temperature
);case 3:return A.z2(A.abg.Bgd);case 26:return A.z2(A.abg.Yr);case 35:return A.z2(
...
jm;},A3X:function(AnG,AL){var result=A.jm;if(!!AL){result=this.Al1(AnG,AL.ET);result=((
...
AL)?AL:null).A4);}else A.aa8("%s",ATz);}return result;},NV:function(aString,A_B,
Bts){var result=A.jm;var Bb_=false;var index=0;var Btu=A_B.length;while(!Bb_){var
A0Y=aString.indexOf(A_B,index);if(A0Y!==-1){result=(result+A.aaY(aString,index,A0Y-
index))+Bts;index=A0Y+Btu;}else{var A_F=aString.length;if(index<A_F)result=result+
A.aa4(aString,A_F-index);Bb_=true;}}return result;},AQ4:function(E){this.AR0=E;A.
aat([this,this.BhJ,this.AQ4],0);},AQ5:function(E){this.AR1=E;A.aat([this,this.BhK
,this.AQ5],0);},Bab:function(){return((A._GetAutoObject(C.Device).ScanState===2)&&
!!A._GetAutoObject(C.Device).PD)&&(A._GetAutoObject(C.Device).PD.TransponderType===
1);},Afj:function(H){if(!this.V.Amb()&&!!this.V.Id)this.Bgc(this.V.Id);},AtY:function(
Ee){return A._GetAutoObject(C.Helper).TS.Get(Ee);},A3T:function(Ee){return A._GetAutoObject(
C.Helper).TR.Get(Ee);},A31:function(){var P=0;var min=32767;while(P<A._GetAutoObject(
...
C.Device).Ao,0);},AOT:function(DW){if(!DW)return false;var BfM=(((this.Ax8(DW.Faeces
)||this.Ax8(DW.Feed))||this.Ax8(DW.Appearance))||this.Ax8(DW.Respiratory))||this.
Ax8(DW.RatingTemperature);return BfM||this.A4u(DW);},Ax8:function(A_f){return(A_f===
2)||(A_f===1);},A4u:function(DW){return!!DW&&(DW.Temperature>A._GetAutoObject(C.
Helper).AtY(A._GetAutoObject(C.Helper).V.AnimalType));},HY:function(L0){var AZ2=
...
Device).Se(-1);this.V.G9();A.vv(this.V,0);}return AZ2;},Ag2:function(Ahk){var B;
return(((B=(this.Aq.A$N()|0))<0)?B+0x100000000:B)-this.Atu(Ahk);},Arf:function(){
var B;A.ow([B=this.Kr,B.Av2],this);},BxT:function(H){A._GetAutoObject(C.Device).
A5(16,false,AbS,0,null);A._GetAutoObject(C.Device).A5(5,true,A.jm,0,null);},Bkf:
function(H){var Ar=(C.PopupContext.isPrototypeOf(H)?H:null);if(!!Ar&&(Ar.PopupState===
5))this.Arf();},Bj5:function(E){if(this.AES===E)return;this.AES=E;A._GetAutoObject(
C.Device).A5(16,true,this.AES.toFixed(),0,[this,this.Bkf]);},ME:function(Bs4,BtJ
){var D2;var BcF=A._NewObject(A.Core.Am7,0);var Gp=A._NewObject(A.Core.Bu,0);var
KV=A._NewObject(A.Core.Bu,0);Gp.Initialize(Bs4);KV.Initialize(BtJ);D2=KV.Bem(Gp);
BcF.Initialize2(0,D2.ABy,D2.ACj,D2.AEt);if(Gp.J(BcF).Gt===Gp.Gt)return D2.J9;else
...
).Ao.Bk(A._GetAutoObject(C.Device).Ao.Filter);}},AI8:function(H){var Bdt=A._GetAutoObject(
C.Helper).AtY(A._GetAutoObject(C.Helper).V.AnimalType);var Bdn=A._GetAutoObject(
C.Helper).A3T(A._GetAutoObject(C.Helper).V.AnimalType);var AsX=A.aaC(Bdt-100,Bdn+
100);this.A$s(AsX);},Atu:function(Ahk){return Ahk*86400;},Aka:function(Kn){var B;
...
AYb,A_H,AG$,Ee){var B;var AoK;if((AYb<650000)&&(A_H<this.DB())){var A_4=this.AfQ.
At0(Ee);var A_3=0;if(A_4>=0)A_3=this.AeI.Get(A_4);AoK=AYb+(this.ME(A_H,this.DB()
)*A_3);if(AG$>0){var AY_=this.Ay0(AG$);AoK=(Math.trunc(((((B=AoK)<0)?B+0x10000000000000000:
...
C.Converter).A8o(Ao6);},AvQ:function(DW,Ne){if(!!DW){DW.OnSetFaeces(Ne);DW.OnSetFeed(
Ne);DW.OnSetAppearance(Ne);DW.OnSetRespiratory(Ne);}},Be7:function(AF,AHe,Ab_,Wt
...
Ahk){var B;var Gp=A._NewObject(A.Core.Bu,0);var BcE=A._NewObject(A.Core.Am7,0);Gp.
Initialize(A._GetAutoObject(C.Converter).Ag4());BcE.Initialize2(Ahk,0,0,0);Gp=Gp.
Blv(BcE);return((B=(Gp.JL()|0))<0)?B+0x100000000:B;},A3U:function(AF,Ab_,AeY,Wt){
...
AEg(AnV)){AY2=A._GetAutoObject(C.Helper).ABd(AnV);L2.Set(AY2,L2.Get(AY2)+1);}}AF.
Bk(Aov);return L2;},AZy:function(AF,Ab_,BuN){if(!AF)throw new Error(ArA);var Bb=
...
).WeightRecordingScope)return true;else return false;},Be8:function(AF,AHe,Ab_,Wt
,AeY){if(!AF)throw new Error(ArA);var Bb=A._NewObject(C.Filter,0);var Aov=AF.Filter;
var N6=A._NewObject(C.Int32FilterCriterion,0);N6.Operator=0;N6.ET=1;N6.A4=Ab_;Bb.
C0(N6);if(Wt>0){var Oj=A._NewObject(C.UInt32FilterCriterion,0);Oj.Operator=2;Oj.
ET=6;Oj.A4=Wt;Bb.C0(Oj);}if(AeY>0){var N$=A._NewObject(C.UInt32FilterCriterion,0
...
0);Gp.AmJ(0);Gp.AmM(0);return((B=(Gp.JL()|0))<0)?B+0x100000000:B;},Be_:function(
BxS,BuY,Aln,AkM){var A$n=A._GetAutoObject(C.Helper).ME(BxS,BuY);if(A$n>0)return((
AkM-Aln)/A$n)|0;return 0;},Bl6:function(Bs5,BtK){var Gp=A._NewObject(A.Core.Bu,0
);var KV=A._NewObject(A.Core.Bu,0);Gp.Initialize(Bs5);KV.Initialize(BtK);return(
Gp.Year===KV.Year)&&(Gp.Aa8()===KV.Aa8());},A3Z:function(){var Bb=A._GetAutoObject(
C.Helper).MX();var Bao=A._NewObject(C.UInt32FilterCriterion,0);var BtT=A._GetAutoObject(
C.Helper).Y0(A._GetAutoObject(C.Device).Apy)-1;Bao.Initialize(28,2,BtT,true);Bb.
C0(Bao);var Ui=A._NewObject(C.AnimalTypeFilterCriterion,0);Ui.Initialize(14,0,1,
true);Bb.C0(Ui);if(A._GetAutoObject(C.Device).AlY){var Ayl=A._NewObject(C.UInt32FilterCriterion
,0);var AZX=A._GetAutoObject(C.Helper).DB()-21600;Ayl.Initialize(30,3,AZX,true);
Bb.C0(Ayl);}return Bb;},BkO:function(){var Jg=A._GetAutoObject(C.Device).Ao.Op();
...
C.Device).Pa.Or(Jg);}},Bgc:function(Ab_){var A9=A._GetAutoObject(C.Device).Ao.K4(
...
C.Helper).DB()-BuV,Sz);return Acl;},BkN:function(aFilter){var AL=aFilter.D0(30,3
);if(!!AL)aFilter.QD(AL);AL=aFilter.D0(31,3);if(!!AL)aFilter.QD(AL);AL=aFilter.D0(
19,3);if(!!AL)aFilter.QD(AL);},AYT:function(Ae7,Axa,AF){if(AF.K8())return 5;if(Ae7.
...
);}return GE;},A8v:function(Akr,LY,BsR,A_j,Btn){var B;var PY=null;var WF=null;switch(
Akr){case 0:{PY=[B=A._GetAutoObject(C.Device),B.AQi,B.AXz];WF=[B=A._GetAutoObject(
C.Device),B.AuM,B.Aw7];}break;case 1:switch(LY){case 1:{PY=[B=A._GetAutoObject(C.
Device),B.A5R,B.A9R];WF=[B=A._GetAutoObject(C.Device),B.AuK,B.Aw5];}break;case 0:{
PY=[B=A._GetAutoObject(C.Device),B.A5S,B.A9S];WF=[B=A._GetAutoObject(C.Device),B.
AuL,B.Aw6];}break;case 2:{PY=[B=A._GetAutoObject(C.Device),B.AQi,B.AXz];WF=[B=A.
...
PY[0],BsR);if((WF[1].call(WF[0])>0)&&(A_j<Btn))PY[2].call(PY[0],PY[1].call(PY[0]
)+WF[1].call(WF[0]));else if((WF[1].call(WF[0])<0)&&(A_j>0))PY[2].call(PY[0],PY[
...
throw new Error(AFu+Akr.toFixed());}},BfN:function(QZ,Eu){var result=false;switch(
...
);}return result;},AIp:function(Eu,A_e,Axa,Ar7,Ae1){switch(A_e){case 2:if(Ar7<=0
...
0:break;default:throw new Error(ATA+A_e.toFixed());}},A$R:function(A_q,LY){var B;
var Ayp=null;switch(A_q){case 0:Ayp=[B=A._GetAutoObject(C.Device),B.AuM,B.Aw7];break;
...
throw new Error(ATB+A_q.toFixed());}return Ayp;},A39:function(PO,BtA){var ZV=A._NewObject(
...
},A$s:function(BtS){var B;if(A._GetAutoObject(C.Device).MeasureState===1){this.Sh.
Cv=A._GetAutoObject(C.Device).Y$;this.Sh.B0=BtS;this.Sh.AEN(this);}},AA4:function(
){var Bb=this.AMz();var Bad=A._NewObject(C.BoolFilterCriterion,0);Bad.Initialize(
38,0,true,true);Bb.C0(Bad);return Bb;},A3S:function(JU){var Bb=A._GetAutoObject(
C.Helper).MX();if(A._GetAutoObject(C.Device).Alx){var AZB=A._GetAutoObject(C.Helper
).AMA(JU,21600,true);Bb.C0(AZB);}return Bb;},A33:function(){var Bb=A._GetAutoObject(
C.Helper).MX();var BaD=A._NewObject(C.UInt64FilterCriterion,0);BaD.Initialize(26
...
B:null);if(!!Ayv)Bb.QD(Ayv);var BbS=A._NewObject(C.BoolFilterCriterion,0);BbS.Initialize(
37,0,true,true);Bb.C0(BbS);return Bb;},U8:function(A1,Btt,AYc){var B;A1=Math.trunc(
A1/this.Ay0(Btt));A1%=this.Ay0(AYc);return A1;},Ay0:function(A_r){switch(A_r){case
...
case 15:return 1000000000000000;default:throw new Error(ATC+A_r.toFixed());}},MX:
function(){var Bb=A._NewObject(C.Filter,0);var Bcc=A._NewObject(C.BoolFilterCriterion
,0);Bcc.Initialize(10,0,true,true);Bb.C0(Bcc);var Ayv=A._NewObject(C.WhereAboutsFilterCriterion
...
1,true);Bb.C0(Ui);return Bb;},ABa:function(){var B;var A1o;var N8=this.Bfo();A1o=(((
...
).U8(A._GetAutoObject(C.Device).YK,10,2)*this.Ay0(8);A1o+=Bvh;}return A1o;},Bfo:
function(){var N8=0;if(A._GetAutoObject(C.Device).YK>0)N8=A._GetAutoObject(C.Converter
).AeF(A._GetAutoObject(C.Device).YK);if(!N8)N8=A._GetAutoObject(C.Converter).A4A(
...
default:throw new Error(ATD+Ae2.toFixed());}},Bdl:function(QZ,Eu){var GE=0;switch(
...
ATE+QZ.toFixed());}return GE;},BeW:function(){var B;var Ax6=(((((((A.z2(A.abg.AgX
)+A.z2(A.abg.Colon))+OQ)+A._GetAutoObject(C.Device).AgX)+Awy)+A.z2(A.abg.Bkv))+A.
z2(A.abg.Colon))+OQ)+A._GetAutoObject(A.abk.K1).BeU(((B=A._GetAutoObject(C.Device
).Qs.Timestamp)<0)?B+0x100000000:B);return Ax6;},BeX:function(){var B;var Ax6=((((((((((((((((((((((((((((
...
OQ)+ATH)+A._GetAutoObject(C.Helper).Bfr())+OP)+A._GetAutoObject(C.Device).GetCommitHash(
))+OP)+A._GetAutoObject(C.Device).GetCommitCount().toFixed())+OP)+A._GetAutoObject(
A.abk.K1).AiZ(A._GetAutoObject(C.Device).GetCommitEpoch());return Ax6;},BeV:function(
...
).Qs.APi.toFixed())+OQ)+A.z2(A.abg.A3L))+A.z2(A.abg.Colon))+N2)+A._GetAutoObject(
...
abg.A3L))+A.z2(A.abg.Colon))+N2)+A._GetAutoObject(A.abk.K1).AiZ(((B=A._GetAutoObject(
C.Device).Sj.Timestamp)<0)?B+0x100000000:B);return Ax6;},A34:function(AYc){var B;
var P;var Ay5=A.jm;for(P=1;P<=AYc;P=P+1)if(!!A.aaC(0,2))Ay5=Ay5+String.fromCharCode(
A.aaC(97,104)&0xFFFF);else Ay5=Ay5+String.fromCharCode(A.aaC(48,57)&0xFFFF);return Ay5;
},Aax:function(Ee){var Axq=0;if(Ee===1)Ee=0;var A_9=this.AfQ.At0(Ee);if(A_9>=0)Axq=
this.AeL.Get(A_9);return Axq;},ABc:function(Ee){var FK=0;var AzD=this.AfQ.At0(Ee
);if(AzD>=0)FK=this.AeK.Get(AzD);return FK;},ABb:function(Ee){var FK=0;var AzD=this.
AfQ.At0(Ee);if(AzD>=0)FK=this.AeJ.Get(AzD);return FK;},A3W:function(){var Bb=this.
...
C.Converter).ALs(BN))return 2;else return 3;},A38:function(){var Bb=A._GetAutoObject(
C.Helper).AMG();var Aku=A._GetAutoObject(C.Helper).Be6(3,A._GetAutoObject(C.Device
).ACd);Aku.AaQ=true;Bb.C0(Aku);return Bb;},Be6:function(EE,A_d){var Av=A._NewObject(
C.UInt32FilterCriterion,0);Av.ET=4;switch(EE){case 2:{Av.Operator=3;Av.A4=A._GetAutoObject(
C.Helper).Y0(A_d);}break;case 3:{Av.Operator=2;Av.A4=A._GetAutoObject(C.Helper).
Y0(A_d-1);}break;default:A.aa8("%s%e",ATK,EE);}return Av;},Bfr:function(){return(((
...
);},Bdm:function(QZ,Eu){var GE=0;switch(QZ){case 0:GE=Eu.VisualId;break;case 2:GE=
...
}return GE;},A8w:function(){var B;var IP=null;var SI=0;if(!A._GetAutoObject(C.Device
...
V.VisualId+1);break;default:;}},A4y:function(Ws,Eu){return(Eu.NaisId!==Ws)&&this.
AOW(Ws);},BfW:function(L1,Eu){return(Eu.TransponderId!==L1)&&this.AOY(L1);},AMy:
function(){var Bb=A._GetAutoObject(C.Helper).A36();var Ayn=A._NewObject(C.UInt64FilterCriterion
,0);Ayn.Initialize(35,5,0,true);Bb.C0(Ayn);return Bb;},AMI:function(){var Bb=A._GetAutoObject(
C.Helper).A36();var Ayn=A._NewObject(C.UInt64FilterCriterion,0);Ayn.Initialize(35
,0,0,true);Bb.C0(Ayn);return Bb;},Mw:function(AX5,Ahj){AX5.Ai(Ahj);AX5.Ap(Ahj);AX5.
X(Ahj);},A2X:function(Ahl){var B;var Z;var A0c=false;var Wz=Ahl.U9(null,0x1);while(
!!Wz&&(((B=Wz)?B.__proto__:null)!==A.Core.Y)){Z=(A.kh.Ck.isPrototypeOf(Wz)?Wz:null
);if(!!Z){Z.Be(A0c);A0c=!A0c;}Wz=Ahl.U9(Wz,0x1);}},Aqb:function(){return this.TN;
},A5W:function(){return this.AgU;},BhJ:function(){return this.AR0;},BhK:function(
){return this.AR1;},BhO:function(){return this.AES;},_Init:function(aArg){C.AlS.
...
100);this.Kr.R5=[this,this.BxT];this.Kr.Q=[this,this.BhO,this.Bj5];this.Sh.R5=[this
...
default:Bt=this.Bl7(A6);}return Bt;},Bl7:function(A6){var AH3=A6;var Bt=A.jm;switch(
...
){var BbO=A6;var Oe=A.jm;switch(BbO){case 0:Oe=AFR;break;case 1:Oe=AwA;break;case
...
throw new Error(AUP+BbO.toFixed());}return Oe;},_Init:function(aArg){C.EnumToString.
_Init.call(this,aArg);this.__proto__=C.OverlayMenuToString;},_className:"Device::OverlayMenuToString"
};C.ScanStateToString={BZ:function(A6){var Bck=A6;var Bn=A.jm;switch(Bck){case 4:
Bn=AwF;break;case 0:Bn=ArJ;break;case 2:Bn=AFU;break;case 3:Bn=AUQ;break;case 1:
Bn=AFV;break;default:throw new Error(AFW+Bck.toFixed());}return Bn;},_Init:function(
...
var Bax=A6;var Bn=A.jm;switch(Bax){case 4:Bn=AwF;break;case 0:Bn=ArJ;break;case 2:
Bn=AUR;break;case 1:Bn=AFV;break;case 3:Bn=AFX;break;default:throw new Error(AUS+
Bax.toFixed());}return Bn;},_Init:function(aArg){C.EnumToString._Init.call(this,
...
function(A6){var BcJ=A6;var Ao0=A.jm;switch(BcJ){case 0:Ao0=A.z2(A.abg.Bmm);break;
case 1:Ao0=A.z2(A.abg.Bmn);break;default:throw new Error(AUT+BcJ.toFixed());}return Ao0;
...
1,SheepLamb:2,LAST:3};C.AnimalTypeToString={BZ:function(A6){var BcA=A6;var type=
A.jm;switch(BcA){case 0:type=A.z2(A.abg.BdT);break;case 1:type=A.z2(A.abg.Bd6);break;
case 2:type=A.z2(A.abg.Bf4);break;default:throw new Error(AUU+BcA.toFixed());}return type;
...
A6;var Ae_=A.jm;switch(type){case 0:Ae_=A.z2(A.abg.Blm);break;case 1:Ae_=A.z2(A.
abg.Bmi);break;case 2:Ae_=A.z2(A.abg.Triplets);break;case 3:Ae_=A.z2(A.abg.Quadruplets
...
A6){var BcD=A6;var Bn=A.jm;switch(BcD){case 7:Bn=AwF;break;case 0:Bn=ArJ;break;case
6:Bn=AFX;break;case 2:Bn=AVb;break;case 5:Bn=AVc;break;case 3:Bn=AVd;break;case 4:
Bn=AVe;break;case 1:Bn=AVf;break;default:throw new Error(AVg+BcD.toFixed());}return Bn;
...
A6){var Ay6=A6;switch(Ay6){case 0:return A.jm;case 1:return A.z2(A.abg.BkE);case
4:return A.z2(A.abg.BkD);case 3:return A.z2(A.abg.BkF);case 2:return A.z2(A.abg.
BkC);default:throw new Error(AF3+Ay6.toFixed());}},Lh:function(A6){var Ay6=A6;switch(
...
case 5:Axx=A.jm;break;case 3:Axx=A.z2(A.abk.Bls);break;case 2:Axx=A.z2(A.abk.Blu
);break;case 1:Axx=A.z2(A.abk.Blt);break;default:throw new Error(AVh+AkB.toFixed(
...
9};C.PopupContext={AD5:null,AjP:A.jm,Aj_:0,PopupState:1,Id:0,Show:false,BjR:function(
...
this.GroupName=E;A.aat([this,this.Bhp,this.ADa],0);},Qv:function(){return this.Id;
},Bhp:function(){return this.GroupName;},_Init:function(aArg){C.Row._Init.call(this
...
BmF)+OQ;switch(AcD){case 0:Az=A.z2(A.abg.Unknown);break;case 1:Az=A.z2(A.abg.SevereError
);break;case 58:Az=A.z2(A.abg.BeJ);break;case 2:Az=A.z2(A.abg.BeH);break;case 3:
Az=A.z2(A.abg.Bmr);break;case 77:Az=A._GetAutoObject(C.Helper).BeX();break;case 78:
Az=A._GetAutoObject(C.Helper).BeV();break;case 79:Az=A._GetAutoObject(C.Helper).
BeW();break;case 9:Az=A.z2(A.abg.BmP);break;case 5:Az=A.z2(A.abg.SuccessDataSync
...
break;case 82:Az=A.z2(A.abg.BeL);break;case 83:Az=A.z2(A.abg.BeM);break;case 80:
Az=A.z2(A.abg.BlD);break;case 81:Az=A.z2(A.abg.SuccessRestoreBackup);break;case 92:
Az=A.z2(A.abg.BdJ);break;case 93:Az=A.z2(A.abg.BkQ);break;case 4:Az=A.z2(A.abg.WarningDataSync
);break;case 7:Az=A.z2(A.abg.BmM);break;case 33:Az=A.z2(A.abg.WarningResetAnimalData
...
A.z2(A.abg.APr))+OQ)+A.z2(A.abg.Bgj);break;case 50:Az=((AH1+A.z2(A.abg.APr))+OQ)+
A.z2(A.abg.Bgl);break;case 51:Az=((AH1+A.z2(A.abg.APr))+OQ)+A.z2(A.abg.Bgk);break;
case 42:Az=A.z2(A.abg.BmO);break;case 91:Az=A.z2(A.abg.WarningScanOverwriteNaisId
);break;case 45:Az=A.z2(A.abg.BmJ);break;case 46:Az=A.z2(A.abg.WarningNoValidCountryCode
...
z2(A.abg.Bdu);break;case 36:Az=A.z2(A.abg.Bmd);break;case 14:Az=A.z2(A.abg.AnimalNotFound
...
abg.SuccessCreationNewAnimals);break;case 24:Az=A.z2(A.abg.Bd9);break;case 49:Az=
A.z2(A.abg.EvaluationInProgress);break;case 16:Az=A.z2(A.abg.Bed);break;case 17:
Az=A.z2(A.abg.Blw);break;case 18:Az=A.z2(A.abg.BlI);break;case 19:Az=A.z2(A.abg.
Blx);break;case 20:Az=A.z2(A.abg.BlJ);break;case 54:Az=A.z2(A.abg.BlE);break;case
55:Az=A.z2(A.abg.BlH);break;case 21:Az=A.z2(A.abg.A2b);break;case 48:Az=(A.z2(A.
abg.A2b)+OQ)+A.z2(A.abg.A2Z);break;case 22:Az=A.z2(A.abg.Bgq);break;case 63:Az=A.
z2(A.abg.BmK);break;case 85:Az=A.z2(A.abg.BmL);break;case 43:Az=A.z2(A.abg.Bgr);
break;case 25:Az=A.z2(A.abg.A8l);break;case 47:Az=(A.z2(A.abg.A8l)+OQ)+A.z2(A.abg.
A2Z);break;case 31:{var BvG=(((((((((((((((((((A.z2(A.abg.Bd0)+Awy)+A.z2(A.abg.ALn
))+A.z2(A.abg.Colon))+N2)+A.z2(A.abg.Bd2))+OQ)+A.z2(A.abg.AMl))+A.z2(A.abg.Colon
))+N2)+A.z2(A.abg.BeR))+OQ)+A.z2(A.abg.ARL))+A.z2(A.abg.Colon))+N2)+A.z2(A.abg.BkH
))+OQ)+A.z2(A.abg.ARK))+A.z2(A.abg.Colon))+N2)+A.z2(A.abg.BkG);Az=BvG;}break;case
32:Az=A.z2(A.abg.Bme);break;case 69:Az=A.z2(A.abg.Bgy);break;case 44:Az=A.z2(A.abg.
BmN);break;case 37:Az=A.z2(A.abg.WarningResetWeightSettings);break;case 38:Az=A.
z2(A.abg.WarningResetTempThresholds);break;case 39:Az=A.z2(A.abg.Bkx);break;case
76:Az=(A.z2(A.abg.A2A)+OQ)+A.z2(A.abg.ARN);break;case 40:Az=A.z2(A.abg.BlF);break;
case 75:Az=A.z2(A.abg.Bly);break;case 59:Az=A.z2(A.abg.QuestionAddAnotherCalfMultiples
);break;case 62:Az=A.z2(A.abg.Blz);break;case 97:Az=A.z2(A.abg.BlA);break;case 60:
Az=A.z2(A.abg.BlB);break;case 99:Az=A.z2(A.abg.BlC);break;case 61:Az=A.z2(A.abg.
BlK);break;case 65:Az=A.z2(A.abg.SuccessClearAnimalLoss);break;case 66:Az=A.z2(A.
...
abg.BlG);break;case 70:Az=A.z2(A.abg.BeN);break;case 71:Az=A.z2(A.abg.BlN);break;
case 72:Az=A.z2(A.abg.BlO);break;case 98:Az=A.z2(A.abg.BeP);break;case 101:Az=A.
z2(A.abg.BlP);break;case 100:Az=A.z2(A.abg.BlQ);break;case 88:Az=A.z2(A.abg.BeO);
break;case 89:Az=A.z2(A.abg.BlL);break;case 90:Az=A.z2(A.abg.BlM);break;case 73:
...
A.abg.WarningNoBackupFilePresent);break;case 84:Az=A.z2(A.abg.Be4);break;case 87:
Az=A.z2(A.abg.BmR);break;case 96:Az=A.z2(A.abg.BmI);break;case 103:Az=A.z2(A.abg.
...
,HDX:2,HDX_URBAN:3,LAST:4};C.TransponderTypeToString={BZ:function(A6){var BcU=A6;
var type=A.jm;switch(BcU){case 1:type=AWl;break;case 2:type=AWm;break;case 3:type=
AGn;break;case 4:type=Anr;break;case 0:type=Awz;break;default:throw new Error(AGo+
BcU.toFixed());}return type;},_Init:function(aArg){C.EnumToString._Init.call(this
,aArg);this.__proto__=C.TransponderTypeToString;},_className:"Device::TransponderTypeToString"
};C.TransponderProtocolToString={BZ:function(A6){var BcT=A6;var Ay3=A.jm;switch(
BcT){case 1:Ay3=AWn;break;case 2:Ay3=AGp;break;case 3:Ay3=AGq;break;case 0:Ay3=Awz;
break;default:throw new Error(Ako+BcT.toFixed());}return Ay3;},_Init:function(aArg
...
E;A.aat([this,this.Bh0,this.ARi],0);},ARh:function(E){if(this.TransponderProtocol===
E)return;this.TransponderProtocol=E;A.aat([this,this.BhZ,this.ARh],0);},OnSetId:
function(E){if(this.Id===E)return;this.Id=E;A.aat([this,this.Qv,this.OnSetId],0);
},AMK:function(){return A._GetAutoObject(C.Converter).Bmc(this.Id);},Bfb:function(
){return A._GetAutoObject(C.Converter).Av9(this.Id);},Bh0:function(){return this.
TransponderType;},BhZ:function(){return this.TransponderProtocol;},Qv:function(){
...
Bau=A6;var Ao0=A.jm;switch(Bau){case 0:Ao0=A.z2(A.abg.Bf2);break;case 1:Ao0=A.z2(
A.abg.Pound);break;default:throw new Error(Ans+Bau.toFixed());}return Ao0;},_Init:
...
P=P+1)HR=HR+this.Get(P);return HR;},toString:function(){var A0a=this.Array.Get(0
).toFixed();var P;for(P=1;P<this.Mx;P=P+1)A0a=(A0a+OP)+this.Array.Get(P).toFixed(
);return A0a;},EK:function(aString){var IM=aString.indexOf(String.fromCharCode(0x2C
),0);var AY1=A.jm;var P=0;while(P<10){if(aString===A.jm)this.Array.Set(P,0);else{
if(IM===-1){AY1=aString;aString=A.jm;}else{AY1=A.aaX(aString,IM);aString=A.aa3(aString
,0,IM+1);}this.Array.Set(P,A.vQ(AY1,0,10));IM=aString.indexOf(String.fromCharCode(
...
A.abg.A3x);break;case 16:EL=A.z2(A.abg.AKg);break;case 1:EL=A.z2(A.abg.Temperature
...
A.z2(A.abg.A4F);break;case 32768:EL=A.z2(A.abg.AAh);break;case 524288:EL=A.z2(A.
abg.AAj);break;case 65536:EL=A.z2(A.abg.Delete);break;case 131072:EL=A.z2(A.abg.
A4G);break;case 0:EL=A.z2(A.abg.A43);break;default:throw new Error(AGs+AxT.toFixed(
...
A3x);break;case 16:EL=A.z2(A.abg.AKg);break;case 1:EL=A.z2(A.abg.Temperature);break;
...
z2(A.abg.A4E);break;case 32768:EL=A.z2(A.abg.AAh);break;case 524288:EL=A.z2(A.abg.
AAj);break;case 65536:EL=A.z2(A.abg.Delete);break;case 131072:EL=A.z2(A.abg.A4E);
break;case 0:EL=A.z2(A.abg.A43);break;default:throw new Error(AGs+AxT.toFixed());
...
C.Converter).A8o(Bxa);},Vb:function(Ab,AX){return 0;},RQ:function(Ab,AX){return 0;
},A35:function(Ab,AX){return this.CE(Ab,AX);},Op:function(){var Jg=0;var BxU=this.
...
);},A71:function(Ab,AX,CX){return this.G_(Ab,AX,CX);},AMD:function(Ab,AX){return this.
CE(Ab,AX);},Be$:function(Ab,AX){return this.CE(Ab,AX);},Bk9:function(Ab,AX,CX){return this.
G_(Ab,AX,CX);},Bk5:function(Ab,AX,CX){return this.G_(Ab,AX,CX);},K4:function(aColumn
,A1){return-1;},Al0:function(Ab,AX){return this.CE(Ab,AX);},Bk3:function(Ab,AX,CX
...
function(aColumn,A1){return-1;},G9:function(){return false;},Bfa:function(Ab,AX){
var Bxc=this.CE(Ab,AX);return A._GetAutoObject(C.Converter).BfA(Bxc);},Bfd:function(
Ab,AX){return this.CE(Ab,AX);},AMM:function(Ab,AX){return this.CE(Ab,AX);},Bk7:function(
Ab,AX,CX){var Bxd=A._GetAutoObject(C.Converter).A2H(CX);return this.G_(Ab,AX,Bxd
);},Bk8:function(Ab,AX,CX){return this.G_(Ab,AX,CX);},Bld:function(Ab,AX,CX){return this.
G_(Ab,AX,CX);},AiV:function(aColumn,A1){return false;},Af5:function(aColumn,A1){
return false;},Bfn:function(Ab,AX){return this.CE(Ab,AX);},Blb:function(Ab,AX,CX
...
BZ:function(A6){var Bcl=A6;var Aze=A.jm;switch(Bcl){case 0:Aze=A.z2(A.abg.Bd$);break;
case 1:Aze=A.z2(A.abg.BdP);break;case 2:Aze=A.z2(A.abg.BdM);break;case 3:Aze=A.z2(
A.abg.BgO);break;default:throw new Error(AGt+Bcl.toFixed());}return Aze;},_Init:
...
4,By6:5,BBJ:6,BzH:7,BAu:8,Bzf:9,BAt:10,BAT:11,LAST:12};C.AnimalListContentToString={
BZ:function(A6){var A_Y=A6;var Wv=A.jm;switch(A_Y){case 0:Wv=AWr;break;case 2:Wv=
...
A_Y.toFixed());}return Wv;},_Init:function(aArg){C.EnumToString._Init.call(this,
...
},_className:"Device::AnimalTypeFilterCriterion"};C.ByC={Ain:0,ByB:1,BAf:2,A7J:3
,A2Q:4,BBs:5,By5:6,BBr:7,LinkTransponder:8,O7:9,Weighing:10,Calving:11,LinkNaisId:
12,BAS:13,ClearBirthNoticePending:14,DeleteAnimal:15,ScanNaisId:16,Edit:17,ClearPurchaseNoticePending:
18};C.AutoRegistrationModeToString={BZ:function(A6){var Uu=A6;var Nm=A.jm;switch(
Uu){case 0:Nm=A.z2(A.abg.Bd3);break;case 1:Nm=A.z2(A.abg.BfE);break;case 2:Nm=A.
...
ASE={Init:function(aArg){var B;A.za([this,this.Bbw],[B=A._GetAutoObject(C.Device
...
AKz={Init:function(aArg){var B;A.za([this,this.Ba2],[B=A._GetAutoObject(C.Device
...
Bdk);default:return Akn+A6.toFixed();}},_Init:function(aArg){C.EnumToString._Init.
...
17,BzK:18,BzU:19,BzV:20,Bz0:21,Bz1:22,Bz2:23,Bz3:24,Bz9:25,BAl:26,BAm:27,BAA:28,
BAB:29,BAQ:30,BAR:31,BA7:32,BA8:33,BA9:34,BBl:35,BBm:36,BBC:37,A8p:38,BBD:39,LAST:
...
abn.BlU);break;case 7:Fq=A.z2(A.abn.BdX);break;case 8:Fq=A.z2(A.abn.Bea);break;case
9:Fq=A.z2(A.abn.Beb);break;case 10:Fq=A.z2(A.abn.Be5);break;case 11:Fq=A.z2(A.abn.
Bei);break;case 12:Fq=A.z2(A.abn.BeK);break;case 13:Fq=A.z2(A.abn.Blp);break;case
14:Fq=A.z2(A.abn.BeT);break;case 15:Fq=A.z2(A.abn.Be1);break;case 16:Fq=A.z2(A.abn.
Bfv);break;case 17:Fq=A.z2(A.abn.Bd_);break;case 18:Fq=A.z2(A.abn.BfB);break;case
19:Fq=A.z2(A.abn.BfL);break;case 20:Fq=A.z2(A.abn.BfX);break;case 21:Fq=A.z2(A.abn.
BfZ);break;case 22:Fq=A.z2(A.abn.Bgb);break;case 23:Fq=A.z2(A.abn.Bgf);break;case
24:Fq=A.z2(A.abn.Bf$);break;case 25:Fq=A.abn.Bgh;break;case 26:Fq=A.z2(A.abn.Bgz
);break;case 27:Fq=A.z2(A.abn.BgP);break;case 28:Fq=A.z2(A.abn.Bkq);break;case 29:
Fq=A.z2(A.abn.Bkr);break;case 30:Fq=A.z2(A.abn.BkR);break;case 31:Fq=A.z2(A.abn.
BkT);break;case 32:Fq=A.z2(A.abn.BlT);break;case 33:Fq=A.z2(A.abn.Blo);break;case
34:Fq=A.z2(A.abn.Bln);break;case 35:Fq=A.z2(A.abn.Bmh);break;case 36:Fq=A.z2(A.abn.
Bl3);break;case 37:Fq=A.z2(A.abn.Bml);break;case 38:Fq=A.z2(A.abn.A8p);break;case
39:Fq=A.z2(A.abn.Bmk);break;case 0:Fq=Ant;break;default:throw new Error(Awq+N8.toFixed(
...
BZ:function(A6){var A$v=A6;var Asg=A.jm;switch(A$v){case 0:Asg=A.z2(A.abg.Unspecified
...
throw new Error(AwP+A$v.toFixed());}return Asg;},_Init:function(aArg){C.EnumToString.
...
10,LAST:11};C.WhereAboutsToString={BZ:function(A6){var Bc$=A6;var ZY=A.jm;switch(
Bc$){case 0:ZY=A.z2(A.abg.Unknown);break;case 1:ZY=A.z2(A.abg.Bmt);break;case 2:
ZY=A.z2(A.abg.Bms);break;case 3:ZY=A.z2(A.abg.BmB);break;case 4:ZY=A.z2(A.abg.BmA
);break;case 5:ZY=A.z2(A.abg.Bmy);break;case 6:ZY=A.z2(A.abg.Bmv);break;case 7:ZY=
A.z2(A.abg.Bmx);break;case 8:ZY=A.z2(A.abg.Bmw);break;case 9:ZY=A.z2(A.abg.Bmu);
break;case 10:ZY=A.z2(A.abg.Bmz);break;default:throw new Error(AWE+Bc$.toFixed()
...
};C.Ia={AnimalId:0,TransponderId:1,BAa:2,Bz$:3,BAd:4,BAc:5};C.Aty={ByF:0,Bza:1};
...
};C.DirectionOfCountingToString={BZ:function(A6){var AxS=A6;var AY8=A.jm;switch(
AxS){case 0:AY8=AWI;break;case 1:AY8=AWJ;break;default:throw new Error(ArP+AxS.toFixed(
...
};C.Ph={UNDEFINED:0,SH:1,AMP:2,APv:3,AMO:4,A4X:5,HE:6,A7H:7,A2r:8,AKK:9,ARX:10,BE:
11,BB:12,A4L:13,ARY:14,ARZ:15,ASx:16};C.GermanStateToString={BZ:function(A6){var
...
);break;case 8:Go=A.z2(A.abp.A2r);break;case 9:Go=A.z2(A.abp.AKK);break;case 10:
Go=A.z2(A.abp.ARX);break;case 11:Go=A.z2(A.abp.BE);break;case 12:Go=A.z2(A.abp.BB
);break;case 13:Go=A.z2(A.abp.A4L);break;case 14:Go=A.z2(A.abp.ARY);break;case 15:
...
A.jm;switch(Bn){case 1:Go=A.z2(A.abp.BkU);break;case 2:Go=A.z2(A.abp.AMP);break;
case 3:Go=A.z2(A.abp.APv);break;case 4:Go=A.z2(A.abp.AMO);break;case 5:Go=A.z2(A.
abp.Bgw);break;case 6:Go=A.z2(A.abp.HE);break;case 7:Go=A.z2(A.abp.BkB);break;case
8:Go=A.z2(A.abp.BdB);break;case 9:Go=A.z2(A.abp.AKK);break;case 10:Go=A.z2(A.abp.
ARX);break;case 11:Go=A.z2(A.abp.BE);break;case 12:Go=A.z2(A.abp.BB);break;case 13:
Go=A.z2(A.abp.Bgg);break;case 14:Go=A.z2(A.abp.ARY);break;case 15:Go=A.z2(A.abp.
ARZ);break;case 16:Go=A.z2(A.abp.ASx);break;case 0:Go=Ant;break;default:throw new
Error(Ahe+Bn.toFixed());}return Go;},Bl8:function(A6){var Bn=A6;var FX=-1;switch(
...
throw new Error(Ahe+Bn.toFixed());}return FX;},Bl9:function(A6){var Bn=A6;var FX=
...
Uu){case 0:Nm=A.z2(A.abg.Bkj);break;case 1:Nm=A.z2(A.abg.Bmj);break;default:throw new
...
};C.Byz={BAr:0,BAh:1,Bzq:2,Bzr:3,Bzs:4,BBn:5};C.EnumToCodeset={AlL:function(Ahh){
...
},_className:"Device::BreedToHitCodeset"};C.ReasonOfLeaving={Unknown:0,A8b:1,SW:
2,A7C:3,A4p:4,BAz:5,A8q:6,A4T:7,A2P:8,A7y:9,A4R:10,A2T:11,BAO:12,BAP:13,LAST:14};
...
abg.SW);break;case 3:SQ=A.z2(A.abg.A7C);break;case 4:SQ=A.z2(A.abg.A4p);break;case
5:SQ=A.z2(A.abg.Bkk);break;case 6:SQ=A.z2(A.abg.A8q);break;case 7:SQ=A.z2(A.abg.
...
Bku);break;case 13:SQ=A.z2(A.abg.Bkt);break;default:throw new Error(AwT+AcE.toFixed(
...
E)return;this.Deregistrations=E;A.aat([this,this.Bhf,this.Au3],0);},Au2:function(
E){if(this.Deaths===E)return;this.Deaths=E;A.aat([this,this.Bhd,this.Au2],0);},AjN:
function(E){if(this.Year===E)return;this.Year=E;A.aat([this,this.Aqe,this.AjN],0
);},Bhf:function(){return this.Deregistrations;},Bhd:function(){return this.Deaths;
...
};C.Atw={Undefined:0,Display:1,A7G:2,A7S:3,A8I:4,BzL:5,BAY:6,BBy:7,Bz_:8,By1:9,Byo:
10,A3R:11,A7I:12,BBF:13,A4W:14,BBI:15};C.DeviceComponentToString={BZ:function(A6
){var A$p=A6;var PU=A.jm;switch(A$p){case 0:PU=AWX;break;case 10:PU=A.z2(A.abg.Bda
);break;case 9:PU=A.z2(A.abg.BdW);break;case 1:PU=A.z2(A.abg.BeA);break;case 11:
PU=A.z2(A.abg.A3R);break;case 5:PU=A.z2(A.abg.BmC);break;case 8:PU=A.z2(A.abg.BeC
);break;case 14:PU=A.z2(A.abg.A4W);break;case 2:PU=A.z2(A.abg.A7G);break;case 12:
PU=A.z2(A.abg.A7I);break;case 6:PU=A.z2(A.abg.BkA);break;case 3:PU=A.z2(A.abg.A7S
);break;case 7:PU=A.z2(A.abg.BeD);break;case 13:PU=A.z2(A.abg.Bel);break;case 15:
PU=A.z2(A.abg.BmG);break;case 4:PU=A.z2(A.abg.A8I);break;default:throw new Error(
AWY+A$p.toFixed());}return PU;},_Init:function(aArg){C.EnumToString._Init.call(this
...
};C.AdT={Arl:function(A6){return A.zW(A.abi.ANW);},Arm:function(A6){var A$z=A6;var
Q$=-1;switch(A$z){case 0:Q$=0;break;case 1:Q$=1;break;case 2:Q$=2;break;default:
throw new Error(AGz+A$z.toFixed());}return Q$;},_Init:function(aArg){C.EnumToIcon.
...
};C.BAk={ALN:0,By8:1,ANy:2,LAST:3};C.BBp={Gt:0,AS9:1,G5:2,Year:3,LAST:4};C.TimespanDaysToString={
BZ:function(A6){var BcM=A6;var Azs=A.jm;switch(BcM){case 0:Azs=A.z2(A.abg.A28);break;
case 1:Azs=A.z2(A.abg.AS9);break;case 2:Azs=A.z2(A.abg.G5);break;case 3:Azs=A.z2(
A.abg.Year);break;default:throw new Error(AWZ+BcM.toFixed());}return Azs;},_Init:
function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=C.TimespanDaysToString;
},_className:"Device::TimespanDaysToString"};C.Akc={BAw:0,Bzb:1,BzR:2,BzT:3,BzS:
4,Bzc:5,LAST:6};C.USBStateToString={BZ:function(A6){var Bc6=A6;var Bn=A.jm;switch(
Bc6){case 0:Bn=AW0;break;case 2:Bn=AW1;break;case 1:Bn=AW2;break;case 5:Bn=AW3;break;
case 3:Bn=AW4;break;case 4:Bn=AW5;break;default:throw new Error(AFW+Bc6.toFixed(
));}return Bn;},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=
C.USBStateToString;},_className:"Device::USBStateToString"};C.AAz={BzP:0,ByA:1,BzQ:
2,BzN:3};C.AvZ={AAv:A.jm,Timestamp:0,ACa:0,ACi:0,AEp:0,OnSetTimestamp:function(E
...
};C.Ape={Undefined:0,BzB:1,ByN:2};C.AfK={Manual:0,TransponderId:1,LAST:2};C.AnimalIdAutoGenerationMethodToString={
BZ:function(A6){var A_W=A6;var AYB=A.jm;switch(A_W){case 0:AYB=A.z2(A.abg.A2Y);break;
case 1:AYB=A.z2(A.abg.A3c);break;default:throw new Error(AW6+A_W.toFixed());}return AYB;
},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=C.AnimalIdAutoGenerationMethodToString;
},_className:"Device::AnimalIdAutoGenerationMethodToString"};C.G5={A2F:0,AB1:1,AAS:
2,ACb:3,AzT:4,ACe:5,AB3:6,AB2:7,Az1:8,AEw:9,ACs:10,ACq:11,AAC:12,LAST:13};C.MonthToString={
BZ:function(A6){var Baz=A6;var WK=A.jm;switch(Baz){case 1:WK=A.z2(A.abu.AB1);break;
...
12:WK=A.z2(A.abu.AAC);break;default:throw new Error(AGA+Baz.toFixed());}return WK;
...
};C.AlC={BzI:0,BBe:1};C.ATe={Init:function(aArg){var B;A.za([this,this.BbI],[B=A.
...
};C.ATd={Init:function(aArg){var B;A.za([this,this.BbG],[B=A._GetAutoObject(C.Device
...
ATg={Init:function(aArg){var B;A.za([this,this.BbK],[B=A._GetAutoObject(C.Device
...
C.ATc={Init:function(aArg){var B;A.za([this,this.BbE],[B=A._GetAutoObject(C.Device
...
C.AKA={Init:function(aArg){var B;A.za([this,this.Ba3],[B=A._GetAutoObject(C.Device
...
};C.BAn={BAq:0,BAe:1,By7:2,BBG:3,Unknown:4};C.ByL={None:0,BAx:1,BAs:2,BAo:3,BAp:
4};C.Ag6={A47:0,Manual:1,TransponderId:2,LAST:3};C.TransponderAssignmentIdChangeMethodToString={
BZ:function(A6){var BcQ=A6;var AJi=A.jm;switch(BcQ){case 0:AJi=A.z2(A.abg.A47);break;
case 1:AJi=A.z2(A.abg.A2Y);break;case 2:AJi=A.z2(A.abg.A3c);break;default:throw new
Error(AW7+BcQ.toFixed());}return AJi;},_Init:function(aArg){C.EnumToString._Init.
call(this,aArg);this.__proto__=C.TransponderAssignmentIdChangeMethodToString;},_className:
"Device::TransponderAssignmentIdChangeMethodToString"};C.A7z={Bw6:function(A_y){
var Nn=A.aa2(A.aaX(A_y,15),0,10);if(!A._GetAutoObject(C.Converter).AeF(Nn))return 0;
return A.aa2(A.aaX(A_y,15),0,10);},Bw5:function(AHV){if(AHV.length<8)return 0;var
AyW=A._NewObject(A.Core.Bu,0);var Bxu=A.aaY(AHV,4,4);var AZG=A.vQ(Bxu,0,10);if((
AZG<2000)||(AZG>2100))return 0;AyW.Year=AZG;var Bxt=A.aaY(AHV,2,2);var AZF=A.vQ(
Bxt,0,10);if((AZF<1)||(AZF>12))return 0;AyW.TE(AZF);var Bxs=A.aaX(AHV,2);var AZE=
A.vQ(Bxs,0,10);if((AZE<1)||(AZE>AyW.Yx()))return 0;AyW.Lb(AZE);return AyW.JL();}
...
};C.AvI={_Init:function(){C.A7z._Init.call(this,0);},_variants:function(){return this;
...
A.abg.Breed);break;case 4:FE=A.z2(A.abg.AfW);break;case 28:FE=A.z2(A.abg.A2L);break;
...
case 38:FE=A.z2(A.abg.BeB);break;case 11:FE=A.z2(A.abg.Fever);break;case 27:FE=A.
...
BuL=A6;var AY3=A.jm;switch(BuL){case 0:AY3=A.abg.Bfw;break;case 1:AY3=A.abg.Bec;
break;default:throw new Error(AW9+A6.toFixed());}return AY3;},_Init:function(aArg
){C.EnumToString._Init.call(this,aArg);this.__proto__=C.DataExportDestinationToString;
},_className:"Device::DataExportDestinationToString"};C.AB_={Bc:0,BBi:1,LAST:2};
C.ListViewScopeToString={BZ:function(A6){var BvR=A6;var AZ1=A.jm;switch(BvR){case
0:AZ1=AW_;break;case 1:AZ1=AW$;break;default:throw new Error(AXa+A6.toFixed());}
return AZ1;},_Init:function(aArg){C.EnumToString._Init.call(this,aArg);this.__proto__=
