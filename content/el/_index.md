...
<p class="lead mt-5">Διαχείριση υγείας στο υψηλότερο επίπεδο!</p>
{{< blocks/link-down color="info" >}}
{{< /blocks/cover >}}

{{% blocks/lead color="primary" %}}

**Μειώστε** τα **χαρτιά**<br/> 

**Αυξήστε** την **υγεία των ζώων σας**

Έχετε **όλα** σε **μια ματιά** <br/> 

Με μόλις **μία συσκευή** <br/>   
{{% /blocks/lead %}}


{{< blocks/section color="dark" type="row" >}}
{{% blocks/feature3 icon="fa-flag" title="16 Γλώσσες" %}}
<br>
...
{{% blocks/feature3 icon="fa-temperature-quarter" title="14 Δράσεις" %}}
<br>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="images/actions/temperature.png" alt="Θερμοκρασία">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Ζύγιση</h3>
      </div>
      <img src="images/actions/weighing.png" alt="Ζύγιση">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Αξιολόγηση</h3>
      </div>
      <img src="images/actions/rating.png" alt="Αξιολόγηση">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Αλυσίδα δράσεων</h3>
      </div>
      <img src="images/actions/chain_of_actions.png" alt="Αλυσίδα δράσεων">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Συναγερμός</h3>
      </div>
      <img src="images/actions/alarm.png" alt="Συναγερμός">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Σε επιφυλακή</h3>
      </div>
      <img src="images/actions/on_watch.png" alt="Σε επιφυλακή">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Ιστορικό ζώου</h3>
      </div>
      <img src="images/actions/animal_history.png" alt="Ιστορικό ζώου">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Επεξεργασία</h3>
      </div>
      <img src="images/actions/edit.png" alt="Επεξεργασία">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Κατάργηση εγγραφής</h3>
      <img src="images/actions/unregister.png" alt="Κατάργηση εγγραφής">
      </div>
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
      ...
      <img src="images/actions/animal_loss.png" alt="Απώλεια ζώου">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Σύνδεση τρανσπόντερ</h3>
      </div>
      <img src="images/actions/link_transponder.png" alt="Σύνδεση τρανσπόντερ">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Αποσύνδεση τρανσπόντερ</h3>
      </div>
      <img src="images/actions/unlink_transponder.png" alt="Αποσύνδεση τρανσπόντερ">
    </div>      
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Σύνδεση ταυτότητας ζώου</h3>
      </div>
      <img src="images/actions/link_animal_ID.png" alt="Σύνδεση ταυτότητας ζώου">
    </div>   
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Σύνδεση ηλεκτρονικής ταυτότητας ζώου</h3>
      </div>
      <img src="images/actions/link_animal_ID2.png" alt="Σύνδεση ηλεκτρονικής ταυτότητας ζώου">
    </div>             
  </div>
...
{{% blocks/feature3 icon="fa-table-list" title="5 Λίστες" %}}
<br>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="images/lists/alarm.png" alt="Συναγερμός">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Υπό Παρακολούθηση</h3>
      </div>
      <img src="images/lists/on_watch.png" alt="Υπό Παρακολούθηση">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Λίστα Ενεργειών</h3>
      </div>      
      <img src="images/lists/action_list.png" alt="Λίστα Ενεργειών">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Φρέσκες Αγελάδες</h3>
      </div>
      <img src="images/lists/fresh_cows.png" alt="Φρέσκες Αγελάδες">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Ξηρές Αγελάδες</h3>
      </div>
    <img src="images/lists/dry_cows.png" alt="Ξηρές Αγελάδες">
    </div>
  </div>
...
{{% blocks/feature3 icon="fa-chart-line" title="4 Αξιολογήσεις" %}}
<br>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="images/evaluation/weight.png" alt="Αξιολόγηση βάρους">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Θερμοκρασία</h3>
      </div> 
      <img src="images/evaluation/temperature.png" alt="Αξιολόγηση θερμοκρασίας">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Βαθμολογία</h3>
      </div> 
      <img src="images/evaluation/rating.png" alt="Αξιολόγηση βαθμολογίας">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Θνησιμότητα</h3>
      </div> 
      <img src="images/evaluation/mortality.png" alt="Αξιολόγηση θνησιμότητας">
    </div>
  </div>
...
{{< blocks/section color="dark" type="row" >}}
{{% blocks/feature3 icon="empty" title="Καταγράψτε <br> τις γεννήσεις σας" %}}
<br>
<img src="images/calving.png" alt="births" />
<br>
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="empty" title="Παρακολουθήστε <br> τις φρέσκες αγελάδες σας" %}}
<br>
<img src="images/fresh_cows.png" alt="Fresh-cows" />
<br>
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="empty" title="Σκανάρετε τα<br>διαβατήρια των ζώων" %}}
<br>
<img src="images/scan.png" alt="Bulk-recording" />
<br>
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="empty" title="Αναφέρετε τις <br> αγορές σας εύκολα" %}}
<br>
...
{{% blocks/feature3 icon="fa-brands fa-instagram" title="Instagram" url="https://www.instagram.com/urban_fuetterungstechnik/" url_text="Ακολουθήστε"%}}
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="fa-brands fa-youtube" title="YouTube" url="https://www.youtube.com/user/calffeeding" url_text="Ρίξτε μια ματιά"%}}
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="fa-brands fa-facebook" title="Facebook" url="https://www.facebook.com/urbanonline" url_text="Ακολουθήστε"%}}
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="fa-light fa-image" title="Φωτογραφίες" url="https://www.flickr.com/photos/urbanonline/" url_text="Συλλέξτε εντυπώσεις"%}}
{{% /blocks/feature3 %}}
