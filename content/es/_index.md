...
{{% blocks/feature3 icon="fa-flag" title="16 Idiomas" %}}
<br>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="/images/homescreen/german.png" alt="Alemán">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Holandés</h3>
      </div>
      <img src="/images/homescreen/dutch.png" alt="Holandés">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Inglés</h3>
      </div>
      <img src="/images/homescreen/english.png" alt="Inglés">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Finés</h3>
      </div>
      <img src="/images/homescreen/finnish.png" alt="Finés">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Francés</h3>
      </div>
      <img src="/images/homescreen/french.png" alt="Francés">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Ruso</h3>
      </div>
    <img src="/images/homescreen/russian.png" alt="Ruso">
    </div>  
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Español</h3>
      </div>
    <img src="/images/homescreen/spanish.png" alt="Español">
    </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Bosnio</h3>
        </div>
      <img src="/images/homescreen/bosnian.png" alt="Bosnio">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Búlgaro</h3>
        </div>
      <img src="/images/homescreen/bulgarian.png" alt="Búlgaro">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Chino</h3>
        </div>
      <img src="/images/homescreen/chinese.png" alt="Chino">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Checo</h3>
        </div>
      <img src="/images/homescreen/czech.png" alt="Checo">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Noruego</h3>
        </div>
      <img src="/images/homescreen/norwegian.png" alt="Noruego">
      </div>
      <div the="carousel-item">
        <div class="position-relative text-center">
          <h3>Griego</h3>
        </div>
      <img src="/images/homescreen/greek.png" alt="Griego">
      </div>      
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Turco</h3>
        </div>
      <img src="/images/homescreen/turkish.png" alt="Turco">
      </div> 
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Ucraniano</h3>
        </div>
      <img src="/images/homescreen/ukrainian.png" alt="Ucraniano">
      </div> 
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Estonio</h3>
        </div>
      <img src="/images/homescreen/estonian.png" alt="Estonio">
      </div> 
  </div>
...
<div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <img src="images/actions/chain_of_actions.png" alt="Cadena de acciones">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Alarma</h3>
    ...
    <div class="carousel-item">
      ...
      <img src="images/actions/link_animal_ID2.png" alt="Vincular ID del animal">
    </div>             
  </div>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="images/lists/alarm.png" alt="Alarma">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
...
<div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <img src="images/evaluation/mortality.png" alt="Mortalidad de la evaluación">
    </div>
  </div>
...
{{% blocks/feature icon="empty" title="Corderos" %}}
<br>
...
{{% blocks/feature3 icon="empty" title="Escanea pasaportes<br>de animales" %}}
<br>
...
{{% blocks/feature3 icon="fa-brands fa-instagram" title="Instagram" url="https://www.instagram.com/urban_fuetterungstechnik/" url_text="Síguenos"%}}
{{% /blocks/feature3 %}}
