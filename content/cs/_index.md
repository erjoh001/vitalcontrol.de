...
<p class="lead mt-5">Správa zdraví na nejvyšší úrovni!</p>
{{< blocks/link-down color="info" >}}
{{< /blocks/cover >}}

{{% blocks/lead color="primary" %}}

**Snižte** **papírování**<br/> 

**Zvyšte** **zdraví zvířat**

Mějte **vše** na **dohled** <br/> 

S **jedním zařízením** <br/>   
{{% /blocks/lead %}}


{{< blocks/section color="dark" type="row" >}}
{{% blocks/feature3 icon="fa-flag" title="17 jazyků" %}}
<br>
...
{{% blocks/feature3 icon="fa-temperature-quarter" title="14 Akcí" %}}
<br>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="images/actions/temperature.png" alt="Teplota">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Vážení</h3>
      </div>
      <img src="images/actions/weighing.png" alt="Vážení">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Hodnocení</h3>
      </div>
      <img src="images/actions/rating.png" alt="Hodnocení">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Řetězec akcí</h3>
      </div>
      <img src="images/actions/chain_of_actions.png" alt="Řetězec akcí">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Alarm</h3>
    ...
    <div class="carousel-item">
      ...
      <img src="images/actions/on_watch.png" alt="Na hlídce">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Historie zvířete</h3>
      </div>
      <img src="images/actions/animal_history.png" alt="Historie zvířete">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Upravit</h3>
      </div>
      <img src="images/actions/edit.png" alt="Upravit">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Odregistrovat</h3>
      <img src="images/actions/unregister.png" alt="Odregistrovat">
      </div>
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
      ...
      <img src="images/actions/animal_loss.png" alt="Ztráta zvířete">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Připojit transpondér</h3>
      </div>
      <img src="images/actions/link_transponder.png" alt="Připojit transpondér">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Odpojit transpondér</h3>
      </div>
      <img src="images/actions/unlink_transponder.png" alt="Odpojit transpondér">
    </div>      
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Připojit ID zvířete</h3>
      </div>
      <img src="images/actions/link_animal_ID.png" alt="Připojit ID zvířete">
    </div>   
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Připojit ID zvířete</h3>
      </div>
      <img src="images/actions/link_animal_ID2.png" alt="Připojit ID zvířete">
    </div>             
  </div>
...
{{% blocks/feature3 icon="fa-table-list" title="5 Seznamů" %}}
<br>
...
<div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <img src="images/lists/on_watch.png" alt="Na hlídce">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Seznam akcí</h3>
      </div>      
      <img src="images/lists/action_list.png" alt="Seznam akcí">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Čerstvé krávy</h3>
      </div>
      <img src="images/lists/fresh_cows.png" alt="Čerstvé krávy">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Suché krávy</h3>
      </div>
    <img src="images/lists/dry_cows.png" alt="Suché krávy">
    </div>
  </div>
...
{{% blocks/feature3 icon="fa-chart-line" title="4 Hodnocení" %}}
<br>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="images/evaluation/weight.png" alt="Hodnocení váhy">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Teplota</h3>
      </div> 
      <img src="images/evaluation/temperature.png" alt="Hodnocení teploty">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Hodnocení</h3>
      </div> 
      <img src="images/evaluation/rating.png" alt="Hodnocení hodnocení">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Úmrtnost</h3>
      </div> 
      <img src="images/evaluation/mortality.png" alt="Hodnocení úmrtnosti">
    </div>
  </div>
...
{{% blocks/feature icon="empty" title="Telata" %}}
<br>
<img src="/icons/animals/calf.svg" width="180" align="bottom" alt="Telata" />
<br>
{{% /blocks/feature %}}

{{% blocks/feature icon="empty" title="Krávy" %}}
<br>
<img src="/icons/animals/cow.svg" width="180" align="bottom" alt="Krávy" />
<br>
{{% /blocks/feature %}}

{{% blocks/feature icon="empty" title="Jehňata" %}}
<br>
<img src="/icons/animals/lamb.svg" width="180" align="bottom" alt="Jehňata" />
<br>
{{% /blocks/feature %}}
...
{{< blocks/section color="dark" type="row" >}}
{{% blocks/feature3 icon="empty" title="Zaznamenejte <br> své porody" %}}
<br>
<img src="images/calving.png" alt="porody" />
<br>
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="empty" title="Monitorujte <br> své čerstvé krávy" %}}
<br>
<img src="images/fresh_cows.png" alt="Čerstvé krávy" />
<br>
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="empty" title="Skenujte zvířecí<br>pasporty" %}}
<br>
<img src="images/scan.png" alt="Hromadné nahrávání" />
<br>
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="empty" title="Snadno hlaste <br> své nákupy" %}}
<br>
<img src="images/purchased.png" alt="Nákupy" />
<br>
{{% /blocks/feature3 %}}
...
{{% blocks/feature3 icon="fa-brands fa-instagram" title="Instagram" url="https://www.instagram.com/urban_fuetterungstechnik/" url_text="Sledujte"%}}
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="fa-brands fa-youtube" title="YouTube" url="https://www.youtube.com/user/calffeeding" url_text="Podívejte se"%}}
{{% /blocks/feature3 %}}


{{% blocks/feature3 icon="fa-brands fa-facebook" title="Facebook" url="https://www.facebook.com/urbanonline" url_text="Sledujte"%}}
{{% /blocks/feature3 %}}

{{% blocks/feature3 icon="fa-light fa-image" title="Fotky" url="https://www.flickr.com/photos/urbanonline/" url_text="Získejte dojmy"%}}
{{% /blocks/feature3 %}}
