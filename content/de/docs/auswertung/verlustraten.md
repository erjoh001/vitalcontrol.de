...
2. Es öffnet sich ein weiteres Untermenü in dem Sie mit den Pfeiltasten △ ▽ ◁ ▷ zwischen den Menüpunkten `Gewicht`, `Temperatur`, `Bewertung` und `Verlustrate` wählen können. Wählen Sie den Menüpunkt &nbsp;<img src="/icons/actions/mortality.svg" width="40" align="bottom" alt="Verlustraten" />&nbsp; `Verlustraten` und bestätigen Sie mit `OK`.
