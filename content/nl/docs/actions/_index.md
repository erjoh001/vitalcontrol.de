...
1. Select the menu item  <img src="/icons/actions.svg" width="40" align="bottom" alt="Acties" /> `Acties` on the main screen of your VitalControl device and press the `OK` button.
