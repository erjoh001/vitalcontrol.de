...
{{% blocks/feature3 icon="fa-flag" title="16 Langues" %}}
<br>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="/images/homescreen/german.png" alt="Allemand">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Néerlandais</h3>
      </div>
      <img src="/images/homescreen/dutch.png" alt="Néerlandais">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Anglais</h3>
      </div>
      <img src="/images/homescreen/english.png" alt="Anglais">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Finnois</h3>
      </div>
      <img src="/images/homescreen/finnish.png" alt="Finnois">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Français</h3>
      </div>
      <img src="/images/homescreen/french.png" alt="Français">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Russe</h3>
      </div>
    <img src="/images/homescreen/russian.png" alt="Russe">
    </div>  
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Espagnol</h3>
      </div>
    <img src="/images/homescreen/spanish.png" alt="Espagnol">
    </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Bosniaque</h3>
        </div>
      <img src="/images/homescreen/bosnian.png" alt="Bosniaque">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Bulgare</h3>
        </div>
      <img src="/images/homescreen/bulgarian.png" alt="Bulgare">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Chinois</h3>
        </div>
      <img src="/images/homescreen/chinese.png" alt="Chinois">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Tchèque</h3>
        </div>
      <img src="/images/homescreen/czech.png" alt="Tchèque">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Norvégien</h3>
        </div>
      <img src="/images/homescreen/norwegian.png" alt="Norvégien">
      </div>
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Grec</h3>
        </div>
      <img src="/images/homescreen/greek.png" alt="Grec">
      </div>      
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Turc</h3>
        </div>
      <img src="/images/homescreen/turkish.png" alt="Turc">
      </div> 
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Ukrainien</h3>
        </div>
      <img src="/images/homescreen/ukrainian.png" alt="Ukrainien">
      </div> 
      <div class="carousel-item">
        <div class="position-relative text-center">
          <h3>Estonien</h3>
        </div>
      <img src="/images/homescreen/estonian.png" alt="Estonien">
      </div> 
  </div>
...
<div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <img src="images/actions/edit.png" alt="Modifier">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Désinscrire</h3>
    ...
    <div class="carousel-item">
      ...
      <img src="images/actions/link_animal_ID.png" alt="Lier l'ID de l'animal">
    </div>   
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Lier l'ID de l'animal</h3>
...
<div class="carousel-inner">
    ...
    <img src="images/lists/dry_cows.png" alt="Vaches taries">
    </div>
  </div>
...
<div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <img src="images/evaluation/weight.png" alt="Poids de l'évaluation">
    </div>
    <div class="carousel-item">
      <div class="position-relative text-center">
        <h3>Température</h3>
...
{{% blocks/feature icon="empty" title="Agneaux" %}}
<br>
...
{{% blocks/feature3 icon="empty" title="Scannez les<br>passports des animaux" %}}
<br>
...
{{% blocks/feature3 icon="fa-brands fa-instagram" title="Instagram" url="https://www.instagram.com/urban_fuetterungstechnik/" url_text="Suivez"%}}
{{% /blocks/feature3 %}}
