...
<figure class="figure" style="margin-top: 10px;">
    ...
    <figcaption class="figure-caption fs-6">Figure 3: Close USB port again</figcaption>
</figure>
...
<figure class="figure" style="margin-top: 25px;">
    ...
    <figcaption class="figure-caption fs-6">Figure 4: Mandatory closing of USB port</figcaption>
</figure>
</div>
</div>
