...
The action <img src="/icons/edit.svg" width="25" align="bottom" alt="Settings" /> `edit` allows you to change the animal data of the selected animal directly. This function makes it easier to correct the animal data if, for example, it becomes apparent during the animal inspection that the gender has been saved incorrectly. You can change the following data:
...
3. A submenu with the animal actions opens. Use the arrow keys ◁ ▷ △ ▽ to select the action <img src="/icons/edit.svg" width="25" align="bottom" alt="Settings" /> `edit` and confirm with `OK`.
